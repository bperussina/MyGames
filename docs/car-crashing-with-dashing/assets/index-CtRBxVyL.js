var Kf=n=>{throw TypeError(n)};var Pr=(n,e,t)=>e.has(n)?Kf("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(n):e.set(n,t);function Jf(n,e){for(var t=0;t<e.length;t++){const i=e[t];if(typeof i!="string"&&!Array.isArray(i)){for(const r in i)if(r!=="default"&&!(r in n)){const s=Object.getOwnPropertyDescriptor(i,r);s&&Object.defineProperty(n,r,s.get?s:{enumerable:!0,get:()=>i[r]})}}}return Object.freeze(Object.defineProperty(n,Symbol.toStringTag,{value:"Module"}))}(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function t(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerPolicy&&(s.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?s.credentials="include":r.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(r){if(r.ep)return;r.ep=!0;const s=t(r);fetch(r.href,s)}})();function Qf(n=document.body){const e=document.createElement("canvas");e.style.display="block",n.appendChild(e);const t=e.getContext("2d");function i(){e.width=window.innerWidth,e.height=window.innerHeight}return i(),window.addEventListener("resize",i),{canvas:e,ctx:t,resize:i}}function Vl(n,e="#1a1a2e"){n.fillStyle=e,n.fillRect(0,0,n.canvas.width,n.canvas.height)}const ep=new Set(["arrowup","arrowdown","arrowleft","arrowright"," ","w","a","s","d","x","e","r","l","b"]);class tp{constructor(e=window){this.keys=new Set,this.pointer={x:0,y:0,down:!1},document.addEventListener("keydown",t=>{const i=t.key.toLowerCase();this.keys.add(i),ep.has(i)&&t.preventDefault()}),document.addEventListener("keyup",t=>{this.keys.delete(t.key.toLowerCase())}),e.addEventListener("pointermove",t=>{this.pointer.x=t.clientX,this.pointer.y=t.clientY}),e.addEventListener("pointerdown",t=>{this.pointer.x=t.clientX,this.pointer.y=t.clientY,this.pointer.down=!0,e.focus&&e.focus()}),e.addEventListener("pointerup",()=>{this.pointer.down=!1})}isDown(e){return this.keys.has(e.toLowerCase())}isPressed(...e){return e.some(t=>this.isDown(t))}}function np(n){let e=0,t=performance.now();function i(r){const s=(r-t)/1e3;t=r,n(s),e=requestAnimationFrame(i)}return e=requestAnimationFrame(i),()=>cancelAnimationFrame(e)}function Fa(n,e,t,i,r={}){const{color:s="#ffffff",size:o=24,align:a="center",baseline:c="middle",font:l="sans-serif"}=r;n.fillStyle=s,n.font=`${o}px ${l}`,n.textAlign=a,n.textBaseline=c,n.fillText(e,t,i)}const Wl=.18;function ip(){var e;return(((e=navigator.getGamepads)==null?void 0:e.call(navigator))??[]).find(t=>t==null?void 0:t.connected)??null}function rp(n){var i,r,s,o;let e=0,t=0;if(n){const a=n.axes[0]??0,c=n.axes[1]??0;Math.abs(a)>Wl&&(e+=a),Math.abs(c)>Wl&&(t-=c),(i=n.buttons[14])!=null&&i.pressed&&(e-=1),(r=n.buttons[15])!=null&&r.pressed&&(e+=1),(s=n.buttons[12])!=null&&s.pressed&&(t+=1),(o=n.buttons[13])!=null&&o.pressed&&(t-=1)}return{mx:e,mz:t}}function sp(n){let e=0,t=0;return n.isPressed("w","arrowup")&&(t+=1),n.isPressed("s","arrowdown")&&(t-=1),n.isPressed("a","arrowleft")&&(e-=1),n.isPressed("d","arrowright")&&(e+=1),{mx:e,mz:t}}function op(n){let e=0,t=0,i=0,r=0;return n.isPressed("w","arrowup")&&(e=1),n.isPressed("s")&&(t=1),n.isPressed("arrowdown")&&(i=1),n.isPressed("a","arrowleft")&&(r-=1),n.isPressed("d","arrowright")&&(r+=1),r=Math.max(-1,Math.min(1,r)),{throttle:e,brake:t,reverse:i,steer:r}}function ap(n){var a,c,l,d,u,h;let e=0,t=0,i=0;if(!n)return{throttle:e,brake:t,reverse:0,steer:i};(a=n.buttons[2])!=null&&a.pressed&&(e=1),(c=n.buttons[1])!=null&&c.pressed&&(t=1);let r=0,s=0;return(l=n.buttons[4])!=null&&l.pressed&&(r=1),(((d=n.buttons[6])==null?void 0:d.value)??((u=n.buttons[6])!=null&&u.pressed?1:0))>.08&&(r=1),(h=n.buttons[5])!=null&&h.pressed&&(s=1),i=s-r,{throttle:e,brake:t,reverse:0,steer:i}}const nl=[{id:"a",label:"A",index:0},{id:"b",label:"B",index:1},{id:"x",label:"X",index:2},{id:"y",label:"Y",index:3},{id:"lb",label:"LB",index:4},{id:"rb",label:"RB",index:5},{id:"lt",label:"LT",index:6},{id:"rt",label:"RT",index:7},{id:"view",label:"View",index:8},{id:"menu",label:"Menu",index:9},{id:"ls",label:"Left stick press",index:10},{id:"rs",label:"Right stick press",index:11},{id:"dpadUp",label:"D-pad Up",index:12},{id:"dpadDown",label:"D-pad Down",index:13},{id:"dpadLeft",label:"D-pad Left",index:14},{id:"dpadRight",label:"D-pad Right",index:15},{id:"xbox",label:"Xbox",index:16}];function cp(n,e,t={}){var s;const i=[];if(!n)return{fired:i,prevPressed:t};const r={...t};for(const o of nl){const a=!!((s=n.buttons[o.index])!=null&&s.pressed),c=t[o.id]??!1;if(r[o.id]=a,a&&!c){const l=(e[o.id]??"").trim();l&&i.push({id:o.id,action:l})}}return{fired:i,prevPressed:r}}const Zu="ccwd-button-labels";function il(){try{return JSON.parse(localStorage.getItem(Zu)??"{}")}catch{return{}}}function lp(n){try{localStorage.setItem(Zu,JSON.stringify(n))}catch{}}let Ot=null,Xr=null;function Ku(n){if(Xr=n,Ot)return Ot;Ot=document.createElement("div"),Ot.id="controller-map",Ot.innerHTML=`
  ...
  `}function Ci(n,e,t={}){if(!n)return;if(!e){n.hidden=!0;return}const i=t.driving?"1":"0";(n.hidden||n.dataset.driving!==i)&&(Ro(n,t),n.dataset.driving=i),n.hidden=!1}function _p(n){return n>66?"#22c55e":n>33?"#eab308":"#ef4444"}function Lr(n,e){const t=_p(e);return`<div class="dmg-row"><span class="dmg-label">${n}</span>
...
`)}function Cv(n,e){let t;switch(e){case th:t="Linear";break;case Wp:t="Reinhard";break;case Xp:t="Cineon";break;case $p:t="ACESFilmic";break;case qp:t="AgX";break;case jp:t="Neutral";break;case Yp:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Ls=new L;function wv(){qe.getLuminanceCoefficients(Ls);const n=Ls.x.toFixed(4),e=Ls.y.toFixed(4),t=Ls.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function Av(n){return[n.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",n.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Yr).join(`
...
`);n.RTCSessionDescription&&r instanceof n.RTCSessionDescription?arguments[0]=new n.RTCSessionDescription({type:r.type,sdp:s}):r.sdp=s}return t.apply(this,arguments)}}function lo(n,e){if(!(n.RTCPeerConnection&&n.RTCPeerConnection.prototype))return;const t=n.RTCPeerConnection.prototype.addIceCandidate;!t||t.length===0||(n.RTCPeerConnection.prototype.addIceCandidate=function(){return arguments[0]?(e.browser==="chrome"&&e.version<78||e.browser==="firefox"&&e.version<68||e.browser==="safari")&&arguments[0]&&arguments[0].candidate===""?Promise.resolve():t.apply(this,arguments):(arguments[1]&&arguments[1].apply(null),Promise.resolve())})}function uo(n,e){if(!(n.RTCPeerConnection&&n.RTCPeerConnection.prototype))return;const t=n.RTCPeerConnection.prototype.setLocalDescription;!t||t.length===0||(n.RTCPeerConnection.prototype.setLocalDescription=function(){let r=arguments[0]||{};if(typeof r!="object"||r.type&&r.sdp)return t.apply(this,arguments);if(r={type:r.type,sdp:r.sdp},!r.type)switch(this.signalingState){case"stable":case"have-local-offer":case"have-remote-pranswer":r.type="offer";break;default:r.type="answer";break}return r.sdp||r.type!=="offer"&&r.type!=="answer"?t.apply(this,[r]):(r.type==="offer"?this.createOffer:this.createAnswer).apply(this).then(o=>t.apply(this,[o]))})}const MS=Object.freeze(Object.defineProperty({__proto__:null,removeExtmapAllowMixed:Yc,shimAddIceCandidateNullOrEmpty:lo,shimConnectionState:$c,shimMaxMessageSize:ao,shimParameterlessSetLocalDescription:uo,shimRTCIceCandidate:oo,shimRTCIceCandidateRelayProtocol:Xc,shimSendThrowTypeError:co},Symbol.toStringTag,{value:"Module"}));function bS({window:n}={},e={shimChrome:!0,shimFirefox:!0,shimSafari:!0}){const t=Rl,i=_S(n),r={browserDetails:i,commonShim:MS,extractVersion:qr,disableLog:mS,disableWarnings:gS,sdp:SS};switch(i.browser){case"chrome":if(!pu||!Vc||!e.shimChrome)return t("Chrome shim is not included in this adapter release."),r;if(i.version===null)return t("Chrome shim can not determine version, not shimming."),r;t("adapter.js shimming chrome."),r.browserShim=pu,lo(n,i),uo(n),ef(n,i),tf(n),Vc(n,i),nf(n,i),af(n,i),rf(n),sf(n,i),cf(n,i),oo(n),Xc(n),$c(n),ao(n,i),co(n,i),Yc(n,i);break;case"firefox":if(!mu||!Wc||!e.shimFirefox)return t("Firefox shim is not included in this adapter release."),r;t("adapter.js shimming firefox."),r.browserShim=mu,lo(n,i),uo(n),lf(n,i),Wc(n,i),uf(n,i),df(n),pf(n),hf(n),ff(n),mf(n),gf(n,i),_f(n,i),vf(n,i),xf(n,i),oo(n),$c(n),ao(n,i),co(n,i);break;case"safari":if(!gu||!e.shimSafari)return t("Safari shim is not included in this adapter release."),r;t("adapter.js shimming safari."),r.browserShim=gu,lo(n,i),uo(n),Tf(n),wf(n),Mf(n),yf(n),Sf(n),Cf(n),bf(n),Af(n),oo(n),Xc(n),ao(n,i),co(n,i),Yc(n,i);break;default:t("Unsupported browser!");break}return r}const vu=bS({window:typeof window>"u"?void 0:window});function Ni(n,e,t,i){Object.defineProperty(n,e,{get:t,set:i,enumerable:!0,configurable:!0})}class Pf{constructor(){this.chunkedMTU=16300,this._dataCount=1,this.chunk=e=>{const t=[],i=e.byteLength,r=Math.ceil(i/this.chunkedMTU);let s=0,o=0;for(;o<i;){const a=Math.min(i,o+this.chunkedMTU),c=e.slice(o,a),l={__peerData:this._dataCount,n:s,data:c,total:r};t.push(l),o=a,s++}return this._dataCount++,t}}}function ES(n){let e=0;for(const r of n)e+=r.byteLength;const t=new Uint8Array(e);let i=0;for(const r of n)t.set(r,i),i+=r.byteLength;return t}const Aa=vu.default||vu,Hr=new class{isWebRTCSupported(){return typeof RTCPeerConnection<"u"}isBrowserSupported(){const n=this.getBrowser(),e=this.getVersion();return this.supportedBrowsers.includes(n)?n==="chrome"?e>=this.minChromeVersion:n==="firefox"?e>=this.minFirefoxVersion:n==="safari"?!this.isIOS&&e>=this.minSafariVersion:!1:!1}getBrowser(){return Aa.browserDetails.browser}getVersion(){return Aa.browserDetails.version||0}isUnifiedPlanSupported(){const n=this.getBrowser(),e=Aa.browserDetails.version||0;if(n==="chrome"&&e<this.minChromeVersion)return!1;if(n==="firefox"&&e>=this.minFirefoxVersion)return!0;if(!window.RTCRtpTransceiver||!("currentDirection"in RTCRtpTransceiver.prototype))return!1;let t,i=!1;try{t=new RTCPeerConnection,t.addTransceiver("audio"),i=!0}catch{}finally{t&&t.close()}return i}toString(){return`Supports:
  ...
  `,e}function tM(n){return new Promise(e=>{const t=n.querySelector("#update-splash-dismiss"),i=()=>{n.classList.add("update-splash-out"),setTimeout(()=>{n.remove(),jr=null,e()},420)};t.addEventListener("click",i,{once:!0});const r=s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),window.removeEventListener("keydown",r),i())};window.addEventListener("keydown",r)})}async function nM(){if(location.hostname==="localhost"||location.hostname==="127.0.0.1")return;let n;try{n=await QS()}catch{return}const e=n==null?void 0:n.v;if(!e)return;const t=localStorage.getItem(Zc)==="1",i=localStorage.getItem(Nu(e))==="1";if(!t&&i){localStorage.setItem(Uu,e),ku();return}localStorage.removeItem(Zc),localStorage.setItem(Uu,e),localStorage.setItem(Nu(e),"1"),ku(),jr=eM(e),document.body.appendChild(jr),requestAnimationFrame(()=>jr.classList.add("update-splash-in")),await tM(jr)}function iM(){localStorage.setItem(Zc,"1")}const rM=10,sM=.5,Ou=2.4,oM=2.2,aM=92,cM=1.6,lM=[[24,18],[-30,22],[45,-35],[-50,40],[12,-55],[-65,-20],[70,55],[-15,75],[88,-12],[-40,-70]];function dM(){const n=document.createElement("canvas");n.width=256,n.height=72;const e=n.getContext("2d");e.fillStyle="rgba(15,23,42,0.55)",e.beginPath(),e.roundRect(8,8,240,56,10),e.fill(),e.fillStyle="#ffffff",e.font="bold 34px system-ui,sans-serif",e.textAlign="center",e.textBaseline="middle",e.fillText("Dashing",128,38);const t=new Tx(n);t.colorSpace=jt;const i=new Ih({map:t,transparent:!0,depthTest:!1}),r=new Mx(i);return r.scale.set(3.6,1,1),r.renderOrder=10,r}function Fu(){const n=new ut,e=new ge(new Vn(1.15,1.15,.18,28),new on({color:2450411,emissive:1920728,emissiveIntensity:.45,flatShading:!0}));e.position.y=.1,n.add(e);const t=new ge(new No(1.28,.08,8,28),new on({color:6333946,flatShading:!0}));t.rotation.x=Math.PI/2,t.position.y=.18,n.add(t);const i=dM();return i.position.y=oM,n.add(i),n}function uM(n){let e=n>>>0;return()=>(e=e*1664525+1013904223>>>0,e/4294967296)}function hM(n,{getPlayerId:e,isHost:t,send:i,relay:r}){const s=new ut;s.name="dash-pickups",n.add(s);let o=[],a={},c=!1,l=0,d=!1;function u(){return(e==null?void 0:e())??"local"}function h(){i==null||i({t:"dashState",pickups:o.map(k=>({id:k.id,x:k.x,z:k.z,active:k.active})),scores:a})}function p(k=Date.now()){for(o=[],a={},c=!1,d=!1;s.children.length;)s.remove(s.children[0]);const H=uM(k);d=!0;for(let O=0;O<rM;O++){if(H()>=sM)continue;const[$,W]=lM[O],te=Fu();te.position.set($,0,W),s.add(te),o.push({id:O,x:$,z:W,active:!0,mesh:te,bob:H()*Math.PI*2,pending:!1})}t!=null&&t()&&h()}function g(){return o.length>0}function _(k){if(k!=null&&k.pickups){for(d=k.pickups.length>0,a={...k.scores??{}};s.children.length;)s.remove(s.children[0]);o=k.pickups.map(H=>{const O=H.active?Fu():null;return O&&(O.position.set(H.x,0,H.z),s.add(O)),{id:H.id,x:H.x,z:H.z,active:H.active,mesh:O,bob:0,pending:!1}})}}function m(k){if(!k.active)return;k.active=!1,k.mesh&&(s.remove(k.mesh),k.mesh=null);const H=u();a[H]=(a[H]??0)+1,B==null||B("Dashing +1!"),t!=null&&t()?h():i==null||i({t:"dashCollect",pickupId:k.id,playerId:H})}function f(k){if(!(t!=null&&t()))return;const H=o.find(O=>O.id===k.pickupId&&O.active);H&&(H.active=!1,H.mesh&&(s.remove(H.mesh),H.mesh=null),a[k.playerId]=(a[k.playerId]??0)+1,h())}function C(k){t!=null&&t()&&(k.playerId&&(a[k.playerId]=0),h())}function T(k=null){const H=k??u();a[H]=0,H===u()&&(c=!1),t!=null&&t()?h():i==null||i({t:"dashScoreReset",playerId:H})}function v(k){k.t==="dashState"&&_(k),k.t==="dashCollect"&&f(k),k.t==="dashScoreReset"&&C(k)}function P(){return{...a}}function b(){const k=Object.entries(a);if(!k.length)return[];const H=Math.max(...k.map(([,O])=>O));return H<=0?[]:k.filter(([,O])=>O===H).map(([O])=>O)}function E(){return b().includes(u())}function A(){return E()?(c=!c,c):!1}function y(k){c=!!k}function S(){return c}function R(k,H){l+=k;for(const O of o)!O.active||!O.mesh||(O.mesh.position.y=Math.sin(l*2.8+O.bob)*.12,O.mesh.children[0].rotation.y+=k*1.6);if(!(!H||!d))for(const O of o){if(!O.active)continue;const $=H.x-O.x,W=H.z-O.z;if($*$+W*W<=Ou*Ou){if(O.pending)break;(t==null?void 0:t())??!0?m(O):(O.pending=!0,i==null||i({t:"dashCollect",pickupId:O.id,playerId:u()}));break}}}let B=null;function F(k){B=k}return{group:s,reset:p,update:R,getScores:P,getLeaderIds:b,isLocalLeader:E,isSuperDashOn:S,toggleSuperDash:A,setSuperDash:y,handleMessage:v,setToast:F,syncState:h,resetPlayerScore:T,isSessionActive:g,SUPER_MAX_SPEED:aM,SUPER_ACCEL_MULT:cM}}const Da="ccwd-build";function fM(){const n=location.hostname;if(n==="localhost"||n==="127.0.0.1")return;const e=async()=>{try{const t=await fetch(`./version.json?_=${Date.now()}`,{cache:"no-store"});if(!t.ok)return;const{v:i}=await t.json();if(!i)return;const r=localStorage.getItem(Da);if(r&&r!==i){iM(),localStorage.setItem(Da,i),location.reload();return}r||localStorage.setItem(Da,i)}catch{}};e(),setInterval(e,180*1e3)}nM().then(()=>{fM()});const pM=5,Bu=7,mM=.05,gM=0,_M=0,zu=5,vM=new URLSearchParams(window.location.search).has("teleport"),{canvas:Vt,ctx:de}=Qf();Vt.id="title-canvas";Vt.style.position="fixed";Vt.style.inset="0";Vt.style.zIndex="1";const dn=new tp(document.body),sn=Sp();sn.onExit(()=>Wf());const st=$x(),Me=Oh(0,0);Zx(st.scene,Me);const mo=WS(st.scene);let Kt=qS()?"drawPaper":"title",Vr=vM?1.8:0,Wr=0,Ys=0,Ia=0,Jr=!1,Qr=!1,qs=!1,Kc=0,vt=null,os=!1,Ua=0,or=1,Na=!1,ka=!1,Oa=!1,Te=null,Bt=!1,pr=0,Hu=0,Zr=0,Sr=[],Mi=0,Gu=!1,Vu={},Kr=0;const es=document.getElementById("action-toast"),wn=document.getElementById("controls-hud"),Mr=document.getElementById("damage-hud"),bi=document.getElementById("room-banner"),ar=document.getElementById("super-dash-btn"),js=document.getElementById("dash-score-hud"),wo=document.getElementById("death-overlay"),Ao=document.getElementById("death-timer"),cr=document.getElementById("non-dying-btn");let Pi=!1;Ku(()=>Ro(wn,{driving:Bt}));Kx(SM);jS(()=>Wu(),()=>Wu(!0));function Wu(n=!1){Kt="title",Vt.style.display="block",Gf(),n&&Ff()}Kt==="drawPaper"&&(Vt.style.display="none",YS());VS(({room:n,isHost:e})=>{vt=n,os=e,Me.x=0,Me.z=0,li(Me),xM(n),Kt="world",Yf(),$f(Xf(n.code??"solo")),go(),An("You're in the game!")});function xM(n){n.onMessage=(e,t)=>{e.t==="pose"&&e.id&&e.id!==n.id&&(n.role==="host"&&n.relay(t,e),mo.applyPose(e.id,e)),e.t==="join"&&e.id&&(mo.applyPose(e.id,{x:0,z:4,facing:0,walkPhase:0,isMoving:!1}),or+=1,go(),An("Someone joined!"),os&&_t.syncState()),e.t==="leave"&&e.id&&(mo.remove(e.id),or=Math.max(1,or-1),go()),(e.t==="dashState"||e.t==="dashCollect")&&(_t.handleMessage(e),br()),e.t==="dashScoreReset"&&(_t.handleMessage(e),br())},n.onPeerCount=e=>{or=e,go()}}function go(){if(!(!bi||!(vt!=null&&vt.code)))if(os){const n=Of(vt.code);bi.innerHTML=`Room <strong>${vt.code}</strong> · ${or} player(s) · <a href="${n}" target="_blank" rel="noopener">Share link</a>`,bi.hidden=!1}else bi.textContent=`Room ${vt.code} · ${or} player(s)`,bi.hidden=!1}function yM(){vt!=null&&vt.id&&vt.send({t:"pose",id:vt.id,x:Me.x,z:Me.z,facing:Me.facing,walkPhase:Me.walkPhase,isMoving:Me.isMoving})}function SM(n){Te&&($h(st.scene,Te),Te=null,Bt=!1,Me.inVehicle=null,Me.mesh.visible=!0),Te=dS(Me,n,st.clampPosition,st.envTex),iS(st.scene,Te),Bt=!0,sn.setDriving(!0),rS(Me,Te),Ro(wn,{driving:!0}),sl(Mr,!0),rl(Mr,Te)}function MM(n){if(!(!Te||pr>0)){if(Xy(Te,st.scene,n,Sr),rl(Mr,Te),Wh(Te)&&!Pi){Vf();return}if(El(n)){cS(Te,n);const e=Math.abs(n)>=38;Zr=e?.5:.22,pr=e?.55:.4}else Math.abs(n)>5&&(Te.speed*=.55,pr=.12)}}function Vf(){if(!Me.dead){if(Me.dead=!0,Mi=zu,Bt&&Te){const n=Te.x,e=Te.z,t=Te.rotY;Yh(Me,Te),Me.x=n,Me.z=e,Me.facing=t,Te.speed=0,Bt=!1,sn.setDriving(!1),_t.setSuperDash(!1),Te.superDashOn=!1}_t.resetPlayerScore(),br(),Me.mesh.rotation.x=-Math.PI/2,li(Me),Ci(wn,!1),sl(Mr,!1),ti(!1),br(),wo&&(wo.hidden=!1),Ao&&(Ao.textContent=`Respawning in ${zu}...`),An("Your car was destroyed!")}}function bM(){var n;Me.dead=!1,Mi=0,Te&&($h(st.scene,Te),Te=null);for(const e of Sr)(n=e.mesh.parent)==null||n.remove(e.mesh);Sr.length=0,Me.x=gM,Me.z=_M,Me.facing=0,Me.mesh.rotation.set(0,0,0),Me.mesh.visible=!0,Me.inVehicle=null,li(Me),Bt=!1,sn.setDriving(!1),wo&&(wo.hidden=!0),ti(!0),Sl(),Ci(wn,!0,{driving:!1}),st.updateCamera(Me.x,Me.z,Me.facing),An("Respawned at spawn!")}function EM(n){Mi=Math.max(0,Mi-n),Ao&&(Ao.textContent=Mi>0?`Respawning in ${Math.ceil(Mi)}...`:"Respawning..."),Al(Sr,n),st.updateWorld(Me.x,Me.z),st.updateCamera(Me.x,Me.z,Me.facing),Mi<=0&&bM()}function Wf(){!Te||!Bt||(Yh(Me,Te),Bt=!1,sn.setDriving(!1),li(Me),st.updateCamera(Me.x,Me.z,Me.facing),Ro(wn,{driving:!1}),sl(Mr,!1),An("Exited vehicle"))}function TM(){return op(dn)}function Xu(n,e){return{throttle:Math.max(n.throttle??0,e.throttle??0),brake:Math.max(n.brake??0,e.brake??0),reverse:Math.max(n.reverse??0,e.reverse??0),steer:Math.abs(n.steer)>Math.abs(e.steer)?n.steer:e.steer}}function $u(n){var i,r;if(!n||Kt!=="world"||Ba()||Ic())return;const{fired:e,prevPressed:t}=cp(n,il(),Vu);Vu=t;for(const s of e)An(s.action);(i=n.buttons[9])!=null&&i.pressed&&!Na&&(Na=!0,Ju()),(r=n==null?void 0:n.buttons[9])!=null&&r.pressed||(Na=!1)}function CM(n,e){const t=Math.max(0,Math.min(1,(e-n.topY)/(n.bottomY-n.topY)));return n.topW*2+(n.bottomW-n.topW*2)*t}function wM(n,e,t){const i=e*.56,r=CM(t,i),s=Math.min(r*.82,n*.78,420),o=s*.34;return{x:t.cx-s/2,y:i-o/2,w:s,h:o,cx:t.cx,cy:i}}function AM(n){const t=n.h*.72,i=n.w*.92,r=n.cy+n.h/2+14+t/2;return{x:n.cx-i/2,y:r-t/2,w:i,h:t,cx:n.cx,cy:r}}function RM(n,e){const t=Vt.getBoundingClientRect(),i=Vt.width/t.width,r=Vt.height/t.height;return{x:(n-t.left)*i,y:(e-t.top)*r}}function Yu(n,e,t){return n>=t.x&&n<=t.x+t.w&&e>=t.y&&e<=t.y+t.h}function PM(n,e,t){const i=e*.22,r=44,s="car crashing with ",o="dashing";de.save(),de.globalAlpha=t,de.font=`800 ${r}px system-ui, sans-serif`,de.textBaseline="middle";const a=de.measureText(s+o).width;let c=n/2-a/2;de.textAlign="left",de.fillStyle="#14532d",de.fillText(s,c,i),c+=de.measureText(s).width,de.fillText(o,c,i);const l=de.measureText(o).width,d=i+r*.38;de.strokeStyle="#14532d",de.lineWidth=4,de.beginPath(),de.moveTo(c,d),de.lineTo(c+l,d),de.stroke(),de.restore()}function qu(n,e,t,i,r,s){const o=1+Math.sin(i)*.04+(r?.05:0)+(s?-.03:0),a=n.w*o,c=n.h*o,l=n.cx-a/2,d=n.cy-c/2,u=c*.28;de.save(),de.shadowColor="rgba(0,0,0,0.45)",de.shadowBlur=24,de.shadowOffsetY=8;const h=de.createLinearGradient(l,d,l,d+c);h.addColorStop(0,s?t.pressedTop:t.top),h.addColorStop(1,s?t.pressedBottom:t.bottom),de.fillStyle=h,de.beginPath(),de.roundRect(l,d,a,c,u),de.fill(),de.shadowBlur=0,de.shadowOffsetY=0,de.strokeStyle=t.stroke,de.lineWidth=5,de.stroke(),Fa(de,e,n.cx,n.cy,{size:Math.floor(c*.38),color:t.text}),de.restore()}function LM(){Kt="comingSoon",Kc=pM,Me.x=0,Me.z=0,li(Me),Yf(),$f(Xf(String(Date.now())))}function DM(n,e){const t=RM(dn.pointer.x,dn.pointer.y);Jr=Yu(t.x,t.y,n),Qr=Yu(t.x,t.y,e),Vt.style.cursor=Jr||Qr?"pointer":"default",dn.pointer.down&&!qs&&(Jr?(LM(),qs=!0):Qr&&(Ff(),qs=!0)),dn.pointer.down||(qs=!1)}function ju(n,e,t=1){const i=n/2,r=e*.42,s=e,o=n*.08*t,a=n*.92;return{cx:i,topY:r,bottomY:s,topW:o,bottomW:a}}function IM(n,e,t){if(t<=0)return ju(n,e,t);const i=ju(n,e,t),{cx:r,topY:s,bottomY:o,topW:a,bottomW:c}=i;de.save(),de.globalAlpha=Math.min(1,t);const l=de.createLinearGradient(0,s,0,o);return l.addColorStop(0,"#334155"),l.addColorStop(1,"#1e293b"),de.fillStyle=l,de.beginPath(),de.moveTo(r-a,s),de.lineTo(r+a,s),de.lineTo(r+c/2,o),de.lineTo(r-c/2,o),de.closePath(),de.fill(),de.strokeStyle="rgba(250,204,21,0.85)",de.lineWidth=3,de.setLineDash([18,16]),de.beginPath(),de.moveTo(r,s),de.lineTo(r,o),de.stroke(),de.setLineDash([]),de.fillStyle="rgba(15,23,42,0.35)",de.fillRect(0,e*.72,n,e*.28),de.restore(),i}function An(n){Kr=2,es&&(es.textContent=n,es.classList.add("show"))}function Xf(n){let e=0;for(let t=0;t<n.length;t++)e=(e<<5)-e+n.charCodeAt(t)|0;return Math.abs(e)||1}const _t=hM(st.scene,{getPlayerId:()=>(vt==null?void 0:vt.id)??"local",isHost:()=>!vt||os,send:n=>{vt&&(os&&n.t==="dashState"?vt.send(n):n.t==="dashCollect"||n.t==="dashScoreReset"?vt.sendToHost(n):vt.send(n))}});_t.setToast(An);function $f(n){_t.reset(n),_t.isSessionActive()&&An("Blue Dashing circles spawned — collect them!")}function Ul(){if(!cr)return;const n=(Kt==="world"||Kt==="comingSoon")&&!Me.dead;cr.hidden=!n,cr.classList.toggle("active",Pi),cr.textContent=Pi?"NON-DYING":"DYING ON"}cr&&cr.addEventListener("click",()=>{Pi=!Pi,Ul(),An(Pi?"Non-dying ON — drive with no parts!":"Dying ON — destroyed car kills you")});function br(){const n=_t.isLocalLeader()&&Bt&&_t.isSessionActive();if(ar&&(ar.hidden=!n,ar.classList.toggle("active",_t.isSuperDashOn()),ar.textContent=_t.isSuperDashOn()?"NORMAL SPEED":"SUPER DASH"),js)if(Kt==="world"&&_t.isSessionActive()){const e=_t.getScores(),t=e[(vt==null?void 0:vt.id)??"local"]??0,i=_t.getLeaderIds(),r=i.length?Math.max(...i.map(s=>e[s]??0)):0;js.hidden=!1,js.textContent=`Dashing: ${t}${n?" ★ LEADING":""} · Best: ${r}`}else js.hidden=!0;n?Te&&(Te.superDashOn=_t.isSuperDashOn(),Te.superMaxSpeed=_t.SUPER_MAX_SPEED,Te.superAccelMult=_t.SUPER_ACCEL_MULT):(_t.setSuperDash(!1),Te&&(Te.superDashOn=!1))}ar&&ar.addEventListener("click",()=>{if(!_t.isLocalLeader()||!Bt||!Te)return;const n=_t.toggleSuperDash();Te.superDashOn=n,Te.superMaxSpeed=_t.SUPER_MAX_SPEED,Te.superAccelMult=_t.SUPER_ACCEL_MULT,An(n?"Super dash ON!":"Normal speed"),br()});function Yf(){Vt.style.display="none",st.show(),Gu||(Ix(st.renderer.domElement),Gu=!0),ti(!0),Sl(),sn.setVisible(!0),sn.setDriving(Bt),Ci(wn,!0,{driving:Bt}),Ul()}function UM(n){if(Me.dead){EM(n);return}const e=ip();let{mx:t,mz:i}=rp(e);const r=sp(dn),s=sn.readMove();t+=r.mx+s.mx,i+=r.mz+s.mz;const o=Math.hypot(t,i);if(o>1&&(t/=o,i/=o),pr>0&&(pr=Math.max(0,pr-n)),Zr>0&&(Zr=Math.max(0,Zr-n*2.8)),Hu+=n,Bt&&Te){const d=ap(e),u=TM(),h=sn.readDrive(),p=Xu(Xu(d,u),h),{impactSpeed:g,wallHit:_}=lS(Te,p,n,st.clampPosition);if(st.city.checkCarCollision(Te.x,Te.z)||_){const f=g;MM(f),El(f)||(Te.x=Te.prevX,Te.z=Te.prevZ),qh(Te)}if(aS(Te,Hu,n),Al(Sr,n),rl(Mr,Te),Wh(Te)&&!Pi){Vf();return}st.updateWorld(Te.x,Te.z),st.updateDrivingCamera(Te.x,Te.z,Te.rotY,Zr),$u(e),dn.isPressed("e")&&!Oa&&(Oa=!0,Wf()),dn.isPressed("e")||(Oa=!1);return}jx(Me,t,i,n);const a=Me.x+t*Bu*n,c=Me.z+i*Bu*n,l=st.clampPosition(a,c);Me.x=l.x,Me.z=l.z,li(Me),st.updateWorld(Me.x,Me.z),st.updateCamera(Me.x,Me.z,Me.facing),mo.lerpAll(n),Ua+=n,Ua>=mM&&(Ua=0,yM()),$u(e),dn.isPressed("m")&&!ka&&(ka=!0,Ju()),dn.isPressed("m")||(ka=!1)}function NM(n){const{width:e,height:t}=Vt;if(!((Ba()||Ic()||Au()||Iu())&&(Ci(wn,!1),Ba()||Iu()))){if(Kr>0&&(Kr=Math.max(0,Kr-n),Kr===0&&es&&es.classList.remove("show")),Vr>0){Vr=Math.max(0,Vr-n);const i=Vr>.35?1-(1.8-Vr)/1.45:0;Vt.style.display="block",st.hide(),ti(!1),sn.setVisible(!1),Vl(de,i>.2?"#e0f2fe":"#22c55e"),i>.05&&(de.fillStyle=`rgba(255,255,255,${i*.75})`,de.fillRect(0,0,e,t)),Fa(de,"TELEPORTING...",e/2,t*.38,{color:"#0f172a",size:36});return}if(Kt==="drawPaper"){Vt.style.display="none",st.hide(),ti(!1),sn.setVisible(!1);return}if(Kt==="title"){Vt.style.display="block",st.hide(),ti(!1),sn.setVisible(!1),Ci(wn,!1),bi&&(bi.hidden=!0),Wr=Math.min(1,Wr+n*1.2),Ys=Math.min(1,Ys+n*.55),Ia+=n*4,Vl(de,"#22c55e");const i=IM(e,t,Ys),r=wM(e,t,i),s=AM(r);if(de.globalAlpha=Wr,PM(e,t,Wr),Fa(de,"The best game ever — realism incoming.",e/2,t*.3,{color:"#166534",size:18}),de.globalAlpha=1,!Au()){DM(r,s);const o=Math.min(1,.35+Ys*.65)*Wr;de.globalAlpha=o,qu(r,"PLAY",{top:"#fde047",bottom:"#facc15",pressedTop:"#facc15",pressedBottom:"#eab308",stroke:"#854d0e",text:"#422006"},Ia,Jr,dn.pointer.down&&Jr),qu(s,"MULTIPLAYER",{top:"#4ade80",bottom:"#22c55e",pressedTop:"#22c55e",pressedBottom:"#16a34a",stroke:"#14532d",text:"#14532d"},Ia+.5,Qr,dn.pointer.down&&Qr),de.globalAlpha=1}return}(Kt==="comingSoon"||Kt==="world")&&(st.renderer.domElement.style.boxShadow="",_t.update(n,Bt?Te:null),Al(Sr,n),br(),Ul(),Ic()||UM(n),Kt==="comingSoon"?(Kc-=n,Kc<=0&&(Kt="world"),Ci(wn,!0,{driving:Bt}),ti(!0),sn.setVisible(!1)):(ti(!0),Ci(wn,!0,{driving:Bt})),st.render())}}window.addEventListener("gamepadconnected",()=>{});np(NM);
