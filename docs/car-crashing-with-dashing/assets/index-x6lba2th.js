var rf=n=>{throw TypeError(n)};var Tr=(n,e,t)=>e.has(n)?rf("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(n):e.set(n,t);function sf(n,e){for(var t=0;t<e.length;t++){const i=e[t];if(typeof i!="string"&&!Array.isArray(i)){for(const r in i)if(r!=="default"&&!(r in n)){const s=Object.getOwnPropertyDescriptor(i,r);s&&Object.defineProperty(n,r,s.get?s:{enumerable:!0,get:()=>i[r]})}}}return Object.freeze(Object.defineProperty(n,Symbol.toStringTag,{value:"Module"}))}(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function t(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerPolicy&&(s.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?s.credentials="include":r.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(r){if(r.ep)return;r.ep=!0;const s=t(r);fetch(r.href,s)}})();function of(n=document.body){const e=document.createElement("canvas");e.style.display="block",n.appendChild(e);const t=e.getContext("2d");function i(){e.width=window.innerWidth,e.height=window.innerHeight}return i(),window.addEventListener("resize",i),{canvas:e,ctx:t,resize:i}}function hl(n,e="#1a1a2e"){n.fillStyle=e,n.fillRect(0,0,n.canvas.width,n.canvas.height)}const af=new Set(["arrowup","arrowdown","arrowleft","arrowright"," ","w","a","s","d","x","e","r","l","b"]);class cf{constructor(e=window){this.keys=new Set,this.pointer={x:0,y:0,down:!1},document.addEventListener("keydown",t=>{const i=t.key.toLowerCase();this.keys.add(i),af.has(i)&&t.preventDefault()}),document.addEventListener("keyup",t=>{this.keys.delete(t.key.toLowerCase())}),e.addEventListener("pointermove",t=>{this.pointer.x=t.clientX,this.pointer.y=t.clientY}),e.addEventListener("pointerdown",t=>{this.pointer.x=t.clientX,this.pointer.y=t.clientY,this.pointer.down=!0,e.focus&&e.focus()}),e.addEventListener("pointerup",()=>{this.pointer.down=!1})}isDown(e){return this.keys.has(e.toLowerCase())}isPressed(...e){return e.some(t=>this.isDown(t))}}function lf(n){let e=0,t=performance.now();function i(r){const s=(r-t)/1e3;t=r,n(s),e=requestAnimationFrame(i)}return e=requestAnimationFrame(i),()=>cancelAnimationFrame(e)}function Hs(n,e,t,i,r={}){const{color:s="#ffffff",size:o=24,align:a="center",baseline:c="middle",font:l="sans-serif"}=r;n.fillStyle=s,n.font=`${o}px ${l}`,n.textAlign=a,n.textBaseline=c,n.fillText(e,t,i)}const fl=.18;function df(){var e;return(((e=navigator.getGamepads)==null?void 0:e.call(navigator))??[]).find(t=>t==null?void 0:t.connected)??null}function uf(n){var i,r,s,o;let e=0,t=0;if(n){const a=n.axes[0]??0,c=n.axes[1]??0;Math.abs(a)>fl&&(e+=a),Math.abs(c)>fl&&(t-=c),(i=n.buttons[14])!=null&&i.pressed&&(e-=1),(r=n.buttons[15])!=null&&r.pressed&&(e+=1),(s=n.buttons[12])!=null&&s.pressed&&(t+=1),(o=n.buttons[13])!=null&&o.pressed&&(t-=1)}return{mx:e,mz:t}}function hf(n){let e=0,t=0;return n.isPressed("w","arrowup")&&(t+=1),n.isPressed("s","arrowdown")&&(t-=1),n.isPressed("a","arrowleft")&&(e-=1),n.isPressed("d","arrowright")&&(e+=1),{mx:e,mz:t}}function ff(n){let e=0,t=0,i=0,r=0;return n.isPressed("w","arrowup")&&(e=1),n.isPressed("s")&&(t=1),n.isPressed("arrowdown")&&(i=1),n.isPressed("a","arrowleft")&&(r-=1),n.isPressed("d","arrowright")&&(r+=1),r=Math.max(-1,Math.min(1,r)),{throttle:e,brake:t,reverse:i,steer:r}}function pf(n){var a,c,l,d,u,h;let e=0,t=0,i=0;if(!n)return{throttle:e,brake:t,reverse:0,steer:i};(a=n.buttons[2])!=null&&a.pressed&&(e=1),(c=n.buttons[1])!=null&&c.pressed&&(t=1);let r=0,s=0;return(l=n.buttons[4])!=null&&l.pressed&&(r=1),(((d=n.buttons[6])==null?void 0:d.value)??((u=n.buttons[6])!=null&&u.pressed?1:0))>.08&&(r=1),(h=n.buttons[5])!=null&&h.pressed&&(s=1),i=s-r,{throttle:e,brake:t,reverse:0,steer:i}}const Rc=[{id:"a",label:"A",index:0},{id:"b",label:"B",index:1},{id:"x",label:"X",index:2},{id:"y",label:"Y",index:3},{id:"lb",label:"LB",index:4},{id:"rb",label:"RB",index:5},{id:"lt",label:"LT",index:6},{id:"rt",label:"RT",index:7},{id:"view",label:"View",index:8},{id:"menu",label:"Menu",index:9},{id:"ls",label:"Left stick press",index:10},{id:"rs",label:"Right stick press",index:11},{id:"dpadUp",label:"D-pad Up",index:12},{id:"dpadDown",label:"D-pad Down",index:13},{id:"dpadLeft",label:"D-pad Left",index:14},{id:"dpadRight",label:"D-pad Right",index:15},{id:"xbox",label:"Xbox",index:16}];function mf(n,e,t={}){var s;const i=[];if(!n)return{fired:i,prevPressed:t};const r={...t};for(const o of Rc){const a=!!((s=n.buttons[o.index])!=null&&s.pressed),c=t[o.id]??!1;if(r[o.id]=a,a&&!c){const l=(e[o.id]??"").trim();l&&i.push({id:o.id,action:l})}}return{fired:i,prevPressed:r}}const fu="ccwd-button-labels";function Ac(){try{return JSON.parse(localStorage.getItem(fu)??"{}")}catch{return{}}}function gf(n){try{localStorage.setItem(fu,JSON.stringify(n))}catch{}}let kt=null,kr=null;function pu(n){if(kr=n,kt)return kt;kt=document.createElement("div"),kt.id="controller-map",kt.innerHTML=`
    <div class="cm-header">
  ...
  `,document.body.appendChild(kt);const e=kt.querySelector("#cm-fields"),t=Ac();for(const i of Rc){const r=document.createElement("div");r.className="cm-row",r.innerHTML=`
      <span class="cm-line"></span>
      <label class="cm-label">${i.label}</label>
      <input type="text" class="cm-input" data-id="${i.id}" placeholder="(blank = does nothing)" value="${_f(t[i.id]??"")}" />
    `,e.appendChild(r)}return kt.querySelector("#cm-done").addEventListener("click",()=>{const i={};kt.querySelectorAll(".cm-input").forEach(r=>{i[r.dataset.id]=r.value}),gf(i),vf(),kr==null||kr()}),kt}function _f(n){return String(n).replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;")}function mu(){pu(kr),kt.style.display="flex"}function vf(){kt&&(kt.style.display="none")}function ga(){return(kt==null?void 0:kt.style.display)==="flex"}const xf={x:"Gas",b:"Brake",lb:"Turn left",lt:"Turn left",rb:"Turn right",menu:"Change controls"},yf={a:"chip-a",b:"chip-b",x:"chip-x",y:"chip-y",lb:"chip-bump",rb:"chip-bump",lt:"chip-trigger",rt:"chip-trigger",view:"chip-misc",menu:"chip-misc",ls:"chip-misc",rs:"chip-misc",dpadUp:"chip-dpad",dpadDown:"chip-dpad",dpadLeft:"chip-dpad",dpadRight:"chip-dpad",xbox:"chip-misc"};function Pi(n){return String(n).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/"/g,"&quot;")}function Mf(n,e){const t=(n[e]??"").trim();return t||(xf[e]??"").trim()}function Sf(n,e){return`<span class="pc-key" title="${Pi(e)}"><span class="pc-key-letter">${Pi(n)}</span><span class="pc-key-word">${Pi(e)}</span></span>`}function bf(n,e){return`<span class="pad-chip ${yf[n.id]??"chip-misc"}" title="${Pi(n.label)} button — ${Pi(e)}"><span class="pad-chip-mark">${Pi(n.label)}</span><span class="pad-chip-word">${Pi(e)}</span></span>`}function ho(n,{driving:e=!1}={}){if(!n)return;const t=n.querySelector("#controls-body");if(!t)return;const i=Ac(),r=e?[{key:"W",word:"Gas"},{key:"↑",word:"Gas"},{key:"S",word:"Brake"},{key:"↓",word:"Reverse"},{key:"A",word:"Left"},{key:"←",word:"Left"},{key:"D",word:"Right"},{key:"→",word:"Right"},{key:"E",word:"Exit car"}]:[{key:"W",word:"Forward"},{key:"↑",word:"Forward"},{key:"A",word:"Left"},{key:"←",word:"Left"},{key:"S",word:"Back"},{key:"↓",word:"Back"},{key:"D",word:"Right"},{key:"→",word:"Right"}],s=['<span class="pad-chip chip-stick" title="Left stick — move"><span class="pad-chip-mark">Stick</span><span class="pad-chip-word">Move</span></span>'];for(const o of Rc){const a=Mf(i,o.id);a&&s.push(bf(o,a))}t.innerHTML=`
  ...
  `}function Or(n,e,t={}){if(!n)return;if(!e){n.hidden=!0;return}const i=t.driving?"1":"0";(n.hidden||n.dataset.driving!==i)&&(ho(n,t),n.dataset.driving=i),n.hidden=!1}function Ef(n){return n>66?"#22c55e":n>33?"#eab308":"#ef4444"}function Cr(n,e){const t=Ef(e);return`<div class="dmg-row"><span class="dmg-label">${n}</span>
    ...
    ${Cr("Wheels",i)}
  `}function gu(n,e){n&&(e?n.removeAttribute("hidden"):n.setAttribute("hidden",""))}function Tf(){return matchMedia("(pointer: coarse)").matches||"ontouchstart"in window}const Cf=()=>({mx:0,mz:0}),wf=()=>({throttle:0,brake:0,reverse:0,steer:0});function Rf(){if(!Tf())return{readMove:Cf,readDrive:wf,setDriving:()=>{},setVisible:()=>{},onExit:()=>{}};const n=document.createElement("div");n.id="touch-pad",n.innerHTML=`
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:di,depthTest:!1,depthWrite:!1})}function Xl(){return new pi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:zc(),fragmentShader:`
		...
		`,blending:di,depthTest:!1,depthWrite:!1})}function $l(){return new pi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:zc(),fragmentShader:`
	...
	`}function Dg(n){let e=new WeakMap,t=null;function i(a){if(a&&a.isTexture){const c=a.mapping,l=c===Ca||c===wa,d=c===hr||c===fr;if(l||d){let u=e.get(a);const h=u!==void 0?u.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==h)return t===null&&(t=new ic(n)),u=l?t.fromEquirectangular(a,u):t.fromCubemap(a,u),u.texture.pmremVersion=a.pmremVersion,e.set(a,u),u.texture;if(u!==void 0)return u.texture;{const p=a.image;return l&&p&&p.height>0||d&&p&&r(p)?(t===null&&(t=new ic(n)),u=l?t.fromEquirectangular(a):t.fromCubemap(a),u.texture.pmremVersion=a.pmremVersion,e.set(a,u),a.addEventListener("dispose",s),u.texture):null}}}return a}function r(a){let c=0;const l=6;for(let d=0;d<l;d++)a[d]!==void 0&&c++;return c===l}function s(a){const c=a.target;c.removeEventListener("dispose",s);const l=e.get(c);l!==void 0&&(e.delete(c),l.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:i,dispose:o}}function Ig(n){const e={};function t(i){if(e[i]!==void 0)return e[i];let r;switch(i){case"WEBGL_depth_texture":r=n.getExtension("WEBGL_depth_texture")||n.getExtension("MOZ_WEBGL_depth_texture")||n.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=n.getExtension("EXT_texture_filter_anisotropic")||n.getExtension("MOZ_EXT_texture_filter_anisotropic")||n.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=n.getExtension("WEBGL_compressed_texture_s3tc")||n.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=n.getExtension("WEBGL_compressed_texture_pvrtc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=n.getExtension(i)}return e[i]=r,r}return{has:function(i){return t(i)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(i){const r=t(i);return r===null&&Br("THREE.WebGLRenderer: "+i+" extension not supported."),r}}}function Ug(n,e,t,i){const r={},s=new WeakMap;function o(u){const h=u.target;h.index!==null&&e.remove(h.index);for(const g in h.attributes)e.remove(h.attributes[g]);for(const g in h.morphAttributes){const _=h.morphAttributes[g];for(let m=0,f=_.length;m<f;m++)e.remove(_[m])}h.removeEventListener("dispose",o),delete r[h.id];const p=s.get(h);p&&(e.remove(p),s.delete(h)),i.releaseStatesOfGeometry(h),h.isInstancedBufferGeometry===!0&&delete h._maxInstanceCount,t.memory.geometries--}function a(u,h){return r[h.id]===!0||(h.addEventListener("dispose",o),r[h.id]=!0,t.memory.geometries++),h}function c(u){const h=u.attributes;for(const g in h)e.update(h[g],n.ARRAY_BUFFER);const p=u.morphAttributes;for(const g in p){const _=p[g];for(let m=0,f=_.length;m<f;m++)e.update(_[m],n.ARRAY_BUFFER)}}function l(u){const h=[],p=u.index,g=u.attributes.position;let _=0;if(p!==null){const w=p.array;_=p.version;for(let C=0,S=w.length;C<S;C+=3){const P=w[C+0],b=w[C+1],E=w[C+2];h.push(P,b,b,E,E,P)}}else if(g!==void 0){const w=g.array;_=g.version;for(let C=0,S=w.length/3-1;C<S;C+=3){const P=C+0,b=C+1,E=C+2;h.push(P,b,b,E,E,P)}}else return;const m=new(Uu(h)?zu:Bu)(h,1);m.version=_;const f=s.get(u);f&&e.remove(f),s.set(u,m)}function d(u){const h=s.get(u);if(h){const p=u.index;p!==null&&h.version<p.version&&l(u)}else l(u);return s.get(u)}return{get:a,update:c,getWireframeAttribute:d}}function Ng(n,e,t){let i;function r(h){i=h}let s,o;function a(h){s=h.type,o=h.bytesPerElement}function c(h,p){n.drawElements(i,p,s,h*o),t.update(p,i,1)}function l(h,p,g){g!==0&&(n.drawElementsInstanced(i,p,s,h*o,g),t.update(p,i,g))}function d(h,p,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,p,0,s,h,0,g);let m=0;for(let f=0;f<g;f++)m+=p[f];t.update(m,i,1)}function u(h,p,g,_){if(g===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let f=0;f<h.length;f++)l(h[f]/o,p[f],_[f]);else{m.multiDrawElementsInstancedWEBGL(i,p,0,s,h,0,_,0,g);let f=0;for(let w=0;w<g;w++)f+=p[w]*_[w];t.update(f,i,1)}}this.setMode=r,this.setIndex=a,this.render=c,this.renderInstances=l,this.renderMultiDraw=d,this.renderMultiDrawInstances=u}function Fg(n){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function i(s,o,a){switch(t.calls++,o){case n.TRIANGLES:t.triangles+=a*(s/3);break;case n.LINES:t.lines+=a*(s/2);break;case n.LINE_STRIP:t.lines+=a*(s-1);break;case n.LINE_LOOP:t.lines+=a*s;break;case n.POINTS:t.points+=a*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:i}}function kg(n,e,t){const i=new WeakMap,r=new at;function s(o,a,c){const l=o.morphTargetInfluences,d=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,u=d!==void 0?d.length:0;let h=i.get(a);if(h===void 0||h.count!==u){let x=function(){A.dispose(),i.delete(a),a.removeEventListener("dispose",x)};var p=x;h!==void 0&&h.texture.dispose();const g=a.morphAttributes.position!==void 0,_=a.morphAttributes.normal!==void 0,m=a.morphAttributes.color!==void 0,f=a.morphAttributes.position||[],w=a.morphAttributes.normal||[],C=a.morphAttributes.color||[];let S=0;g===!0&&(S=1),_===!0&&(S=2),m===!0&&(S=3);let P=a.attributes.position.count*S,b=1;P>e.maxTextureSize&&(b=Math.ceil(P/e.maxTextureSize),P=e.maxTextureSize);const E=new Float32Array(P*b*4*u),A=new Fu(E,P,b,u);A.type=Wn,A.needsUpdate=!0;const y=S*4;for(let R=0;R<u;R++){const O=f[R],F=w[R],V=C[R],X=P*b*4*R;for(let W=0;W<O.count;W++){const q=W*y;g===!0&&(r.fromBufferAttribute(O,W),E[X+q+0]=r.x,E[X+q+1]=r.y,E[X+q+2]=r.z,E[X+q+3]=0),_===!0&&(r.fromBufferAttribute(F,W),E[X+q+4]=r.x,E[X+q+5]=r.y,E[X+q+6]=r.z,E[X+q+7]=0),m===!0&&(r.fromBufferAttribute(V,W),E[X+q+8]=r.x,E[X+q+9]=r.y,E[X+q+10]=r.z,E[X+q+11]=V.itemSize===4?r.w:1)}}h={count:u,texture:A,size:new $e(P,b)},i.set(a,h),a.addEventListener("dispose",x)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)c.getUniforms().setValue(n,"morphTexture",o.morphTexture,t);else{let g=0;for(let m=0;m<l.length;m++)g+=l[m];const _=a.morphTargetsRelative?1:1-g;c.getUniforms().setValue(n,"morphTargetBaseInfluence",_),c.getUniforms().setValue(n,"morphTargetInfluences",l)}c.getUniforms().setValue(n,"morphTargetsTexture",h.texture,t),c.getUniforms().setValue(n,"morphTargetsTextureSize",h.size)}return{update:s}}function Og(n,e,t,i){let r=new WeakMap;function s(c){const l=i.render.frame,d=c.geometry,u=e.get(c,d);if(r.get(u)!==l&&(e.update(u),r.set(u,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",a)===!1&&c.addEventListener("dispose",a),r.get(c)!==l&&(t.update(c.instanceMatrix,n.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,n.ARRAY_BUFFER),r.set(c,l))),c.isSkinnedMesh){const h=c.skeleton;r.get(h)!==l&&(h.update(),r.set(h,l))}return u}function o(){r=new WeakMap}function a(c){const l=c.target;l.removeEventListener("dispose",a),t.remove(l.instanceMatrix),l.instanceColor!==null&&t.remove(l.instanceColor)}return{update:s,dispose:o}}class $u extends jt{constructor(e,t,i,r,s,o,a,c,l,d=ar){if(d!==ar&&d!==mr)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");i===void 0&&d===ar&&(i=Ui),i===void 0&&d===mr&&(i=pr),super(null,r,s,o,a,c,d,i,l),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=a!==void 0?a:bn,this.minFilter=c!==void 0?c:bn,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const Yu=new jt,Yl=new $u(1,1),qu=new Fu,ju=new bp,Zu=new Vu,ql=[],jl=[],Zl=new Float32Array(16),Kl=new Float32Array(9),Jl=new Float32Array(4);function Sr(n,e,t){const i=n[0];if(i<=0||i>0)return n;const r=e*t;let s=ql[r];if(s===void 0&&(s=new Float32Array(r),ql[r]=s),e!==0){i.toArray(s,0);for(let o=1,a=0;o!==e;++o)a+=t,n[o].toArray(s,a)}return s}function wt(n,e){if(n.length!==e.length)return!1;for(let t=0,i=n.length;t<i;t++)if(n[t]!==e[t])return!1;return!0}function Rt(n,e){for(let t=0,i=e.length;t<i;t++)n[t]=e[t]}function go(n,e){let t=jl[e];t===void 0&&(t=new Int32Array(e),jl[e]=t);for(let i=0;i!==e;++i)t[i]=n.allocateTextureUnit();return t}function Bg(n,e){const t=this.cache;t[0]!==e&&(n.uniform1f(this.addr,e),t[0]=e)}function zg(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(wt(t,e))return;n.uniform2fv(this.addr,e),Rt(t,e)}}function Hg(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(n.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(wt(t,e))return;n.uniform3fv(this.addr,e),Rt(t,e)}}function Gg(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(wt(t,e))return;n.uniform4fv(this.addr,e),Rt(t,e)}}function Vg(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(wt(t,e))return;n.uniformMatrix2fv(this.addr,!1,e),Rt(t,e)}else{if(wt(t,i))return;Jl.set(i),n.uniformMatrix2fv(this.addr,!1,Jl),Rt(t,i)}}function Wg(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(wt(t,e))return;n.uniformMatrix3fv(this.addr,!1,e),Rt(t,e)}else{if(wt(t,i))return;Kl.set(i),n.uniformMatrix3fv(this.addr,!1,Kl),Rt(t,i)}}function Xg(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(wt(t,e))return;n.uniformMatrix4fv(this.addr,!1,e),Rt(t,e)}else{if(wt(t,i))return;Zl.set(i),n.uniformMatrix4fv(this.addr,!1,Zl),Rt(t,i)}}function $g(n,e){const t=this.cache;t[0]!==e&&(n.uniform1i(this.addr,e),t[0]=e)}function Yg(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(wt(t,e))return;n.uniform2iv(this.addr,e),Rt(t,e)}}function qg(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(wt(t,e))return;n.uniform3iv(this.addr,e),Rt(t,e)}}function jg(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(wt(t,e))return;n.uniform4iv(this.addr,e),Rt(t,e)}}function Zg(n,e){const t=this.cache;t[0]!==e&&(n.uniform1ui(this.addr,e),t[0]=e)}function Kg(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(wt(t,e))return;n.uniform2uiv(this.addr,e),Rt(t,e)}}function Jg(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(wt(t,e))return;n.uniform3uiv(this.addr,e),Rt(t,e)}}function Qg(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(wt(t,e))return;n.uniform4uiv(this.addr,e),Rt(t,e)}}function e_(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r);let s;this.type===n.SAMPLER_2D_SHADOW?(Yl.compareFunction=Iu,s=Yl):s=Yu,t.setTexture2D(e||s,r)}function t_(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture3D(e||ju,r)}function n_(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTextureCube(e||Zu,r)}function i_(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture2DArray(e||qu,r)}function r_(n){switch(n){case 5126:return Bg;case 35664:return zg;case 35665:return Hg;case 35666:return Gg;case 35674:return Vg;case 35675:return Wg;case 35676:return Xg;case 5124:case 35670:return $g;case 35667:case 35671:return Yg;case 35668:case 35672:return qg;case 35669:case 35673:return jg;case 5125:return Zg;case 36294:return Kg;case 36295:return Jg;case 36296:return Qg;case 35678:case 36198:case 36298:case 36306:case 35682:return e_;case 35679:case 36299:case 36307:return t_;case 35680:case 36300:case 36308:case 36293:return n_;case 36289:case 36303:case 36311:case 36292:return i_}}function s_(n,e){n.uniform1fv(this.addr,e)}function o_(n,e){const t=Sr(e,this.size,2);n.uniform2fv(this.addr,t)}function a_(n,e){const t=Sr(e,this.size,3);n.uniform3fv(this.addr,t)}function c_(n,e){const t=Sr(e,this.size,4);n.uniform4fv(this.addr,t)}function l_(n,e){const t=Sr(e,this.size,4);n.uniformMatrix2fv(this.addr,!1,t)}function d_(n,e){const t=Sr(e,this.size,9);n.uniformMatrix3fv(this.addr,!1,t)}function u_(n,e){const t=Sr(e,this.size,16);n.uniformMatrix4fv(this.addr,!1,t)}function h_(n,e){n.uniform1iv(this.addr,e)}function f_(n,e){n.uniform2iv(this.addr,e)}function p_(n,e){n.uniform3iv(this.addr,e)}function m_(n,e){n.uniform4iv(this.addr,e)}function g_(n,e){n.uniform1uiv(this.addr,e)}function __(n,e){n.uniform2uiv(this.addr,e)}function v_(n,e){n.uniform3uiv(this.addr,e)}function x_(n,e){n.uniform4uiv(this.addr,e)}function y_(n,e,t){const i=this.cache,r=e.length,s=go(t,r);wt(i,s)||(n.uniform1iv(this.addr,s),Rt(i,s));for(let o=0;o!==r;++o)t.setTexture2D(e[o]||Yu,s[o])}function M_(n,e,t){const i=this.cache,r=e.length,s=go(t,r);wt(i,s)||(n.uniform1iv(this.addr,s),Rt(i,s));for(let o=0;o!==r;++o)t.setTexture3D(e[o]||ju,s[o])}function S_(n,e,t){const i=this.cache,r=e.length,s=go(t,r);wt(i,s)||(n.uniform1iv(this.addr,s),Rt(i,s));for(let o=0;o!==r;++o)t.setTextureCube(e[o]||Zu,s[o])}function b_(n,e,t){const i=this.cache,r=e.length,s=go(t,r);wt(i,s)||(n.uniform1iv(this.addr,s),Rt(i,s));for(let o=0;o!==r;++o)t.setTexture2DArray(e[o]||qu,s[o])}function E_(n){switch(n){case 5126:return s_;case 35664:return o_;case 35665:return a_;case 35666:return c_;case 35674:return l_;case 35675:return d_;case 35676:return u_;case 5124:case 35670:return h_;case 35667:case 35671:return f_;case 35668:case 35672:return p_;case 35669:case 35673:return m_;case 5125:return g_;case 36294:return __;case 36295:return v_;case 36296:return x_;case 35678:case 36198:case 36298:case 36306:case 35682:return y_;case 35679:case 36299:case 36307:return M_;case 35680:case 36300:case 36308:case 36293:return S_;case 36289:case 36303:case 36311:case 36292:return b_}}class T_{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.setValue=r_(t.type)}}class C_{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=E_(t.type)}}class w_{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,i){const r=this.seq;for(let s=0,o=r.length;s!==o;++s){const a=r[s];a.setValue(e,t[a.id],i)}}}const Zo=/(\w+)(\])?(\[|\.)?/g;function Ql(n,e){n.seq.push(e),n.map[e.id]=e}function R_(n,e,t){const i=n.name,r=i.length;for(Zo.lastIndex=0;;){const s=Zo.exec(i),o=Zo.lastIndex;let a=s[1];const c=s[2]==="]",l=s[3];if(c&&(a=a|0),l===void 0||l==="["&&o+2===r){Ql(t,l===void 0?new T_(a,n,e):new C_(a,n,e));break}else{let u=t.map[a];u===void 0&&(u=new w_(a),Ql(t,u)),t=u}}}class Ys{constructor(e,t){this.seq=[],this.map={};const i=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<i;++r){const s=e.getActiveUniform(t,r),o=e.getUniformLocation(t,s.name);R_(s,o,this)}}setValue(e,t,i,r){const s=this.map[t];s!==void 0&&s.setValue(e,i,r)}setOptional(e,t,i){const r=t[i];r!==void 0&&this.setValue(e,i,r)}static upload(e,t,i,r){for(let s=0,o=t.length;s!==o;++s){const a=t[s],c=i[a.id];c.needsUpdate!==!1&&a.setValue(e,c.value,r)}}static seqWithValue(e,t){const i=[];for(let r=0,s=e.length;r!==s;++r){const o=e[r];o.id in t&&i.push(o)}return i}}function ed(n,e,t){const i=n.createShader(e);return n.shaderSource(i,t),n.compileShader(i),i}const A_=37297;let P_=0;function L_(n,e){const t=n.split(`
`),i=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let o=r;o<s;o++){const a=o+1;i.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return i.join(`
`)}const td=new Ne;function D_(n){je._getMatrix(td,je.workingColorSpace,n);const e=`mat3( ${td.elements.map(t=>t.toFixed(4))} )`;switch(je.getTransfer(n)){case po:return[e,"LinearTransferOETF"];case ot:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",n),[e,"LinearTransferOETF"]}}function nd(n,e,t){const i=n.getShaderParameter(e,n.COMPILE_STATUS),r=n.getShaderInfoLog(e).trim();if(i&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const o=parseInt(s[1]);return t.toUpperCase()+`

`+r+`

`+L_(n.getShaderSource(e),o)}else return r}function I_(n,e){const t=D_(e);return[`vec4 ${n}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}function U_(n,e){let t;switch(e){case Kf:t="Linear";break;case Jf:t="Reinhard";break;case Qf:t="Cineon";break;case yu:t="ACESFilmic";break;case tp:t="AgX";break;case np:t="Neutral";break;case ep:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Rs=new L;function N_(){je.getLuminanceCoefficients(Rs);const n=Rs.x.toFixed(4),e=Rs.y.toFixed(4),t=Rs.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function F_(n){return[n.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",n.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(zr).join(`
`)}function k_(n){const e=[];for(const t in n){const i=n[t];i!==!1&&e.push("#define "+t+" "+i)}return e.join(`
`)}function O_(n,e){const t={},i=n.getProgramParameter(e,n.ACTIVE_ATTRIBUTES);for(let r=0;r<i;r++){const s=n.getActiveAttrib(e,r),o=s.name;let a=1;s.type===n.FLOAT_MAT2&&(a=2),s.type===n.FLOAT_MAT3&&(a=3),s.type===n.FLOAT_MAT4&&(a=4),t[o]={type:s.type,location:n.getAttribLocation(e,o),locationSize:a}}return t}function zr(n){return n!==""}function id(n,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return n.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function rd(n,e){return n.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const B_=/^[ \t]*#include +<([\w\d./]+)>/gm;function rc(n){return n.replace(B_,H_)}const z_=new Map;function H_(n,e){let t=Oe[e];if(t===void 0){const i=z_.get(e);if(i!==void 0)t=Oe[i],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,i);else throw new Error("Can not resolve #include <"+e+">")}return rc(t)}const G_=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function sd(n){return n.replace(G_,V_)}function V_(n,e,t,i){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=i.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function od(n){let e=`precision ${n.precision} float;
...
#define LOW_PRECISION`),e}function W_(n){let e="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===_u?e="SHADOWMAP_TYPE_PCF":n.shadowMapType===vu?e="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===Gn&&(e="SHADOWMAP_TYPE_VSM"),e}function X_(n){let e="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case hr:case fr:e="ENVMAP_TYPE_CUBE";break;case fo:e="ENVMAP_TYPE_CUBE_UV";break}return e}function $_(n){let e="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case fr:e="ENVMAP_MODE_REFRACTION";break}return e}function Y_(n){let e="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case xu:e="ENVMAP_BLENDING_MULTIPLY";break;case jf:e="ENVMAP_BLENDING_MIX";break;case Zf:e="ENVMAP_BLENDING_ADD";break}return e}function q_(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:i,maxMip:t}}function j_(n,e,t,i){const r=n.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const c=W_(t),l=X_(t),d=$_(t),u=Y_(t),h=q_(t),p=F_(t),g=k_(s),_=r.createProgram();let m,f,w=t.glslVersion?"#version "+t.glslVersion+`
...
void main() {
  ...
  `,document.body.appendChild(Dt);const t=Dt.querySelector("#garage-grid");for(const i of vd){const r=document.createElement("button");r.type="button",r.className="garage-car",r.dataset.id=i.id,r.dataset.search=`${i.name} ${i.maker} ${i.year}`.toLowerCase(),r.innerHTML=`
      <span class="garage-car-year">${i.year}</span>
      <span class="garage-car-name">${xd(i.name)}</span>
      <span class="garage-car-maker">${xd(i.maker)}</span>
    `,r.addEventListener("click",()=>{const s=vd.find(o=>o.id===i.id);s&&(yd(),Is==null||Is(s))}),t.appendChild(r)}return Dt.querySelector("#garage-close").addEventListener("click",yd),Dt.querySelector("#garage-search").addEventListener("input",i=>{const r=i.target.value.trim().toLowerCase();t.querySelectorAll(".garage-car").forEach(s=>{s.hidden=r.length>0&&!s.dataset.search.includes(r)})}),{box:e,overlay:Dt}}function eh(){Dt&&(Dt.style.display="flex",Dt.querySelector("#garage-search").value="",Dt.querySelectorAll(".garage-car").forEach(n=>{n.hidden=!1}))}function yd(){Dt&&(Dt.style.display="none")}function lc(){return(Dt==null?void 0:Dt.style.display)==="flex"}function nr(n){const e=document.getElementById("garage-box");e&&(e.hidden=!n)}const Ir=new L;function ln(n,e,t,i,r,s){const o=2*Math.PI*r/4,a=Math.max(s-2*r,0),c=Math.PI/4;Ir.copy(e),Ir[i]=0,Ir.normalize();const l=.5*o/(o+a),d=1-Ir.angleTo(n)/c;return Math.sign(Ir[t])===1?d*l:a/(o+a)+l+l*(1-d)}class ex extends He{constructor(e=1,t=1,i=1,r=2,s=.1){if(r=r*2+1,s=Math.min(e/2,t/2,i/2,s),super(1,1,1,r,r,r),r===1)return;const o=this.toNonIndexed();this.index=null,this.attributes.position=o.attributes.position,this.attributes.normal=o.attributes.normal,this.attributes.uv=o.attributes.uv;const a=new L,c=new L,l=new L(e,t,i).divideScalar(2).subScalar(s),d=this.attributes.position.array,u=this.attributes.normal.array,h=this.attributes.uv.array,p=d.length/6,g=new L,_=.5/r;for(let m=0,f=0;m<d.length;m+=3,f+=2)switch(a.fromArray(d,m),c.copy(a),c.x-=Math.sign(c.x)*_,c.y-=Math.sign(c.y)*_,c.z-=Math.sign(c.z)*_,c.normalize(),d[m+0]=l.x*Math.sign(a.x)+c.x*s,d[m+1]=l.y*Math.sign(a.y)+c.y*s,d[m+2]=l.z*Math.sign(a.z)+c.z*s,u[m+0]=c.x,u[m+1]=c.y,u[m+2]=c.z,Math.floor(m/p)){case 0:g.set(1,0,0),h[f+0]=ln(g,c,"z","y",s,i),h[f+1]=1-ln(g,c,"y","z",s,t);break;case 1:g.set(-1,0,0),h[f+0]=1-ln(g,c,"z","y",s,i),h[f+1]=1-ln(g,c,"y","z",s,t);break;case 2:g.set(0,1,0),h[f+0]=1-ln(g,c,"x","z",s,e),h[f+1]=ln(g,c,"z","x",s,i);break;case 3:g.set(0,-1,0),h[f+0]=1-ln(g,c,"x","z",s,e),h[f+1]=1-ln(g,c,"z","x",s,i);break;case 4:g.set(0,0,1),h[f+0]=1-ln(g,c,"x","y",s,e),h[f+1]=1-ln(g,c,"y","x",s,t);break;case 5:g.set(0,0,-1),h[f+0]=ln(g,c,"x","y",s,e),h[f+1]=1-ln(g,c,"y","x",s,t);break}}}const Md={sedan:{length:4.55,width:1.88,ride:.52,cabinH:.78,cabinLen:2.15,hoodLen:1.35,wheelR:.36,wheelX:.86,wheelZ:1.36,grille:!0,chromeTrim:!0},sports:{length:4.15,width:1.92,ride:.38,cabinH:.52,cabinLen:1.42,hoodLen:1.62,wheelR:.34,wheelX:.9,wheelZ:1.22,low:!0,spoiler:!0,wideHips:!0},suv:{length:4.65,width:2.02,ride:.72,cabinH:.98,cabinLen:2.55,hoodLen:1.15,wheelR:.4,wheelX:.92,wheelZ:1.48,roofRails:!0,upright:!0},truck:{length:5.4,width:2.05,ride:.78,cabinH:.82,cabinLen:1.55,hoodLen:1.05,wheelR:.42,wheelX:.96,wheelZ:1.38,bedLen:2.45,bed:!0},compact:{length:3.35,width:1.62,ride:.46,cabinH:.68,cabinLen:1.65,hoodLen:.85,wheelR:.32,wheelX:.72,wheelZ:1.05},vintage:{length:3.85,width:1.72,ride:.68,cabinH:.62,cabinLen:1.45,hoodLen:1.1,wheelR:.36,wheelX:.78,wheelZ:1.2,fenders:!0,tall:!0},van:{length:4.55,width:1.92,ride:.95,cabinH:1.38,cabinLen:3.2,hoodLen:.55,wheelR:.37,wheelX:.88,wheelZ:1.38,flatFront:!0},cybertruck:{bodyShape:"cybertruck"}},tx={cybertruck:{bodyShape:"cybertruck"},beetle:{bodyShape:"round",length:3.25,width:1.58,ride:.5,roundH:1.02},"citroen-2cv":{bodyShape:"round",length:3.45,width:1.48,ride:.48,roundH:.95,softTop:!0},"fiat-500":{bodyShape:"round",length:2.95,width:1.42,ride:.42,roundH:.88},"vw-bus":{bodyShape:"flat-van",length:4.55,width:1.88,ride:1.05,splitWindshield:!0},"porsche-911":{bodyShape:"911",length:4.35,width:1.9,ride:.4,rearHump:!0,roundLights:!0},"ford-mustang":{bodyShape:"fastback",length:4.55,width:1.92,hoodLen:1.75,fastback:!0,scoop:!0},"dodge-charger":{bodyShape:"fastback",length:4.85,width:1.98,hoodLen:1.7,fastback:!0,muscle:!0},"chevy-camaro":{bodyShape:"fastback",length:4.45,width:1.9,hoodLen:1.65,fastback:!0},delorean:{bodyShape:"wedge",stainless:!0,length:4.2,width:1.85,ride:.42,gullwing:!0},"lamborghini-aventador":{bodyShape:"supercar",length:4.55,width:2.05,ride:.32,scissor:!0,wide:!0},"lamborghini-miura":{bodyShape:"supercar",length:4.35,width:1.92,ride:.34},"ferrari-308":{bodyShape:"supercar",length:4.25,width:1.88,ride:.35,roundLights:!0},"bugatti-chiron":{bodyShape:"supercar",length:4.55,width:2.08,ride:.3,wide:!0,horseshoe:!0},"jeep-wrangler":{bodyShape:"box-suv",length:4.2,width:1.88,ride:.82,spare:!0,roundLights:!0,upright:!0},"mercedes-g":{bodyShape:"box-suv",length:4.55,width:1.95,ride:.88,boxy:!0,spare:!1},"hummer-h1":{bodyShape:"box-suv",length:4.85,width:2.15,ride:.95,wide:!0,military:!0},"model-t":{bodyShape:"vintage-tall",length:3.35,width:1.55,ride:.82,tall:!0,spoked:!0},"rolls-silver-ghost":{bodyShape:"vintage-tall",length:4.85,width:1.82,ride:.95,tall:!0,longHood:!0},"tesla-model-s":{bodyShape:"ev-sedan",length:4.75,width:1.92,ride:.48,smooth:!0,noGrille:!0},"tesla-model-3":{bodyShape:"ev-sedan",length:4.55,width:1.85,ride:.45,smooth:!0,noGrille:!0},"tesla-model-x":{bodyShape:"ev-suv",length:4.75,width:2,ride:.72,falcon:!0,noGrille:!0},"tesla-model-y":{bodyShape:"ev-suv",length:4.65,width:1.92,ride:.68,smooth:!0,noGrille:!0},"tesla-roadster":{bodyShape:"supercar",length:4,width:1.88,ride:.34,smooth:!0,noGrille:!0},"rivian-r1t":{bodyShape:"ev-truck",length:5.35,width:2.05,ride:.82,bed:!0,roundLights:!0},"ford-f150":{bodyShape:"truck",length:5.55,width:2.08,ride:.82,bedLen:2.55,chromeGrille:!0},"dodge-ram":{bodyShape:"truck",length:5.65,width:2.1,ride:.85,bedLen:2.6,tallGrille:!0},"mercedes-300sl":{bodyShape:"gullwing",length:4.35,width:1.82,ride:.42,gullwing:!0},"jaguar-e-type":{bodyShape:"fastback",length:4.45,width:1.78,hoodLen:1.85,longNose:!0},"vw-id4":{bodyShape:"ev-suv",length:4.55,width:1.92,ride:.7,smooth:!0},"renault-5-ev":{bodyShape:"round",length:3.55,width:1.65,ride:.48,roundH:.82,retro:!0},"mini-cooper":{bodyShape:"round",length:3.55,width:1.62,ride:.44,roundH:.72},"ford-gt":{bodyShape:"supercar",length:4.35,width:1.95,ride:.33,stripe:!0},"ford-gt40":{bodyShape:"supercar",length:4.15,width:1.92,ride:.32,stripe:!0},"aston-db5":{bodyShape:"fastback",length:4.45,width:1.82,hoodLen:1.55,elegant:!0},"rolls-phantom":{bodyShape:"luxury-sedan",length:5.35,width:2,ride:.58,tall:!0,longHood:!0},"cadillac-escalade":{bodyShape:"luxury-suv",length:5.05,width:2.05,ride:.78,chromeGrille:!0},trabant:{bodyShape:"round",length:3.25,width:1.48,ride:.46,roundH:.78,twoStroke:!0},"toyota-prius":{bodyShape:"hybrid",length:4.35,width:1.78,ride:.5,wedgeRear:!0},"hyundai-ioniq5":{bodyShape:"ev-suv",length:4.55,width:1.92,ride:.68,pixelLights:!0,retro:!0}};function nx(n){const e=n.style??"sedan",t={...Md[e]??Md.sedan},i=tx[n.id]??{},r={...t,...i,id:n.id,name:n.name,style:e,color:n.color??12107204,year:n.year??2e3,maker:n.maker??""};return r.bodyShape||(r.bodyShape=e),r}const ra=new Ze({color:2762016,roughness:.82,metalness:.05}),ix=new Ze({color:1316896,roughness:.55,metalness:.15}),Sd=new Ze({color:13421772,metalness:.9,roughness:.2});function rx(n,e={x:.32,y:.78,z:.05}){const t=new Xe;t.name="cockpit";const i=new xe(new He(1.45,.38,.55),ix);i.position.set(.05,e.y+.08,e.z+.42),i.rotation.x=-.35,t.add(i);const r=new xe(new He(.42,.18,.06),new Ze({color:660768,emissive:2245734,emissiveIntensity:.35}));r.position.set(.12,e.y+.22,e.z+.52),r.rotation.x=-.35,t.add(r);const s=new Xe,o=new xe(new _o(.17,.028,10,20),Sd);o.rotation.x=Math.PI/2;const a=new xe(new He(.3,.025,.04),Sd);s.add(o,a),s.position.set(e.x,e.y+.02,e.z+.28),s.rotation.x=-.55,t.add(s);const c=new xe(new He(.42,.12,.42),ra);c.position.set(e.x,e.y-.08,e.z);const l=new xe(new He(.4,.45,.1),ra);l.position.set(e.x,e.y+.12,e.z-.16),l.rotation.x=-.2;const d=new xe(new He(.22,.18,.08),ra);return d.position.set(e.x,e.y+.38,e.z-.18),t.add(c,l,d),n.add(t),t}function sx(n,e={x:.32,y:.78,z:.05}){const t=new Xe;t.name="engine",t.userData.carPart="engine",t.userData.detachable=!1;const i=new xe(new He(.72,.42,.85),new Ze({color:3816002,metalness:.75,roughness:.45}));i.position.y=.21,i.castShadow=!0;const r=new xe(new He(.55,.22,.48),new Ze({color:2763314,metalness:.8,roughness:.35}));r.position.set(0,.48,.12);const s=new xe(new He(.62,.08,.35),new Ze({color:5592416,metalness:.85,roughness:.3}));s.position.set(0,.38,-.22);for(const o of[-.18,.18]){const a=new xe(new Gt(.06,.06,.2,8),new Ze({color:4868693,metalness:.7,roughness:.4}));a.position.set(o,.52,.05),t.add(a)}return t.add(i,r,s),t.position.set(.02,e.y-.42,e.z+.55),n.add(t),t}function ox(n){const e=n.userData.wheels??[];for(const t of e)t.userData.baseY=t.position.y,t.userData.baseX=t.position.x,t.userData.steerable=String(t.userData.carPart??"").includes("_f")}function ax(n,e){e&&n.traverse(t=>{if(!t.isMesh||!t.material)return;const i=Array.isArray(t.material)?t.material:[t.material];for(const r of i)(r.isMeshPhysicalMaterial||r.isMeshStandardMaterial)&&(r.envMap=e,r.envMapIntensity=String(t.userData.carPart??"").includes("window")||t.userData.carPart==="windshield"?1.5:.65,r.needsUpdate=!0)})}function xt(n,e=.78,t=.16){return new ss({color:n,metalness:e,roughness:t,clearcoat:.95,clearcoatRoughness:.06})}function mi(){return new ss({color:13164016,metalness:.15,roughness:.02,transparent:!0,opacity:.22,transmission:.88,thickness:.3,ior:1.52,envMapIntensity:1.6})}function vr(){return new Ze({color:15263980,metalness:.96,roughness:.12})}function cx(){return new Ze({color:921102,metalness:.04,roughness:.94})}function Dn(n=1315860){return new Ze({color:n,metalness:.12,roughness:.68})}function dc(n=12107204){return new ss({color:n,metalness:.97,roughness:.12,clearcoat:.6,clearcoatRoughness:.05})}function uc(){return new Ze({color:789516,metalness:.3,roughness:.58})}function hc(n=.4){return new ss({color:16775400,emissive:16773324,emissiveIntensity:n,metalness:.05,roughness:.04,transparent:!0,opacity:.9})}function lx(){return new ss({color:16720418,emissive:16716049,emissiveIntensity:.55,metalness:.1,roughness:.2,transparent:!0,opacity:.92})}function Be(n,e,t={}){return n.userData.carPart=e,t.detachable!==!1&&(n.userData.detachable=!0),t.dentPanel&&(n.userData.dentPanel="front"),n}function ut(n,e,t=!0){const i=new xe(n,e);return i.castShadow=t,i.receiveShadow=!0,i}function bt(n,e,t,i,r=e/2,s=0,o=0,a=0,c=0){const l=ut(new He(n,e,t),i);return l.position.set(s,r,o),l.rotation.set(a,c,0),l}function Le(n,e,t,i,r=e/2,s=.08){const o=ut(new ex(n,e,t,5,s),i,!0);return o.position.y=r,o}function Zt(n,e={x:.32,y:.78,z:.05}){if(n.userData.driverSeat=e,!n.userData.wheels){const t=[];n.traverse(i=>{var r;(r=i.userData)!=null&&r.isWheel&&t.push(i)}),n.userData.wheels=t}return rx(n,e),sx(n,e),ox(n),n}function dx(n,e){return ax(n,e),n}function Xc(n=.36,e=!1){const t=new Xe;t.userData.isWheel=!0;const i=ut(new Gt(n,n,e?.3:.26,28),cx);i.rotation.z=Math.PI/2;const r=ut(new Gt(n*.68,n*.68,e?.26:.24,20),vr);r.rotation.z=Math.PI/2;const s=ut(new Gt(n*.2,n*.2,e?.28:.26,12),Dn(2763306));s.rotation.z=Math.PI/2;const o=e?7:5;for(let c=0;c<o;c++){const l=ut(new He(n*.58,.06,e?.12:.14),vr);l.rotation.x=c/o*Math.PI*2,l.rotation.z=Math.PI/2,t.add(l)}const a=ut(new Gt(n*.48,n*.48,.05,16),Dn(3355443));return a.rotation.z=Math.PI/2,t.add(i,r,s,a),t}function nn(n,e){const t=[],i=e.wheelR??.36,r=e.wheelX??.86,s=e.wheelZ??1.32,o=e.low||e.bodyShape==="supercar";for(const[a,c,l]of[[-r,s,"wheel_fl"],[r,s,"wheel_fr"],[-r,-s,"wheel_rl"],[r,-s,"wheel_rr"]]){const d=Xc(i,o);d.position.set(a,i,c),d.userData.carPart=l,d.userData.detachable=!0,n.add(d),t.push(d)}n.userData.wheels=t}function ux(n,e,t,i,r){const s=ut(new _o(i*1.02,i*.14,8,16,Math.PI),xt(r,.7,.22));s.rotation.x=Math.PI/2,s.rotation.z=e<0?Math.PI:0,s.position.set(e,i*.92,t),n.add(Be(s,`arch_${e<0?"l":"r"}_${t>0?"f":"r"}`))}function $c(n,e,t,i,r=!1){const s=new Xe;if(r){s.add(ut(new Gt(.1,.1,.12,18),Dn()));const o=ut(new Gt(.085,.085,.03,18),hc(.45));o.rotation.z=Math.PI/2,o.position.x=.065,s.add(o),s.rotation.z=Math.PI/2}else s.add(ut(new He(.34,.15,.1),Dn())),s.add(ut(new He(.28,.11,.04),hc(.42))),s.children[1].position.z=.06;s.position.set(e,t,i),n.add(Be(s,"headlight",{detachable:!0}))}function th(n,e,t,i){const r=new Xe;r.add(ut(new He(.36,.14,.08),Dn(2228224)));const s=ut(new He(.3,.1,.03),lx());s.position.z=.045,r.add(s),r.position.set(e,t,i),n.add(Be(r,"taillight"))}function Cn(n,e,t,i){const r=e.width*.38,s=e.roundLights;for(const o of[-r,r])$c(n,o,e.ride+.02,t,s),th(n,o,e.ride+.12,i)}function rn(n,e,t,i){const r=(s,o)=>{const a=o==="bumper_front",c=Be(Le(e.width*.94,.2,.26,Dn(1710618),.2,.03),o,{detachable:!0,dentPanel:a});return c.position.z=s,c};n.add(r(t,"bumper_front"),r(i,"bumper_rear"))}function Fi(n,e,t,i=!1){if(e.noGrille){const o=bt(e.width*.7,.06,.06,Dn(1118481),e.ride*.55,0,t);n.add(o);return}const r=i?.48:.36,s=Be(Le(e.width*.58,r,.08,Dn(526344),r/2+.08,.02),"grille",{detachable:!0});s.position.z=t,n.add(s);for(let o=-2;o<=2;o++){const a=bt(.04,r*.85,.02,vr(),e.ride*.55+r*.08,o*e.width*.1,t+.02);n.add(a)}}function jn(n,e,t){for(const[i,r]of[[-e.width*.52,"mirror_l"],[e.width*.52,"mirror_r"]]){const s=Be(ut(new He(.12,.08,.16),xt(e.color,.55,.28)),r,{detachable:!0});s.position.set(i,e.ride+e.cabinH*.55,t),n.add(s)}}function Zn(n,e,t){const i=xt(e.color),r=Be(Le(.08,e.cabinH*.92,e.cabinLen*.55,i,e.cabinH*.46,.03),"door_l",{detachable:!0});r.position.set(-e.width*.5,0,t);const s=r.clone();s.position.x=e.width*.5,n.add(r,s);const o=Be(Le(.04,e.cabinH*.62,e.cabinLen*.48,mi(),e.cabinH*.38,.015),"window_l");o.position.set(-e.width*.47,e.ride+e.cabinH*.55,t);const a=Be(Le(.04,e.cabinH*.62,e.cabinLen*.48,mi(),e.cabinH*.38,.015),"window_r");n.add(o,a)}function Un(n,e,t,i=null){const r=i??e.color,s=Le(e.width*.88,e.cabinH,e.cabinLen,xt(r,.55,.2),e.cabinH/2+e.ride,.07);s.position.z=t;const o=Be(Le(e.width*.82,e.cabinH*.68,e.cabinLen*.38,mi(),e.cabinH*.42+e.ride,.04),"windshield",{detachable:!0});o.position.set(0,0,t+e.cabinLen*.16),o.rotation.x=-.28;const a=Le(e.width*.78,e.cabinH*.55,e.cabinLen*.22,mi(),e.cabinH*.38+e.ride,.03);a.position.set(0,0,t-e.cabinLen*.38),a.rotation.x=.32,n.add(s,o,a)}function gi(n,e){const t=e.wheelX??.86,i=e.wheelZ??1.32,r=e.wheelR??.36;for(const[s,o]of[[-t,i],[t,i],[-t,-i],[t,-i]])ux(n,s,o,r,e.color)}function sn(n){return n.length*.5-.08}function Pt(n){return-n.length*.5+.08}function hx(n){const e=new Xe,t=dc(n.color),i=dc(10133672);e.add(bt(2.28,.42,5.05,i,.48)),e.add(bt(2.18,.55,4.85,t,.78,0,.05)),e.add(Be(bt(2.12,.28,1.55,t,.98,0,1.55,-.08),"hood",{dentPanel:!0})),e.add(Be(bt(2.22,.72,.22,t,.72,0,2.42),"front_panel",{dentPanel:!0})),e.add(Be(bt(2.05,.1,.08,hc(1.4),.62,0,2.52),"headlight")),e.add(Be(bt(2.24,.18,.2,uc(),.22,0,2.58),"bumper_front",{detachable:!0,dentPanel:!0})),e.add(bt(2.02,.52,2.05,t,1.42,0,-.15,-.32)),e.add(bt(2.02,.48,1.85,t,1.55,0,-1.55,.28)),e.add(Be(bt(.12,.95,3.35,i,1.05,-1.1,-.35,0,.12),"door_l",{detachable:!0})),e.add(Be(bt(.12,.95,3.35,i,1.05,1.1,-.35,0,-.12),"door_r",{detachable:!0})),e.add(Be(bt(1.75,.32,1.15,mi(),1.12,0,.55,-.42),"windshield",{detachable:!0})),e.add(bt(2.12,.18,2.15,i,.52,0,-1.75)),e.add(bt(.14,.42,2.15,t,.78,-1.08,-1.75)),e.add(bt(.14,.42,2.15,t,.78,1.08,-1.75));for(const s of[-1.02,1.02]){const o=ut(new Gt(.35,.35,.18,6),uc());o.rotation.z=Math.PI/2,o.position.set(s,.38,1.48),e.add(o);const a=o.clone();a.position.z=-1.48,e.add(a)}const r=[];for(const[s,o,a]of[[-1.02,1.48,"wheel_fl"],[1.02,1.48,"wheel_fr"],[-1.02,-1.48,"wheel_rl"],[1.02,-1.48,"wheel_rr"]]){const c=Xc(.4,!1);c.position.set(s,.38,o),c.userData.carPart=a,c.userData.detachable=!0,e.add(c),r.push(c)}return e.userData.wheels=r,Zt(e,{x:.28,y:.88,z:.12})}function fx(n){const e=new Xe,t=xt(n.color,.65,.22),i=n.roundH??.95,r=ut(new fn(n.width*.52,20,16),t);r.scale.set(1,i/n.width,n.length/n.width*.55),r.position.set(0,n.ride+i*.35,0),e.add(r);const s=ut(new fn(n.width*.38,16,12),t);if(s.scale.set(1,.55,1.1),s.position.set(0,n.ride+i*.72,-.05),e.add(s),n.softTop){const l=ut(new fn(n.width*.36,12,8,0,Math.PI*2,0,Math.PI/2),xt(2771498,.2,.7));l.position.set(0,n.ride+i*.55,-.08),e.add(l)}const o=Be(Le(n.width*.75,.12,n.length*.28,t,.08,.05),"hood",{dentPanel:!0});o.position.set(0,n.ride+.08,n.length*.28),e.add(o);const a=sn(n),c=Pt(n);for(const l of[-n.width*.32,n.width*.32])$c(e,l,n.ride+.08,a,!0);rn(e,n,a+.06,c-.06),nn(e,n);for(const[l,d]of[[-n.wheelX,n.wheelZ],[n.wheelX,n.wheelZ],[-n.wheelX,-n.wheelZ],[n.wheelX,-n.wheelZ]]){const u=ut(new fn(n.wheelR*.95,14,10),t);u.scale.set(1,.5,1.05),u.position.set(l,n.wheelR*.75,d),e.add(u)}return Zt(e,{x:.28,y:n.ride+.35,z:0})}function bd(n){const e=new Xe,t=xt(n.color,.6,.24);e.add(Be(Le(n.width,n.ride*1.35,n.length*.92,t,n.ride*.85,.08),"body",{dentPanel:!0}));const i=sn(n);if(n.splitWindshield){const s=Be(Le(n.width*.38,n.cabinH*.55,.08,mi(),n.cabinH*.35,.03),"windshield");s.position.set(-n.width*.2,n.ride+n.cabinH*.45,i-.15),s.rotation.y=.12;const o=s.clone();o.position.x=n.width*.2,o.rotation.y=-.12,e.add(s,o)}const r=Le(n.width*.88,n.cabinH*.7,n.cabinLen*.85,mi(),n.cabinH*.42,.05);return r.position.set(0,n.ride+n.cabinH*.5,-.1),e.add(r),Zn(e,n,-.1),Cn(e,n,i,Pt(n)),rn(e,n,i+.06,Pt(n)-.06),jn(e,n,.2),nn(e,n),Zt(e,{x:.34,y:n.ride+.45,z:-.1})}function px(n){const e=new Xe,t=xt(n.color,.82,.12);e.add(Le(n.width,n.ride*.75,n.length*.88,t,n.ride*.55,.06));const i=Be(Le(n.width*.88,.12,n.hoodLen,t,.08,.04),"hood",{dentPanel:!0});i.position.set(0,n.ride+.02,n.length*.28),e.add(i);const r=Le(n.width*.82,n.cabinH,n.cabinLen*.85,t,n.cabinH/2+n.ride,.06);r.position.z=-.05,e.add(r);const s=Le(n.width*.92,.28,.85,t,.18,.05);s.position.set(0,n.ride+.42,-n.length*.32),e.add(s),Un(e,n,-.05);const o=sn(n),a=Pt(n);for(const c of[-n.width*.36,n.width*.36])$c(e,c,n.ride+.05,o,!0);for(const c of[-n.width*.38,n.width*.38])th(e,c,n.ride+.1,a);return rn(e,n,o+.05,a-.05),jn(e,n,.15),nn(e,n),gi(e,n),Zt(e,{x:.32,y:n.ride+.35,z:.05})}function mx(n){const e=new Xe,t=xt(n.color,.8,.14);e.add(Le(n.width,n.ride*.72,n.length*.82,t,n.ride*.48,.07));const i=Be(Le(n.width*.92,.14,n.hoodLen,t,.09,.04),"hood",{dentPanel:!0});if(i.position.set(0,n.ride+.02,n.length*.22),e.add(i),n.scoop){const l=bt(.35,.06,.45,uc(),n.ride+.12,0,n.length*.18);e.add(l)}const r=Le(n.width*.86,n.cabinH,n.cabinLen,xt(n.color,.75,.18),n.cabinH/2+n.ride,.06);r.position.z=-.12,e.add(r);const s=Le(n.width*.82,n.cabinH*.65,1.15,t,n.cabinH*.38+n.ride,.05);s.position.set(0,0,-n.length*.32),s.rotation.x=-.38,e.add(s),Un(e,n,-.1,1381664),Zn(e,n,-.1);const o=sn(n),a=Pt(n);Fi(e,n,o-.05),Cn(e,n,o,a),rn(e,n,o+.06,a-.06),jn(e,n,.12),nn(e,n),gi(e,n);const c=Be(ut(new He(n.width*.78,.06,.28),t),"spoiler",{detachable:!0});return c.position.set(0,n.ride+n.cabinH*.55,a+.12),e.add(c),Zt(e,{x:.32,y:n.ride+.35,z:.02})}function Ed(n){const e=new Xe,t=n.stainless?dc(n.color):xt(n.color,.85,.12),i=Le(n.width,n.ride*.85,n.length*.88,t,n.ride*.52,.05);e.add(i);const r=Le(n.width*.92,n.ride*.55,1.25,t,n.ride*.38,.04);r.position.set(0,0,n.length*.28),r.rotation.x=-.08,e.add(Be(r,"hood",{dentPanel:!0}));const s=Le(n.width*.78,n.cabinH*.55,n.cabinLen*.75,t,n.cabinH*.35+n.ride,.04);if(s.position.z=-.05,s.rotation.x=-.15,e.add(s),n.gullwing)for(const a of[-n.width*.42,n.width*.42]){const c=Be(Le(.06,n.cabinH*.5,n.cabinLen*.4,mi(),n.cabinH*.3,.02),"window_l");c.position.set(a,n.ride+n.cabinH*.45,0),c.rotation.z=a<0?.35:-.35,e.add(c)}const o=sn(n);return Cn(e,n,o,Pt(n)),rn(e,n,o+.05,Pt(n)-.05),nn(e,n),gi(e,n),Zt(e,{x:.3,y:n.ride+.38,z:.05})}function gx(n){const e=new Xe,t=xt(n.color,.88,.08);e.add(Le(n.width,n.ride*.65,n.length*.85,t,n.ride*.42,.05));const i=Be(Le(n.width*.9,.1,n.hoodLen*.95,t,.07,.03),"hood",{dentPanel:!0});i.position.set(0,n.ride+.02,n.length*.26),e.add(i);const r=Le(n.width*.78,n.cabinH,n.cabinLen*.9,xt(1118488,.5,.3),n.cabinH/2+n.ride,.04);if(r.position.z=-.02,e.add(r),Un(e,n,-.02,1052696),n.wide){const c=Le(.22,.18,1.05,t,.12,.03);c.position.set(-n.width*.48,n.ride+.15,-n.length*.22);const l=c.clone();l.position.x=n.width*.48,e.add(c,l)}if(n.stripe){const c=bt(.12,.02,n.length*.55,xt(16777215,.6,.2),n.ride+.14,0,0);e.add(c)}const s=sn(n),o=Pt(n);if(n.horseshoe){const c=Le(n.width*.45,.22,.1,Dn(657930),.14,.02);c.position.set(0,n.ride+.05,s-.02),e.add(c)}else Fi(e,n,s-.04);Cn(e,n,s,o),rn(e,n,s+.04,o-.04),nn(e,{...n,wheelR:n.wheelR??.35}),gi(e,n);const a=Be(ut(new He(n.width*.72,.05,.32),t),"spoiler",{detachable:!0});return a.position.set(0,n.ride+.42,o+.1),e.add(a),Zt(e,{x:.3,y:n.ride+.28,z:.02})}function Td(n){const e=new Xe,t=xt(n.color,.55,.28);e.add(Be(Le(n.width,n.ride*1.15,n.length*.9,t,n.ride*.72,.06),"body",{dentPanel:!0})),Un(e,n,-.15),Zn(e,n,-.15);const i=sn(n),r=Pt(n);if(Fi(e,n,i-.04,n.tallGrille),Cn(e,{...n,roundLights:!0},i,r),rn(e,n,i+.06,r-.06),jn(e,n,0),n.spare){const s=Xc(.32);s.position.set(0,n.ride+.45,r-.15),e.add(s)}if(n.roofRails)for(const s of[-n.width*.48,n.width*.48]){const o=ut(new Gt(.025,.025,n.cabinLen*.9,8),vr());o.rotation.x=Math.PI/2,o.position.set(s,n.ride+n.cabinH+.08,-.1),e.add(o)}return nn(e,n),Zt(e,{x:.36,y:n.ride+.42,z:0})}function Cd(n){const e=new Xe,t=xt(n.color,.82,.1),i=Le(n.width,n.ride*.95,n.length*.92,t,n.ride*.55,.09);e.add(Be(i,"body",{dentPanel:!0}));const r=Be(Le(n.width*.88,.1,n.hoodLen*.9,t,.07,.05),"hood",{dentPanel:!0});r.position.set(0,n.ride+.02,n.length*.28),e.add(r),Un(e,n,-.12),Zn(e,n,-.12);const s=sn(n),o=Pt(n),a=bt(n.width*.75,.05,.08,Dn(1118481),n.ride*.45,0,s-.02);return e.add(a),Cn(e,n,s,o),rn(e,n,s+.05,o-.05),jn(e,n,.05),nn(e,n),gi(e,n),Zt(e,{x:.34,y:n.ride+.38,z:.02})}function _x(n){const e=new Xe,t=xt(n.color,.78,.14);e.add(Be(Le(n.width,n.ride*1.05,n.length*.9,t,n.ride*.65,.1),"body",{dentPanel:!0})),Un(e,n,-.18),Zn(e,n,-.18);const i=sn(n);if(Cn(e,n,i,Pt(n)),rn(e,n,i+.06,Pt(n)-.06),jn(e,n,-.02),n.falcon)for(const r of[-n.width*.42,n.width*.42]){const s=Be(Le(.08,.06,.45,t,.04,.02),"door_l");s.position.set(r,n.ride+n.cabinH+.02,.1),s.rotation.z=r<0?.4:-.4,e.add(s)}return nn(e,n),gi(e,n),Zt(e,{x:.36,y:n.ride+.48,z:-.02})}function wd(n){const e=new Xe,t=xt(n.color,.4,.42);if(e.add(Be(Le(n.width,n.ride*1.05,n.length*.88,t,n.ride*.65,.1),"body",{dentPanel:!0})),n.longHood){const r=Be(Le(n.width*.85,.18,n.hoodLen,t,.12,.06),"hood",{dentPanel:!0});r.position.set(0,n.ride+.05,n.length*.22),e.add(r)}Un(e,n,.12,3811866),Zn(e,n,.12);for(const r of[-n.width*.5,n.width*.5]){const s=ut(new fn(.36,14,10),t);s.scale.set(1,.52,1.08),s.position.set(r,n.ride+.15,n.length*.15),e.add(s)}const i=sn(n);return Fi(e,n,i-.04),Cn(e,{...n,roundLights:!0},i,Pt(n)),rn(e,n,i+.06,Pt(n)-.06),nn(e,n),Zt(e,{x:.3,y:n.ride+.4,z:.08})}function vx(n){const e=new Xe,t=xt(n.color,.85,.1);e.add(Be(Le(n.width,n.ride*.95,n.length*.94,t,n.ride*.58,.1),"body",{dentPanel:!0}));const i=Be(Le(n.width*.9,.14,n.hoodLen*1.1,t,.1,.05),"hood",{dentPanel:!0});i.position.set(0,n.ride+.03,n.length*.26),e.add(i),Un(e,n,-.1),Zn(e,n,-.1);const r=sn(n);Fi(e,n,r-.04,!0),Cn(e,n,r,Pt(n)),rn(e,n,r+.05,Pt(n)-.05),jn(e,n,.05);const s=bt(n.width*.96,.04,n.length*.88,vr(),n.ride*.35,0,0);return e.add(s),nn(e,n),gi(e,n),Zt(e,{x:.34,y:n.ride+.42,z:.02})}function Rd(n){const e=new Xe,t=xt(n.color,.62,.26),i=n.cabinLen??1.55;e.add(Be(Le(n.width,n.ride*1.05,i,t,n.ride*.78,.08),"cab",{dentPanel:!0})),Un(e,n,.45),Zn(e,n,.45);const r=n.bedLen??2.45,s=-i*.5-r*.5+.2;e.add(Le(n.width,.2,r,xt(n.color,.5,.35),.52,.04)),e.children[e.children.length-1].position.z=s;for(const c of[-n.width*.48,n.width*.48]){const l=Le(.1,.52,r,t,.78,.02);l.position.set(c,0,s),e.add(l)}const o=sn(n),a=Pt(n);return Fi(e,n,o-.04,n.tallGrille),Cn(e,n,o,a),rn(e,n,o+.06,a-.06),jn(e,n,.45),nn(e,n),Zt(e,{x:.38,y:n.ride+.45,z:.4})}function Hr(n){const e=new Xe,t=xt(n.color);e.add(Be(Le(n.width,n.ride*.95,n.length*.9,t,n.ride*.55,.08),"body",{dentPanel:!0}));const i=Be(Le(n.width*.86,.12,n.hoodLen,t,.08,.05),"hood",{dentPanel:!0});i.position.set(0,n.ride+.02,n.length*.28),e.add(i),Un(e,n,-.12),Zn(e,n,-.12);const r=sn(n),s=Pt(n);if(Fi(e,n,r-.04),Cn(e,n,r,s),rn(e,n,r+.06,s-.06),jn(e,n,.05),n.roofRails)for(const a of[-n.width*.48,n.width*.48]){const c=ut(new He(.05,.05,n.cabinLen*.85),vr());c.position.set(a,n.ride+n.cabinH+.05,-.1),e.add(c)}if(n.spoiler){const a=Be(ut(new He(n.width*.72,.06,.28),t),"spoiler",{detachable:!0});a.position.set(0,n.ride+n.cabinH*.5,s+.1),e.add(a)}nn(e,n),gi(e,n);const o=n.ride+(n.low?.28:.38);return Zt(e,{x:.32,y:o,z:.02})}const xx={cybertruck:hx,round:fx,"flat-van":bd,911:px,fastback:mx,wedge:Ed,supercar:gx,"box-suv":Td,"ev-sedan":Cd,"ev-suv":_x,"ev-truck":Rd,"vintage-tall":wd,"luxury-sedan":vx,"luxury-suv":Td,gullwing:Ed,hybrid:Cd,truck:Rd,sedan:Hr,sports:Hr,suv:Hr,compact:Hr,vintage:wd,van:bd};function yx(n){const e=nx(n),i=(xx[e.bodyShape]??Hr)(e);return i.userData.carId=n.id,i.userData.carName=n.name,i}const Mx=5,dn=28,Rn=38,Us=30,Sx=18;function Yc(){return{engine:100,body:100,hood:100,windshield:100,wheel_fl:100,wheel_fr:100,wheel_rl:100,wheel_rr:100}}function Ns(n,e){let t=null;return n.traverse(i=>{var r;((r=i.userData)==null?void 0:r.carPart)===e&&!i.userData.detached&&(t=i)}),t}function Gr(n,e,t){n.partHealth||(n.partHealth=Yc());const i=n.partHealth,s={headlight:"body",grille:"body",bumper_front:"body",hood:"hood",windshield:"windshield",door_l:"body",door_r:"body",wheel_fl:"wheel_fl",wheel_fr:"wheel_fr",wheel_rl:"wheel_rl",wheel_rr:"wheel_rr"}[e]??"body";i[s]!=null&&(i[s]=Math.max(0,i[s]-t)),(e==="hood"||e==="bumper_front"||e==="grille")&&(i.engine=Math.max(0,i.engine-t*.45))}function qc(n){return Math.abs(n)>=dn}function fc(n){return qc(n)?Math.min(1,(Math.abs(n)-dn)/(52-dn)):0}function bx(n){var t;const e=((t=n==null?void 0:n.geometry)==null?void 0:t.parameters)??{};return{width:e.width??2,height:e.height??.6,depth:e.depth??1.2}}function jc(n){const e={minX:1/0,maxX:-1/0,minY:1/0,maxY:-1/0,minZ:1/0,maxZ:-1/0};for(let t=0;t<n.length;t+=3)e.minX=Math.min(e.minX,n[t]),e.maxX=Math.max(e.maxX,n[t]),e.minY=Math.min(e.minY,n[t+1]),e.maxY=Math.max(e.maxY,n[t+1]),e.minZ=Math.min(e.minZ,n[t+2]),e.maxZ=Math.max(e.maxZ,n[t+2]);return e}function Ex(n,e,t){const i=Math.max(0,Math.min(1,(t-n)/(e-n)));return i*i*(3-2*i)}function Tx(n){if(n.userData.dentDense)return;const e=n.geometry,t=e==null?void 0:e.parameters;if(!(t!=null&&t.width))return;const{width:i,height:r,depth:s}=t,o=Math.max(10,Math.ceil(i*14)),a=Math.max(10,Math.ceil(r*14)),c=Math.max(5,Math.ceil(s*12)),l=new He(i,r,s,o,a,c);n.geometry.dispose(),n.geometry=l,n.userData.dentOriginal=null,n.userData.dentColorOriginal=null,n.userData.dentDense=!0}function Cx(n){const e=[];if(n.traverse(s=>{s.isMesh&&s.userData.dentPanel==="front"&&e.push(s)}),!e.length)return null;n.updateWorldMatrix(!0,!0);const t=new L;let i=e[0],r=-1/0;for(const s of e)s.getWorldPosition(t),n.worldToLocal(t),t.z>r&&(r=t.z,i=s);return i}function pc(n){const e=[];return n.traverse(t=>{var i,r,s;t!==n&&(!((i=t.userData)!=null&&i.detachable)||t.userData.detached||(s=(r=t.parent)==null?void 0:r.userData)!=null&&s.detachable||e.push(t))}),e}const Ad={headlight:100,grille:85,front_panel:82,bumper_front:78,hood:72,windshield:65,mirror_l:50,mirror_r:50,door_l:40,door_r:40,window_l:38,window_r:38,bumper_rear:20,taillight:18,spoiler:15};function Pd(n){const e=n.userData.carPart??"";return Ad[e]!=null?Ad[e]:e.startsWith("wheel_")?35:12}function wx(n,e){const t=new L;n.getWorldPosition(t),e.worldToLocal(t);const i=n.userData.carPart??"";return i==="headlight"||i==="grille"||i==="bumper_front"||i==="hood"||i==="front_panel"?!0:t.z>.15}function Rx(n,e=.5){if(!n||n.userData.shattered)return;n.userData.shattered=!0;const t=new mo({color:16777215,transparent:!0,opacity:.85,depthWrite:!1}),i=new Xe;i.name="cracks";const r=10+Math.floor(e*16);for(let s=0;s<r;s++){const o=new xe(new Yn(.15+Math.random()*.55,.012+Math.random()*.02),t);o.position.set((Math.random()-.5)*1.4,(Math.random()-.5)*.9,.03+Math.random()*.02),o.rotation.z=Math.random()*Math.PI,i.add(o)}n.add(i),n.material&&!Array.isArray(n.material)&&(n.material=n.material.clone(),n.material.opacity=Math.min(n.material.opacity??.4,.35),n.material.transmission=.25,n.material.needsUpdate=!0)}function Ld(n,e=1){!n||n.userData.hung||n.userData.detached||(n.userData.hung=!0,n.rotation.y=e*(.55+Math.random()*.35),n.position.x+=e*.08)}function Ax(n,e,t,i,r,s,o,a){var m;if(!(t!=null&&t.geometry))return;const l=jc(Zc(t)).maxZ,d=.28+s*.42,u=5+Math.floor(s*4),h=new we(((m=e.spec)==null?void 0:m.color)??12107204),p=new L(0,0,1).applyAxisAngle(new L(0,1,0),e.rotY),g=new L,_=Math.abs(o);for(let f=0;f<u;f++)for(let w=0;w<u;w++){const C=(f/(u-1)-.5)*2,S=(w/(u-1)-.5)*2,P=Math.hypot(C,S);if(P>1)continue;const b=1-P;if(b<.25&&Math.random()>s*.85)continue;g.set(i+C*d,r+S*d*.85,l),t.localToWorld(g);const E=.07+Math.random()*.11,A=.05+Math.random()*.08,y=.06+Math.random()*.1,x=new Ze({color:h.clone().lerp(new we(6710886),.2+Math.random()*.35),metalness:.55+Math.random()*.3,roughness:.35+Math.random()*.25}),R=new xe(new He(E,A,y),x);R.position.copy(g),R.rotation.set(Math.random()*Math.PI,Math.random()*Math.PI,Math.random()*Math.PI),n.add(R);const O=p.clone().multiplyScalar(2+_*.05*b).add(new L((Math.random()-.5)*3,1.5+Math.random()*3,(Math.random()-.5)*2));a.push({mesh:R,vel:O,life:5+Math.random()*2,bounce:.28,spin:new L((Math.random()-.5)*10,(Math.random()-.5)*10,(Math.random()-.5)*10)})}}function Px(n,e,t,i){var c,l;const r=Zc(n),s=(l=(c=n.geometry)==null?void 0:c.attributes)==null?void 0:l.position;if(!r||!s)return;const o=.25+i*.4,a=jc(r).minZ;for(let d=0;d<s.count;d++){const u=r[d*3],h=r[d*3+1];r[d*3+2];const p=Math.hypot(u-e,h-t);if(p>o)continue;1-p/o>.55+i*.25&&s.setXYZ(d,e+(u-e)*.15,t+(h-t)*.15,a-.02)}s.needsUpdate=!0,n.geometry.computeVertexNormals()}function Lx(n,e,t,i){const r=Math.abs(t);if(r<Sx)return;const s=n.mesh,o=fc(t),a=(h,p,g=18)=>{if(r<p)return!1;const _=Ns(s,h);return _?(js(n,e,_,t,i),Gr(n,h,g+o*22),!0):!1},c=pc(s).filter(h=>h.userData.carPart==="headlight");for(const h of c)js(n,e,h,t,i),Gr(n,"headlight",10);r>=dn-4&&(a("bumper_front",dn-4,15),a("grille",dn-2,12));const l=Ns(s,"windshield");if(l&&r>=dn-6&&(Rx(l,o),Gr(n,"windshield",20+o*30)),l&&r>=Us&&a("windshield",Us,35),r>=dn&&a("hood",dn,25),r>=Us+4){const h=Ns(s,"door_l"),p=Ns(s,"door_r");h&&!h.userData.detached&&Math.random()<.7&&(r>=Rn?a("door_l",Rn,20):Ld(h,-1)),p&&!p.userData.detached&&Math.random()<.7&&(r>=Rn?a("door_r",Rn,20):Ld(p,1))}if(r>=Rn)for(const h of["wheel_fl","wheel_fr"])Math.random()<.35+o*.25&&a(h,Rn,30);let d=r>=Rn?3:r>=Us?2:0;const u=pc(s).filter(h=>wx(h,s)).sort((h,p)=>Pd(p)-Pd(h));for(const h of u){if(d<=0)break;h.userData.detached||(js(n,e,h,t,i),Gr(n,h.userData.carPart??"body",15),d--)}}function Dx(n,e,t,i,r){const s=pc(n.mesh);for(let o=0;o<r&&s.length;o++){const a=Math.floor(Math.random()*s.length);js(n,e,s[a],t,i),s.splice(a,1)}}function Zc(n){var t,i;if(n.userData.dentOriginal)return n.userData.dentOriginal;const e=(i=(t=n.geometry)==null?void 0:t.attributes)==null?void 0:i.position;return e?(n.userData.dentOriginal=Float32Array.from(e.array),n.userData.dentOriginal):null}function Ix(n){var r,s,o;const e=(s=(r=n.geometry)==null?void 0:r.attributes)==null?void 0:s.position;if(!e||n.geometry.attributes.color)return;const t=new we(((o=n.material)==null?void 0:o.color)??11184810),i=new Float32Array(e.count*3);for(let a=0;a<e.count;a++)i[a*3]=t.r,i[a*3+1]=t.g,i[a*3+2]=t.b;n.geometry.setAttribute("color",new En(i,3)),n.material&&(n.material=n.material.clone(),n.material.vertexColors=!0)}function Ux(n){var r,s;const e=n.userData.dentOriginal,t=(s=(r=n.geometry)==null?void 0:r.attributes)==null?void 0:s.position;if(!e||!t)return;t.array.set(e),t.needsUpdate=!0;const i=n.geometry.attributes.color;i&&n.userData.dentColorOriginal&&(i.array.set(n.userData.dentColorOriginal),i.needsUpdate=!0),n.geometry.computeVertexNormals()}function Nx(n,e,t,i,r){var A,y,x;Tx(n);const s=Zc(n),o=(y=(A=n.geometry)==null?void 0:A.attributes)==null?void 0:y.position;if(!s||!o)return;Ix(n);const a=n.geometry.attributes.color;a&&!n.userData.dentColorOriginal&&(n.userData.dentColorOriginal=Float32Array.from(a.array));const c=jc(s),l=c.minZ,d=c.maxZ,u=Math.max(d-l,.02),{width:h,height:p}=bx(n),g=Math.min(h,p),_=g*(r?.26+i*.2:.14+i*.08),m=_*1.25,f=r?3.2+i*1.4:2,w=r?u*(1.25+i*1.6)+g*.06*i:u*(.4+i*.28),C=r?u*(.45+i*.55):u*.08,S=new we(3816002),P=new we(6044200),b=new we(1710624),E=new we(((x=n.material)==null?void 0:x.color)??11184810);for(let R=0;R<o.count;R++){const O=s[R*3],F=s[R*3+1],V=s[R*3+2],X=O-e,W=F-t,q=Math.hypot(X,W);if(q>m){o.setXYZ(R,O,F,V),a&&n.userData.dentColorOriginal&&a.setXYZ(R,n.userData.dentColorOriginal[R*3],n.userData.dentColorOriginal[R*3+1],n.userData.dentColorOriginal[R*3+2]);continue}const te=(1-q/m)**f,re=Ex(l,d,V),me=Math.abs(q-_*.88),De=r?Math.exp(-(me*me)*90)*.38:0,rt=.12+.88*re,$=r?te*(1-re)*.72:te*(1-re)*.25,J=te*w*rt+De*w*re+$*w,pe=te*(r?.62+i*.28:.22)*(.35+.65*re),ie=O-X/(q+1e-4)*pe,be=F-W/(q+1e-4)*pe,Ae=l-C*te,ze=Math.min(V,Math.max(Ae,V-J));if(o.setXYZ(R,ie,be,ze),a){const Qe=J/(w+.001),Fe=E.clone();Qe>.35&&Fe.lerp(P,(Qe-.35)*1.6),Qe>.58&&Fe.lerp(S,(Qe-.58)*2.2),Qe>.78&&Fe.lerp(b,(Qe-.78)*3.5),a.setXYZ(R,Fe.r,Fe.g,Fe.b)}}o.needsUpdate=!0,a&&(a.needsUpdate=!0),n.geometry.computeVertexNormals()}function Fx(n,e){Ux(n);for(const t of e)t.panel===n&&Nx(n,t.hitX,t.hitY,t.severity,t.scoop)}function Kc(n){const e=new L(0,.75,2.1);return n.mesh.localToWorld(e),e}function kx(n,e){const t=Kc(e);return n.worldToLocal(t),{x:t.x,y:t.y}}function Ox(n,e,t,i){var a;const r=((a=e.spec)==null?void 0:a.color)??12107204,s=Kc(e),o=new we(r);for(let c=0;c<t;c++){const l=o.clone().lerp(new we(16777215),.1+Math.random()*.35),d=new Ze({color:l,metalness:.45+Math.random()*.35,roughness:.25+Math.random()*.3}),u=new xe(new He(.03+Math.random()*.06,.008+Math.random()*.012,.04+Math.random()*.05),d);u.position.copy(s),u.position.x+=(Math.random()-.5)*.55,u.position.y+=(Math.random()-.5)*.4,u.position.z+=(Math.random()-.5)*.3,u.rotation.set(Math.random()*Math.PI,Math.random()*Math.PI,Math.random()*Math.PI),n.add(u);const h=new L((Math.random()-.5)*4,1.8+Math.random()*3.5,(Math.random()-.2)*4);h.applyAxisAngle(new L(0,1,0),e.rotY),i.push({mesh:u,vel:h,life:.9+Math.random()*.6,bounce:.32})}}function Bx(n,e,t,i){const r=new Ze({color:16755268,emissive:16737792,emissiveIntensity:2,metalness:.8,roughness:.3});for(let s=0;s<t;s++){const o=new xe(new fn(.025+Math.random()*.03,6,6),r);o.position.copy(e),n.add(o),i.push({mesh:o,vel:new L((Math.random()-.5)*8,2+Math.random()*6,(Math.random()-.5)*8),life:.15+Math.random()*.2,sparkle:!0})}}function js(n,e,t,i,r){if(!(t!=null&&t.parent)||t.userData.detached)return;const s=new L,o=new Mr,a=new L;t.updateWorldMatrix(!0,!1),t.matrixWorld.decompose(s,o,a),t.parent.remove(t),t.traverse(h=>{h.userData&&(h.userData.detached=!0)}),e.add(t),t.position.copy(s),t.quaternion.copy(o),t.scale.copy(a);const c=Math.abs(i),l=t.userData.carPart??"";Gr(n,l,12+c*.35);const u=new L(0,0,1).applyAxisAngle(new L(0,1,0),n.rotY).clone().multiplyScalar(1.5+c*.045).add(new L((Math.random()-.5)*2,1.2+Math.random()*2.5,(Math.random()-.5)*1.5));l.startsWith("wheel_")&&(u.y+=1.5,u.multiplyScalar(1.2)),r.push({mesh:t,vel:u,life:6,isPart:!0,bounce:.32,spin:new L((Math.random()-.5)*8,(Math.random()-.5)*8,(Math.random()-.5)*8)})}function zx(n,e,t,i){const r=Math.abs(t);if(r<Mx)return;const s=Kc(n),o=Math.min(18,3+Math.floor(r*.28));if(Ox(e,n,o,i),r>=dn){const a=fc(t),c=!0,l=Cx(n.mesh);if(l){const{x:d,y:u}=kx(l,n),h={panel:l,hitX:d,hitY:u,severity:a,scoop:c};n.dents||(n.dents=[]),n.dents.push(h),Fx(l,n.dents),Px(l,d,u,a),Ax(e,n,l,d,u,a,t,i),n.damage=(n.damage??0)+35+a*40,n.partHealth||(n.partHealth=Yc()),n.partHealth.body=Math.max(0,n.partHealth.body-15-a*35),n.partHealth.engine=Math.max(0,n.partHealth.engine-a*20)}r>=Rn&&Bx(e,s,8+Math.floor(a*8),i)}Lx(n,e,t,i),r>=Rn&&Dx(n,e,t,i,1+Math.floor(fc(t)*2))}function nh(n,e){var t,i;for(let r=n.length-1;r>=0;r--){const s=n[r];s.life-=e,s.vel.y-=16*e,s.mesh.position.addScaledVector(s.vel,e),!s.sparkle&&s.mesh.position.y<.04&&(s.mesh.position.y=.04,s.vel.y<0&&(s.vel.y=-s.vel.y*(s.bounce??.3)),s.vel.x*=.72,s.vel.z*=.72),s.spin&&(s.mesh.rotation.x+=s.spin.x*e,s.mesh.rotation.y+=s.spin.y*e,s.mesh.rotation.z+=s.spin.z*e),s.sparkle&&((t=s.mesh.material)==null?void 0:t.emissiveIntensity)>0&&(s.mesh.material.emissiveIntensity=Math.max(0,s.mesh.material.emissiveIntensity-e*8)),s.life<=0&&((i=s.mesh.parent)==null||i.remove(s.mesh),n.splice(r,1))}}const Dd=52,Hx=22,Gx=32,Vx=48,Wx=42,Xx=2.4,$x=8,Yx=.38,qx=28,jx=.9,Zx=26,Id=38;function Kx(n,e,t,i=0,r=null){const s=yx(n);return dx(s,r),s.position.set(e,0,t),s.rotation.y=i,{spec:n,mesh:s,x:e,z:t,rotY:i,speed:0,steer:0,damage:0,partHealth:Yc(),dents:[],prevX:e,prevZ:t,reverseCharge:0,knockTilt:0,wheelSpin:0,suspensionT:0,bodyRoll:0,debris:[]}}function Jx(n,e){n.add(e.mesh)}function Qx(n,e){e!=null&&e.mesh&&n.remove(e.mesh)}function ey(n,e){const t=e.mesh.userData.driverSeat??{x:.35,y:.78,z:.05};e.mesh.attach(n.mesh),n.mesh.position.set(t.x,t.y,t.z),n.mesh.rotation.set(0,0,0),n.mesh.scale.setScalar(.42),n.mesh.visible=!0,n.inVehicle=e}function ty(n,e){const t=e.mesh.parent,i=e.x-Math.sin(e.rotY)*2.5,r=e.z-Math.cos(e.rotY)*2.5;t&&t.attach(n.mesh),n.mesh.scale.setScalar(1),n.x=i,n.z=r,n.mesh.visible=!0,n.inVehicle=null,ny(n)}function ny(n){n.mesh.position.set(n.x,n.mesh.position.y,n.z)}function iy(n,e){const t=n.mesh.userData.wheels??[],i=n.speed,r=i*e*2.6;n.wheelSpin=(n.wheelSpin??0)+r,n.suspensionT=(n.suspensionT??0)+e*(6+Math.abs(i)*.5);const s=Math.abs(i)*.004;t.forEach((o,a)=>{if(o.userData.detached)return;const c=o.userData.baseY??o.position.y;o.position.y=c+Math.sin(n.suspensionT+a*1.7)*s,o.rotation.x=n.wheelSpin,o.userData.steerable&&(o.rotation.y=-n.steer*.42)})}function ih(n){n.mesh.position.x=n.x,n.mesh.position.z=n.z,n.mesh.rotation.y=n.rotY}function ry(n,e,t){if(!(n!=null&&n.mesh))return;let i=0,r=0,s=0;if(n.bodyRoll+=(-n.steer*.08*Math.min(1,Math.abs(n.speed)/18)-n.bodyRoll)*Math.min(1,t*6),r=n.bodyRoll,(n.knockTilt??0)>.01)i=-n.knockTilt,n.knockTilt*=Math.exp(-7*t);else{n.knockTilt=0;const o=Math.abs(n.speed);if(o>=Id){const a=e*.012,c=Math.min(1,(o-Id)/12);s=Math.abs(Math.sin(a*5))*.12*c,i=Math.sin(a*4)*.07*c,r=Math.cos(a*3.2)*.09*c}}n.mesh.position.y=s,n.mesh.rotation.x=i,n.mesh.rotation.z=r}function sy(n,e){const t=Math.abs(e),i=Math.min(1,Math.max(0,(t-dn)/(52-dn))),r=t>=Rn,s=r?.52:.26+i*.18,o=t*s;n.speed=-Math.sign(n.speed||1)*o;const a=r?1.25:.45+i*.4;return n.x-=Math.sin(n.rotY)*a,n.z-=Math.cos(n.rotY)*a,n.knockTilt=r?.48:.18+i*.26,n.prevX=n.x,n.prevZ=n.z,{huge:r,severity:i}}function oy(n,e,t,i){const{throttle:r,brake:s,steer:o,reverse:a=0}=e;n.prevX=n.x,n.prevZ=n.z,n.steer+=(o*Xx-n.steer)*Math.min(1,t*8);const c=.85+Math.abs(n.speed)*.05;n.rotY-=n.steer*t*c;const l=Math.abs(o)<=Yx&&r>0&&a<=0;if(s>0)n.speed-=s*Wx*t;else if(a>0)n.speed-=a*qx*t,n.speed=Math.max(n.speed,-14),n.speed<-3&&(n.reverseCharge=Math.min(1,(n.reverseCharge??0)+jx*t));else if(r>0)if((n.reverseCharge??0)>.12&&n.speed<2.5)n.speed+=n.reverseCharge*Zx,n.reverseCharge=0;else{const _=l?Vx*(1+Math.min(Math.abs(n.speed)/28,1.2)):Gx*.75;n.speed+=r*_*t}a<=0&&r<=0&&(n.reverseCharge=Math.max(0,(n.reverseCharge??0)-.2*t)),r<=0&&s<=0&&a<=0&&(Math.abs(n.speed)<.4?n.speed=0:n.speed-=Math.sign(n.speed)*$x*t);const d=l?Dd:Hx;n.speed=Math.max(-Dd*.3,Math.min(d,n.speed));const u=Math.sin(n.rotY)*n.speed*t,h=Math.cos(n.rotY)*n.speed*t,p=i(n.x+u,n.z+h);n.x=p.x,n.z=p.z,ih(n),iy(n,t);const g=Math.abs(p.x-(n.prevX+u))>.05||Math.abs(p.z-(n.prevZ+h))>.05;return{impactSpeed:Math.abs(n.speed),charging:l,wallHit:g}}function ay(n,e,t,i=null){const s=n.x+Math.sin(n.facing)*4,o=n.z+Math.cos(n.facing)*4,a=t(s,o);return Kx(e,a.x,a.z,n.facing,i)}class cy{constructor(){this.encoder=new TextEncoder,this._pieces=[],this._parts=[]}append_buffer(e){this.flush(),this._parts.push(e)}append(e){this._pieces.push(e)}flush(){if(this._pieces.length>0){const e=new Uint8Array(this._pieces);this._parts.push(e),this._pieces=[]}}toArrayBuffer(){const e=[];for(const t of this._parts)e.push(t);return ly(e).buffer}}function ly(n){let e=0;for(const r of n)e+=r.byteLength;const t=new Uint8Array(e);let i=0;for(const r of n){const s=new Uint8Array(r.buffer,r.byteOffset,r.byteLength);t.set(s,i),i+=r.byteLength}return t}function rh(n){return new dy(n).unpack()}function sh(n){const e=new uy,t=e.pack(n);return t instanceof Promise?t.then(()=>e.getBuffer()):e.getBuffer()}class dy{constructor(e){this.index=0,this.dataBuffer=e,this.dataView=new Uint8Array(this.dataBuffer),this.length=this.dataBuffer.byteLength}unpack(){const e=this.unpack_uint8();if(e<128)return e;if((e^224)<32)return(e^224)-32;let t;if((t=e^160)<=15)return this.unpack_raw(t);if((t=e^176)<=15)return this.unpack_string(t);if((t=e^144)<=15)return this.unpack_array(t);if((t=e^128)<=15)return this.unpack_map(t);switch(e){case 192:return null;case 193:return;case 194:return!1;case 195:return!0;case 202:return this.unpack_float();case 203:return this.unpack_double();case 204:return this.unpack_uint8();case 205:return this.unpack_uint16();case 206:return this.unpack_uint32();case 207:return this.unpack_uint64();case 208:return this.unpack_int8();case 209:return this.unpack_int16();case 210:return this.unpack_int32();case 211:return this.unpack_int64();case 212:return;case 213:return;case 214:return;case 215:return;case 216:return t=this.unpack_uint16(),this.unpack_string(t);case 217:return t=this.unpack_uint32(),this.unpack_string(t);case 218:return t=this.unpack_uint16(),this.unpack_raw(t);case 219:return t=this.unpack_uint32(),this.unpack_raw(t);case 220:return t=this.unpack_uint16(),this.unpack_array(t);case 221:return t=this.unpack_uint32(),this.unpack_array(t);case 222:return t=this.unpack_uint16(),this.unpack_map(t);case 223:return t=this.unpack_uint32(),this.unpack_map(t)}}unpack_uint8(){const e=this.dataView[this.index]&255;return this.index++,e}unpack_uint16(){const e=this.read(2),t=(e[0]&255)*256+(e[1]&255);return this.index+=2,t}unpack_uint32(){const e=this.read(4),t=((e[0]*256+e[1])*256+e[2])*256+e[3];return this.index+=4,t}unpack_uint64(){const e=this.read(8),t=((((((e[0]*256+e[1])*256+e[2])*256+e[3])*256+e[4])*256+e[5])*256+e[6])*256+e[7];return this.index+=8,t}unpack_int8(){const e=this.unpack_uint8();return e<128?e:e-256}unpack_int16(){const e=this.unpack_uint16();return e<32768?e:e-65536}unpack_int32(){const e=this.unpack_uint32();return e<2**31?e:e-2**32}unpack_int64(){const e=this.unpack_uint64();return e<2**63?e:e-2**64}unpack_raw(e){if(this.length<this.index+e)throw new Error(`BinaryPackFailure: index is out of range ${this.index} ${e} ${this.length}`);const t=this.dataBuffer.slice(this.index,this.index+e);return this.index+=e,t}unpack_string(e){const t=this.read(e);let i=0,r="",s,o;for(;i<e;)s=t[i],s<160?(o=s,i++):(s^192)<32?(o=(s&31)<<6|t[i+1]&63,i+=2):(s^224)<16?(o=(s&15)<<12|(t[i+1]&63)<<6|t[i+2]&63,i+=3):(o=(s&7)<<18|(t[i+1]&63)<<12|(t[i+2]&63)<<6|t[i+3]&63,i+=4),r+=String.fromCodePoint(o);return this.index+=e,r}unpack_array(e){const t=new Array(e);for(let i=0;i<e;i++)t[i]=this.unpack();return t}unpack_map(e){const t={};for(let i=0;i<e;i++){const r=this.unpack();t[r]=this.unpack()}return t}unpack_float(){const e=this.unpack_uint32(),t=e>>31,i=(e>>23&255)-127,r=e&8388607|8388608;return(t===0?1:-1)*r*2**(i-23)}unpack_double(){const e=this.unpack_uint32(),t=this.unpack_uint32(),i=e>>31,r=(e>>20&2047)-1023,o=(e&1048575|1048576)*2**(r-20)+t*2**(r-52);return(i===0?1:-1)*o}read(e){const t=this.index;if(t+e<=this.length)return this.dataView.subarray(t,t+e);throw new Error("BinaryPackFailure: read index out of range")}}class uy{getBuffer(){return this._bufferBuilder.toArrayBuffer()}pack(e){if(typeof e=="string")this.pack_string(e);else if(typeof e=="number")Math.floor(e)===e?this.pack_integer(e):this.pack_double(e);else if(typeof e=="boolean")e===!0?this._bufferBuilder.append(195):e===!1&&this._bufferBuilder.append(194);else if(e===void 0)this._bufferBuilder.append(192);else if(typeof e=="object")if(e===null)this._bufferBuilder.append(192);else{const t=e.constructor;if(e instanceof Array){const i=this.pack_array(e);if(i instanceof Promise)return i.then(()=>this._bufferBuilder.flush())}else if(e instanceof ArrayBuffer)this.pack_bin(new Uint8Array(e));else if("BYTES_PER_ELEMENT"in e){const i=e;this.pack_bin(new Uint8Array(i.buffer,i.byteOffset,i.byteLength))}else if(e instanceof Date)this.pack_string(e.toString());else{if(e instanceof Blob)return e.arrayBuffer().then(i=>{this.pack_bin(new Uint8Array(i)),this._bufferBuilder.flush()});if(t==Object||t.toString().startsWith("class")){const i=this.pack_object(e);if(i instanceof Promise)return i.then(()=>this._bufferBuilder.flush())}else throw new Error(`Type "${t.toString()}" not yet supported`)}}else throw new Error(`Type "${typeof e}" not yet supported`);this._bufferBuilder.flush()}pack_bin(e){const t=e.length;if(t<=15)this.pack_uint8(160+t);else if(t<=65535)this._bufferBuilder.append(218),this.pack_uint16(t);else if(t<=4294967295)this._bufferBuilder.append(219),this.pack_uint32(t);else throw new Error("Invalid length");this._bufferBuilder.append_buffer(e)}pack_string(e){const t=this._textEncoder.encode(e),i=t.length;if(i<=15)this.pack_uint8(176+i);else if(i<=65535)this._bufferBuilder.append(216),this.pack_uint16(i);else if(i<=4294967295)this._bufferBuilder.append(217),this.pack_uint32(i);else throw new Error("Invalid length");this._bufferBuilder.append_buffer(t)}pack_array(e){const t=e.length;if(t<=15)this.pack_uint8(144+t);else if(t<=65535)this._bufferBuilder.append(220),this.pack_uint16(t);else if(t<=4294967295)this._bufferBuilder.append(221),this.pack_uint32(t);else throw new Error("Invalid length");const i=r=>{if(r<t){const s=this.pack(e[r]);return s instanceof Promise?s.then(()=>i(r+1)):i(r+1)}};return i(0)}pack_integer(e){if(e>=-32&&e<=127)this._bufferBuilder.append(e&255);else if(e>=0&&e<=255)this._bufferBuilder.append(204),this.pack_uint8(e);else if(e>=-128&&e<=127)this._bufferBuilder.append(208),this.pack_int8(e);else if(e>=0&&e<=65535)this._bufferBuilder.append(205),this.pack_uint16(e);else if(e>=-32768&&e<=32767)this._bufferBuilder.append(209),this.pack_int16(e);else if(e>=0&&e<=4294967295)this._bufferBuilder.append(206),this.pack_uint32(e);else if(e>=-2147483648&&e<=2147483647)this._bufferBuilder.append(210),this.pack_int32(e);else if(e>=-9223372036854776e3&&e<=9223372036854776e3)this._bufferBuilder.append(211),this.pack_int64(e);else if(e>=0&&e<=18446744073709552e3)this._bufferBuilder.append(207),this.pack_uint64(e);else throw new Error("Invalid integer")}pack_double(e){let t=0;e<0&&(t=1,e=-e);const i=Math.floor(Math.log(e)/Math.LN2),r=e/2**i-1,s=Math.floor(r*2**52),o=2**32,a=t<<31|i+1023<<20|s/o&1048575,c=s%o;this._bufferBuilder.append(203),this.pack_int32(a),this.pack_int32(c)}pack_object(e){const t=Object.keys(e),i=t.length;if(i<=15)this.pack_uint8(128+i);else if(i<=65535)this._bufferBuilder.append(222),this.pack_uint16(i);else if(i<=4294967295)this._bufferBuilder.append(223),this.pack_uint32(i);else throw new Error("Invalid length");const r=s=>{if(s<t.length){const o=t[s];if(e.hasOwnProperty(o)){this.pack(o);const a=this.pack(e[o]);if(a instanceof Promise)return a.then(()=>r(s+1))}return r(s+1)}};return r(0)}pack_uint8(e){this._bufferBuilder.append(e)}pack_uint16(e){this._bufferBuilder.append(e>>8),this._bufferBuilder.append(e&255)}pack_uint32(e){const t=e&4294967295;this._bufferBuilder.append((t&4278190080)>>>24),this._bufferBuilder.append((t&16711680)>>>16),this._bufferBuilder.append((t&65280)>>>8),this._bufferBuilder.append(t&255)}pack_uint64(e){const t=e/4294967296,i=e%2**32;this._bufferBuilder.append((t&4278190080)>>>24),this._bufferBuilder.append((t&16711680)>>>16),this._bufferBuilder.append((t&65280)>>>8),this._bufferBuilder.append(t&255),this._bufferBuilder.append((i&4278190080)>>>24),this._bufferBuilder.append((i&16711680)>>>16),this._bufferBuilder.append((i&65280)>>>8),this._bufferBuilder.append(i&255)}pack_int8(e){this._bufferBuilder.append(e&255)}pack_int16(e){this._bufferBuilder.append((e&65280)>>8),this._bufferBuilder.append(e&255)}pack_int32(e){this._bufferBuilder.append(e>>>24&255),this._bufferBuilder.append((e&16711680)>>>16),this._bufferBuilder.append((e&65280)>>>8),this._bufferBuilder.append(e&255)}pack_int64(e){const t=Math.floor(e/4294967296),i=e%2**32;this._bufferBuilder.append((t&4278190080)>>>24),this._bufferBuilder.append((t&16711680)>>>16),this._bufferBuilder.append((t&65280)>>>8),this._bufferBuilder.append(t&255),this._bufferBuilder.append((i&4278190080)>>>24),this._bufferBuilder.append((i&16711680)>>>16),this._bufferBuilder.append((i&65280)>>>8),this._bufferBuilder.append(i&255)}constructor(){this._bufferBuilder=new cy,this._textEncoder=new TextEncoder}}let oh=!0,ah=!0;function Vr(n,e,t){const i=n.match(e);return i&&i.length>=t&&parseFloat(i[t],10)}function ki(n,e,t){if(!n.RTCPeerConnection)return;if(!Object.getOwnPropertyDescriptor(EventTarget.prototype,"addEventListener").writable){Jc("Unable to polyfill events");return}const r=n.RTCPeerConnection.prototype,s=r.addEventListener;r.addEventListener=function(a,c){if(a!==e)return s.apply(this,arguments);const l=d=>{const u=t(d);u&&(c.handleEvent?c.handleEvent(u):c(u))};return this._eventMap=this._eventMap||{},this._eventMap[e]||(this._eventMap[e]=new Map),this._eventMap[e].set(c,l),s.apply(this,[a,l])};const o=r.removeEventListener;r.removeEventListener=function(a,c){if(a!==e||!this._eventMap||!this._eventMap[e])return o.apply(this,arguments);if(!this._eventMap[e].has(c))return o.apply(this,arguments);const l=this._eventMap[e].get(c);return this._eventMap[e].delete(c),this._eventMap[e].size===0&&delete this._eventMap[e],Object.keys(this._eventMap).length===0&&delete this._eventMap,o.apply(this,[a,l])},Object.defineProperty(r,"on"+e,{get(){return this["_on"+e]},set(a){this["_on"+e]&&(this.removeEventListener(e,this["_on"+e]),delete this["_on"+e]),a&&this.addEventListener(e,this["_on"+e]=a)},enumerable:!0,configurable:!0})}function hy(n){return typeof n!="boolean"?new Error("Argument type: "+typeof n+". Please use a boolean."):(oh=n,n?"adapter.js logging disabled":"adapter.js logging enabled")}function fy(n){return typeof n!="boolean"?new Error("Argument type: "+typeof n+". Please use a boolean."):(ah=!n,"adapter.js deprecation warnings "+(n?"disabled":"enabled"))}function Jc(){if(typeof window=="object"){if(oh)return;typeof console<"u"&&typeof console.log=="function"&&console.log.apply(console,arguments)}}function Qc(n,e){ah&&console.warn(n+" is deprecated, please use "+e+" instead.")}function py(n){const e={browser:null,version:null};if(typeof n>"u"||!n.navigator||!n.navigator.userAgent)return e.browser="Not a browser.",e;const{navigator:t}=n;if(t.userAgentData&&t.userAgentData.brands){const i=t.userAgentData.brands.find(r=>r.brand==="Chromium");if(i){const r=parseInt(i.version,10);if(r>=90)return{browser:"chrome",version:r}}}if(t.mozGetUserMedia)e.browser="firefox",e.version=parseInt(Vr(t.userAgent,/Firefox\/(\d+)\./,1));else if(t.webkitGetUserMedia||n.isSecureContext===!1&&n.webkitRTCPeerConnection)e.browser="chrome",e.version=parseInt(Vr(t.userAgent,/Chrom(e|ium)\/(\d+)\./,2))||null;else if(n.RTCPeerConnection&&t.userAgent.match(/AppleWebKit\/(\d+)\./))e.browser="safari",e.version=parseInt(Vr(t.userAgent,/AppleWebKit\/(\d+)\./,1)),e.supportsUnifiedPlan=n.RTCRtpTransceiver&&"currentDirection"in n.RTCRtpTransceiver.prototype,e._safariVersion=Vr(t.userAgent,/Version\/(\d+(\.?\d+))/,1);else return e.browser="Not a supported browser.",e;return e}function Ud(n){return Object.prototype.toString.call(n)==="[object Object]"}function ch(n){return Ud(n)?Object.keys(n).reduce(function(e,t){const i=Ud(n[t]),r=i?ch(n[t]):n[t],s=i&&!Object.keys(r).length;return r===void 0||s?e:Object.assign(e,{[t]:r})},{}):n}function mc(n,e,t){!e||t.has(e.id)||(t.set(e.id,e),Object.keys(e).forEach(i=>{i.endsWith("Id")?mc(n,n.get(e[i]),t):i.endsWith("Ids")&&e[i].forEach(r=>{mc(n,n.get(r),t)})}))}function Nd(n,e,t){const i=t?"outbound-rtp":"inbound-rtp",r=new Map;if(e===null)return r;const s=[];return n.forEach(o=>{o.type==="track"&&o.trackIdentifier===e.id&&s.push(o)}),s.forEach(o=>{n.forEach(a=>{a.type===i&&a.trackId===o.id&&mc(n,a,r)})}),r}const Fd=Jc;function lh(n,e){if(e.version>=64)return;const t=n&&n.navigator;if(!t.mediaDevices)return;const i=function(a){if(typeof a!="object"||a.mandatory||a.optional)return a;const c={};return Object.keys(a).forEach(l=>{if(l==="require"||l==="advanced"||l==="mediaSource")return;const d=typeof a[l]=="object"?a[l]:{ideal:a[l]};d.exact!==void 0&&typeof d.exact=="number"&&(d.min=d.max=d.exact);const u=function(h,p){return h?h+p.charAt(0).toUpperCase()+p.slice(1):p==="deviceId"?"sourceId":p};if(d.ideal!==void 0){c.optional=c.optional||[];let h={};typeof d.ideal=="number"?(h[u("min",l)]=d.ideal,c.optional.push(h),h={},h[u("max",l)]=d.ideal,c.optional.push(h)):(h[u("",l)]=d.ideal,c.optional.push(h))}d.exact!==void 0&&typeof d.exact!="number"?(c.mandatory=c.mandatory||{},c.mandatory[u("",l)]=d.exact):["min","max"].forEach(h=>{d[h]!==void 0&&(c.mandatory=c.mandatory||{},c.mandatory[u(h,l)]=d[h])})}),a.advanced&&(c.optional=(c.optional||[]).concat(a.advanced)),c},r=function(a,c){if(e.version>=61)return c(a);if(a=JSON.parse(JSON.stringify(a)),a&&typeof a.audio=="object"){const l=function(d,u,h){u in d&&!(h in d)&&(d[h]=d[u],delete d[u])};a=JSON.parse(JSON.stringify(a)),l(a.audio,"autoGainControl","googAutoGainControl"),l(a.audio,"noiseSuppression","googNoiseSuppression"),a.audio=i(a.audio)}if(a&&typeof a.video=="object"){let l=a.video.facingMode;l=l&&(typeof l=="object"?l:{ideal:l});const d=e.version<66;if(l&&(l.exact==="user"||l.exact==="environment"||l.ideal==="user"||l.ideal==="environment")&&!(t.mediaDevices.getSupportedConstraints&&t.mediaDevices.getSupportedConstraints().facingMode&&!d)){delete a.video.facingMode;let u;if(l.exact==="environment"||l.ideal==="environment"?u=["back","rear"]:(l.exact==="user"||l.ideal==="user")&&(u=["front"]),u)return t.mediaDevices.enumerateDevices().then(h=>{h=h.filter(g=>g.kind==="videoinput");let p=h.find(g=>u.some(_=>g.label.toLowerCase().includes(_)));return!p&&h.length&&u.includes("back")&&(p=h[h.length-1]),p&&(a.video.deviceId=l.exact?{exact:p.deviceId}:{ideal:p.deviceId}),a.video=i(a.video),Fd("chrome: "+JSON.stringify(a)),c(a)})}a.video=i(a.video)}return Fd("chrome: "+JSON.stringify(a)),c(a)},s=function(a){return e.version>=64?a:{name:{PermissionDeniedError:"NotAllowedError",PermissionDismissedError:"NotAllowedError",InvalidStateError:"NotAllowedError",DevicesNotFoundError:"NotFoundError",ConstraintNotSatisfiedError:"OverconstrainedError",TrackStartError:"NotReadableError",MediaDeviceFailedDueToShutdown:"NotAllowedError",MediaDeviceKillSwitchOn:"NotAllowedError",TabCaptureError:"AbortError",ScreenCaptureError:"AbortError",DeviceCaptureError:"AbortError"}[a.name]||a.name,message:a.message,constraint:a.constraint||a.constraintName,toString(){return this.name+(this.message&&": ")+this.message}}},o=function(a,c,l){r(a,d=>{t.webkitGetUserMedia(d,c,u=>{l&&l(s(u))})})};if(t.getUserMedia=o.bind(t),t.mediaDevices.getUserMedia){const a=t.mediaDevices.getUserMedia.bind(t.mediaDevices);t.mediaDevices.getUserMedia=function(c){return r(c,l=>a(l).then(d=>{if(l.audio&&!d.getAudioTracks().length||l.video&&!d.getVideoTracks().length)throw d.getTracks().forEach(u=>{u.stop()}),new DOMException("","NotFoundError");return d},d=>Promise.reject(s(d))))}}}function dh(n){n.MediaStream=n.MediaStream||n.webkitMediaStream}function uh(n,e){if(!(e.version>102))if(typeof n=="object"&&n.RTCPeerConnection&&!("ontrack"in n.RTCPeerConnection.prototype)){Object.defineProperty(n.RTCPeerConnection.prototype,"ontrack",{get(){return this._ontrack},set(i){this._ontrack&&this.removeEventListener("track",this._ontrack),this.addEventListener("track",this._ontrack=i)},enumerable:!0,configurable:!0});const t=n.RTCPeerConnection.prototype.setRemoteDescription;n.RTCPeerConnection.prototype.setRemoteDescription=function(){return this._ontrackpoly||(this._ontrackpoly=r=>{r.stream.addEventListener("addtrack",s=>{let o;n.RTCPeerConnection.prototype.getReceivers?o=this.getReceivers().find(c=>c.track&&c.track.id===s.track.id):o={track:s.track};const a=new Event("track");a.track=s.track,a.receiver=o,a.transceiver={receiver:o},a.streams=[r.stream],this.dispatchEvent(a)}),r.stream.getTracks().forEach(s=>{let o;n.RTCPeerConnection.prototype.getReceivers?o=this.getReceivers().find(c=>c.track&&c.track.id===s.id):o={track:s};const a=new Event("track");a.track=s,a.receiver=o,a.transceiver={receiver:o},a.streams=[r.stream],this.dispatchEvent(a)})},this.addEventListener("addstream",this._ontrackpoly)),t.apply(this,arguments)}}else ki(n,"track",t=>(t.transceiver||Object.defineProperty(t,"transceiver",{value:{receiver:t.receiver}}),t))}function hh(n){if(typeof n=="object"&&n.RTCPeerConnection&&!("getSenders"in n.RTCPeerConnection.prototype)&&"createDTMFSender"in n.RTCPeerConnection.prototype){const e=function(r,s){return{track:s,get dtmf(){return this._dtmf===void 0&&(s.kind==="audio"?this._dtmf=r.createDTMFSender(s):this._dtmf=null),this._dtmf},_pc:r}};if(!n.RTCPeerConnection.prototype.getSenders){n.RTCPeerConnection.prototype.getSenders=function(){return this._senders=this._senders||[],this._senders.slice()};const r=n.RTCPeerConnection.prototype.addTrack;n.RTCPeerConnection.prototype.addTrack=function(a,c){let l=r.apply(this,arguments);return l||(l=e(this,a),this._senders.push(l)),l};const s=n.RTCPeerConnection.prototype.removeTrack;n.RTCPeerConnection.prototype.removeTrack=function(a){s.apply(this,arguments);const c=this._senders.indexOf(a);c!==-1&&this._senders.splice(c,1)}}const t=n.RTCPeerConnection.prototype.addStream;n.RTCPeerConnection.prototype.addStream=function(s){this._senders=this._senders||[],t.apply(this,[s]),s.getTracks().forEach(o=>{this._senders.push(e(this,o))})};const i=n.RTCPeerConnection.prototype.removeStream;n.RTCPeerConnection.prototype.removeStream=function(s){this._senders=this._senders||[],i.apply(this,[s]),s.getTracks().forEach(o=>{const a=this._senders.find(c=>c.track===o);a&&this._senders.splice(this._senders.indexOf(a),1)})}}else if(typeof n=="object"&&n.RTCPeerConnection&&"getSenders"in n.RTCPeerConnection.prototype&&"createDTMFSender"in n.RTCPeerConnection.prototype&&n.RTCRtpSender&&!("dtmf"in n.RTCRtpSender.prototype)){const e=n.RTCPeerConnection.prototype.getSenders;n.RTCPeerConnection.prototype.getSenders=function(){const i=e.apply(this,[]);return i.forEach(r=>r._pc=this),i},Object.defineProperty(n.RTCRtpSender.prototype,"dtmf",{get(){return this._dtmf===void 0&&(this.track.kind==="audio"?this._dtmf=this._pc.createDTMFSender(this.track):this._dtmf=null),this._dtmf}})}}function fh(n,e){if(e.version>=67||!(typeof n=="object"&&n.RTCPeerConnection&&n.RTCRtpSender&&n.RTCRtpReceiver))return;if(!("getStats"in n.RTCRtpSender.prototype)){const i=n.RTCPeerConnection.prototype.getSenders;i&&(n.RTCPeerConnection.prototype.getSenders=function(){const o=i.apply(this,[]);return o.forEach(a=>a._pc=this),o});const r=n.RTCPeerConnection.prototype.addTrack;r&&(n.RTCPeerConnection.prototype.addTrack=function(){const o=r.apply(this,arguments);return o._pc=this,o}),n.RTCRtpSender.prototype.getStats=function(){const o=this;return this._pc.getStats().then(a=>Nd(a,o.track,!0))}}if(!("getStats"in n.RTCRtpReceiver.prototype)){const i=n.RTCPeerConnection.prototype.getReceivers;i&&(n.RTCPeerConnection.prototype.getReceivers=function(){const s=i.apply(this,[]);return s.forEach(o=>o._pc=this),s}),ki(n,"track",r=>(r.receiver._pc=r.srcElement,r)),n.RTCRtpReceiver.prototype.getStats=function(){const s=this;return this._pc.getStats().then(o=>Nd(o,s.track,!1))}}if(!("getStats"in n.RTCRtpSender.prototype&&"getStats"in n.RTCRtpReceiver.prototype))return;const t=n.RTCPeerConnection.prototype.getStats;n.RTCPeerConnection.prototype.getStats=function(){if(arguments.length>0&&arguments[0]instanceof n.MediaStreamTrack){const r=arguments[0];let s,o,a;return this.getSenders().forEach(c=>{c.track===r&&(s?a=!0:s=c)}),this.getReceivers().forEach(c=>(c.track===r&&(o?a=!0:o=c),c.track===r)),a||s&&o?Promise.reject(new DOMException("There are more than one sender or receiver for the track.","InvalidAccessError")):s?s.getStats():o?o.getStats():Promise.reject(new DOMException("There is no sender or receiver for the track.","InvalidAccessError"))}return t.apply(this,arguments)}}function ph(n){n.RTCPeerConnection.prototype.getLocalStreams=function(){return this._shimmedLocalStreams=this._shimmedLocalStreams||{},Object.keys(this._shimmedLocalStreams).map(o=>this._shimmedLocalStreams[o][0])};const e=n.RTCPeerConnection.prototype.addTrack;n.RTCPeerConnection.prototype.addTrack=function(o,a){if(!a)return e.apply(this,arguments);this._shimmedLocalStreams=this._shimmedLocalStreams||{};const c=e.apply(this,arguments);return this._shimmedLocalStreams[a.id]?this._shimmedLocalStreams[a.id].indexOf(c)===-1&&this._shimmedLocalStreams[a.id].push(c):this._shimmedLocalStreams[a.id]=[a,c],c};const t=n.RTCPeerConnection.prototype.addStream;n.RTCPeerConnection.prototype.addStream=function(o){this._shimmedLocalStreams=this._shimmedLocalStreams||{},o.getTracks().forEach(l=>{if(this.getSenders().find(u=>u.track===l))throw new DOMException("Track already exists.","InvalidAccessError")});const a=this.getSenders();t.apply(this,arguments);const c=this.getSenders().filter(l=>a.indexOf(l)===-1);this._shimmedLocalStreams[o.id]=[o].concat(c)};const i=n.RTCPeerConnection.prototype.removeStream;n.RTCPeerConnection.prototype.removeStream=function(o){return this._shimmedLocalStreams=this._shimmedLocalStreams||{},delete this._shimmedLocalStreams[o.id],i.apply(this,arguments)};const r=n.RTCPeerConnection.prototype.removeTrack;n.RTCPeerConnection.prototype.removeTrack=function(o){return this._shimmedLocalStreams=this._shimmedLocalStreams||{},o&&Object.keys(this._shimmedLocalStreams).forEach(a=>{const c=this._shimmedLocalStreams[a].indexOf(o);c!==-1&&this._shimmedLocalStreams[a].splice(c,1),this._shimmedLocalStreams[a].length===1&&delete this._shimmedLocalStreams[a]}),r.apply(this,arguments)}}function mh(n,e){if(!n.RTCPeerConnection)return;if(n.RTCPeerConnection.prototype.addTrack&&e.version>=65)return ph(n);const t=n.RTCPeerConnection.prototype.getLocalStreams;n.RTCPeerConnection.prototype.getLocalStreams=function(){const d=t.apply(this);return this._reverseStreams=this._reverseStreams||{},d.map(u=>this._reverseStreams[u.id])};const i=n.RTCPeerConnection.prototype.addStream;n.RTCPeerConnection.prototype.addStream=function(d){if(this._streams=this._streams||{},this._reverseStreams=this._reverseStreams||{},d.getTracks().forEach(u=>{if(this.getSenders().find(p=>p.track===u))throw new DOMException("Track already exists.","InvalidAccessError")}),!this._reverseStreams[d.id]){const u=new n.MediaStream(d.getTracks());this._streams[d.id]=u,this._reverseStreams[u.id]=d,d=u}i.apply(this,[d])};const r=n.RTCPeerConnection.prototype.removeStream;n.RTCPeerConnection.prototype.removeStream=function(d){this._streams=this._streams||{},this._reverseStreams=this._reverseStreams||{},r.apply(this,[this._streams[d.id]||d]),delete this._reverseStreams[this._streams[d.id]?this._streams[d.id].id:d.id],delete this._streams[d.id]},n.RTCPeerConnection.prototype.addTrack=function(d,u){if(this.signalingState==="closed")throw new DOMException("The RTCPeerConnection's signalingState is 'closed'.","InvalidStateError");const h=[].slice.call(arguments,1);if(h.length!==1||!h[0].getTracks().find(_=>_===d))throw new DOMException("The adapter.js addTrack polyfill only supports a single  stream which is associated with the specified track.","NotSupportedError");if(this.getSenders().find(_=>_.track===d))throw new DOMException("Track already exists.","InvalidAccessError");this._streams=this._streams||{},this._reverseStreams=this._reverseStreams||{};const g=this._streams[u.id];if(g)g.addTrack(d),Promise.resolve().then(()=>{this.dispatchEvent(new Event("negotiationneeded"))});else{const _=new n.MediaStream([d]);this._streams[u.id]=_,this._reverseStreams[_.id]=u,this.addStream(_)}return this.getSenders().find(_=>_.track===d)};function s(l,d){let u=d.sdp;return Object.keys(l._reverseStreams||[]).forEach(h=>{const p=l._reverseStreams[h],g=l._streams[p.id];u=u.replace(new RegExp(g.id,"g"),p.id)}),new RTCSessionDescription({type:d.type,sdp:u})}function o(l,d){let u=d.sdp;return Object.keys(l._reverseStreams||[]).forEach(h=>{const p=l._reverseStreams[h],g=l._streams[p.id];u=u.replace(new RegExp(p.id,"g"),g.id)}),new RTCSessionDescription({type:d.type,sdp:u})}["createOffer","createAnswer"].forEach(function(l){const d=n.RTCPeerConnection.prototype[l],u={[l](){const h=arguments;return arguments.length&&typeof arguments[0]=="function"?d.apply(this,[g=>{const _=s(this,g);h[0].apply(null,[_])},g=>{h[1]&&h[1].apply(null,g)},arguments[2]]):d.apply(this,arguments).then(g=>s(this,g))}};n.RTCPeerConnection.prototype[l]=u[l]});const a=n.RTCPeerConnection.prototype.setLocalDescription;n.RTCPeerConnection.prototype.setLocalDescription=function(){return!arguments.length||!arguments[0].type?a.apply(this,arguments):(arguments[0]=o(this,arguments[0]),a.apply(this,arguments))};const c=Object.getOwnPropertyDescriptor(n.RTCPeerConnection.prototype,"localDescription");Object.defineProperty(n.RTCPeerConnection.prototype,"localDescription",{get(){const l=c.get.apply(this);return l.type===""?l:s(this,l)}}),n.RTCPeerConnection.prototype.removeTrack=function(d){if(this.signalingState==="closed")throw new DOMException("The RTCPeerConnection's signalingState is 'closed'.","InvalidStateError");if(!d._pc)throw new DOMException("Argument 1 of RTCPeerConnection.removeTrack does not implement interface RTCRtpSender.","TypeError");if(!(d._pc===this))throw new DOMException("Sender was not created by this connection.","InvalidAccessError");this._streams=this._streams||{};let h;Object.keys(this._streams).forEach(p=>{this._streams[p].getTracks().find(_=>d.track===_)&&(h=this._streams[p])}),h&&(h.getTracks().length===1?this.removeStream(this._reverseStreams[h.id]):h.removeTrack(d.track),this.dispatchEvent(new Event("negotiationneeded")))}}function gc(n,e){!n.RTCPeerConnection&&n.webkitRTCPeerConnection&&(n.RTCPeerConnection=n.webkitRTCPeerConnection),n.RTCPeerConnection&&e.version<53&&["setLocalDescription","setRemoteDescription","addIceCandidate"].forEach(function(t){const i=n.RTCPeerConnection.prototype[t],r={[t](){return arguments[0]=new(t==="addIceCandidate"?n.RTCIceCandidate:n.RTCSessionDescription)(arguments[0]),i.apply(this,arguments)}};n.RTCPeerConnection.prototype[t]=r[t]})}function gh(n,e){e.version>102||ki(n,"negotiationneeded",t=>{const i=t.target;if(!((e.version<72||i.getConfiguration&&i.getConfiguration().sdpSemantics==="plan-b")&&i.signalingState!=="stable"))return t})}const kd=Object.freeze(Object.defineProperty({__proto__:null,fixNegotiationNeeded:gh,shimAddTrackRemoveTrack:mh,shimAddTrackRemoveTrackWithNative:ph,shimGetSendersWithDtmf:hh,shimGetUserMedia:lh,shimMediaStream:dh,shimOnTrack:uh,shimPeerConnection:gc,shimSenderReceiverGetStats:fh},Symbol.toStringTag,{value:"Module"}));function _h(n,e){const t=n&&n.navigator;if(!t.mediaDevices)return;const i=n&&n.MediaStreamTrack;if(t.getUserMedia=function(r,s,o){Qc("navigator.getUserMedia","navigator.mediaDevices.getUserMedia"),t.mediaDevices.getUserMedia(r).then(s,o)},!(e.version>55&&"autoGainControl"in t.mediaDevices.getSupportedConstraints())){const r=function(o,a,c){a in o&&!(c in o)&&(o[c]=o[a],delete o[a])},s=t.mediaDevices.getUserMedia.bind(t.mediaDevices);if(t.mediaDevices.getUserMedia=function(o){return typeof o=="object"&&typeof o.audio=="object"&&(o=JSON.parse(JSON.stringify(o)),r(o.audio,"autoGainControl","mozAutoGainControl"),r(o.audio,"noiseSuppression","mozNoiseSuppression")),s(o)},i&&i.prototype.getSettings){const o=i.prototype.getSettings;i.prototype.getSettings=function(){const a=o.apply(this,arguments);return r(a,"mozAutoGainControl","autoGainControl"),r(a,"mozNoiseSuppression","noiseSuppression"),a}}if(i&&i.prototype.applyConstraints){const o=i.prototype.applyConstraints;i.prototype.applyConstraints=function(a){return this.kind==="audio"&&typeof a=="object"&&(a=JSON.parse(JSON.stringify(a)),r(a,"autoGainControl","mozAutoGainControl"),r(a,"noiseSuppression","mozNoiseSuppression")),o.apply(this,[a])}}}}function my(n,e){n.navigator.mediaDevices&&(n.navigator.mediaDevices&&"getDisplayMedia"in n.navigator.mediaDevices||(n.navigator.mediaDevices.getDisplayMedia=function(i){if(!(i&&i.video)){const r=new DOMException("getDisplayMedia without video constraints is undefined");return r.name="NotFoundError",r.code=8,Promise.reject(r)}return i.video===!0?i.video={mediaSource:e}:i.video.mediaSource=e,n.navigator.mediaDevices.getUserMedia(i)}))}function vh(n){typeof n=="object"&&n.RTCTrackEvent&&"receiver"in n.RTCTrackEvent.prototype&&!("transceiver"in n.RTCTrackEvent.prototype)&&Object.defineProperty(n.RTCTrackEvent.prototype,"transceiver",{get(){return{receiver:this.receiver}}})}function _c(n,e){typeof n!="object"||!(n.RTCPeerConnection||n.mozRTCPeerConnection)||(!n.RTCPeerConnection&&n.mozRTCPeerConnection&&(n.RTCPeerConnection=n.mozRTCPeerConnection),e.version<53&&["setLocalDescription","setRemoteDescription","addIceCandidate"].forEach(function(t){const i=n.RTCPeerConnection.prototype[t],r={[t](){return arguments[0]=new(t==="addIceCandidate"?n.RTCIceCandidate:n.RTCSessionDescription)(arguments[0]),i.apply(this,arguments)}};n.RTCPeerConnection.prototype[t]=r[t]}))}function xh(n,e){if(typeof n!="object"||!(n.RTCPeerConnection||n.mozRTCPeerConnection)||e.version>=151)return;const t={inboundrtp:"inbound-rtp",outboundrtp:"outbound-rtp",candidatepair:"candidate-pair",localcandidate:"local-candidate",remotecandidate:"remote-candidate"},i=n.RTCPeerConnection.prototype.getStats;n.RTCPeerConnection.prototype.getStats=function(){const[s,o,a]=arguments;return this.signalingState==="closed"?Promise.resolve(new Map):i.apply(this,[s||null]).then(c=>{if(e.version<53&&!o)try{c.forEach(l=>{l.type=t[l.type]||l.type})}catch(l){if(l.name!=="TypeError")throw l;c.forEach((d,u)=>{c.set(u,Object.assign({},d,{type:t[d.type]||d.type}))})}return c}).then(o,a)}}function yh(n){if(!(typeof n=="object"&&n.RTCPeerConnection&&n.RTCRtpSender)||n.RTCRtpSender&&"getStats"in n.RTCRtpSender.prototype)return;const e=n.RTCPeerConnection.prototype.getSenders;e&&(n.RTCPeerConnection.prototype.getSenders=function(){const r=e.apply(this,[]);return r.forEach(s=>s._pc=this),r});const t=n.RTCPeerConnection.prototype.addTrack;t&&(n.RTCPeerConnection.prototype.addTrack=function(){const r=t.apply(this,arguments);return r._pc=this,r}),n.RTCRtpSender.prototype.getStats=function(){return this.track?this._pc.getStats(this.track):Promise.resolve(new Map)}}function Mh(n){if(!(typeof n=="object"&&n.RTCPeerConnection&&n.RTCRtpSender)||n.RTCRtpSender&&"getStats"in n.RTCRtpReceiver.prototype)return;const e=n.RTCPeerConnection.prototype.getReceivers;e&&(n.RTCPeerConnection.prototype.getReceivers=function(){const i=e.apply(this,[]);return i.forEach(r=>r._pc=this),i}),ki(n,"track",t=>(t.receiver._pc=t.srcElement,t)),n.RTCRtpReceiver.prototype.getStats=function(){return this._pc.getStats(this.track)}}function Sh(n){!n.RTCPeerConnection||"removeStream"in n.RTCPeerConnection.prototype||(n.RTCPeerConnection.prototype.removeStream=function(t){Qc("removeStream","removeTrack"),this.getSenders().forEach(i=>{i.track&&t.getTracks().includes(i.track)&&this.removeTrack(i)})})}function bh(n){n.DataChannel&&!n.RTCDataChannel&&(n.RTCDataChannel=n.DataChannel)}function Eh(n,e){if(!(typeof n=="object"&&n.RTCPeerConnection)||e.version>=110)return;const t=n.RTCPeerConnection.prototype.addTransceiver;t&&(n.RTCPeerConnection.prototype.addTransceiver=function(){this.setParametersPromises=[];let r=arguments[1]&&arguments[1].sendEncodings;r===void 0&&(r=[]),r=[...r];const s=r.length>0;s&&r.forEach(a=>{if("rid"in a&&!/^[a-z0-9]{0,16}$/i.test(a.rid))throw new TypeError("Invalid RID value provided.");if("scaleResolutionDownBy"in a&&!(parseFloat(a.scaleResolutionDownBy)>=1))throw new RangeError("scale_resolution_down_by must be >= 1.0");if("maxFramerate"in a&&!(parseFloat(a.maxFramerate)>=0))throw new RangeError("max_framerate must be >= 0.0")});const o=t.apply(this,arguments);if(s){const{sender:a}=o,c=a.getParameters();(!("encodings"in c)||c.encodings.length===1&&Object.keys(c.encodings[0]).length===0)&&(c.encodings=r,a.sendEncodings=r,this.setParametersPromises.push(a.setParameters(c).then(()=>{delete a.sendEncodings}).catch(()=>{delete a.sendEncodings})))}return o})}function Th(n,e){if(!(typeof n=="object"&&n.RTCRtpSender)||e.version>=110)return;const t=n.RTCRtpSender.prototype.getParameters;t&&(n.RTCRtpSender.prototype.getParameters=function(){const r=t.apply(this,arguments);return"encodings"in r||(r.encodings=[].concat(this.sendEncodings||[{}])),r})}function Ch(n,e){if(!(typeof n=="object"&&n.RTCPeerConnection)||e.version>=110)return;const t=n.RTCPeerConnection.prototype.createOffer;n.RTCPeerConnection.prototype.createOffer=function(){return this.setParametersPromises&&this.setParametersPromises.length?Promise.all(this.setParametersPromises).then(()=>t.apply(this,arguments)).finally(()=>{this.setParametersPromises=[]}):t.apply(this,arguments)}}function wh(n,e){if(!(typeof n=="object"&&n.RTCPeerConnection)||e.version>=110)return;const t=n.RTCPeerConnection.prototype.createAnswer;n.RTCPeerConnection.prototype.createAnswer=function(){return this.setParametersPromises&&this.setParametersPromises.length?Promise.all(this.setParametersPromises).then(()=>t.apply(this,arguments)).finally(()=>{this.setParametersPromises=[]}):t.apply(this,arguments)}}const Od=Object.freeze(Object.defineProperty({__proto__:null,shimAddTransceiver:Eh,shimCreateAnswer:wh,shimCreateOffer:Ch,shimGetDisplayMedia:my,shimGetParameters:Th,shimGetStats:xh,shimGetUserMedia:_h,shimOnTrack:vh,shimPeerConnection:_c,shimRTCDataChannel:bh,shimReceiverGetStats:Mh,shimRemoveStream:Sh,shimSenderGetStats:yh},Symbol.toStringTag,{value:"Module"}));function Rh(n){if(!(typeof n!="object"||!n.RTCPeerConnection)){if("getLocalStreams"in n.RTCPeerConnection.prototype||(n.RTCPeerConnection.prototype.getLocalStreams=function(){return this._localStreams||(this._localStreams=[]),this._localStreams}),!("addStream"in n.RTCPeerConnection.prototype)){const e=n.RTCPeerConnection.prototype.addTrack;n.RTCPeerConnection.prototype.addStream=function(i){this._localStreams||(this._localStreams=[]),this._localStreams.includes(i)||this._localStreams.push(i),i.getAudioTracks().forEach(r=>e.call(this,r,i)),i.getVideoTracks().forEach(r=>e.call(this,r,i))},n.RTCPeerConnection.prototype.addTrack=function(i,...r){return r&&r.forEach(s=>{this._localStreams?this._localStreams.includes(s)||this._localStreams.push(s):this._localStreams=[s]}),e.apply(this,arguments)}}"removeStream"in n.RTCPeerConnection.prototype||(n.RTCPeerConnection.prototype.removeStream=function(t){this._localStreams||(this._localStreams=[]);const i=this._localStreams.indexOf(t);if(i===-1)return;this._localStreams.splice(i,1);const r=t.getTracks();this.getSenders().forEach(s=>{r.includes(s.track)&&this.removeTrack(s)})})}}function Ah(n){if(!(typeof n!="object"||!n.RTCPeerConnection)&&("getRemoteStreams"in n.RTCPeerConnection.prototype||(n.RTCPeerConnection.prototype.getRemoteStreams=function(){return this._remoteStreams?this._remoteStreams:[]}),!("onaddstream"in n.RTCPeerConnection.prototype))){Object.defineProperty(n.RTCPeerConnection.prototype,"onaddstream",{get(){return this._onaddstream},set(t){this._onaddstream&&(this.removeEventListener("addstream",this._onaddstream),this.removeEventListener("track",this._onaddstreampoly)),this.addEventListener("addstream",this._onaddstream=t),this.addEventListener("track",this._onaddstreampoly=i=>{i.streams.forEach(r=>{if(this._remoteStreams||(this._remoteStreams=[]),this._remoteStreams.includes(r))return;this._remoteStreams.push(r);const s=new Event("addstream");s.stream=r,this.dispatchEvent(s)})})}});const e=n.RTCPeerConnection.prototype.setRemoteDescription;n.RTCPeerConnection.prototype.setRemoteDescription=function(){const i=this;return this._onaddstreampoly||this.addEventListener("track",this._onaddstreampoly=function(r){r.streams.forEach(s=>{if(i._remoteStreams||(i._remoteStreams=[]),i._remoteStreams.indexOf(s)>=0)return;i._remoteStreams.push(s);const o=new Event("addstream");o.stream=s,i.dispatchEvent(o)})}),e.apply(i,arguments)}}}function Ph(n){if(typeof n!="object"||!n.RTCPeerConnection)return;const e=n.RTCPeerConnection.prototype,t=e.createOffer,i=e.createAnswer,r=e.setLocalDescription,s=e.setRemoteDescription,o=e.addIceCandidate;e.createOffer=function(l,d){const u=arguments.length>=2?arguments[2]:arguments[0],h=t.apply(this,[u]);return d?(h.then(l,d),Promise.resolve()):h},e.createAnswer=function(l,d){const u=arguments.length>=2?arguments[2]:arguments[0],h=i.apply(this,[u]);return d?(h.then(l,d),Promise.resolve()):h};let a=function(c,l,d){const u=r.apply(this,[c]);return d?(u.then(l,d),Promise.resolve()):u};e.setLocalDescription=a,a=function(c,l,d){const u=s.apply(this,[c]);return d?(u.then(l,d),Promise.resolve()):u},e.setRemoteDescription=a,a=function(c,l,d){const u=o.apply(this,[c]);return d?(u.then(l,d),Promise.resolve()):u},e.addIceCandidate=a}function Lh(n){const e=n&&n.navigator;if(e.mediaDevices&&e.mediaDevices.getUserMedia){const t=e.mediaDevices,i=t.getUserMedia.bind(t);e.mediaDevices.getUserMedia=r=>i(Dh(r))}!e.getUserMedia&&e.mediaDevices&&e.mediaDevices.getUserMedia&&(e.getUserMedia=(function(i,r,s){e.mediaDevices.getUserMedia(i).then(r,s)}).bind(e))}function Dh(n){return n&&n.video!==void 0?Object.assign({},n,{video:ch(n.video)}):n}function Ih(n){if(!n.RTCPeerConnection)return;const e=n.RTCPeerConnection;n.RTCPeerConnection=function(i,r){if(i&&i.iceServers){const s=[];for(let o=0;o<i.iceServers.length;o++){let a=i.iceServers[o];a.urls===void 0&&a.url?(Qc("RTCIceServer.url","RTCIceServer.urls"),a=JSON.parse(JSON.stringify(a)),a.urls=a.url,delete a.url,s.push(a)):s.push(i.iceServers[o])}i.iceServers=s}return new e(i,r)},n.RTCPeerConnection.prototype=e.prototype,"generateCertificate"in e&&Object.defineProperty(n.RTCPeerConnection,"generateCertificate",{get(){return e.generateCertificate}})}function Uh(n){typeof n=="object"&&n.RTCTrackEvent&&"receiver"in n.RTCTrackEvent.prototype&&!("transceiver"in n.RTCTrackEvent.prototype)&&Object.defineProperty(n.RTCTrackEvent.prototype,"transceiver",{get(){return{receiver:this.receiver}}})}function Nh(n){const e=n.RTCPeerConnection.prototype.createOffer;n.RTCPeerConnection.prototype.createOffer=function(i){if(i){typeof i.offerToReceiveAudio<"u"&&(i.offerToReceiveAudio=!!i.offerToReceiveAudio);const r=this.getTransceivers().find(o=>o.receiver.track.kind==="audio");i.offerToReceiveAudio===!1&&r?r.direction==="sendrecv"?r.setDirection?r.setDirection("sendonly"):r.direction="sendonly":r.direction==="recvonly"&&(r.setDirection?r.setDirection("inactive"):r.direction="inactive"):i.offerToReceiveAudio===!0&&!r&&this.addTransceiver("audio",{direction:"recvonly"}),typeof i.offerToReceiveVideo<"u"&&(i.offerToReceiveVideo=!!i.offerToReceiveVideo);const s=this.getTransceivers().find(o=>o.receiver.track.kind==="video");i.offerToReceiveVideo===!1&&s?s.direction==="sendrecv"?s.setDirection?s.setDirection("sendonly"):s.direction="sendonly":s.direction==="recvonly"&&(s.setDirection?s.setDirection("inactive"):s.direction="inactive"):i.offerToReceiveVideo===!0&&!s&&this.addTransceiver("video",{direction:"recvonly"})}return e.apply(this,arguments)}}function Fh(n){typeof n!="object"||n.AudioContext||(n.AudioContext=n.webkitAudioContext)}const Bd=Object.freeze(Object.defineProperty({__proto__:null,shimAudioContext:Fh,shimCallbacksAPI:Ph,shimConstraints:Dh,shimCreateOfferLegacy:Nh,shimGetUserMedia:Lh,shimLocalStreamsAPI:Rh,shimRTCIceServerUrls:Ih,shimRemoteStreamsAPI:Ah,shimTrackEventTransceiver:Uh},Symbol.toStringTag,{value:"Module"}));function gy(n){return n&&n.__esModule&&Object.prototype.hasOwnProperty.call(n,"default")?n.default:n}var sa={exports:{}},zd;function _y(){return zd||(zd=1,(function(n){const e={};e.generateIdentifier=function(){return Math.random().toString(36).substring(2,12)},e.localCName=e.generateIdentifier(),e.splitLines=function(t){return t.trim().split(`
...
s=-\r
t=0 0\r
`},e.getDirection=function(t,i){const r=e.splitLines(t);for(let s=0;s<r.length;s++)switch(r[s]){case"a=sendrecv":case"a=sendonly":case"a=recvonly":case"a=inactive":return r[s].substring(2)}return i?e.getDirection(i):"sendrecv"},e.getKind=function(t){return e.splitLines(t)[0].split(" ")[0].substring(2)},e.isRejected=function(t){return t.split(" ",2)[1]==="0"},e.parseMLine=function(t){const r=e.splitLines(t)[0].substring(2).split(" ");return{kind:r[0],port:parseInt(r[1],10),protocol:r[2],fmt:r.slice(3).join(" ")}},e.parseOLine=function(t){const r=e.matchPrefix(t,"o=")[0].substring(2).split(" ");return{username:r[0],sessionId:r[1],sessionVersion:parseInt(r[2],10),netType:r[3],addressType:r[4],address:r[5]}},e.isValidSDP=function(t){if(typeof t!="string"||t.length===0)return!1;const i=e.splitLines(t);for(let r=0;r<i.length;r++)if(i[r].length<2||i[r].charAt(1)!=="=")return!1;return!0},n.exports=e})(sa)),sa.exports}var kh=_y();const lr=gy(kh),vy=sf({__proto__:null,default:lr},[kh]);function Zs(n){if(!n.RTCIceCandidate||n.RTCIceCandidate&&"foundation"in n.RTCIceCandidate.prototype)return;const e=n.RTCIceCandidate;n.RTCIceCandidate=function(i){if(typeof i=="object"&&i.candidate&&i.candidate.indexOf("a=")===0&&(i=JSON.parse(JSON.stringify(i)),i.candidate=i.candidate.substring(2)),i.candidate&&i.candidate.length){const r=new e(i),s=lr.parseCandidate(i.candidate);for(const o in s)o in r||Object.defineProperty(r,o,{value:s[o]});return r.toJSON=function(){return{candidate:r.candidate,sdpMid:r.sdpMid,sdpMLineIndex:r.sdpMLineIndex,usernameFragment:r.usernameFragment}},r}return new e(i)},n.RTCIceCandidate.prototype=e.prototype,ki(n,"icecandidate",t=>(t.candidate&&Object.defineProperty(t,"candidate",{value:new n.RTCIceCandidate(t.candidate),writable:"false"}),t))}function vc(n){!n.RTCIceCandidate||n.RTCIceCandidate&&"relayProtocol"in n.RTCIceCandidate.prototype||ki(n,"icecandidate",e=>{if(e.candidate){const t=lr.parseCandidate(e.candidate.candidate);t.type==="relay"&&(e.candidate.relayProtocol={0:"tls",1:"tcp",2:"udp"}[t.priority>>24])}return e})}function Ks(n,e){if(!n.RTCPeerConnection||e.browser==="chrome"&&e.version>102||e.browser==="firefox"&&e.version>=113)return;"sctp"in n.RTCPeerConnection.prototype||Object.defineProperty(n.RTCPeerConnection.prototype,"sctp",{get(){return typeof this._sctp>"u"?null:this._sctp}});const t=function(a){if(!a||!a.sdp)return!1;const c=lr.splitSections(a.sdp);return c.shift(),c.some(l=>{const d=lr.parseMLine(l);return d&&d.kind==="application"&&d.protocol.indexOf("SCTP")!==-1})},i=function(a){const c=a.sdp.match(/mozilla...THIS_IS_SDPARTA-(\d+)/);if(c===null||c.length<2)return-1;const l=parseInt(c[1],10);return l!==l?-1:l},r=function(a){let c=65536;return e.browser==="firefox"&&(e.version<57?a===-1?c=16384:c=2147483637:e.version<60?c=e.version===57?65535:65536:c=2147483637),c},s=function(a,c){let l=65536;e.browser==="firefox"&&e.version===57&&(l=65535);const d=lr.matchPrefix(a.sdp,"a=max-message-size:");return d.length>0?l=parseInt(d[0].substring(19),10):e.browser==="firefox"&&c!==-1&&(l=2147483637),l},o=n.RTCPeerConnection.prototype.setRemoteDescription;n.RTCPeerConnection.prototype.setRemoteDescription=function(){if(this._sctp=null,e.browser==="chrome"&&e.version>=76){const{sdpSemantics:c}=this.getConfiguration();c==="plan-b"&&Object.defineProperty(this,"sctp",{get(){return typeof this._sctp>"u"?null:this._sctp},enumerable:!0,configurable:!0})}if(t(arguments[0])){const c=i(arguments[0]),l=r(c),d=s(arguments[0],c);let u;l===0&&d===0?u=Number.POSITIVE_INFINITY:l===0||d===0?u=Math.max(l,d):u=Math.min(l,d);const h={};Object.defineProperty(h,"maxMessageSize",{get(){return u}}),this._sctp=h}return o.apply(this,arguments)}}function Js(n,e){if(!(n.RTCPeerConnection&&"createDataChannel"in n.RTCPeerConnection.prototype)||e.browser==="chrome"&&e.version>=149||e.browser==="firefox"&&e.version>60)return;function t(r,s){const o=r.send;r.send=function(){const c=arguments[0],l=c.length||c.size||c.byteLength;if(r.readyState==="open"&&s.sctp&&l>s.sctp.maxMessageSize)throw new TypeError("Message too large (can send a maximum of "+s.sctp.maxMessageSize+" bytes)");return o.apply(r,arguments)}}const i=n.RTCPeerConnection.prototype.createDataChannel;n.RTCPeerConnection.prototype.createDataChannel=function(){const s=i.apply(this,arguments);return t(s,this),s},ki(n,"datachannel",r=>(t(r.channel,r.target),r))}function xc(n){if(!n.RTCPeerConnection||"connectionState"in n.RTCPeerConnection.prototype)return;const e=n.RTCPeerConnection.prototype;Object.defineProperty(e,"connectionState",{get(){return{completed:"connected",checking:"connecting"}[this.iceConnectionState]||this.iceConnectionState},enumerable:!0,configurable:!0}),Object.defineProperty(e,"onconnectionstatechange",{get(){return this._onconnectionstatechange||null},set(t){this._onconnectionstatechange&&(this.removeEventListener("connectionstatechange",this._onconnectionstatechange),delete this._onconnectionstatechange),t&&this.addEventListener("connectionstatechange",this._onconnectionstatechange=t)},enumerable:!0,configurable:!0}),["setLocalDescription","setRemoteDescription"].forEach(t=>{const i=e[t];e[t]=function(){return this._connectionstatechangepoly||(this._connectionstatechangepoly=r=>{const s=r.target;if(s._lastConnectionState!==s.connectionState){s._lastConnectionState=s.connectionState;const o=new Event("connectionstatechange",r);s.dispatchEvent(o)}return r},this.addEventListener("iceconnectionstatechange",this._connectionstatechangepoly)),i.apply(this,arguments)}})}function yc(n,e){if(!n.RTCPeerConnection||e.browser==="chrome"&&e.version>=71||e.browser==="safari"&&e._safariVersion>=13.1)return;const t=n.RTCPeerConnection.prototype.setRemoteDescription;n.RTCPeerConnection.prototype.setRemoteDescription=function(r){if(r&&r.sdp&&r.sdp.indexOf(`
a=extmap-allow-mixed`)!==-1){const s=r.sdp.split(`
`).filter(o=>o.trim()!=="a=extmap-allow-mixed").join(`
`);n.RTCSessionDescription&&r instanceof n.RTCSessionDescription?arguments[0]=new n.RTCSessionDescription({type:r.type,sdp:s}):r.sdp=s}return t.apply(this,arguments)}}function Qs(n,e){if(!(n.RTCPeerConnection&&n.RTCPeerConnection.prototype))return;const t=n.RTCPeerConnection.prototype.addIceCandidate;!t||t.length===0||(n.RTCPeerConnection.prototype.addIceCandidate=function(){return arguments[0]?(e.browser==="chrome"&&e.version<78||e.browser==="firefox"&&e.version<68||e.browser==="safari")&&arguments[0]&&arguments[0].candidate===""?Promise.resolve():t.apply(this,arguments):(arguments[1]&&arguments[1].apply(null),Promise.resolve())})}function eo(n,e){if(!(n.RTCPeerConnection&&n.RTCPeerConnection.prototype))return;const t=n.RTCPeerConnection.prototype.setLocalDescription;!t||t.length===0||(n.RTCPeerConnection.prototype.setLocalDescription=function(){let r=arguments[0]||{};if(typeof r!="object"||r.type&&r.sdp)return t.apply(this,arguments);if(r={type:r.type,sdp:r.sdp},!r.type)switch(this.signalingState){case"stable":case"have-local-offer":case"have-remote-pranswer":r.type="offer";break;default:r.type="answer";break}return r.sdp||r.type!=="offer"&&r.type!=="answer"?t.apply(this,[r]):(r.type==="offer"?this.createOffer:this.createAnswer).apply(this).then(o=>t.apply(this,[o]))})}const xy=Object.freeze(Object.defineProperty({__proto__:null,removeExtmapAllowMixed:yc,shimAddIceCandidateNullOrEmpty:Qs,shimConnectionState:xc,shimMaxMessageSize:Ks,shimParameterlessSetLocalDescription:eo,shimRTCIceCandidate:Zs,shimRTCIceCandidateRelayProtocol:vc,shimSendThrowTypeError:Js},Symbol.toStringTag,{value:"Module"}));function yy({window:n}={},e={shimChrome:!0,shimFirefox:!0,shimSafari:!0}){const t=Jc,i=py(n),r={browserDetails:i,commonShim:xy,extractVersion:Vr,disableLog:hy,disableWarnings:fy,sdp:vy};switch(i.browser){case"chrome":if(!kd||!gc||!e.shimChrome)return t("Chrome shim is not included in this adapter release."),r;if(i.version===null)return t("Chrome shim can not determine version, not shimming."),r;t("adapter.js shimming chrome."),r.browserShim=kd,Qs(n,i),eo(n),lh(n,i),dh(n),gc(n,i),uh(n,i),mh(n,i),hh(n),fh(n,i),gh(n,i),Zs(n),vc(n),xc(n),Ks(n,i),Js(n,i),yc(n,i);break;case"firefox":if(!Od||!_c||!e.shimFirefox)return t("Firefox shim is not included in this adapter release."),r;t("adapter.js shimming firefox."),r.browserShim=Od,Qs(n,i),eo(n),_h(n,i),_c(n,i),xh(n,i),vh(n),Sh(n),yh(n),Mh(n),bh(n),Eh(n,i),Th(n,i),Ch(n,i),wh(n,i),Zs(n),xc(n),Ks(n,i),Js(n,i);break;case"safari":if(!Bd||!e.shimSafari)return t("Safari shim is not included in this adapter release."),r;t("adapter.js shimming safari."),r.browserShim=Bd,Qs(n,i),eo(n),Ih(n),Nh(n),Ph(n),Rh(n),Ah(n),Uh(n),Lh(n),Fh(n),Zs(n),vc(n),Ks(n,i),Js(n,i),yc(n,i);break;default:t("Unsupported browser!");break}return r}const Hd=yy({window:typeof window>"u"?void 0:window});function Oi(n,e,t,i){Object.defineProperty(n,e,{get:t,set:i,enumerable:!0,configurable:!0})}class Oh{constructor(){this.chunkedMTU=16300,this._dataCount=1,this.chunk=e=>{const t=[],i=e.byteLength,r=Math.ceil(i/this.chunkedMTU);let s=0,o=0;for(;o<i;){const a=Math.min(i,o+this.chunkedMTU),c=e.slice(o,a),l={__peerData:this._dataCount,n:s,data:c,total:r};t.push(l),o=a,s++}return this._dataCount++,t}}}function My(n){let e=0;for(const r of n)e+=r.byteLength;const t=new Uint8Array(e);let i=0;for(const r of n)t.set(r,i),i+=r.byteLength;return t}const oa=Hd.default||Hd,Ur=new class{isWebRTCSupported(){return typeof RTCPeerConnection<"u"}isBrowserSupported(){const n=this.getBrowser(),e=this.getVersion();return this.supportedBrowsers.includes(n)?n==="chrome"?e>=this.minChromeVersion:n==="firefox"?e>=this.minFirefoxVersion:n==="safari"?!this.isIOS&&e>=this.minSafariVersion:!1:!1}getBrowser(){return oa.browserDetails.browser}getVersion(){return oa.browserDetails.version||0}isUnifiedPlanSupported(){const n=this.getBrowser(),e=oa.browserDetails.version||0;if(n==="chrome"&&e<this.minChromeVersion)return!1;if(n==="firefox"&&e>=this.minFirefoxVersion)return!0;if(!window.RTCRtpTransceiver||!("currentDirection"in RTCRtpTransceiver.prototype))return!1;let t,i=!1;try{t=new RTCPeerConnection,t.addTransceiver("audio"),i=!0}catch{}finally{t&&t.close()}return i}toString(){return`Supports:
    browser:${this.getBrowser()}
    version:${this.getVersion()}
    isIOS:${this.isIOS}
    isWebRTCSupported:${this.isWebRTCSupported()}
    isBrowserSupported:${this.isBrowserSupported()}
    isUnifiedPlanSupported:${this.isUnifiedPlanSupported()}`}constructor(){this.isIOS=typeof navigator<"u"?["iPad","iPhone","iPod"].includes(navigator.platform):!1,this.supportedBrowsers=["firefox","chrome","safari"],this.minFirefoxVersion=59,this.minChromeVersion=72,this.minSafariVersion=605}},Sy=n=>!n||/^[A-Za-z0-9]+(?:[ _-][A-Za-z0-9]+)*$/.test(n),Bh=()=>Math.random().toString(36).slice(2),Gd={iceServers:[{urls:"stun:stun.l.google.com:19302"},{urls:["turn:eu-0.turn.peerjs.com:3478","turn:us-0.turn.peerjs.com:3478"],username:"peerjs",credential:"peerjsp"}],sdpSemantics:"unified-plan"};class by extends Oh{noop(){}blobToArrayBuffer(e,t){const i=new FileReader;return i.onload=function(r){r.target&&t(r.target.result)},i.readAsArrayBuffer(e),i}binaryStringToArrayBuffer(e){const t=new Uint8Array(e.length);for(let i=0;i<e.length;i++)t[i]=e.charCodeAt(i)&255;return t.buffer}isSecure(){return location.protocol==="https:"}constructor(...e){super(...e),this.CLOUD_HOST="0.peerjs.com",this.CLOUD_PORT=443,this.chunkedBrowsers={Chrome:1,chrome:1},this.defaultConfig=Gd,this.browser=Ur.getBrowser(),this.browserVersion=Ur.getVersion(),this.pack=sh,this.unpack=rh,this.supports=(function(){const t={browser:Ur.isBrowserSupported(),webRTC:Ur.isWebRTCSupported(),audioVideo:!1,data:!1,binaryBlob:!1,reliable:!1};if(!t.webRTC)return t;let i;try{i=new RTCPeerConnection(Gd),t.audioVideo=!0;let r;try{r=i.createDataChannel("_PEERJSTEST",{ordered:!0}),t.data=!0,t.reliable=!!r.ordered;try{r.binaryType="blob",t.binaryBlob=!Ur.isIOS}catch{}}catch{}finally{r&&r.close()}}catch{}finally{i&&i.close()}return t})(),this.validateId=Sy,this.randomToken=Bh}}const qt=new by,Ey="PeerJS: ";class Ty{get logLevel(){return this._logLevel}set logLevel(e){this._logLevel=e}log(...e){this._logLevel>=3&&this._print(3,...e)}warn(...e){this._logLevel>=2&&this._print(2,...e)}error(...e){this._logLevel>=1&&this._print(1,...e)}setLogFunction(e){this._print=e}_print(e,...t){const i=[Ey,...t];for(const r in i)i[r]instanceof Error&&(i[r]="("+i[r].name+") "+i[r].message);e>=3?console.log(...i):e>=2?console.warn("WARNING",...i):e>=1&&console.error("ERROR",...i)}constructor(){this._logLevel=0}}var fe=new Ty,el={},Cy=Object.prototype.hasOwnProperty,Xt="~";function Jr(){}Object.create&&(Jr.prototype=Object.create(null),new Jr().__proto__||(Xt=!1));function wy(n,e,t){this.fn=n,this.context=e,this.once=t||!1}function zh(n,e,t,i,r){if(typeof t!="function")throw new TypeError("The listener must be a function");var s=new wy(t,i||n,r),o=Xt?Xt+e:e;return n._events[o]?n._events[o].fn?n._events[o]=[n._events[o],s]:n._events[o].push(s):(n._events[o]=s,n._eventsCount++),n}function to(n,e){--n._eventsCount===0?n._events=new Jr:delete n._events[e]}function Bt(){this._events=new Jr,this._eventsCount=0}Bt.prototype.eventNames=function(){var e=[],t,i;if(this._eventsCount===0)return e;for(i in t=this._events)Cy.call(t,i)&&e.push(Xt?i.slice(1):i);return Object.getOwnPropertySymbols?e.concat(Object.getOwnPropertySymbols(t)):e};Bt.prototype.listeners=function(e){var t=Xt?Xt+e:e,i=this._events[t];if(!i)return[];if(i.fn)return[i.fn];for(var r=0,s=i.length,o=new Array(s);r<s;r++)o[r]=i[r].fn;return o};Bt.prototype.listenerCount=function(e){var t=Xt?Xt+e:e,i=this._events[t];return i?i.fn?1:i.length:0};Bt.prototype.emit=function(e,t,i,r,s,o){var a=Xt?Xt+e:e;if(!this._events[a])return!1;var c=this._events[a],l=arguments.length,d,u;if(c.fn){switch(c.once&&this.removeListener(e,c.fn,void 0,!0),l){case 1:return c.fn.call(c.context),!0;case 2:return c.fn.call(c.context,t),!0;case 3:return c.fn.call(c.context,t,i),!0;case 4:return c.fn.call(c.context,t,i,r),!0;case 5:return c.fn.call(c.context,t,i,r,s),!0;case 6:return c.fn.call(c.context,t,i,r,s,o),!0}for(u=1,d=new Array(l-1);u<l;u++)d[u-1]=arguments[u];c.fn.apply(c.context,d)}else{var h=c.length,p;for(u=0;u<h;u++)switch(c[u].once&&this.removeListener(e,c[u].fn,void 0,!0),l){case 1:c[u].fn.call(c[u].context);break;case 2:c[u].fn.call(c[u].context,t);break;case 3:c[u].fn.call(c[u].context,t,i);break;case 4:c[u].fn.call(c[u].context,t,i,r);break;default:if(!d)for(p=1,d=new Array(l-1);p<l;p++)d[p-1]=arguments[p];c[u].fn.apply(c[u].context,d)}}return!0};Bt.prototype.on=function(e,t,i){return zh(this,e,t,i,!1)};Bt.prototype.once=function(e,t,i){return zh(this,e,t,i,!0)};Bt.prototype.removeListener=function(e,t,i,r){var s=Xt?Xt+e:e;if(!this._events[s])return this;if(!t)return to(this,s),this;var o=this._events[s];if(o.fn)o.fn===t&&(!r||o.once)&&(!i||o.context===i)&&to(this,s);else{for(var a=0,c=[],l=o.length;a<l;a++)(o[a].fn!==t||r&&!o[a].once||i&&o[a].context!==i)&&c.push(o[a]);c.length?this._events[s]=c.length===1?c[0]:c:to(this,s)}return this};Bt.prototype.removeAllListeners=function(e){var t;return e?(t=Xt?Xt+e:e,this._events[t]&&to(this,t)):(this._events=new Jr,this._eventsCount=0),this};Bt.prototype.off=Bt.prototype.removeListener;Bt.prototype.addListener=Bt.prototype.on;Bt.prefixed=Xt;Bt.EventEmitter=Bt;el=Bt;var Bi={};Oi(Bi,"ConnectionType",()=>hi);Oi(Bi,"PeerErrorType",()=>Et);Oi(Bi,"BaseConnectionErrorType",()=>Mc);Oi(Bi,"DataConnectionErrorType",()=>tl);Oi(Bi,"SerializationType",()=>vo);Oi(Bi,"SocketEventType",()=>ci);Oi(Bi,"ServerMessageType",()=>Ot);var hi=(function(n){return n.Data="data",n.Media="media",n})({}),Et=(function(n){return n.BrowserIncompatible="browser-incompatible",n.Disconnected="disconnected",n.InvalidID="invalid-id",n.InvalidKey="invalid-key",n.Network="network",n.PeerUnavailable="peer-unavailable",n.SslUnavailable="ssl-unavailable",n.ServerError="server-error",n.SocketError="socket-error",n.SocketClosed="socket-closed",n.UnavailableID="unavailable-id",n.WebRTC="webrtc",n})({}),Mc=(function(n){return n.NegotiationFailed="negotiation-failed",n.ConnectionClosed="connection-closed",n})({}),tl=(function(n){return n.NotOpenYet="not-open-yet",n.MessageToBig="message-too-big",n})({}),vo=(function(n){return n.Binary="binary",n.BinaryUTF8="binary-utf8",n.JSON="json",n.None="raw",n})({}),ci=(function(n){return n.Message="message",n.Disconnected="disconnected",n.Error="error",n.Close="close",n})({}),Ot=(function(n){return n.Heartbeat="HEARTBEAT",n.Candidate="CANDIDATE",n.Offer="OFFER",n.Answer="ANSWER",n.Open="OPEN",n.Error="ERROR",n.IdTaken="ID-TAKEN",n.InvalidKey="INVALID-KEY",n.Leave="LEAVE",n.Expire="EXPIRE",n})({});const Hh="1.5.5";class Ry extends el.EventEmitter{constructor(e,t,i,r,s,o=5e3){super(),this.pingInterval=o,this._disconnected=!0,this._messagesQueue=[];const a=e?"wss://":"ws://";this._baseUrl=a+t+":"+i+r+"peerjs?key="+s}start(e,t){this._id=e;const i=`${this._baseUrl}&id=${e}&token=${t}`;this._socket||!this._disconnected||(this._socket=new WebSocket(i+"&version="+Hh),this._disconnected=!1,this._socket.onmessage=r=>{let s;try{s=JSON.parse(r.data),fe.log("Server message received:",s)}catch{fe.log("Invalid server message",r.data);return}this.emit(ci.Message,s)},this._socket.onclose=r=>{this._disconnected||(fe.log("Socket closed.",r),this._cleanup(),this._disconnected=!0,this.emit(ci.Disconnected))},this._socket.onopen=()=>{this._disconnected||(this._sendQueuedMessages(),fe.log("Socket open"),this._scheduleHeartbeat())})}_scheduleHeartbeat(){this._wsPingTimer=setTimeout(()=>{this._sendHeartbeat()},this.pingInterval)}_sendHeartbeat(){if(!this._wsOpen()){fe.log("Cannot send heartbeat, because socket closed");return}const e=JSON.stringify({type:Ot.Heartbeat});this._socket.send(e),this._scheduleHeartbeat()}_wsOpen(){return!!this._socket&&this._socket.readyState===1}_sendQueuedMessages(){const e=[...this._messagesQueue];this._messagesQueue=[];for(const t of e)this.send(t)}send(e){if(this._disconnected)return;if(!this._id){this._messagesQueue.push(e);return}if(!e.type){this.emit(ci.Error,"Invalid message");return}if(!this._wsOpen())return;const t=JSON.stringify(e);this._socket.send(t)}close(){this._disconnected||(this._cleanup(),this._disconnected=!0)}_cleanup(){this._socket&&(this._socket.onopen=this._socket.onmessage=this._socket.onclose=null,this._socket.close(),this._socket=void 0),clearTimeout(this._wsPingTimer)}}class Gh{constructor(e){this.connection=e}startConnection(e){const t=this._startPeerConnection();if(this.connection.peerConnection=t,this.connection.type===hi.Media&&e._stream&&this._addTracksToConnection(e._stream,t),e.originator){const i=this.connection,r={ordered:!!e.reliable},s=t.createDataChannel(i.label,r);i._initializeDataChannel(s),this._makeOffer()}else this.handleSDP("OFFER",e.sdp)}_startPeerConnection(){fe.log("Creating RTCPeerConnection.");const e=new RTCPeerConnection(this.connection.provider.options.config);return this._setupListeners(e),e}_setupListeners(e){const t=this.connection.peer,i=this.connection.connectionId,r=this.connection.type,s=this.connection.provider;fe.log("Listening for ICE candidates."),e.onicecandidate=o=>{!o.candidate||!o.candidate.candidate||(fe.log(`Received ICE candidates for ${t}:`,o.candidate),s.socket.send({type:Ot.Candidate,payload:{candidate:o.candidate,type:r,connectionId:i},dst:t}))},e.oniceconnectionstatechange=()=>{switch(e.iceConnectionState){case"failed":fe.log("iceConnectionState is failed, closing connections to "+t),this.connection.emitError(Mc.NegotiationFailed,"Negotiation of connection to "+t+" failed."),this.connection.close();break;case"closed":fe.log("iceConnectionState is closed, closing connections to "+t),this.connection.emitError(Mc.ConnectionClosed,"Connection to "+t+" closed."),this.connection.close();break;case"disconnected":fe.log("iceConnectionState changed to disconnected on the connection with "+t);break;case"completed":e.onicecandidate=()=>{};break}this.connection.emit("iceStateChanged",e.iceConnectionState)},fe.log("Listening for data channel"),e.ondatachannel=o=>{fe.log("Received data channel");const a=o.channel;s.getConnection(t,i)._initializeDataChannel(a)},fe.log("Listening for remote stream"),e.ontrack=o=>{fe.log("Received remote stream");const a=o.streams[0],c=s.getConnection(t,i);if(c.type===hi.Media){const l=c;this._addStreamToMediaConnection(a,l)}}}cleanup(){fe.log("Cleaning up PeerConnection to "+this.connection.peer);const e=this.connection.peerConnection;if(!e)return;this.connection.peerConnection=null,e.onicecandidate=e.oniceconnectionstatechange=e.ondatachannel=e.ontrack=()=>{};const t=e.signalingState!=="closed";let i=!1;const r=this.connection.dataChannel;r&&(i=!!r.readyState&&r.readyState!=="closed"),(t||i)&&e.close()}async _makeOffer(){const e=this.connection.peerConnection,t=this.connection.provider;try{const i=await e.createOffer(this.connection.options.constraints);fe.log("Created offer."),this.connection.options.sdpTransform&&typeof this.connection.options.sdpTransform=="function"&&(i.sdp=this.connection.options.sdpTransform(i.sdp)||i.sdp);try{await e.setLocalDescription(i),fe.log("Set localDescription:",i,`for:${this.connection.peer}`);let r={sdp:i,type:this.connection.type,connectionId:this.connection.connectionId,metadata:this.connection.metadata};if(this.connection.type===hi.Data){const s=this.connection;r={...r,label:s.label,reliable:s.reliable,serialization:s.serialization}}t.socket.send({type:Ot.Offer,payload:r,dst:this.connection.peer})}catch(r){r!="OperationError: Failed to set local offer sdp: Called in wrong state: kHaveRemoteOffer"&&(t.emitError(Et.WebRTC,r),fe.log("Failed to setLocalDescription, ",r))}}catch(i){t.emitError(Et.WebRTC,i),fe.log("Failed to createOffer, ",i)}}async _makeAnswer(){const e=this.connection.peerConnection,t=this.connection.provider;try{const i=await e.createAnswer();fe.log("Created answer."),this.connection.options.sdpTransform&&typeof this.connection.options.sdpTransform=="function"&&(i.sdp=this.connection.options.sdpTransform(i.sdp)||i.sdp);try{await e.setLocalDescription(i),fe.log("Set localDescription:",i,`for:${this.connection.peer}`),t.socket.send({type:Ot.Answer,payload:{sdp:i,type:this.connection.type,connectionId:this.connection.connectionId},dst:this.connection.peer})}catch(r){t.emitError(Et.WebRTC,r),fe.log("Failed to setLocalDescription, ",r)}}catch(i){t.emitError(Et.WebRTC,i),fe.log("Failed to create answer, ",i)}}async handleSDP(e,t){t=new RTCSessionDescription(t);const i=this.connection.peerConnection,r=this.connection.provider;fe.log("Setting remote description",t);const s=this;try{await i.setRemoteDescription(t),fe.log(`Set remoteDescription:${e} for:${this.connection.peer}`),e==="OFFER"&&await s._makeAnswer()}catch(o){r.emitError(Et.WebRTC,o),fe.log("Failed to setRemoteDescription, ",o)}}async handleCandidate(e){fe.log("handleCandidate:",e);try{await this.connection.peerConnection.addIceCandidate(e),fe.log(`Added ICE candidate for:${this.connection.peer}`)}catch(t){this.connection.provider.emitError(Et.WebRTC,t),fe.log("Failed to handleCandidate, ",t)}}_addTracksToConnection(e,t){if(fe.log(`add tracks from stream ${e.id} to peer connection`),!t.addTrack)return fe.error("Your browser does't support RTCPeerConnection#addTrack. Ignored.");e.getTracks().forEach(i=>{t.addTrack(i,e)})}_addStreamToMediaConnection(e,t){fe.log(`add stream ${e.id} to media connection ${t.connectionId}`),t.addStream(e)}}class Vh extends el.EventEmitter{emitError(e,t){fe.error("Error:",t),this.emit("error",new Ay(`${e}`,t))}}class Ay extends Error{constructor(e,t){typeof t=="string"?super(t):(super(),Object.assign(this,t)),this.type=e}}class Wh extends Vh{get open(){return this._open}constructor(e,t,i){super(),this.peer=e,this.provider=t,this.options=i,this._open=!1,this.metadata=i.metadata}}var Ec;const jr=class jr extends Wh{get type(){return hi.Media}get localStream(){return this._localStream}get remoteStream(){return this._remoteStream}constructor(e,t,i){super(e,t,i),this._localStream=this.options._stream,this.connectionId=this.options.connectionId||jr.ID_PREFIX+qt.randomToken(),this._negotiator=new Gh(this),this._localStream&&this._negotiator.startConnection({_stream:this._localStream,originator:!0})}_initializeDataChannel(e){this.dataChannel=e,this.dataChannel.onopen=()=>{fe.log(`DC#${this.connectionId} dc connection success`),this.emit("willCloseOnRemote")},this.dataChannel.onclose=()=>{fe.log(`DC#${this.connectionId} dc closed for:`,this.peer),this.close()}}addStream(e){fe.log("Receiving stream",e),this._remoteStream=e,super.emit("stream",e)}handleMessage(e){const t=e.type,i=e.payload;switch(e.type){case Ot.Answer:this._negotiator.handleSDP(t,i.sdp),this._open=!0;break;case Ot.Candidate:this._negotiator.handleCandidate(i.candidate);break;default:fe.warn(`Unrecognized message type:${t} from peer:${this.peer}`);break}}answer(e,t={}){if(this._localStream){fe.warn("Local stream already exists on this MediaConnection. Are you answering a call twice?");return}this._localStream=e,t&&t.sdpTransform&&(this.options.sdpTransform=t.sdpTransform),this._negotiator.startConnection({...this.options._payload,_stream:e});const i=this.provider._getMessages(this.connectionId);for(const r of i)this.handleMessage(r);this._open=!0}close(){this._negotiator&&(this._negotiator.cleanup(),this._negotiator=null),this._localStream=null,this._remoteStream=null,this.provider&&(this.provider._removeConnection(this),this.provider=null),this.options&&this.options._stream&&(this.options._stream=null),this.open&&(this._open=!1,super.emit("close"))}};Ec=new WeakMap,Tr(jr,Ec,jr.ID_PREFIX="mc_");let lo=jr;class Py{constructor(e){this._options=e}_buildRequest(e){const t=this._options.secure?"https":"http",{host:i,port:r,path:s,key:o}=this._options,a=new URL(`${t}://${i}:${r}${s}${o}/${e}`);return a.searchParams.set("ts",`${Date.now()}${Math.random()}`),a.searchParams.set("version",Hh),fetch(a.href,{referrerPolicy:this._options.referrerPolicy})}async retrieveId(){try{const e=await this._buildRequest("id");if(e.status!==200)throw new Error(`Error. Status:${e.status}`);return e.text()}catch(e){fe.error("Error retrieving ID",e);let t="";throw this._options.path==="/"&&this._options.host!==qt.CLOUD_HOST&&(t=" If you passed in a `path` to your self-hosted PeerServer, you'll also need to pass in that same path when creating a new Peer."),new Error("Could not get an ID from the server."+t)}}async listAllPeers(){try{const e=await this._buildRequest("peers");if(e.status!==200){if(e.status===401){let t="";throw this._options.host===qt.CLOUD_HOST?t="It looks like you're using the cloud server. You can email team@peerjs.com to enable peer listing for your API key.":t="You need to enable `allow_discovery` on your self-hosted PeerServer to use this feature.",new Error("It doesn't look like you have permission to list peers IDs. "+t)}throw new Error(`Error. Status:${e.status}`)}return e.json()}catch(e){throw fe.error("Error retrieving list peers",e),new Error("Could not get list peers from the server."+e)}}}var Tc,Cc;const Ai=class Ai extends Wh{get type(){return hi.Data}constructor(e,t,i){super(e,t,i),this.connectionId=this.options.connectionId||Ai.ID_PREFIX+Bh(),this.label=this.options.label||this.connectionId,this.reliable=!!this.options.reliable,this._negotiator=new Gh(this),this._negotiator.startConnection(this.options._payload||{originator:!0,reliable:this.reliable})}_initializeDataChannel(e){this.dataChannel=e,this.dataChannel.onopen=()=>{fe.log(`DC#${this.connectionId} dc connection success`),this._open=!0,this.emit("open")},this.dataChannel.onmessage=t=>{fe.log(`DC#${this.connectionId} dc onmessage:`,t.data)},this.dataChannel.onclose=()=>{fe.log(`DC#${this.connectionId} dc closed for:`,this.peer),this.close()}}close(e){if(e!=null&&e.flush){this.send({__peerData:{type:"close"}});return}this._negotiator&&(this._negotiator.cleanup(),this._negotiator=null),this.provider&&(this.provider._removeConnection(this),this.provider=null),this.dataChannel&&(this.dataChannel.onopen=null,this.dataChannel.onmessage=null,this.dataChannel.onclose=null,this.dataChannel=null),this.open&&(this._open=!1,super.emit("close"))}send(e,t=!1){if(!this.open){this.emitError(tl.NotOpenYet,"Connection is not open. You should listen for the `open` event before sending messages.");return}return this._send(e,t)}async handleMessage(e){const t=e.payload;switch(e.type){case Ot.Answer:await this._negotiator.handleSDP(e.type,t.sdp);break;case Ot.Candidate:await this._negotiator.handleCandidate(t.candidate);break;default:fe.warn("Unrecognized message type:",e.type,"from peer:",this.peer);break}}};Tc=new WeakMap,Cc=new WeakMap,Tr(Ai,Tc,Ai.ID_PREFIX="dc_"),Tr(Ai,Cc,Ai.MAX_BUFFERED_AMOUNT=8388608);let uo=Ai;class nl extends uo{get bufferSize(){return this._bufferSize}_initializeDataChannel(e){super._initializeDataChannel(e),this.dataChannel.binaryType="arraybuffer",this.dataChannel.addEventListener("message",t=>this._handleDataMessage(t))}_bufferedSend(e){(this._buffering||!this._trySend(e))&&(this._buffer.push(e),this._bufferSize=this._buffer.length)}_trySend(e){if(!this.open)return!1;if(this.dataChannel.bufferedAmount>uo.MAX_BUFFERED_AMOUNT)return this._buffering=!0,setTimeout(()=>{this._buffering=!1,this._tryBuffer()},50),!1;try{this.dataChannel.send(e)}catch(t){return fe.error(`DC#:${this.connectionId} Error when sending:`,t),this._buffering=!0,this.close(),!1}return!0}_tryBuffer(){if(!this.open||this._buffer.length===0)return;const e=this._buffer[0];this._trySend(e)&&(this._buffer.shift(),this._bufferSize=this._buffer.length,this._tryBuffer())}close(e){if(e!=null&&e.flush){this.send({__peerData:{type:"close"}});return}this._buffer=[],this._bufferSize=0,super.close()}constructor(...e){super(...e),this._buffer=[],this._bufferSize=0,this._buffering=!1}}class aa extends nl{close(e){super.close(e),this._chunkedData={}}constructor(e,t,i){super(e,t,i),this.chunker=new Oh,this.serialization=vo.Binary,this._chunkedData={}}_handleDataMessage({data:e}){const t=rh(e),i=t.__peerData;if(i){if(i.type==="close"){this.close();return}this._handleChunk(t);return}this.emit("data",t)}_handleChunk(e){const t=e.__peerData,i=this._chunkedData[t]||{data:[],count:0,total:e.total};if(i.data[e.n]=new Uint8Array(e.data),i.count++,this._chunkedData[t]=i,i.total===i.count){delete this._chunkedData[t];const r=My(i.data);this._handleDataMessage({data:r})}}_send(e,t){const i=sh(e);if(i instanceof Promise)return this._send_blob(i);if(!t&&i.byteLength>this.chunker.chunkedMTU){this._sendChunks(i);return}this._bufferedSend(i)}async _send_blob(e){const t=await e;if(t.byteLength>this.chunker.chunkedMTU){this._sendChunks(t);return}this._bufferedSend(t)}_sendChunks(e){const t=this.chunker.chunk(e);fe.log(`DC#${this.connectionId} Try to send ${t.length} chunks...`);for(const i of t)this.send(i,!0)}}class Ly extends nl{_handleDataMessage({data:e}){super.emit("data",e)}_send(e,t){this._bufferedSend(e)}constructor(...e){super(...e),this.serialization=vo.None}}class Dy extends nl{_handleDataMessage({data:e}){const t=this.parse(this.decoder.decode(e)),i=t.__peerData;if(i&&i.type==="close"){this.close();return}this.emit("data",t)}_send(e,t){const i=this.encoder.encode(this.stringify(e));if(i.byteLength>=qt.chunkedMTU){this.emitError(tl.MessageToBig,"Message too big for JSON channel");return}this._bufferedSend(i)}constructor(...e){super(...e),this.serialization=vo.JSON,this.encoder=new TextEncoder,this.decoder=new TextDecoder,this.stringify=JSON.stringify,this.parse=JSON.parse}}var wc;const Zr=class Zr extends Vh{get id(){return this._id}get options(){return this._options}get open(){return this._open}get socket(){return this._socket}get connections(){const e=Object.create(null);for(const[t,i]of this._connections)e[t]=i;return e}get destroyed(){return this._destroyed}get disconnected(){return this._disconnected}constructor(e,t){super(),this._serializers={raw:Ly,json:Dy,binary:aa,"binary-utf8":aa,default:aa},this._id=null,this._lastServerId=null,this._destroyed=!1,this._disconnected=!1,this._open=!1,this._connections=new Map,this._lostMessages=new Map;let i;if(e&&e.constructor==Object?t=e:e&&(i=e.toString()),t={debug:0,host:qt.CLOUD_HOST,port:qt.CLOUD_PORT,path:"/",key:Zr.DEFAULT_KEY,token:qt.randomToken(),config:qt.defaultConfig,referrerPolicy:"strict-origin-when-cross-origin",serializers:{},...t},this._options=t,this._serializers={...this._serializers,...this.options.serializers},this._options.host==="/"&&(this._options.host=window.location.hostname),this._options.path&&(this._options.path[0]!=="/"&&(this._options.path="/"+this._options.path),this._options.path[this._options.path.length-1]!=="/"&&(this._options.path+="/")),this._options.secure===void 0&&this._options.host!==qt.CLOUD_HOST?this._options.secure=qt.isSecure():this._options.host==qt.CLOUD_HOST&&(this._options.secure=!0),this._options.logFunction&&fe.setLogFunction(this._options.logFunction),fe.logLevel=this._options.debug||0,this._api=new Py(t),this._socket=this._createServerConnection(),!qt.supports.audioVideo&&!qt.supports.data){this._delayedAbort(Et.BrowserIncompatible,"The current browser does not support WebRTC");return}if(i&&!qt.validateId(i)){this._delayedAbort(Et.InvalidID,`ID "${i}" is invalid`);return}i?this._initialize(i):this._api.retrieveId().then(r=>this._initialize(r)).catch(r=>this._abort(Et.ServerError,r))}_createServerConnection(){const e=new Ry(this._options.secure,this._options.host,this._options.port,this._options.path,this._options.key,this._options.pingInterval);return e.on(ci.Message,t=>{this._handleMessage(t)}),e.on(ci.Error,t=>{this._abort(Et.SocketError,t)}),e.on(ci.Disconnected,()=>{this.disconnected||(this.emitError(Et.Network,"Lost connection to server."),this.disconnect())}),e.on(ci.Close,()=>{this.disconnected||this._abort(Et.SocketClosed,"Underlying socket is already closed.")}),e}_initialize(e){this._id=e,this.socket.start(e,this._options.token)}_handleMessage(e){const t=e.type,i=e.payload,r=e.src;switch(t){case Ot.Open:this._lastServerId=this.id,this._open=!0,this.emit("open",this.id);break;case Ot.Error:this._abort(Et.ServerError,i.msg);break;case Ot.IdTaken:this._abort(Et.UnavailableID,`ID "${this.id}" is taken`);break;case Ot.InvalidKey:this._abort(Et.InvalidKey,`API KEY "${this._options.key}" is invalid`);break;case Ot.Leave:fe.log(`Received leave message from ${r}`),this._cleanupPeer(r),this._connections.delete(r);break;case Ot.Expire:this.emitError(Et.PeerUnavailable,`Could not connect to peer ${r}`);break;case Ot.Offer:{const s=i.connectionId;let o=this.getConnection(r,s);if(o&&(o.close(),fe.warn(`Offer received for existing Connection ID:${s}`)),i.type===hi.Media){const c=new lo(r,this,{connectionId:s,_payload:i,metadata:i.metadata});o=c,this._addConnection(r,o),this.emit("call",c)}else if(i.type===hi.Data){const c=new this._serializers[i.serialization](r,this,{connectionId:s,_payload:i,metadata:i.metadata,label:i.label,serialization:i.serialization,reliable:i.reliable});o=c,this._addConnection(r,o),this.emit("connection",c)}else{fe.warn(`Received malformed connection type:${i.type}`);return}const a=this._getMessages(s);for(const c of a)o.handleMessage(c);break}default:{if(!i){fe.warn(`You received a malformed message from ${r} of type ${t}`);return}const s=i.connectionId,o=this.getConnection(r,s);o&&o.peerConnection?o.handleMessage(e):s?this._storeMessage(s,e):fe.warn("You received an unrecognized message:",e);break}}}_storeMessage(e,t){this._lostMessages.has(e)||this._lostMessages.set(e,[]),this._lostMessages.get(e).push(t)}_getMessages(e){const t=this._lostMessages.get(e);return t?(this._lostMessages.delete(e),t):[]}connect(e,t={}){if(t={serialization:"default",...t},this.disconnected){fe.warn("You cannot connect to a new Peer because you called .disconnect() on this Peer and ended your connection with the server. You can create a new Peer to reconnect, or call reconnect on this peer if you believe its ID to still be available."),this.emitError(Et.Disconnected,"Cannot connect to new Peer after disconnecting from server.");return}const i=new this._serializers[t.serialization](e,this,t);return this._addConnection(e,i),i}call(e,t,i={}){if(this.disconnected){fe.warn("You cannot connect to a new Peer because you called .disconnect() on this Peer and ended your connection with the server. You can create a new Peer to reconnect."),this.emitError(Et.Disconnected,"Cannot connect to new Peer after disconnecting from server.");return}if(!t){fe.error("To call a peer, you must provide a stream from your browser's `getUserMedia`.");return}const r=new lo(e,this,{...i,_stream:t});return this._addConnection(e,r),r}_addConnection(e,t){fe.log(`add connection ${t.type}:${t.connectionId} to peerId:${e}`),this._connections.has(e)||this._connections.set(e,[]),this._connections.get(e).push(t)}_removeConnection(e){const t=this._connections.get(e.peer);if(t){const i=t.indexOf(e);i!==-1&&t.splice(i,1)}this._lostMessages.delete(e.connectionId)}getConnection(e,t){const i=this._connections.get(e);if(!i)return null;for(const r of i)if(r.connectionId===t)return r;return null}_delayedAbort(e,t){setTimeout(()=>{this._abort(e,t)},0)}_abort(e,t){fe.error("Aborting!"),this.emitError(e,t),this._lastServerId?this.disconnect():this.destroy()}destroy(){this.destroyed||(fe.log(`Destroy peer with ID:${this.id}`),this.disconnect(),this._cleanup(),this._destroyed=!0,this.emit("close"))}_cleanup(){for(const e of this._connections.keys())this._cleanupPeer(e),this._connections.delete(e);this.socket.removeAllListeners()}_cleanupPeer(e){const t=this._connections.get(e);if(t)for(const i of t)i.close()}disconnect(){if(this.disconnected)return;const e=this.id;fe.log(`Disconnect peer with ID:${e}`),this._disconnected=!0,this._open=!1,this.socket.close(),this._lastServerId=e,this._id=null,this.emit("disconnected",e)}reconnect(){if(this.disconnected&&!this.destroyed)fe.log(`Attempting reconnection to server with ID ${this._lastServerId}`),this._disconnected=!1,this._initialize(this._lastServerId);else{if(this.destroyed)throw new Error("This peer cannot reconnect to the server. It has already been destroyed.");if(!this.disconnected&&!this.open)fe.error("In a hurry? We're still trying to make the initial connection!");else throw new Error(`Peer ${this.id} cannot reconnect because it is not disconnected from the server!`)}}listAllPeers(e=t=>{}){this._api.listAllPeers().then(t=>e(t)).catch(t=>this._abort(Et.ServerError,t))}};wc=new WeakMap,Tr(Zr,wc,Zr.DEFAULT_KEY="peerjs");let Sc=Zr;var Vd=Sc;const Iy="ccwd-",Wd="ABCDEFGHJKLMNPQRSTUVWXYZ23456789",Uy="https://bperussina.github.io/MyGames/car-crashing-with-dashing/index.html",Ny={host:"0.peerjs.com",port:443,path:"/",secure:!0,debug:0},Fy={iceServers:[{urls:"stun:stun.l.google.com:19302"},{urls:"stun:global.stun.twilio.com:3478"},{urls:["turn:eu-0.turn.peerjs.com:3478","turn:us-0.turn.peerjs.com:3478"],username:"peerjs",credential:"peerjsp"}]},ca=12,ky=2e3,Xd=15e3;function Oy(n=6){let e="";for(let t=0;t<n;t++)e+=Wd[Math.floor(Math.random()*Wd.length)];return e}function Xh(n){const e=new URL(Uy);return e.searchParams.set("room",n.toUpperCase()),e.toString()}function $d(n){return`${Iy}${n.toUpperCase()}`}function By(n){return new Promise(e=>setTimeout(e,n))}function Yd(n=void 0){return{...Ny,...n?{id:n}:{},config:Fy}}function qd(){let n=null,e=null,t=null,i=null,r=new Map,s=null,o=null,a=null;function c(b){o==null||o(b)}function l(){for(const[,b]of r)try{b.close()}catch{}if(r.clear(),n){try{n.destroy()}catch{}n=null}}function d(b,E=null){const A=JSON.stringify(b);for(const[,y]of r)y!==E&&y.open&&y.send(A)}function u(b){r.set(b.peer,b),a==null||a(r.size+(e==="host"?1:0)),b.on("data",E=>{try{const A=typeof E=="string"?JSON.parse(E):E;s==null||s(A,b.peer)}catch{}}),b.on("close",()=>{r.delete(b.peer),a==null||a(r.size+(e==="host"?1:0)),s==null||s({t:"leave",id:b.peer})})}function h(b){return new Promise((E,A)=>{const y=setTimeout(()=>{A(Object.assign(new Error("timeout"),{type:"network"}))},Xd);b.once("open",x=>{clearTimeout(y),E(x)}),b.once("error",x=>{clearTimeout(y),A(x)})})}function p(b){return t=b.toUpperCase(),e="host",i=$d(t),c("Opening your room (works on any internet)…"),new Promise((E,A)=>{l(),n=new Vd(i,Yd(i)),n.on("connection",y=>{y.on("open",()=>{u(y),y.send(JSON.stringify({t:"welcome",host:i,code:t})),s==null||s({t:"join",id:y.peer})})}),h(n).then(()=>{c(`Room ${t} ready — share your link!`),E({code:t,link:Xh(t),role:"host",id:i})}).catch(y=>{c(f(y,"host")),l(),A(y)})})}function g(b){t=b.toUpperCase(),e="client";const E=$d(t);return new Promise((A,y)=>{l(),n=new Vd(Yd()),h(n).then(x=>{i=x;const R=n.connect(E,{reliable:!0}),O=setTimeout(()=>{y(Object.assign(new Error("connect failed"),{type:"peer-unavailable"}))},Xd);R.on("open",()=>{clearTimeout(O),u(R),c("You're in the game!"),A({code:t,role:"client",id:i})}),R.on("error",()=>{clearTimeout(O),y(Object.assign(new Error("connect failed"),{type:"peer-unavailable"}))})}).catch(x=>{y(x)})})}function _(b){const E=(b==null?void 0:b.type)??"";return E==="peer-unavailable"||E==="network"||E==="disconnected"}async function m(b){t=b.toUpperCase(),e="client",c(`Joining ${t}…`);let E=null;for(let A=1;A<=ca;A++)try{return A>1&&c(`Still connecting… (${A}/${ca}) — ask host to keep the game open`),await g(b)}catch(y){if(E=y,l(),A<ca&&_(y)){await By(ky);continue}throw c(f(y,"join")),y}throw c(f(E,"join")),E}function f(b,E){const A=(b==null?void 0:b.type)??"";return A==="peer-unavailable"?E==="join"?"Room not open yet — ask host to tap Generate Code and keep the game open.":"That room code is taken — tap Generate Code again.":A==="unavailable-id"?"That room code is taken — tap Generate Code again.":A==="network"||A==="disconnected"?"Internet hiccup — check Wi‑Fi or data and try again.":A==="browser-incompatible"?"Try Chrome, Safari, or Edge for multiplayer.":E==="join"?"Could not connect — make sure the host shared the link and left the game open.":`Could not open room (${A||"error"}) — try again.`}function w(b){if(e==="host")d(b);else{const E=r.values().next().value;E!=null&&E.open&&E.send(JSON.stringify(b))}}function C(b){if(e==="host")s==null||s(b,i);else{const E=r.values().next().value;E!=null&&E.open&&E.send(JSON.stringify(b))}}function S(b,E){e==="host"&&d(E,r.get(b))}function P(){l(),e=null,t=null,i=null}return{host:p,join:m,send:w,sendToHost:C,relay:S,close:P,get role(){return e},get code(){return t},get id(){return i},set onMessage(b){s=b},set onStatus(b){o=b},set onPeerCount(b){a=b}}}const xo="ccwd-player-name",jd="ccwd-host-room";let nt=null,qe=null,Fs=null,si=new Map;function oi(){if(!nt)return"Player";const n=nt.querySelector("#player-name"),e=n==null?void 0:n.value.trim();if(e)return e;try{return localStorage.getItem(xo)||"Player"}catch{return"Player"}}function Zd(n){try{localStorage.setItem(xo,n)}catch{}}function zy(n){Fs=n,nt=document.createElement("div"),nt.id="multiplayer-lobby",nt.innerHTML=`
  ...
  `,document.body.appendChild(nt);const e=nt.querySelector("#lobby-status"),t=nt.querySelector("#host-info"),i=nt.querySelector("#room-code"),r=nt.querySelector("#share-link"),s=nt.querySelector("#player-name"),o=nt.querySelector("#lobby-people-list"),a=nt.querySelector("#btn-enter");try{const P=localStorage.getItem(xo);P&&(s.value=P)}catch{}function c(P){e&&(e.textContent=P)}function l(P){if(o){if(o.innerHTML="",!P.length){const b=document.createElement("li");b.className="lobby-person empty",b.textContent="Nobody here yet",o.appendChild(b);return}for(const b of P){const E=document.createElement("li");E.className="lobby-person",E.textContent=b.you?`${b.name} (you)`:b.name,o.appendChild(E)}}}function d(){return[{id:"local",name:oi(),you:!0}]}function u(){if(!(qe!=null&&qe.id))return d();const P=[{id:qe.id,name:oi(),you:!0}];for(const[b,E]of si)P.push({id:b,name:E,you:!1});return P}function h(){(qe==null?void 0:qe.role)==="host"?l(u()):(qe==null?void 0:qe.role)==="client"||l(d())}function p(){if((qe==null?void 0:qe.role)!=="host")return;const P=u();l(P),qe.send({t:"roster",people:P})}function g(P){qe=P,si.clear(),qe.onMessage=(b,E)=>{if(qe.role==="host"&&(b.t==="hello"&&E&&(si.set(E,b.name||"Player"),p(),c(`${b.name||"Someone"} joined the lobby`)),b.t==="setName"&&E&&(si.set(E,b.name||"Player"),p()),b.t==="leave")){const A=E||b.id;A&&(si.delete(A),p(),c("Someone left the lobby"))}b.t==="roster"&&Array.isArray(b.people)&&l(b.people)},qe.onPeerCount=()=>h()}function _(){const P=oi();if(Zd(P),!qe){h();return}qe.role==="host"?p():qe.role==="client"&&qe.send({t:"setName",name:P})}function m(){a.hidden=!1}s.addEventListener("input",()=>{_()}),nt.querySelector("#btn-generate").addEventListener("click",async()=>{try{qe&&qe.close(),si.clear();const P=qd();P.onStatus=c,g(P);const b=Oy(),E=await P.host(b);i.textContent=E.code,r.value=E.link,t.hidden=!1;try{sessionStorage.setItem(jd,E.code)}catch{}history.replaceState(null,"",`?room=${encodeURIComponent(E.code)}`),_(),m(),c("Share the link — friends appear in the lobby when they join.")}catch{c("Could not create room — try again.")}}),nt.querySelector("#btn-copy").addEventListener("click",async()=>{try{await navigator.clipboard.writeText(r.value),c("Link copied! Send it to your family.")}catch{r.select(),c("Select the link and copy it.")}}),nt.querySelector("#btn-join").addEventListener("click",()=>f()),nt.querySelector("#join-code").addEventListener("keydown",P=>{P.key==="Enter"&&f()});async function f({fromLink:P=!1}={}){const b=nt.querySelector("#join-code").value.trim();if(!b){c("Type a room code first.");return}try{qe&&qe.close(),si.clear();const E=qd();E.onStatus=c,g(E),await E.join(b),E.send({t:"hello",name:oi()}),m(),c("You're in the game!"),P&&setTimeout(()=>w(),500)}catch{}}function w(){qe&&(Zd(oi()),la(),Fs==null||Fs({room:qe,isHost:qe.role==="host",playerName:oi()}))}a.addEventListener("click",w);function C(){qe&&qe.close(),qe=null,si.clear(),a.hidden=!0,t.hidden=!0;try{sessionStorage.removeItem(jd)}catch{}la(),h()}nt.querySelector("#lobby-x").addEventListener("click",C);const S=new URLSearchParams(window.location.search).get("room");return S&&(nt.querySelector("#join-code").value=S),la(),h(),nt}function la(){nt&&nt.classList.remove("open")}function $h(){if(nt){nt.classList.add("open");const n=nt.querySelector("#player-name");if(n)try{const t=localStorage.getItem(xo);t&&!n.value&&(n.value=t)}catch{}const e=nt.querySelector("#lobby-people-list");if(e&&!qe){oi(),e.innerHTML="";const t=document.createElement("li");t.className="lobby-person",t.textContent=`${oi()} (you)`,e.appendChild(t)}}}function Kd(){return(nt==null?void 0:nt.classList.contains("open"))??!1}const Jd=[15680580,16347926,15381256,2278750,440020,11032055,15485081];function Hy(n){const e=new Map;let t=0;function i(){const l=Jd[t%Jd.length];return t+=1,l}function r(l){if(e.has(l))return e.get(l);const d=i(),u=Qu(0,0,d);u.mesh.userData.remoteId=l,n.add(u.mesh);const h={player:u,target:{x:0,z:0,facing:0,walkPhase:0,isMoving:!1}};return e.set(l,h),h}function s(l,d){const u=r(l);Object.assign(u.target,d);const h=u.player;h.x=d.x,h.z=d.z,h.facing=d.facing??0,h.walkPhase=d.walkPhase??0,h.isMoving=!!d.isMoving,_r(h)}function o(l){const d=e.get(l);d&&(n.remove(d.player.mesh),e.delete(l))}function a(l){const d=Math.min(1,l*12);for(const[,u]of e){const h=u.player,p=u.target;h.x+=(p.x-h.x)*d,h.z+=(p.z-h.z)*d,h.facing+=(p.facing-h.facing)*d,h.walkPhase=p.walkPhase,h.isMoving=p.isMoving,_r(h)}}function c(){for(const l of[...e.keys()])o(l)}return{applyPose:s,remove:o,lerpAll:a,clear:c,count:()=>e.size}}const Yh="ccwd-design-sketch",rr=28,qh=[{name:"Stainless",hex:"#b8bdc4"},{name:"Black",hex:"#1a1a1a"},{name:"White",hex:"#ffffff"},{name:"Gray",hex:"#6b7280"},{name:"Red",hex:"#dc2626"},{name:"Blue",hex:"#2563eb"},{name:"Green",hex:"#16a34a"},{name:"Yellow",hex:"#eab308"}];let Tt=null,Mt=null,dt=null,Qr=!1,Nr="draw",no=qh[0].hex,ks=!1,Ii=null;function io(){if(Mt)try{localStorage.setItem(Yh,Mt.toDataURL("image/png"))}catch{}}function Gy(){if(!(!Mt||!dt))try{const n=localStorage.getItem(Yh);if(!n)return;const e=new Image;e.onload=()=>{dt.drawImage(e,0,0,Mt.width,Mt.height)},e.src=n}catch{}}function jh(){if(!Mt||!dt)return;const n=Math.min(window.devicePixelRatio||1,2),e=window.innerWidth,t=window.innerHeight;Mt.width=Math.floor(e*n),Mt.height=Math.floor(t*n),Mt.style.width=`${e}px`,Mt.style.height=`${t}px`,dt.setTransform(n,0,0,n,0,0),dt.fillStyle="#ffffff",dt.fillRect(0,0,e,t),Gy()}function Qd(n){return Math.round(n/rr)*rr}function eu(n,e){const t=Mt.getBoundingClientRect();return{x:n-t.left,y:e-t.top}}function Vy(n,e){const t=Qd(n),i=Qd(e);dt.fillStyle=no,dt.fillRect(t,i,rr,rr),dt.strokeStyle="rgba(0,0,0,0.12)",dt.lineWidth=1,dt.strokeRect(t+.5,i+.5,rr-1,rr-1)}function tu(){io(),Zh(),Ii==null||Ii()}function nu(){return Qr}function Zh(){Tt&&(Qr=!1,Tt.hidden=!0)}function Wy(){Tt&&(Qr=!0,Tt.hidden=!1,jh())}function Xy(){return new URLSearchParams(window.location.search).has("draw")}function $y(n,e){Ii=n,Tt=document.createElement("div"),Tt.id="draw-paper",Tt.innerHTML=`
  ...
  `,document.body.appendChild(Tt),Mt=Tt.querySelector("#draw-paper-canvas"),dt=Mt.getContext("2d");const t=Tt.querySelector("#draw-colors");for(const c of qh){const l=document.createElement("button");l.type="button",l.className="draw-swatch",l.style.background=c.hex,l.title=c.name,l.dataset.color=c.hex,c.hex===no&&l.classList.add("active"),l.addEventListener("click",()=>{no=c.hex,t.querySelectorAll(".draw-swatch").forEach(d=>d.classList.remove("active")),l.classList.add("active"),Nr==="erase"&&i("draw")}),t.appendChild(l)}function i(c){Nr=c,Tt.querySelectorAll(".draw-tool").forEach(l=>{l.classList.toggle("active",l.dataset.tool===c)})}Tt.querySelectorAll(".draw-tool").forEach(c=>{c.addEventListener("click",()=>i(c.dataset.tool))}),Tt.querySelector("#draw-clear").addEventListener("click",()=>{dt.fillStyle="#ffffff",dt.fillRect(0,0,Mt.width,Mt.height),io()}),Tt.querySelector("#draw-play-btn").addEventListener("click",tu),Tt.querySelector("#draw-multi-btn").addEventListener("click",()=>{Qr=!1,Tt.hidden=!0,e?e():Ii==null||Ii()});const r=Tt.querySelector("#draw-undo-input");r.addEventListener("keydown",c=>{c.key==="Enter"&&r.value.trim().toLowerCase()==="undo"&&tu()});function s(c){if(c.target.closest(".draw-toolbar, .draw-footer"))return;c.preventDefault(),ks=!0;const l=eu(c.clientX,c.clientY);Nr==="cube"?(Vy(l.x,l.y),io()):Nr==="erase"?(dt.strokeStyle="#ffffff",dt.lineWidth=20,dt.lineCap="round",dt.beginPath(),dt.moveTo(l.x,l.y)):(dt.strokeStyle=no,dt.lineWidth=4,dt.lineCap="round",dt.beginPath(),dt.moveTo(l.x,l.y)),Mt.setPointerCapture(c.pointerId)}function o(c){if(!ks)return;const l=eu(c.clientX,c.clientY);Nr!=="cube"&&(dt.lineTo(l.x,l.y),dt.stroke())}function a(c){if(ks){ks=!1,io();try{Mt.releasePointerCapture(c.pointerId)}catch{}}}return Mt.addEventListener("pointerdown",s),Mt.addEventListener("pointermove",o),Mt.addEventListener("pointerup",a),Mt.addEventListener("pointercancel",a),window.addEventListener("resize",()=>{Qr&&jh()}),Tt.hidden=!0,Tt}const da="ccwd-build";function Yy(){const n=location.hostname;if(n==="localhost"||n==="127.0.0.1")return;const e=async()=>{try{const t=await fetch(`./version.json?_=${Date.now()}`,{cache:"no-store"});if(!t.ok)return;const{v:i}=await t.json();if(!i)return;const r=localStorage.getItem(da);if(r&&r!==i){localStorage.setItem(da,i),location.reload();return}r||localStorage.setItem(da,i)}catch{}};e(),setInterval(e,180*1e3)}Yy();const qy="car crashing with dashing",jy=5,iu=7,Zy=.05,Ky=new URLSearchParams(window.location.search).has("teleport"),{canvas:Vt,ctx:Te}=of();Vt.id="title-canvas";Vt.style.position="fixed";Vt.style.inset="0";Vt.style.zIndex="1";const hn=new cf(document.body),Sn=Rf();Sn.onExit(()=>Jh());const vt=qv(),Je=Qu(0,0);Jv(vt.scene,Je);const ro=Hy(vt.scene);let xn=Xy()?"drawPaper":"title",Fr=Ky?1.8:0,Os=0,Bs=0,ua=0,$r=!1,Yr=!1,zs=!1,bc=0,un=null,Kh=!1,ha=0,sr=1,fa=!1,pa=!1,ma=!1,it=null,In=!1,dr=0,ru=0,Wr=0,il=[],su=!1,ou={},Xr=0;const qr=document.getElementById("action-toast"),li=document.getElementById("controls-hud"),es=document.getElementById("damage-hud"),Ri=document.getElementById("room-banner");pu(()=>ho(li,{driving:In}));Qv(eM);$y(()=>au(),()=>au(!0));function au(n=!1){xn="title",Vt.style.display="block",Zh(),n&&$h()}xn==="drawPaper"&&(Vt.style.display="none",Wy());zy(({room:n,isHost:e})=>{un=n,Kh=e,Je.x=0,Je.z=0,_r(Je),Jy(n),xn="world",Qh(),so(),yo("You're in the game!")});function Jy(n){n.onMessage=(e,t)=>{e.t==="pose"&&e.id&&e.id!==n.id&&(n.role==="host"&&n.relay(t,e),ro.applyPose(e.id,e)),e.t==="join"&&e.id&&(ro.applyPose(e.id,{x:0,z:4,facing:0,walkPhase:0,isMoving:!1}),sr+=1,so(),yo("Someone joined!")),e.t==="leave"&&e.id&&(ro.remove(e.id),sr=Math.max(1,sr-1),so())},n.onPeerCount=e=>{sr=e,so()}}function so(){if(!(!Ri||!(un!=null&&un.code)))if(Kh){const n=Xh(un.code);Ri.innerHTML=`Room <strong>${un.code}</strong> · ${sr} player(s) · <a href="${n}" target="_blank" rel="noopener">Share link</a>`,Ri.hidden=!1}else Ri.textContent=`Room ${un.code} · ${sr} player(s)`,Ri.hidden=!1}function Qy(){un!=null&&un.id&&un.send({t:"pose",id:un.id,x:Je.x,z:Je.z,facing:Je.facing,walkPhase:Je.walkPhase,isMoving:Je.isMoving})}function eM(n){it&&(Qx(vt.scene,it),it=null,In=!1,Je.inVehicle=null,Je.mesh.visible=!0),it=ay(Je,n,vt.clampPosition,vt.envTex),Jx(vt.scene,it),In=!0,Sn.setDriving(!0),ey(Je,it),ho(li,{driving:!0}),gu(es,!0),Pc(es,it)}function tM(n){if(!(!it||dr>0))if(zx(it,vt.scene,n,il),Pc(es,it),qc(n)){sy(it,n);const e=Math.abs(n)>=38;Wr=e?.5:.22,dr=e?.55:.4}else Math.abs(n)>5&&(it.speed*=.55,dr=.12)}function Jh(){!it||!In||(ty(Je,it),In=!1,Sn.setDriving(!1),_r(Je),vt.updateCamera(Je.x,Je.z,Je.facing),ho(li,{driving:!1}),gu(es,!1),yo("Exited vehicle"))}function nM(){return ff(hn)}function cu(n,e){return{throttle:Math.max(n.throttle??0,e.throttle??0),brake:Math.max(n.brake??0,e.brake??0),reverse:Math.max(n.reverse??0,e.reverse??0),steer:Math.abs(n.steer)>Math.abs(e.steer)?n.steer:e.steer}}function lu(n){var i,r;if(!n||xn!=="world"||ga()||lc())return;const{fired:e,prevPressed:t}=mf(n,Ac(),ou);ou=t;for(const s of e)yo(s.action);(i=n.buttons[9])!=null&&i.pressed&&!fa&&(fa=!0,mu()),(r=n==null?void 0:n.buttons[9])!=null&&r.pressed||(fa=!1)}function iM(n,e){const t=Math.max(0,Math.min(1,(e-n.topY)/(n.bottomY-n.topY)));return n.topW*2+(n.bottomW-n.topW*2)*t}function rM(n,e,t){const i=e*.56,r=iM(t,i),s=Math.min(r*.82,n*.78,420),o=s*.34;return{x:t.cx-s/2,y:i-o/2,w:s,h:o,cx:t.cx,cy:i}}function sM(n){const t=n.h*.72,i=n.w*.92,r=n.cy+n.h/2+14+t/2;return{x:n.cx-i/2,y:r-t/2,w:i,h:t,cx:n.cx,cy:r}}function oM(n,e){const t=Vt.getBoundingClientRect(),i=Vt.width/t.width,r=Vt.height/t.height;return{x:(n-t.left)*i,y:(e-t.top)*r}}function du(n,e,t){return n>=t.x&&n<=t.x+t.w&&e>=t.y&&e<=t.y+t.h}function uu(n,e,t,i,r,s){const o=1+Math.sin(i)*.04+(r?.05:0)+(s?-.03:0),a=n.w*o,c=n.h*o,l=n.cx-a/2,d=n.cy-c/2,u=c*.28;Te.save(),Te.shadowColor="rgba(0,0,0,0.45)",Te.shadowBlur=24,Te.shadowOffsetY=8;const h=Te.createLinearGradient(l,d,l,d+c);h.addColorStop(0,s?t.pressedTop:t.top),h.addColorStop(1,s?t.pressedBottom:t.bottom),Te.fillStyle=h,Te.beginPath(),Te.roundRect(l,d,a,c,u),Te.fill(),Te.shadowBlur=0,Te.shadowOffsetY=0,Te.strokeStyle=t.stroke,Te.lineWidth=5,Te.stroke(),Hs(Te,e,n.cx,n.cy,{size:Math.floor(c*.38),color:t.text}),Te.restore()}function aM(){xn="comingSoon",bc=jy,Je.x=0,Je.z=0,_r(Je),Qh()}function cM(n,e){const t=oM(hn.pointer.x,hn.pointer.y);$r=du(t.x,t.y,n),Yr=du(t.x,t.y,e),Vt.style.cursor=$r||Yr?"pointer":"default",hn.pointer.down&&!zs&&($r?(aM(),zs=!0):Yr&&($h(),zs=!0)),hn.pointer.down||(zs=!1)}function hu(n,e,t=1){const i=n/2,r=e*.42,s=e,o=n*.08*t,a=n*.92;return{cx:i,topY:r,bottomY:s,topW:o,bottomW:a}}function lM(n,e,t){if(t<=0)return hu(n,e,t);const i=hu(n,e,t),{cx:r,topY:s,bottomY:o,topW:a,bottomW:c}=i;Te.save(),Te.globalAlpha=Math.min(1,t);const l=Te.createLinearGradient(0,s,0,o);return l.addColorStop(0,"#334155"),l.addColorStop(1,"#1e293b"),Te.fillStyle=l,Te.beginPath(),Te.moveTo(r-a,s),Te.lineTo(r+a,s),Te.lineTo(r+c/2,o),Te.lineTo(r-c/2,o),Te.closePath(),Te.fill(),Te.strokeStyle="rgba(250,204,21,0.85)",Te.lineWidth=3,Te.setLineDash([18,16]),Te.beginPath(),Te.moveTo(r,s),Te.lineTo(r,o),Te.stroke(),Te.setLineDash([]),Te.fillStyle="rgba(15,23,42,0.35)",Te.fillRect(0,e*.72,n,e*.28),Te.restore(),i}function yo(n){Xr=2,qr&&(qr.textContent=n,qr.classList.add("show"))}function Qh(){Vt.style.display="none",vt.show(),su||(Nv(vt.renderer.domElement),su=!0),nr(!0),eh(),Sn.setVisible(!0),Sn.setDriving(In),Or(li,!0,{driving:In})}function dM(n){const e=df();let{mx:t,mz:i}=uf(e);const r=hf(hn),s=Sn.readMove();t+=r.mx+s.mx,i+=r.mz+s.mz;const o=Math.hypot(t,i);if(o>1&&(t/=o,i/=o),dr>0&&(dr=Math.max(0,dr-n)),Wr>0&&(Wr=Math.max(0,Wr-n*2.8)),ru+=n,In&&it){const d=pf(e),u=nM(),h=Sn.readDrive(),p=cu(cu(d,u),h),{impactSpeed:g,wallHit:_}=oy(it,p,n,vt.clampPosition);if(vt.city.checkCarCollision(it.x,it.z)||_){const f=g;tM(f),qc(f)||(it.x=it.prevX,it.z=it.prevZ),ih(it)}ry(it,ru,n),nh(il,n),Pc(es,it),vt.updateWorld(it.x,it.z),vt.updateDrivingCamera(it.x,it.z,it.rotY,Wr),lu(e),hn.isPressed("e")&&!ma&&(ma=!0,Jh()),hn.isPressed("e")||(ma=!1);return}Kv(Je,t,i,n);const a=Je.x+t*iu*n,c=Je.z+i*iu*n,l=vt.clampPosition(a,c);Je.x=l.x,Je.z=l.z,_r(Je),vt.updateWorld(Je.x,Je.z),vt.updateCamera(Je.x,Je.z,Je.facing),ro.lerpAll(n),ha+=n,ha>=Zy&&(ha=0,Qy()),lu(e),hn.isPressed("m")&&!pa&&(pa=!0,mu()),hn.isPressed("m")||(pa=!1)}function uM(n){const{width:e,height:t}=Vt;if(!((ga()||lc()||Kd()||nu())&&(Or(li,!1),ga()||nu()))){if(Xr>0&&(Xr=Math.max(0,Xr-n),Xr===0&&qr&&qr.classList.remove("show")),Fr>0){Fr=Math.max(0,Fr-n);const i=Fr>.35?1-(1.8-Fr)/1.45:0;Vt.style.display="block",vt.hide(),nr(!1),Sn.setVisible(!1),hl(Te,i>.2?"#e0f2fe":"#22c55e"),i>.05&&(Te.fillStyle=`rgba(255,255,255,${i*.75})`,Te.fillRect(0,0,e,t)),Hs(Te,"TELEPORTING...",e/2,t*.38,{color:"#0f172a",size:36});return}if(xn==="drawPaper"){Vt.style.display="none",vt.hide(),nr(!1),Sn.setVisible(!1);return}if(xn==="title"){Vt.style.display="block",vt.hide(),nr(!1),Sn.setVisible(!1),Or(li,!1),Ri&&(Ri.hidden=!0),Os=Math.min(1,Os+n*1.2),Bs=Math.min(1,Bs+n*.55),ua+=n*4,hl(Te,"#22c55e");const i=lM(e,t,Bs),r=rM(e,t,i),s=sM(r);if(Te.globalAlpha=Os,Hs(Te,qy,e/2,t*.22,{color:"#14532d",size:44}),Hs(Te,"The best game ever — realism incoming.",e/2,t*.3,{color:"#166534",size:18}),Te.globalAlpha=1,!Kd()){cM(r,s);const o=Math.min(1,.35+Bs*.65)*Os;Te.globalAlpha=o,uu(r,"PLAY",{top:"#fde047",bottom:"#facc15",pressedTop:"#facc15",pressedBottom:"#eab308",stroke:"#854d0e",text:"#422006"},ua,$r,hn.pointer.down&&$r),uu(s,"MULTIPLAYER",{top:"#4ade80",bottom:"#22c55e",pressedTop:"#22c55e",pressedBottom:"#16a34a",stroke:"#14532d",text:"#14532d"},ua+.5,Yr,hn.pointer.down&&Yr),Te.globalAlpha=1}return}(xn==="comingSoon"||xn==="world")&&(vt.renderer.domElement.style.boxShadow="",nh(il,n),lc()||dM(n),xn==="comingSoon"?(bc-=n,bc<=0&&(xn="world"),Or(li,!0,{driving:In}),nr(!0),Sn.setVisible(!1)):(nr(!0),Or(li,!0,{driving:In})),vt.render())}}window.addEventListener("gamepadconnected",()=>{});lf(uM);
