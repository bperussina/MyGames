var um=n=>{throw TypeError(n)};var Xr=(n,e,t)=>e.has(n)?um("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(n):e.set(n,t);function hm(n,e){for(var t=0;t<e.length;t++){const i=e[t];if(typeof i!="string"&&!Array.isArray(i)){for(const r in i)if(r!=="default"&&!(r in n)){const s=Object.getOwnPropertyDescriptor(i,r);s&&Object.defineProperty(n,r,s.get?s:{enumerable:!0,get:()=>i[r]})}}}return Object.freeze(Object.defineProperty(n,Symbol.toStringTag,{value:"Module"}))}(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function t(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerPolicy&&(s.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?s.credentials="include":r.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(r){if(r.ep)return;r.ep=!0;const s=t(r);fetch(r.href,s)}})();function fm(n=document.body){const e=document.createElement("canvas");e.style.display="block",n.appendChild(e);const t=e.getContext("2d");function i(){e.width=window.innerWidth,e.height=window.innerHeight}return i(),window.addEventListener("resize",i),{canvas:e,ctx:t,resize:i}}function Od(n,e="#1a1a2e"){n.fillStyle=e,n.fillRect(0,0,n.canvas.width,n.canvas.height)}const pm=new Set(["arrowup","arrowdown","arrowleft","arrowright"," ","w","a","s","d","x","e","r","l","b"]);class mm{constructor(e=window){this.keys=new Set,this.pointer={x:0,y:0,down:!1},document.addEventListener("keydown",t=>{const i=t.key.toLowerCase();this.keys.add(i),pm.has(i)&&t.preventDefault()}),document.addEventListener("keyup",t=>{this.keys.delete(t.key.toLowerCase())}),e.addEventListener("pointermove",t=>{this.pointer.x=t.clientX,this.pointer.y=t.clientY}),e.addEventListener("pointerdown",t=>{this.pointer.x=t.clientX,this.pointer.y=t.clientY,this.pointer.down=!0,e.focus&&e.focus()}),e.addEventListener("pointerup",()=>{this.pointer.down=!1})}isDown(e){return this.keys.has(e.toLowerCase())}isPressed(...e){return e.some(t=>this.isDown(t))}}function gm(n){let e=0,t=performance.now();function i(r){const s=(r-t)/1e3;t=r,n(s),e=requestAnimationFrame(i)}return e=requestAnimationFrame(i),()=>cancelAnimationFrame(e)}function hc(n,e,t,i,r={}){const{color:s="#ffffff",size:o=24,align:a="center",baseline:c="middle",font:l="sans-serif"}=r;n.fillStyle=s,n.font=`${o}px ${l}`,n.textAlign=a,n.textBaseline=c,n.fillText(e,t,i)}const Fd=.18;function _m(){var e;return(((e=navigator.getGamepads)==null?void 0:e.call(navigator))??[]).find(t=>t==null?void 0:t.connected)??null}function xm(n){var i,r,s,o;let e=0,t=0;if(n){const a=n.axes[0]??0,c=n.axes[1]??0;Math.abs(a)>Fd&&(e+=a),Math.abs(c)>Fd&&(t-=c),(i=n.buttons[14])!=null&&i.pressed&&(e-=1),(r=n.buttons[15])!=null&&r.pressed&&(e+=1),(s=n.buttons[12])!=null&&s.pressed&&(t+=1),(o=n.buttons[13])!=null&&o.pressed&&(t-=1)}return{mx:e,mz:t}}function ym(n){let e=0,t=0;return n.isPressed("w","arrowup")&&(t+=1),n.isPressed("s","arrowdown")&&(t-=1),n.isPressed("a","arrowleft")&&(e-=1),n.isPressed("d","arrowright")&&(e+=1),{mx:e,mz:t}}function vm(n){let e=0,t=0,i=0,r=0;return n.isPressed("w","arrowup")&&(e=1),n.isPressed("s")&&(t=1),n.isPressed("arrowdown")&&(i=1),n.isPressed("a","arrowleft")&&(r-=1),n.isPressed("d","arrowright")&&(r+=1),r=Math.max(-1,Math.min(1,r)),{throttle:e,brake:t,reverse:i,steer:r}}function Sm(n){var a,c,l,u,d,h;let e=0,t=0,i=0;if(!n)return{throttle:e,brake:t,reverse:0,steer:i};(a=n.buttons[2])!=null&&a.pressed&&(e=1),(c=n.buttons[1])!=null&&c.pressed&&(t=1);let r=0,s=0;return(l=n.buttons[4])!=null&&l.pressed&&(r=1),(((u=n.buttons[6])==null?void 0:u.value)??((d=n.buttons[6])!=null&&d.pressed?1:0))>.08&&(r=1),(h=n.buttons[5])!=null&&h.pressed&&(s=1),i=s-r,{throttle:e,brake:t,reverse:0,steer:i}}const Fl=[{id:"a",label:"A",index:0},{id:"b",label:"B",index:1},{id:"x",label:"X",index:2},{id:"y",label:"Y",index:3},{id:"lb",label:"LB",index:4},{id:"rb",label:"RB",index:5},{id:"lt",label:"LT",index:6},{id:"rt",label:"RT",index:7},{id:"view",label:"View",index:8},{id:"menu",label:"Menu",index:9},{id:"ls",label:"Left stick press",index:10},{id:"rs",label:"Right stick press",index:11},{id:"dpadUp",label:"D-pad Up",index:12},{id:"dpadDown",label:"D-pad Down",index:13},{id:"dpadLeft",label:"D-pad Left",index:14},{id:"dpadRight",label:"D-pad Right",index:15},{id:"xbox",label:"Xbox",index:16}];function Mm(n,e,t={}){var s;const i=[];if(!n)return{fired:i,prevPressed:t};const r={...t};for(const o of Fl){const a=!!((s=n.buttons[o.index])!=null&&s.pressed),c=t[o.id]??!1;if(r[o.id]=a,a&&!c){const l=(e[o.id]??"").trim();l&&i.push({id:o.id,action:l})}}return{fired:i,prevPressed:r}}const nf="ccwd-button-labels";function Bl(){try{return JSON.parse(localStorage.getItem(nf)??"{}")}catch{return{}}}function bm(n){try{localStorage.setItem(nf,JSON.stringify(n))}catch{}}let zt=null,os=null;function rf(n){if(os=n,zt)return zt;zt=document.createElement("div"),zt.id="controller-map",zt.innerHTML=`
    <div class="cm-header">
  ...
  `,document.body.appendChild(zt);const e=zt.querySelector("#cm-fields"),t=Bl();for(const i of Fl){const r=document.createElement("div");r.className="cm-row",r.innerHTML=`
      ...
      <input type="text" class="cm-input" data-id="${i.id}" placeholder="(blank = does nothing)" value="${Em(t[i.id]??"")}" />
    `,e.appendChild(r)}return zt.querySelector("#cm-done").addEventListener("click",()=>{const i={};zt.querySelectorAll(".cm-input").forEach(r=>{i[r.dataset.id]=r.value}),bm(i),Tm(),os==null||os()}),zt}function Em(n){return String(n).replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;")}function sf(){rf(os),zt.style.display="flex"}function Tm(){zt&&(zt.style.display="none")}function fc(){return(zt==null?void 0:zt.style.display)==="flex"}const wm={x:"Gas",b:"Brake",lb:"Turn left",lt:"Turn left",rb:"Turn right",menu:"Change controls"},Cm={a:"chip-a",b:"chip-b",x:"chip-x",y:"chip-y",lb:"chip-bump",rb:"chip-bump",lt:"chip-trigger",rt:"chip-trigger",view:"chip-misc",menu:"chip-misc",ls:"chip-misc",rs:"chip-misc",dpadUp:"chip-dpad",dpadDown:"chip-dpad",dpadLeft:"chip-dpad",dpadRight:"chip-dpad",xbox:"chip-misc"};function Ui(n){return String(n).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/"/g,"&quot;")}function Am(n,e){const t=(n[e]??"").trim();return t||(wm[e]??"").trim()}function Rm(n,e){return`<span class="pc-key" title="${Ui(e)}"><span class="pc-key-letter">${Ui(n)}</span><span class="pc-key-word">${Ui(e)}</span></span>`}function Pm(n,e){return`<span class="pad-chip ${Cm[n.id]??"chip-misc"}" title="${Ui(n.label)} button — ${Ui(e)}"><span class="pad-chip-mark">${Ui(n.label)}</span><span class="pad-chip-word">${Ui(e)}</span></span>`}function qo(n,{driving:e=!1}={}){if(!n)return;const t=n.querySelector("#controls-body");if(!t)return;const i=Bl(),r=e?[{key:"W",word:"Gas"},{key:"↑",word:"Gas"},{key:"S",word:"Brake"},{key:"↓",word:"Reverse"},{key:"A",word:"Left"},{key:"←",word:"Left"},{key:"D",word:"Right"},{key:"→",word:"Right"},{key:"E",word:"Exit car"}]:[{key:"W",word:"Forward"},{key:"↑",word:"Forward"},{key:"A",word:"Left"},{key:"←",word:"Left"},{key:"S",word:"Back"},{key:"↓",word:"Back"},{key:"D",word:"Right"},{key:"→",word:"Right"}],s=['<span class="pad-chip chip-stick" title="Left stick — move"><span class="pad-chip-mark">Stick</span><span class="pad-chip-word">Move</span></span>'];for(const o of Fl){const a=Am(i,o.id);a&&s.push(Pm(o,a))}t.innerHTML=`
    ...
    <div class="controls-mini-block">
      ...
      <div class="pc-keys">${r.map(({key:o,word:a})=>Rm(o,a)).join("")}</div>
    </div>
    <div class="controls-mini-block">
...
void main() {
	...
	`}function Ix(n){let e=new WeakMap,t=null;function i(a){if(a&&a.isTexture){const c=a.mapping,l=c===bc||c===Ec,u=c===Lr||c===Dr;if(l||u){let d=e.get(a);const h=d!==void 0?d.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==h)return t===null&&(t=new tl(n)),d=l?t.fromEquirectangular(a,d):t.fromCubemap(a,d),d.texture.pmremVersion=a.pmremVersion,e.set(a,d),d.texture;if(d!==void 0)return d.texture;{const p=a.image;return l&&p&&p.height>0||u&&p&&r(p)?(t===null&&(t=new tl(n)),d=l?t.fromEquirectangular(a):t.fromCubemap(a),d.texture.pmremVersion=a.pmremVersion,e.set(a,d),a.addEventListener("dispose",s),d.texture):null}}}return a}function r(a){let c=0;const l=6;for(let u=0;u<l;u++)a[u]!==void 0&&c++;return c===l}function s(a){const c=a.target;c.removeEventListener("dispose",s);const l=e.get(c);l!==void 0&&(e.delete(c),l.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:i,dispose:o}}function Ux(n){const e={};function t(i){if(e[i]!==void 0)return e[i];let r;switch(i){case"WEBGL_depth_texture":r=n.getExtension("WEBGL_depth_texture")||n.getExtension("MOZ_WEBGL_depth_texture")||n.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=n.getExtension("EXT_texture_filter_anisotropic")||n.getExtension("MOZ_EXT_texture_filter_anisotropic")||n.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=n.getExtension("WEBGL_compressed_texture_s3tc")||n.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=n.getExtension("WEBGL_compressed_texture_pvrtc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=n.getExtension(i)}return e[i]=r,r}return{has:function(i){return t(i)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(i){const r=t(i);return r===null&&as("THREE.WebGLRenderer: "+i+" extension not supported."),r}}}function Nx(n,e,t,i){const r={},s=new WeakMap;function o(d){const h=d.target;h.index!==null&&e.remove(h.index);for(const g in h.attributes)e.remove(h.attributes[g]);for(const g in h.morphAttributes){const _=h.morphAttributes[g];for(let m=0,f=_.length;m<f;m++)e.remove(_[m])}h.removeEventListener("dispose",o),delete r[h.id];const p=s.get(h);p&&(e.remove(p),s.delete(h)),i.releaseStatesOfGeometry(h),h.isInstancedBufferGeometry===!0&&delete h._maxInstanceCount,t.memory.geometries--}function a(d,h){return r[h.id]===!0||(h.addEventListener("dispose",o),r[h.id]=!0,t.memory.geometries++),h}function c(d){const h=d.attributes;for(const g in h)e.update(h[g],n.ARRAY_BUFFER);const p=d.morphAttributes;for(const g in p){const _=p[g];for(let m=0,f=_.length;m<f;m++)e.update(_[m],n.ARRAY_BUFFER)}}function l(d){const h=[],p=d.index,g=d.attributes.position;let _=0;if(p!==null){const S=p.array;_=p.version;for(let T=0,x=S.length;T<x;T+=3){const P=S[T+0],b=S[T+1],w=S[T+2];h.push(P,b,b,w,w,P)}}else if(g!==void 0){const S=g.array;_=g.version;for(let T=0,x=S.length/3-1;T<x;T+=3){const P=T+0,b=T+1,w=T+2;h.push(P,b,b,w,w,P)}}else return;const m=new(Sf(h)?wf:Tf)(h,1);m.version=_;const f=s.get(d);f&&e.remove(f),s.set(d,m)}function u(d){const h=s.get(d);if(h){const p=d.index;p!==null&&h.version<p.version&&l(d)}else l(d);return s.get(d)}return{get:a,update:c,getWireframeAttribute:u}}function kx(n,e,t){let i;function r(h){i=h}let s,o;function a(h){s=h.type,o=h.bytesPerElement}function c(h,p){n.drawElements(i,p,s,h*o),t.update(p,i,1)}function l(h,p,g){g!==0&&(n.drawElementsInstanced(i,p,s,h*o,g),t.update(p,i,g))}function u(h,p,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,p,0,s,h,0,g);let m=0;for(let f=0;f<g;f++)m+=p[f];t.update(m,i,1)}function d(h,p,g,_){if(g===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let f=0;f<h.length;f++)l(h[f]/o,p[f],_[f]);else{m.multiDrawElementsInstancedWEBGL(i,p,0,s,h,0,_,0,g);let f=0;for(let S=0;S<g;S++)f+=p[S]*_[S];t.update(f,i,1)}}this.setMode=r,this.setIndex=a,this.render=c,this.renderInstances=l,this.renderMultiDraw=u,this.renderMultiDrawInstances=d}function Ox(n){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function i(s,o,a){switch(t.calls++,o){case n.TRIANGLES:t.triangles+=a*(s/3);break;case n.LINES:t.lines+=a*(s/2);break;case n.LINE_STRIP:t.lines+=a*(s-1);break;case n.LINE_LOOP:t.lines+=a*s;break;case n.POINTS:t.points+=a*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:i}}function Fx(n,e,t){const i=new WeakMap,r=new lt;function s(o,a,c){const l=o.morphTargetInfluences,u=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,d=u!==void 0?u.length:0;let h=i.get(a);if(h===void 0||h.count!==d){let v=function(){C.dispose(),i.delete(a),a.removeEventListener("dispose",v)};var p=v;h!==void 0&&h.texture.dispose();const g=a.morphAttributes.position!==void 0,_=a.morphAttributes.normal!==void 0,m=a.morphAttributes.color!==void 0,f=a.morphAttributes.position||[],S=a.morphAttributes.normal||[],T=a.morphAttributes.color||[];let x=0;g===!0&&(x=1),_===!0&&(x=2),m===!0&&(x=3);let P=a.attributes.position.count*x,b=1;P>e.maxTextureSize&&(b=Math.ceil(P/e.maxTextureSize),P=e.maxTextureSize);const w=new Float32Array(P*b*4*d),C=new bf(w,P,b,d);C.type=Vn,C.needsUpdate=!0;const y=x*4;for(let R=0;R<d;R++){const B=f[R],F=S[R],k=T[R],H=P*b*4*R;for(let O=0;O<B.count;O++){const $=O*y;g===!0&&(r.fromBufferAttribute(B,O),w[H+$+0]=r.x,w[H+$+1]=r.y,w[H+$+2]=r.z,w[H+$+3]=0),_===!0&&(r.fromBufferAttribute(F,O),w[H+$+4]=r.x,w[H+$+5]=r.y,w[H+$+6]=r.z,w[H+$+7]=0),m===!0&&(r.fromBufferAttribute(k,O),w[H+$+8]=r.x,w[H+$+9]=r.y,w[H+$+10]=r.z,w[H+$+11]=k.itemSize===4?r.w:1)}}h={count:d,texture:C,size:new Ue(P,b)},i.set(a,h),a.addEventListener("dispose",v)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)c.getUniforms().setValue(n,"morphTexture",o.morphTexture,t);else{let g=0;for(let m=0;m<l.length;m++)g+=l[m];const _=a.morphTargetsRelative?1:1-g;c.getUniforms().setValue(n,"morphTargetBaseInfluence",_),c.getUniforms().setValue(n,"morphTargetInfluences",l)}c.getUniforms().setValue(n,"morphTargetsTexture",h.texture,t),c.getUniforms().setValue(n,"morphTargetsTextureSize",h.size)}return{update:s}}function Bx(n,e,t,i){let r=new WeakMap;function s(c){const l=i.render.frame,u=c.geometry,d=e.get(c,u);if(r.get(d)!==l&&(e.update(d),r.set(d,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",a)===!1&&c.addEventListener("dispose",a),r.get(c)!==l&&(t.update(c.instanceMatrix,n.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,n.ARRAY_BUFFER),r.set(c,l))),c.isSkinnedMesh){const h=c.skeleton;r.get(h)!==l&&(h.update(),r.set(h,l))}return d}function o(){r=new WeakMap}function a(c){const l=c.target;l.removeEventListener("dispose",a),t.remove(l.instanceMatrix),l.instanceColor!==null&&t.remove(l.instanceColor)}return{update:s,dispose:o}}class Df extends Yt{constructor(e,t,i,r,s,o,a,c,l,u=Tr){if(u!==Tr&&u!==Ur)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");i===void 0&&u===Tr&&(i=zi),i===void 0&&u===Ur&&(i=Ir),super(null,r,s,o,a,c,u,i,l),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=a!==void 0?a:En,this.minFilter=c!==void 0?c:En,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const If=new Yt,_u=new Df(1,1),Uf=new bf,Nf=new T0,kf=new Rf,xu=[],yu=[],vu=new Float32Array(16),Su=new Float32Array(9),Mu=new Float32Array(4);function Gr(n,e,t){const i=n[0];if(i<=0||i>0)return n;const r=e*t;let s=xu[r];if(s===void 0&&(s=new Float32Array(r),xu[r]=s),e!==0){i.toArray(s,0);for(let o=1,a=0;o!==e;++o)a+=t,n[o].toArray(s,a)}return s}function Lt(n,e){if(n.length!==e.length)return!1;for(let t=0,i=n.length;t<i;t++)if(n[t]!==e[t])return!1;return!0}function Dt(n,e){for(let t=0,i=e.length;t<i;t++)n[t]=e[t]}function Qo(n,e){let t=yu[e];t===void 0&&(t=new Int32Array(e),yu[e]=t);for(let i=0;i!==e;++i)t[i]=n.allocateTextureUnit();return t}function zx(n,e){const t=this.cache;t[0]!==e&&(n.uniform1f(this.addr,e),t[0]=e)}function Hx(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Lt(t,e))return;n.uniform2fv(this.addr,e),Dt(t,e)}}function Gx(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(n.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(Lt(t,e))return;n.uniform3fv(this.addr,e),Dt(t,e)}}function Vx(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Lt(t,e))return;n.uniform4fv(this.addr,e),Dt(t,e)}}function Wx(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(Lt(t,e))return;n.uniformMatrix2fv(this.addr,!1,e),Dt(t,e)}else{if(Lt(t,i))return;Mu.set(i),n.uniformMatrix2fv(this.addr,!1,Mu),Dt(t,i)}}function Xx(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(Lt(t,e))return;n.uniformMatrix3fv(this.addr,!1,e),Dt(t,e)}else{if(Lt(t,i))return;Su.set(i),n.uniformMatrix3fv(this.addr,!1,Su),Dt(t,i)}}function $x(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(Lt(t,e))return;n.uniformMatrix4fv(this.addr,!1,e),Dt(t,e)}else{if(Lt(t,i))return;vu.set(i),n.uniformMatrix4fv(this.addr,!1,vu),Dt(t,i)}}function Yx(n,e){const t=this.cache;t[0]!==e&&(n.uniform1i(this.addr,e),t[0]=e)}function qx(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Lt(t,e))return;n.uniform2iv(this.addr,e),Dt(t,e)}}function jx(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Lt(t,e))return;n.uniform3iv(this.addr,e),Dt(t,e)}}function Zx(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Lt(t,e))return;n.uniform4iv(this.addr,e),Dt(t,e)}}function Kx(n,e){const t=this.cache;t[0]!==e&&(n.uniform1ui(this.addr,e),t[0]=e)}function Jx(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Lt(t,e))return;n.uniform2uiv(this.addr,e),Dt(t,e)}}function Qx(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Lt(t,e))return;n.uniform3uiv(this.addr,e),Dt(t,e)}}function ey(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Lt(t,e))return;n.uniform4uiv(this.addr,e),Dt(t,e)}}function ty(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r);let s;this.type===n.SAMPLER_2D_SHADOW?(_u.compareFunction=vf,s=_u):s=If,t.setTexture2D(e||s,r)}function ny(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture3D(e||Nf,r)}function iy(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTextureCube(e||kf,r)}function ry(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture2DArray(e||Uf,r)}function sy(n){switch(n){case 5126:return zx;case 35664:return Hx;case 35665:return Gx;case 35666:return Vx;case 35674:return Wx;case 35675:return Xx;case 35676:return $x;case 5124:case 35670:return Yx;case 35667:case 35671:return qx;case 35668:case 35672:return jx;case 35669:case 35673:return Zx;case 5125:return Kx;case 36294:return Jx;case 36295:return Qx;case 36296:return ey;case 35678:case 36198:case 36298:case 36306:case 35682:return ty;case 35679:case 36299:case 36307:return ny;case 35680:case 36300:case 36308:case 36293:return iy;case 36289:case 36303:case 36311:case 36292:return ry}}function oy(n,e){n.uniform1fv(this.addr,e)}function ay(n,e){const t=Gr(e,this.size,2);n.uniform2fv(this.addr,t)}function cy(n,e){const t=Gr(e,this.size,3);n.uniform3fv(this.addr,t)}function ly(n,e){const t=Gr(e,this.size,4);n.uniform4fv(this.addr,t)}function dy(n,e){const t=Gr(e,this.size,4);n.uniformMatrix2fv(this.addr,!1,t)}function uy(n,e){const t=Gr(e,this.size,9);n.uniformMatrix3fv(this.addr,!1,t)}function hy(n,e){const t=Gr(e,this.size,16);n.uniformMatrix4fv(this.addr,!1,t)}function fy(n,e){n.uniform1iv(this.addr,e)}function py(n,e){n.uniform2iv(this.addr,e)}function my(n,e){n.uniform3iv(this.addr,e)}function gy(n,e){n.uniform4iv(this.addr,e)}function _y(n,e){n.uniform1uiv(this.addr,e)}function xy(n,e){n.uniform2uiv(this.addr,e)}function yy(n,e){n.uniform3uiv(this.addr,e)}function vy(n,e){n.uniform4uiv(this.addr,e)}function Sy(n,e,t){const i=this.cache,r=e.length,s=Qo(t,r);Lt(i,s)||(n.uniform1iv(this.addr,s),Dt(i,s));for(let o=0;o!==r;++o)t.setTexture2D(e[o]||If,s[o])}function My(n,e,t){const i=this.cache,r=e.length,s=Qo(t,r);Lt(i,s)||(n.uniform1iv(this.addr,s),Dt(i,s));for(let o=0;o!==r;++o)t.setTexture3D(e[o]||Nf,s[o])}function by(n,e,t){const i=this.cache,r=e.length,s=Qo(t,r);Lt(i,s)||(n.uniform1iv(this.addr,s),Dt(i,s));for(let o=0;o!==r;++o)t.setTextureCube(e[o]||kf,s[o])}function Ey(n,e,t){const i=this.cache,r=e.length,s=Qo(t,r);Lt(i,s)||(n.uniform1iv(this.addr,s),Dt(i,s));for(let o=0;o!==r;++o)t.setTexture2DArray(e[o]||Uf,s[o])}function Ty(n){switch(n){case 5126:return oy;case 35664:return ay;case 35665:return cy;case 35666:return ly;case 35674:return dy;case 35675:return uy;case 35676:return hy;case 5124:case 35670:return fy;case 35667:case 35671:return py;case 35668:case 35672:return my;case 35669:case 35673:return gy;case 5125:return _y;case 36294:return xy;case 36295:return yy;case 36296:return vy;case 35678:case 36198:case 36298:case 36306:case 35682:return Sy;case 35679:case 36299:case 36307:return My;case 35680:case 36300:case 36308:case 36293:return by;case 36289:case 36303:case 36311:case 36292:return Ey}}class wy{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.setValue=sy(t.type)}}class Cy{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Ty(t.type)}}class Ay{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,i){const r=this.seq;for(let s=0,o=r.length;s!==o;++s){const a=r[s];a.setValue(e,t[a.id],i)}}}const Na=/(\w+)(\])?(\[|\.)?/g;function bu(n,e){n.seq.push(e),n.map[e.id]=e}function Ry(n,e,t){const i=n.name,r=i.length;for(Na.lastIndex=0;;){const s=Na.exec(i),o=Na.lastIndex;let a=s[1];const c=s[2]==="]",l=s[3];if(c&&(a=a|0),l===void 0||l==="["&&o+2===r){bu(t,l===void 0?new wy(a,n,e):new Cy(a,n,e));break}else{let d=t.map[a];d===void 0&&(d=new Ay(a),bu(t,d)),t=d}}}class So{constructor(e,t){this.seq=[],this.map={};const i=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<i;++r){const s=e.getActiveUniform(t,r),o=e.getUniformLocation(t,s.name);Ry(s,o,this)}}setValue(e,t,i,r){const s=this.map[t];s!==void 0&&s.setValue(e,i,r)}setOptional(e,t,i){const r=t[i];r!==void 0&&this.setValue(e,i,r)}static upload(e,t,i,r){for(let s=0,o=t.length;s!==o;++s){const a=t[s],c=i[a.id];c.needsUpdate!==!1&&a.setValue(e,c.value,r)}}static seqWithValue(e,t){const i=[];for(let r=0,s=e.length;r!==s;++r){const o=e[r];o.id in t&&i.push(o)}return i}}function Eu(n,e,t){const i=n.createShader(e);return n.shaderSource(i,t),n.compileShader(i),i}const Py=37297;let Ly=0;function Dy(n,e){const t=n.split(`
`),i=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let o=r;o<s;o++){const a=o+1;i.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return i.join(`
`)}const Tu=new Fe;function Iy(n){Ke._getMatrix(Tu,Ke.workingColorSpace,n);const e=`mat3( ${Tu.elements.map(t=>t.toFixed(4))} )`;switch(Ke.getTransfer(n)){case Zo:return[e,"LinearTransferOETF"];case at:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",n),[e,"LinearTransferOETF"]}}function wu(n,e,t){const i=n.getShaderParameter(e,n.COMPILE_STATUS),r=n.getShaderInfoLog(e).trim();if(i&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const o=parseInt(s[1]);return t.toUpperCase()+`

`+r+`

`+Dy(n.getShaderSource(e),o)}else return r}function Uy(n,e){const t=Iy(e);return[`vec4 ${n}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}function Ny(n,e){let t;switch(e){case cf:t="Linear";break;case Qm:t="Reinhard";break;case e0:t="Cineon";break;case t0:t="ACESFilmic";break;case i0:t="AgX";break;case r0:t="Neutral";break;case n0:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const $s=new L;function ky(){Ke.getLuminanceCoefficients($s);const n=$s.x.toFixed(4),e=$s.y.toFixed(4),t=$s.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function Oy(n){return[n.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",n.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(cs).join(`
`)}function Fy(n){const e=[];for(const t in n){const i=n[t];i!==!1&&e.push("#define "+t+" "+i)}return e.join(`
`)}function By(n,e){const t={},i=n.getProgramParameter(e,n.ACTIVE_ATTRIBUTES);for(let r=0;r<i;r++){const s=n.getActiveAttrib(e,r),o=s.name;let a=1;s.type===n.FLOAT_MAT2&&(a=2),s.type===n.FLOAT_MAT3&&(a=3),s.type===n.FLOAT_MAT4&&(a=4),t[o]={type:s.type,location:n.getAttribLocation(e,o),locationSize:a}}return t}function cs(n){return n!==""}function Cu(n,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return n.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Au(n,e){return n.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const zy=/^[ \t]*#include +<([\w\d./]+)>/gm;function nl(n){return n.replace(zy,Gy)}const Hy=new Map;function Gy(n,e){let t=He[e];if(t===void 0){const i=Hy.get(e);if(i!==void 0)t=He[i],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,i);else throw new Error("Can not resolve #include <"+e+">")}return nl(t)}const Vy=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Ru(n){return n.replace(Vy,Wy)}function Wy(n,e,t,i){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=i.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function Pu(n){let e=`precision ${n.precision} float;
...
#define LOW_PRECISION`),e}function Xy(n){let e="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===of?e="SHADOWMAP_TYPE_PCF":n.shadowMapType===af?e="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===zn&&(e="SHADOWMAP_TYPE_VSM"),e}function $y(n){let e="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case Lr:case Dr:e="ENVMAP_TYPE_CUBE";break;case jo:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Yy(n){let e="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case Dr:e="ENVMAP_MODE_REFRACTION";break}return e}function qy(n){let e="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case Hl:e="ENVMAP_BLENDING_MULTIPLY";break;case Km:e="ENVMAP_BLENDING_MIX";break;case Jm:e="ENVMAP_BLENDING_ADD";break}return e}function jy(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:i,maxMip:t}}function Zy(n,e,t,i){const r=n.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const c=Xy(t),l=$y(t),u=Yy(t),d=qy(t),h=jy(t),p=Oy(t),g=Fy(s),_=r.createProgram();let m,f,S=t.glslVersion?"#version "+t.glslVersion+`
...
void main() {
    ...
    <p class="dmg-width">${r.toFixed(2)}m wide · ${Wv(r,e)}</p>
    ${ts("Engine",t.engine)}
    ${ts("Body",t.body)}
    ${ts("Hood",t.hood)}
    ${ts("Glass",t.windshield)}
    ${ts("Wheels",i)}
  `}function na(n,e){n&&(e?n.removeAttribute("hidden"):n.setAttribute("hidden",""))}function $v(){return matchMedia("(pointer: coarse)").matches||"ontouchstart"in window}const Yv=()=>({mx:0,mz:0}),qv=()=>({throttle:0,brake:0,reverse:0,steer:0});function jv(){if(!$v())return{readMove:Yv,readDrive:qv,setDriving:()=>{},setVisible:()=>{},onExit:()=>{}};const n=document.createElement("div");n.id="touch-pad",n.innerHTML=`
...
`);n.RTCSessionDescription&&r instanceof n.RTCSessionDescription?arguments[0]=new n.RTCSessionDescription({type:r.type,sdp:s}):r.sdp=s}return t.apply(this,arguments)}}function Co(n,e){if(!(n.RTCPeerConnection&&n.RTCPeerConnection.prototype))return;const t=n.RTCPeerConnection.prototype.addIceCandidate;!t||t.length===0||(n.RTCPeerConnection.prototype.addIceCandidate=function(){return arguments[0]?(e.browser==="chrome"&&e.version<78||e.browser==="firefox"&&e.version<68||e.browser==="safari")&&arguments[0]&&arguments[0].candidate===""?Promise.resolve():t.apply(this,arguments):(arguments[1]&&arguments[1].apply(null),Promise.resolve())})}function Ao(n,e){if(!(n.RTCPeerConnection&&n.RTCPeerConnection.prototype))return;const t=n.RTCPeerConnection.prototype.setLocalDescription;!t||t.length===0||(n.RTCPeerConnection.prototype.setLocalDescription=function(){let r=arguments[0]||{};if(typeof r!="object"||r.type&&r.sdp)return t.apply(this,arguments);if(r={type:r.type,sdp:r.sdp},!r.type)switch(this.signalingState){case"stable":case"have-local-offer":case"have-remote-pranswer":r.type="offer";break;default:r.type="answer";break}return r.sdp||r.type!=="offer"&&r.type!=="answer"?t.apply(this,[r]):(r.type==="offer"?this.createOffer:this.createAnswer).apply(this).then(o=>t.apply(this,[o]))})}const OM=Object.freeze(Object.defineProperty({__proto__:null,removeExtmapAllowMixed:bl,shimAddIceCandidateNullOrEmpty:Co,shimConnectionState:Ml,shimMaxMessageSize:To,shimParameterlessSetLocalDescription:Ao,shimRTCIceCandidate:Eo,shimRTCIceCandidateRelayProtocol:Sl,shimSendThrowTypeError:wo},Symbol.toStringTag,{value:"Module"}));function FM({window:n}={},e={shimChrome:!0,shimFirefox:!0,shimSafari:!0}){const t=xd,i=DM(n),r={browserDetails:i,commonShim:OM,extractVersion:ls,disableLog:PM,disableWarnings:LM,sdp:kM};switch(i.browser){case"chrome":if(!uh||!yl||!e.shimChrome)return t("Chrome shim is not included in this adapter release."),r;if(i.version===null)return t("Chrome shim can not determine version, not shimming."),r;t("adapter.js shimming chrome."),r.browserShim=uh,Co(n,i),Ao(n),op(n,i),ap(n),yl(n,i),cp(n,i),hp(n,i),lp(n),dp(n,i),fp(n,i),Eo(n),Sl(n),Ml(n),To(n,i),wo(n,i),bl(n,i);break;case"firefox":if(!hh||!vl||!e.shimFirefox)return t("Firefox shim is not included in this adapter release."),r;t("adapter.js shimming firefox."),r.browserShim=hh,Co(n,i),Ao(n),pp(n,i),vl(n,i),gp(n,i),mp(n),yp(n),_p(n),xp(n),vp(n),Sp(n,i),Mp(n,i),bp(n,i),Ep(n,i),Eo(n),Ml(n),To(n,i),wo(n,i);break;case"safari":if(!fh||!e.shimSafari)return t("Safari shim is not included in this adapter release."),r;t("adapter.js shimming safari."),r.browserShim=fh,Co(n,i),Ao(n),Pp(n),Dp(n),Cp(n),Tp(n),wp(n),Lp(n),Ap(n),Ip(n),Eo(n),Sl(n),To(n,i),wo(n,i),bl(n,i);break;default:t("Unsupported browser!");break}return r}const mh=FM({window:typeof window>"u"?void 0:window});function Yi(n,e,t,i){Object.defineProperty(n,e,{get:t,set:i,enumerable:!0,configurable:!0})}class Np{constructor(){this.chunkedMTU=16300,this._dataCount=1,this.chunk=e=>{const t=[],i=e.byteLength,r=Math.ceil(i/this.chunkedMTU);let s=0,o=0;for(;o<i;){const a=Math.min(i,o+this.chunkedMTU),c=e.slice(o,a),l={__peerData:this._dataCount,n:s,data:c,total:r};t.push(l),o=a,s++}return this._dataCount++,t}}}function BM(n){let e=0;for(const r of n)e+=r.byteLength;const t=new Uint8Array(e);let i=0;for(const r of n)t.set(r,i),i+=r.byteLength;return t}const ja=mh.default||mh,ns=new class{isWebRTCSupported(){return typeof RTCPeerConnection<"u"}isBrowserSupported(){const n=this.getBrowser(),e=this.getVersion();return this.supportedBrowsers.includes(n)?n==="chrome"?e>=this.minChromeVersion:n==="firefox"?e>=this.minFirefoxVersion:n==="safari"?!this.isIOS&&e>=this.minSafariVersion:!1:!1}getBrowser(){return ja.browserDetails.browser}getVersion(){return ja.browserDetails.version||0}isUnifiedPlanSupported(){const n=this.getBrowser(),e=ja.browserDetails.version||0;if(n==="chrome"&&e<this.minChromeVersion)return!1;if(n==="firefox"&&e>=this.minFirefoxVersion)return!0;if(!window.RTCRtpTransceiver||!("currentDirection"in RTCRtpTransceiver.prototype))return!1;let t,i=!1;try{t=new RTCPeerConnection,t.addTransceiver("audio"),i=!0}catch{}finally{t&&t.close()}return i}toString(){return`Supports:
  ...
  `,document.body.appendChild(o);const c=o.querySelector("#admin-shop-grid"),l=o.querySelector("#admin-shop-coins");let u="skins";function d(S){const T=S?Do:Do.filter(x=>n.ownsSkin(x.id));if(!S&&T.length===0){c.innerHTML='<p class="shop-empty">Buy a skin in the Skins tab!</p>';return}for(const x of T){const P=n.ownsSkin(x.id),b=n.getEquippedSkinId()===x.id,w=document.createElement("button");w.type="button",w.className="shop-item",b&&w.classList.add("equipped"),w.innerHTML=`
      ...
      `,y.addEventListener("click",()=>{var v;if(S)if(w)n.equipWeapon(b.id),e==null||e(b.id);else{const R=n.buyWeapon(b.id);R.ok?e==null||e(((v=R.weapon)==null?void 0:v.id)??b.id):R.reason==="insufficient"&&(s==null||s("insufficient"))}else n.equipWeapon(b.id),e==null||e(b.id);p()}),c.appendChild(y)}}function p(){if(c){if(c.innerHTML="",l.textContent=(r==null?void 0:r())??`Coins: ${n.getCoins()}`,u==="skins")d(!0);else if(u==="weapons")h(!0);else if(u==="equip"){const S=Do.filter(x=>n.ownsSkin(x.id)),T=kh().filter(x=>n.ownsWeapon(x.id));if(S.length===0&&T.length===0){c.innerHTML='<p class="shop-empty">Buy skins or weapons first!</p>';return}S.length&&d(!1),T.length&&h(!1)}}}o.querySelectorAll(".shop-tab").forEach(S=>{S.addEventListener("click",()=>{u=S.dataset.tab,o.querySelectorAll(".shop-tab").forEach(T=>T.classList.toggle("active",T===S)),p()})}),o.querySelector("#admin-shop-close").addEventListener("click",()=>_());function g(){a=!0,o.style.display="flex",p()}function _(){a=!1,o.style.display="none",i==null||i()}function m(){return a}function f(){a&&p()}return{showAdminShop:g,hideAdminShop:_,isAdminShopVisible:m,refreshAdminShop:f}}const sc="ccwd-build";function oE(){const n=location.hostname;if(n==="localhost"||n==="127.0.0.1")return;const e=async()=>{try{const t=await fetch(`./version.json?_=${Date.now()}`,{cache:"no-store"});if(!t.ok)return;const{v:i}=await t.json();if(!i)return;const r=localStorage.getItem(sc);if(r&&r!==i){xb(),localStorage.setItem(sc,i),location.reload();return}r||localStorage.setItem(sc,i)}catch{}};e(),setInterval(e,180*1e3)}_b().then(()=>{oE()});const aE=5,Wh=7,cE=.05,Zp=0,Kp=0,Xh=5,lE=new URLSearchParams(window.location.search).has("teleport"),{canvas:Xt,ctx:he}=fm();Xt.id="title-canvas";Xt.style.position="fixed";Xt.style.inset="0";Xt.style.zIndex="1";const pn=new mm(document.body),nn=jv();nn.onExit(()=>im());const Ve=uS(),pe=Gf(0,0);mS(Ve.scene,pe);const Rr=sb(Ve.scene);let Ct=lb()?"drawPaper":"title",rs=lE?1.8:0,ss=0,ho=0,oc=0,fs=!1,ps=!1,fo=!1,Ll=0,ot=null,Vi=!1,ac=0,vr=1,cc=!1,lc=!1,dc=!1,J=null,Pt=!1,hi=null,Bi=0,$h=0,Sr=0,ln=[],li=0,Yh=!1,qh={},hs=0;const ms=document.getElementById("action-toast"),bn=document.getElementById("controls-hud"),vi=document.getElementById("damage-hud"),Di=document.getElementById("room-banner"),Mr=document.getElementById("super-dash-btn"),po=document.getElementById("dash-score-hud"),Or=document.getElementById("death-overlay"),Wo=document.getElementById("death-timer"),br=document.getElementById("non-dying-btn"),Xo=document.getElementById("regenerate-btn"),uc=document.getElementById("coin-hud"),$o=document.getElementById("kill-shop-btn"),Yo=document.getElementById("admin-shop-btn");let Yn=!1;function dE(){return(ot==null?void 0:ot.id)??"local"}const jt=Ub(dE),Fi=Hb(Ve.scene);function Ed(){return`Coins: ${jt.getCoins()}`}function Jp(n,e){!n||n<=0||(jt.addCoins(n),Ad(),_E(),vE(),e&&vt(e))}Fi.setOnDestroyed(()=>{});let jh={firing:!1};function uE(n,e){if(!n||n<=0)return;const t=e==="shred"?`+${n} coins — shredded!`:e==="target"?`+${n} coins — target destroyed!`:`+${n} coins — hit!`;Jp(n,t)}function hE(){const n=Math.round(Gb*Yb(J));Jp(n,`+${n} coins — player shredded!`)}const fE=rE(jt,{getCoinsText:Ed,onEquip:n=>{J&&oa(J,jt.ownsWeapon(n)?n:null);const e=jt.getEquippedWeapon();(e==null?void 0:e.type)==="mini_gun"?vt("Mini gun mounted — hold click to shoot!"):(e==null?void 0:e.type)==="saw_blade"?vt("Saw blade mounted — ram targets head-on!"):(e==null?void 0:e.type)==="chainsaw"?vt("Chainsaws mounted on sides & back — sideswipe to shred!"):vt("Weapon equipped on your car!")},onClose:()=>ji(),onPurchaseFail:()=>vt("Not enough coins!")}),pE=sE(jt,{getCoinsText:Ed,onEquipWeapon:n=>{J&&oa(J,jt.ownsWeapon(n)?n:null);const e=jt.getEquippedWeapon();(e==null?void 0:e.type)==="mini_gun"?vt("Mini gun mounted — hold click to shoot!"):(e==null?void 0:e.type)==="saw_blade"?vt("Saw blade mounted — ram targets head-on!"):(e==null?void 0:e.type)==="chainsaw"?vt("Chainsaws mounted on sides & back — sideswipe to shred!"):vt("Weapon equipped on your car!")},onEquipSkin:()=>{vt("Skin equipped — spawn a car from the garage to apply it!")},onClose:()=>ji(),onPurchaseFail:()=>vt("Not enough coins!")}),{showKillShop:mE,hideKillShop:gE,isKillShopVisible:Dl,refreshKillShop:_E}=fE,{showAdminShop:xE,hideAdminShop:yE,isAdminShopVisible:Il,refreshAdminShop:vE}=pE;function Dn(){return Vi||!ot}rf(()=>qo(bn,{driving:Pt}));gS(Td);db(()=>Zh(),()=>Zh(!0));function Zh(n=!1){Ct="title",Xt.style.display="block",Yp(),n&&Vp()}Ct==="drawPaper"&&(Xt.style.display="none",cb());rb(({room:n,isHost:e})=>{ot=n,Vi=e,jt.resetForPlayer(),rm(),SE(n),Ct="world",am(),om(sm(n.code??"solo")),Io(),Fi.reset(),vt("You're in the game!")});function SE(n){n.onMessage=(e,t)=>{e.t==="pose"&&e.id&&e.id!==n.id&&(n.role==="host"&&n.relay(t,e),Rr.applyPose(e.id,e)),e.t==="join"&&e.id&&(Rr.applyPose(e.id,{x:0,z:4,facing:0,walkPhase:0,isMoving:!1}),vr+=1,Io(),vt("Someone joined!"),Vi&&pt.syncState()),e.t==="leave"&&e.id&&(Rr.remove(e.id),vr=Math.max(1,vr-1),Io()),(e.t==="dashState"||e.t==="dashCollect")&&(pt.handleMessage(e),Fr()),e.t==="dashScoreReset"&&(pt.handleMessage(e),Fr())},n.onPeerCount=e=>{vr=e,Io()}}function Io(){if(!(!Di||!(ot!=null&&ot.code)))if(Vi){const n=Gp(ot.code);Di.innerHTML=`Room <strong>${ot.code}</strong> · ${vr} player(s) · <a href="${n}" target="_blank" rel="noopener">Share link</a>`,Di.hidden=!1}else Di.textContent=`Room ${ot.code} · ${vr} player(s)`,Di.hidden=!1}function ME(){ot!=null&&ot.id&&ot.send({t:"pose",id:ot.id,x:pe.x,z:pe.z,facing:pe.facing,walkPhase:pe.walkPhase,isMoving:pe.isMoving})}const bE="cybertruck";function Qp(){if(hi!=null&&hi.id){const n=Qu(hi.id);if(n)return n}return Qu(bE)}function em(n){const e=Dn()?jt.getEquippedSkinId():null;return e?Ib(n,e):n}function tm(){var n;return((n=jt.getEquippedWeapon())==null?void 0:n.id)??null}function EE(){const n=jt.getEquippedWeapon();return(n==null?void 0:n.type)==="mini_gun"&&jt.ownsWeapon(n.id)}function Td(n){n&&(hi=n,kr(),J&&(_d(pe,Ve.scene),gd(Ve.scene,J),J=null,Pt=!1),J=TM(pe,em(n),Ve.clampPosition,Ve.envTex),yM(Ve.scene,J),oa(J,tm()),sd(J),Pt=!0,nn.setDriving(!0),Jf(pe,J),ia(J),Ve.updateDrivingCamera(J.x,J.z,J.rotY),qo(bn,{driving:!0}),na(vi,!0),ta(vi,J),wd(),ji(),di(bn,!0,{driving:!0}))}function TE(n){if(!(!J||Bi>0)){if(aM(J,Ve.scene,n,ln),ta(vi,J),Zf(J)&&!Yn){nm();return}if(dd(n)){ep(J,n);const e=Math.abs(n)>=38;Sr=e?.5:.22,Bi=e?.55:.4}else Math.abs(n)>5&&(J.speed*=.55,Bi=.12)}}function nm(){if(!pe.dead){if(pe.dead=!0,li=Xh,Pt&&J){const n=J.x,e=J.z,t=J.rotY;Qf(pe,J),pe.x=n,pe.z=e,pe.facing=t,J.speed=0,Pt=!1,nn.setDriving(!1),pt.setSuperDash(!1),J.superDashOn=!1}pt.resetPlayerScore(),Fr(),pe.mesh.rotation.x=-Math.PI/2,Gi(pe),di(bn,!1),na(vi,!1),ci(!1),Fr(),Or&&(Or.hidden=!1),Wo&&(Wo.textContent=`Respawning in ${Xh}...`),vt("Your car was destroyed!")}}function wE(){var e;pe.dead=!1,li=0,J&&(gd(Ve.scene,J),J=null);for(const t of ln)(e=t.mesh.parent)==null||e.remove(t.mesh);ln.length=0,pe.x=Zp,pe.z=Kp,pe.facing=0,pe.mesh.rotation.set(0,0,0),pe.mesh.visible=!0,pe.inVehicle=null,Gi(pe),Pt=!1,nn.setDriving(!1),Or&&(Or.hidden=!0),ci(!0),kr(),di(bn,!0,{driving:!1});const n=Qp();n?(Td(n),vt("Respawned — back in your car!")):(od(),vt("Respawned at spawn!"))}function CE(n){li=Math.max(0,li-n),Wo&&(Wo.textContent=li>0?`Respawning in ${Math.ceil(li)}...`:"Respawning..."),md(ln,n),Ve.updateWorld(pe.x,pe.z),Ve.updateCamera(pe.x,pe.z,pe.facing),li<=0&&wE()}function im(){!J||!Pt||(Qf(pe,J),Pt=!1,nn.setDriving(!1),Gi(pe),Ve.updateCamera(pe.x,pe.z,pe.facing),qo(bn,{driving:!1}),na(vi,!1),vt("Exited vehicle"))}function AE(){return vm(pn)}function Kh(n,e){return{throttle:Math.max(n.throttle??0,e.throttle??0),brake:Math.max(n.brake??0,e.brake??0),reverse:Math.max(n.reverse??0,e.reverse??0),steer:Math.abs(n.steer)>Math.abs(e.steer)?n.steer:e.steer}}function Jh(n){var i,r;if(!n||Ct!=="world"||fc()||ll())return;const{fired:e,prevPressed:t}=Mm(n,Bl(),qh);qh=t;for(const s of e)vt(s.action);(i=n.buttons[9])!=null&&i.pressed&&!cc&&(cc=!0,sf()),(r=n==null?void 0:n.buttons[9])!=null&&r.pressed||(cc=!1)}function RE(n,e){const t=Math.max(0,Math.min(1,(e-n.topY)/(n.bottomY-n.topY)));return n.topW*2+(n.bottomW-n.topW*2)*t}function PE(n,e,t){const i=e*.56,r=RE(t,i),s=Math.min(r*.82,n*.78,420),o=s*.34;return{x:t.cx-s/2,y:i-o/2,w:s,h:o,cx:t.cx,cy:i}}function LE(n){const t=n.h*.72,i=n.w*.92,r=n.cy+n.h/2+14+t/2;return{x:n.cx-i/2,y:r-t/2,w:i,h:t,cx:n.cx,cy:r}}function DE(n,e){const t=Xt.getBoundingClientRect(),i=Xt.width/t.width,r=Xt.height/t.height;return{x:(n-t.left)*i,y:(e-t.top)*r}}function Qh(n,e,t){return n>=t.x&&n<=t.x+t.w&&e>=t.y&&e<=t.y+t.h}function IE(n,e,t){const i=e*.22,r=44,s="car crashing with ",o="dashing";he.save(),he.globalAlpha=t,he.font=`800 ${r}px system-ui, sans-serif`,he.textBaseline="middle";const a=he.measureText(s+o).width;let c=n/2-a/2;he.textAlign="left",he.fillStyle="#14532d",he.fillText(s,c,i),c+=he.measureText(s).width,he.fillText(o,c,i);const l=he.measureText(o).width,u=i+r*.38;he.strokeStyle="#14532d",he.lineWidth=4,he.beginPath(),he.moveTo(c,u),he.lineTo(c+l,u),he.stroke(),he.restore()}function ef(n,e,t,i,r,s){const o=1+Math.sin(i)*.04+(r?.05:0)+(s?-.03:0),a=n.w*o,c=n.h*o,l=n.cx-a/2,u=n.cy-c/2,d=c*.28;he.save(),he.shadowColor="rgba(0,0,0,0.45)",he.shadowBlur=24,he.shadowOffsetY=8;const h=he.createLinearGradient(l,u,l,u+c);h.addColorStop(0,s?t.pressedTop:t.top),h.addColorStop(1,s?t.pressedBottom:t.bottom),he.fillStyle=h,he.beginPath(),he.roundRect(l,u,a,c,d),he.fill(),he.shadowBlur=0,he.shadowOffsetY=0,he.strokeStyle=t.stroke,he.lineWidth=5,he.stroke(),hc(he,e,n.cx,n.cy,{size:Math.floor(c*.38),color:t.text}),he.restore()}function rm(){var n;Yn=!1,J&&(_d(pe,Ve.scene),gd(Ve.scene,J),J=null),Pt=!1,hi=null,nn.setDriving(!1),pe.dead=!1,li=0,pe.x=Zp,pe.z=Kp,pe.facing=0,pe.mesh.rotation.set(0,0,0),pe.mesh.visible=!0,pe.inVehicle=null,Gi(pe);for(const e of ln)(n=e.mesh.parent)==null||n.remove(e.mesh);ln.length=0,Bi=0,Sr=0,pt.setSuperDash(!1),pt.resetPlayerScore(),Or&&(Or.hidden=!0),na(vi,!1),kr(),gE(),yE()}function UE(){Ct="comingSoon",Ll=aE,ot=null,Vi=!1,jt.resetForPlayer(),rm(),am(),om(sm(String(Date.now()))),Fi.reset()}function NE(n,e){const t=DE(pn.pointer.x,pn.pointer.y);fs=Qh(t.x,t.y,n),ps=Qh(t.x,t.y,e),Xt.style.cursor=fs||ps?"pointer":"default",pn.pointer.down&&!fo&&(fs?(UE(),fo=!0):ps&&(Vp(),fo=!0)),pn.pointer.down||(fo=!1)}function tf(n,e,t=1){const i=n/2,r=e*.42,s=e,o=n*.08*t,a=n*.92;return{cx:i,topY:r,bottomY:s,topW:o,bottomW:a}}function kE(n,e,t){if(t<=0)return tf(n,e,t);const i=tf(n,e,t),{cx:r,topY:s,bottomY:o,topW:a,bottomW:c}=i;he.save(),he.globalAlpha=Math.min(1,t);const l=he.createLinearGradient(0,s,0,o);return l.addColorStop(0,"#334155"),l.addColorStop(1,"#1e293b"),he.fillStyle=l,he.beginPath(),he.moveTo(r-a,s),he.lineTo(r+a,s),he.lineTo(r+c/2,o),he.lineTo(r-c/2,o),he.closePath(),he.fill(),he.strokeStyle="rgba(250,204,21,0.85)",he.lineWidth=3,he.setLineDash([18,16]),he.beginPath(),he.moveTo(r,s),he.lineTo(r,o),he.stroke(),he.setLineDash([]),he.fillStyle="rgba(15,23,42,0.35)",he.fillRect(0,e*.72,n,e*.28),he.restore(),i}function vt(n){hs=2,ms&&(ms.textContent=n,ms.classList.add("show"))}function sm(n){let e=0;for(let t=0;t<n.length;t++)e=(e<<5)-e+n.charCodeAt(t)|0;return Math.abs(e)||1}const pt=Cb(Ve.scene,{getPlayerId:()=>(ot==null?void 0:ot.id)??"local",isHost:()=>!ot||Vi,send:n=>{ot&&(Vi&&n.t==="dashState"?ot.send(n):n.t==="dashCollect"||n.t==="dashScoreReset"?ot.sendToHost(n):ot.send(n))}});pt.setToast(vt);function om(n){pt.reset(n),pt.isSessionActive()&&vt("Blue Dashing circles spawned — collect them!")}function OE(){var n,e;if(!(!Dn()||!J||!hi||pe.dead)){for(let t=ln.length-1;t>=0;t--)ln[t].isPart&&((n=ln[t].mesh.parent)==null||n.remove(ln[t].mesh),ln.splice(t,1));(e=jt.getEquippedWeapon())==null||e.id,_d(pe,Ve.scene),bM(J,Ve.scene,em(hi),Ve.envTex),oa(J,tm()),Jf(pe,J),ta(vi,J),vt("Car regenerated — good as new!")}}function wd(){if(!Xo)return;const n=Dn()&&Pt&&J&&!pe.dead&&(Ct==="world"||Ct==="comingSoon");Xo.hidden=!n}Xo&&Xo.addEventListener("click",()=>OE());function Cd(){if(!br)return;Dn()||(Yn=!1);const n=Dn()&&(Ct==="world"||Ct==="comingSoon")&&!pe.dead;br.hidden=!n,br.classList.toggle("active",Yn),br.textContent=Yn?"NON-DYING":"DYING ON"}br&&br.addEventListener("click",()=>{Dn()&&(Yn=!Yn,Cd(),vt(Yn?"Non-dying ON — drive with no parts!":"Dying ON — destroyed car kills you"))});function Ad(){if(!uc)return;const n=(Ct==="world"||Ct==="comingSoon")&&!pe.dead;uc.hidden=!n,uc.textContent=Ed()}function ji(){const n=(Ct==="world"||Ct==="comingSoon")&&!pe.dead,e=Dl()||Il();$o&&($o.hidden=!n||Dn()||e),Yo&&(Yo.hidden=!n||!Dn()||e)}$o&&$o.addEventListener("click",()=>{Dn()||(mE(),ji())});Yo&&Yo.addEventListener("click",()=>{Dn()&&(xE(),ji())});function Fr(){const n=pt.isLocalLeader()&&Pt&&pt.isSessionActive();if(Mr&&(Mr.hidden=!n,Mr.classList.toggle("active",pt.isSuperDashOn()),Mr.textContent=pt.isSuperDashOn()?"NORMAL SPEED":"SUPER DASH"),po)if(Ct==="world"&&pt.isSessionActive()){const e=pt.getScores(),t=e[(ot==null?void 0:ot.id)??"local"]??0,i=pt.getLeaderIds(),r=i.length?Math.max(...i.map(s=>e[s]??0)):0;po.hidden=!1,po.textContent=`Dashing: ${t}${n?" ★ LEADING":""} · Best: ${r}`}else po.hidden=!0;n?J&&(J.superDashOn=pt.isSuperDashOn(),J.superMaxSpeed=pt.SUPER_MAX_SPEED,J.superAccelMult=pt.SUPER_ACCEL_MULT):(pt.setSuperDash(!1),J&&(J.superDashOn=!1))}Mr&&Mr.addEventListener("click",()=>{if(!pt.isLocalLeader()||!Pt||!J)return;const n=pt.toggleSuperDash();J.superDashOn=n,J.superMaxSpeed=pt.SUPER_MAX_SPEED,J.superAccelMult=pt.SUPER_ACCEL_MULT,vt(n?"Super dash ON!":"Normal speed"),Fr()});function am(){if(Xt.style.display="none",Ve.show(),Yh||(Jv(Ve.renderer.domElement),Kb(Ve.renderer.domElement),Yh=!0),ci(!0),kr(),nn.setVisible(!0),!Pt&&!pe.dead){const n=Qp();n?Td(n):od()}else nn.setDriving(Pt),di(bn,!0,{driving:Pt});Cd(),wd(),Ad(),ji()}function FE(n){if(pe.dead){CE(n);return}const e=_m();let{mx:t,mz:i}=xm(e);const r=ym(pn),s=nn.readMove();t+=r.mx+s.mx,i+=r.mz+s.mz;const o=Math.hypot(t,i);if(o>1&&(t/=o,i/=o),Bi>0&&(Bi=Math.max(0,Bi-n)),Sr>0&&(Sr=Math.max(0,Sr-n*2.8)),$h+=n,Pt&&J){const u=Sm(e),d=AE(),h=nn.readDrive(),p=Kh(Kh(u,d),h),{impactSpeed:g,wallHit:_}=EM(J,p,n,Ve.clampPosition),m=Ve.city.checkCarCollision(J.x,J.z,J.rotY,J.collisionHw??1.15,J.collisionHd??2.25),f=Fi.checkCarCollision(J.x,J.z,J.rotY,J.collisionHw??1.15,J.collisionHd??2.25);if(m||_||f){const S=g;f&&Fi.applyCarImpact(f,S),TE(S),f?(J.x=J.prevX,J.z=J.prevZ,Math.abs(S)>5?ep(J,S):J.speed*=.45):dd(S)||(J.x=J.prevX,J.z=J.prevZ),ia(J)}if(MM(J,$h,n),md(ln,n),Fi.update(n),jh=Qb(n,{vehicle:J,camera:Ve.camera,renderer:Ve.renderer,scene:Ve.scene,shredTargets:Fi,remotePlayers:Rr,onTargetHit:uE,onPlayerShred:hE,canFireMinigun:EE}),qb(J,n,jh.firing),Rr.tickCooldowns(n),ta(vi,J),Zf(J)&&!Yn){nm();return}Ve.updateWorld(J.x,J.z),Ve.updateDrivingCamera(J.x,J.z,J.rotY,Sr),Jh(e),pn.isPressed("e")&&!dc&&(dc=!0,im()),pn.isPressed("e")||(dc=!1);return}pS(pe,t,i,n);const a=pe.x+t*Wh*n,c=pe.z+i*Wh*n,l=Ve.clampPosition(a,c);pe.x=l.x,pe.z=l.z,Gi(pe),Ve.updateWorld(pe.x,pe.z),Ve.updateCamera(pe.x,pe.z,pe.facing),Rr.lerpAll(n),ac+=n,ac>=cE&&(ac=0,ME()),Jh(e),pn.isPressed("m")&&!lc&&(lc=!0,sf()),pn.isPressed("m")||(lc=!1)}function BE(n){const{width:e,height:t}=Xt;if(!((fc()||ll()||Th()||Ph()||Dl()||Il())&&(di(bn,!1),fc()||Ph()))){if(hs>0&&(hs=Math.max(0,hs-n),hs===0&&ms&&ms.classList.remove("show")),rs>0){rs=Math.max(0,rs-n);const i=rs>.35?1-(1.8-rs)/1.45:0;Xt.style.display="block",Ve.hide(),ci(!1),nn.setVisible(!1),Od(he,i>.2?"#e0f2fe":"#22c55e"),i>.05&&(he.fillStyle=`rgba(255,255,255,${i*.75})`,he.fillRect(0,0,e,t)),hc(he,"TELEPORTING...",e/2,t*.38,{color:"#0f172a",size:36});return}if(Ct==="drawPaper"){Xt.style.display="none",Ve.hide(),ci(!1),nn.setVisible(!1);return}if(Ct==="title"){Xt.style.display="block",Ve.hide(),ci(!1),nn.setVisible(!1),di(bn,!1),Di&&(Di.hidden=!0),ss=Math.min(1,ss+n*1.2),ho=Math.min(1,ho+n*.55),oc+=n*4,Od(he,"#22c55e");const i=kE(e,t,ho),r=PE(e,t,i),s=LE(r);if(he.globalAlpha=ss,IE(e,t,ss),hc(he,"The best game ever — realism incoming.",e/2,t*.3,{color:"#166534",size:18}),he.globalAlpha=1,!Th()){NE(r,s);const o=Math.min(1,.35+ho*.65)*ss;he.globalAlpha=o,ef(r,"PLAY",{top:"#fde047",bottom:"#facc15",pressedTop:"#facc15",pressedBottom:"#eab308",stroke:"#854d0e",text:"#422006"},oc,fs,pn.pointer.down&&fs),ef(s,"MULTIPLAYER",{top:"#4ade80",bottom:"#22c55e",pressedTop:"#22c55e",pressedBottom:"#16a34a",stroke:"#14532d",text:"#14532d"},oc+.5,ps,pn.pointer.down&&ps),he.globalAlpha=1}return}(Ct==="comingSoon"||Ct==="world")&&(Ve.renderer.domElement.style.boxShadow="",pt.update(n,Pt?J:null),md(ln,n),Fr(),Cd(),wd(),Ad(),ji(),!ll()&&!Dl()&&!Il()&&FE(n),Ct==="comingSoon"?(Ll-=n,Ll<=0&&(Ct="world"),di(bn,!0,{driving:Pt}),ci(!0),nn.setVisible(!1)):(ci(!0),di(bn,!0,{driving:Pt})),Ve.render())}}window.addEventListener("gamepadconnected",()=>{});gm(BE);
