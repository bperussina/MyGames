...
`);n.RTCSessionDescription&&r instanceof n.RTCSessionDescription?arguments[0]=new n.RTCSessionDescription({type:r.type,sdp:s}):r.sdp=s}return t.apply(this,arguments)}}function To(n,e){if(!(n.RTCPeerConnection&&n.RTCPeerConnection.prototype))return;const t=n.RTCPeerConnection.prototype.addIceCandidate;!t||t.length===0||(n.RTCPeerConnection.prototype.addIceCandidate=function(){return arguments[0]?(e.browser==="chrome"&&e.version<78||e.browser==="firefox"&&e.version<68||e.browser==="safari")&&arguments[0]&&arguments[0].candidate===""?Promise.resolve():t.apply(this,arguments):(arguments[1]&&arguments[1].apply(null),Promise.resolve())})}function wo(n,e){if(!(n.RTCPeerConnection&&n.RTCPeerConnection.prototype))return;const t=n.RTCPeerConnection.prototype.setLocalDescription;!t||t.length===0||(n.RTCPeerConnection.prototype.setLocalDescription=function(){let r=arguments[0]||{};if(typeof r!="object"||r.type&&r.sdp)return t.apply(this,arguments);if(r={type:r.type,sdp:r.sdp},!r.type)switch(this.signalingState){case"stable":case"have-local-offer":case"have-remote-pranswer":r.type="offer";break;default:r.type="answer";break}return r.sdp||r.type!=="offer"&&r.type!=="answer"?t.apply(this,[r]):(r.type==="offer"?this.createOffer:this.createAnswer).apply(this).then(o=>t.apply(this,[o]))})}const IM=Object.freeze(Object.defineProperty({__proto__:null,removeExtmapAllowMixed:Ml,shimAddIceCandidateNullOrEmpty:To,shimConnectionState:Sl,shimMaxMessageSize:bo,shimParameterlessSetLocalDescription:wo,shimRTCIceCandidate:Mo,shimRTCIceCandidateRelayProtocol:vl,shimSendThrowTypeError:Eo},Symbol.toStringTag,{value:"Module"}));function UM({window:n}={},e={shimChrome:!0,shimFirefox:!0,shimSafari:!0}){const t=md,i=AM(n),r={browserDetails:i,commonShim:IM,extractVersion:os,disableLog:wM,disableWarnings:CM,sdp:DM};switch(i.browser){case"chrome":if(!ch||!xl||!e.shimChrome)return t("Chrome shim is not included in this adapter release."),r;if(i.version===null)return t("Chrome shim can not determine version, not shimming."),r;t("adapter.js shimming chrome."),r.browserShim=ch,To(n,i),wo(n),sp(n,i),op(n),xl(n,i),ap(n,i),up(n,i),cp(n),lp(n,i),hp(n,i),Mo(n),vl(n),Sl(n),bo(n,i),Eo(n,i),Ml(n,i);break;case"firefox":if(!lh||!yl||!e.shimFirefox)return t("Firefox shim is not included in this adapter release."),r;t("adapter.js shimming firefox."),r.browserShim=lh,To(n,i),wo(n),fp(n,i),yl(n,i),mp(n,i),pp(n),xp(n),gp(n),_p(n),yp(n),vp(n,i),Sp(n,i),Mp(n,i),bp(n,i),Mo(n),Sl(n),bo(n,i),Eo(n,i);break;case"safari":if(!dh||!e.shimSafari)return t("Safari shim is not included in this adapter release."),r;t("adapter.js shimming safari."),r.browserShim=dh,To(n,i),wo(n),Rp(n),Lp(n),wp(n),Ep(n),Tp(n),Pp(n),Cp(n),Dp(n),Mo(n),vl(n),bo(n,i),Eo(n,i),Ml(n,i);break;default:t("Unsupported browser!");break}return r}const hh=UM({window:typeof window>"u"?void 0:window});function $i(n,e,t,i){Object.defineProperty(n,e,{get:t,set:i,enumerable:!0,configurable:!0})}class Up{constructor(){this.chunkedMTU=16300,this._dataCount=1,this.chunk=e=>{const t=[],i=e.byteLength,r=Math.ceil(i/this.chunkedMTU);let s=0,o=0;for(;o<i;){const a=Math.min(i,o+this.chunkedMTU),c=e.slice(o,a),l={__peerData:this._dataCount,n:s,data:c,total:r};t.push(l),o=a,s++}return this._dataCount++,t}}}function NM(n){let e=0;for(const r of n)e+=r.byteLength;const t=new Uint8Array(e);let i=0;for(const r of n)t.set(r,i),i+=r.byteLength;return t}const Ya=hh.default||hh,Qr=new class{isWebRTCSupported(){return typeof RTCPeerConnection<"u"}isBrowserSupported(){const n=this.getBrowser(),e=this.getVersion();return this.supportedBrowsers.includes(n)?n==="chrome"?e>=this.minChromeVersion:n==="firefox"?e>=this.minFirefoxVersion:n==="safari"?!this.isIOS&&e>=this.minSafariVersion:!1:!1}getBrowser(){return Ya.browserDetails.browser}getVersion(){return Ya.browserDetails.version||0}isUnifiedPlanSupported(){const n=this.getBrowser(),e=Ya.browserDetails.version||0;if(n==="chrome"&&e<this.minChromeVersion)return!1;if(n==="firefox"&&e>=this.minFirefoxVersion)return!0;if(!window.RTCRtpTransceiver||!("currentDirection"in RTCRtpTransceiver.prototype))return!1;let t,i=!1;try{t=new RTCPeerConnection,t.addTransceiver("audio"),i=!0}catch{}finally{t&&t.close()}return i}toString(){return`Supports:
  ...
  `,document.body.appendChild(nt);const e=nt.querySelector("#lobby-status"),t=nt.querySelector("#host-info"),i=nt.querySelector("#room-code"),r=nt.querySelector("#share-link"),s=nt.querySelector("#player-name"),o=nt.querySelector("#lobby-people-list"),a=nt.querySelector("#btn-enter");try{const R=localStorage.getItem(ia);R&&(s.value=R)}catch{}function c(R){e&&(e.textContent=R)}function l(R){if(o){if(o.innerHTML="",!R.length){const y=document.createElement("li");y.className="lobby-person empty",y.textContent="Nobody here yet",o.appendChild(y);return}for(const y of R){const w=document.createElement("li");w.className="lobby-person",w.textContent=y.you?`${y.name} (you)`:y.name,o.appendChild(w)}}}function u(){return[{id:"local",name:oi(),you:!0}]}function d(){if(!(Ze!=null&&Ze.id))return u();const R=[{id:Ze.id,name:oi(),you:!0}];for(const[y,w]of ni)R.push({id:y,name:w,you:!1});return R}function h(){(Ze==null?void 0:Ze.role)==="host"?l(d()):(Ze==null?void 0:Ze.role)==="client"||l(u())}function p(){if((Ze==null?void 0:Ze.role)!=="host")return;const R=d();l(R),Ze.send({t:"roster",people:R})}function g(R){Ze=R,ni.clear(),Ze.onMessage=(y,w)=>{if(Ze.role==="host"&&(y.t==="hello"&&w&&(ni.set(w,y.name||"Player"),p(),c(`${y.name||"Someone"} joined the lobby`)),y.t==="setName"&&w&&(ni.set(w,y.name||"Player"),p()),y.t==="leave")){const A=w||y.id;A&&(ni.delete(A),p(),c("Someone left the lobby"))}y.t==="roster"&&Array.isArray(y.people)&&l(y.people)},Ze.onPeerCount=()=>h()}function _(){const R=oi();if(Sh(R),!Ze){h();return}Ze.role==="host"?p():Ze.role==="client"&&Ze.send({t:"setName",name:R})}function m(){a.hidden=!1}s.addEventListener("input",()=>{_()}),nt.querySelector("#btn-generate").addEventListener("click",async()=>{try{Ze&&Ze.close(),ni.clear();const R=yh();R.onStatus=c,g(R);const y=JM(),w=await R.host(y);i.textContent=w.code,r.value=w.link,t.hidden=!1;try{sessionStorage.setItem(vh,w.code)}catch{}history.replaceState(null,"",`?room=${encodeURIComponent(w.code)}`),_(),m(),c("Share the link — friends appear in the lobby when they join.")}catch{c("Could not create room — try again.")}}),nt.querySelector("#btn-copy").addEventListener("click",async()=>{try{await navigator.clipboard.writeText(r.value),c("Link copied! Send it to your family.")}catch{r.select(),c("Select the link and copy it.")}}),nt.querySelector("#btn-join").addEventListener("click",()=>f()),nt.querySelector("#join-code").addEventListener("keydown",R=>{R.key==="Enter"&&f()});async function f({fromLink:R=!1}={}){const y=nt.querySelector("#join-code").value.trim();if(!y){c("Type a room code first.");return}try{Ze&&Ze.close(),ni.clear();const w=yh();w.onStatus=c,g(w),await w.join(y),w.send({t:"hello",name:oi()}),m(),c("You're in the game!"),R&&setTimeout(()=>S(),500)}catch{}}function S(){Ze&&(Sh(oi()),Za(),so==null||so({room:Ze,isHost:Ze.role==="host",playerName:oi()}))}a.addEventListener("click",S);function T(){Ze&&Ze.close(),Ze=null,ni.clear(),a.hidden=!0,t.hidden=!0;try{sessionStorage.removeItem(vh)}catch{}Za(),h()}nt.querySelector("#lobby-x").addEventListener("click",T);const x=new URLSearchParams(window.location.search).get("room");return x&&(nt.querySelector("#join-code").value=x),Za(),h(),nt}function Za(){nt&&nt.classList.remove("open")}function Gp(){if(nt){nt.classList.add("open");const n=nt.querySelector("#player-name");if(n)try{const t=localStorage.getItem(ia);t&&!n.value&&(n.value=t)}catch{}const e=nt.querySelector("#lobby-people-list");if(e&&!Ze){oi(),e.innerHTML="";const t=document.createElement("li");t.className="lobby-person",t.textContent=`${oi()} (you)`,e.appendChild(t)}}}function Mh(){return(nt==null?void 0:nt.classList.contains("open"))??!1}const bh=[15680580,16347926,15381256,2278750,440020,11032055,15485081];function tb(n){const e=new Map;let t=0;function i(){const p=bh[t%bh.length];return t+=1,p}function r(p){if(e.has(p))return e.get(p);const g=i(),_=Bf(0,0,g);_.mesh.userData.remoteId=p,n.add(_.mesh);const m={player:_,target:{x:0,z:0,facing:0,walkPhase:0,isMoving:!1}};return e.set(p,m),m}function s(p,g){const _=r(p);Object.assign(_.target,g);const m=_.player;m.x=g.x,m.z=g.z,m.facing=g.facing??0,m.walkPhase=g.walkPhase??0,m.isMoving=!!g.isMoving,xi(m)}function o(p){const g=e.get(p);g&&(n.remove(g.player.mesh),e.delete(p))}function a(p){const g=Math.min(1,p*12);for(const[,_]of e){const m=_.player,f=_.target;m.x+=(f.x-m.x)*g,m.z+=(f.z-m.z)*g,m.facing+=(f.facing-m.facing)*g,m.walkPhase=f.walkPhase,m.isMoving=f.isMoving,xi(m)}}function c(){for(const p of[...e.keys()])o(p)}function l(p){for(const[g,_]of e)p(g,_.player,_.target)}function u(p,g,{minSpeed:_,cooldownSec:m,onShred:f}){const S=e.get(p);if(!S||(S.shredCooldown=S.shredCooldown??0,S.shredCooldown>0)||Math.abs(g.speed)<_)return!1;const x=g.x-S.player.x,R=g.z-S.player.z;return Math.hypot(x,R)>3.8?!1:(S.shredCooldown=m,f==null||f(p,S.player),!0)}function d(p,g,_){const m=e.get(p);return!m||(m.shredCooldown=m.shredCooldown??0,m.shredCooldown>0)?!1:(m.shredCooldown=g,_==null||_(p,m.player),!0)}function h(p){for(const[,g]of e)g.shredCooldown>0&&(g.shredCooldown=Math.max(0,g.shredCooldown-p))}return{applyPose:s,remove:o,lerpAll:a,clear:c,count:()=>e.size,forEach:l,tryShred:u,tryGunHit:d,tickCooldowns:h}}const Vp="ccwd-design-sketch",xr=28,Wp=[{name:"Stainless",hex:"#b8bdc4"},{name:"Black",hex:"#1a1a1a"},{name:"White",hex:"#ffffff"},{name:"Gray",hex:"#6b7280"},{name:"Red",hex:"#dc2626"},{name:"Blue",hex:"#2563eb"},{name:"Green",hex:"#16a34a"},{name:"Yellow",hex:"#eab308"}];let At=null,Et=null,ft=null,ys=!1,es="draw",Ao=Wp[0].hex,oo=!1,ki=null;function Ro(){if(Et)try{localStorage.setItem(Vp,Et.toDataURL("image/png"))}catch{}}function nb(){if(!(!Et||!ft))try{const n=localStorage.getItem(Vp);if(!n)return;const e=new Image;e.onload=()=>{ft.drawImage(e,0,0,Et.width,Et.height)},e.src=n}catch{}}function Xp(){if(!Et||!ft)return;const n=Math.min(window.devicePixelRatio||1,2),e=window.innerWidth,t=window.innerHeight;Et.width=Math.floor(e*n),Et.height=Math.floor(t*n),Et.style.width=`${e}px`,Et.style.height=`${t}px`,ft.setTransform(n,0,0,n,0,0),ft.fillStyle="#ffffff",ft.fillRect(0,0,e,t),nb()}function Eh(n){return Math.round(n/xr)*xr}function Th(n,e){const t=Et.getBoundingClientRect();return{x:n-t.left,y:e-t.top}}function ib(n,e){const t=Eh(n),i=Eh(e);ft.fillStyle=Ao,ft.fillRect(t,i,xr,xr),ft.strokeStyle="rgba(0,0,0,0.12)",ft.lineWidth=1,ft.strokeRect(t+.5,i+.5,xr-1,xr-1)}function wh(){Ro(),$p(),ki==null||ki()}function Ch(){return ys}function $p(){At&&(ys=!1,At.hidden=!0)}function rb(){At&&(ys=!0,At.hidden=!1,Xp())}function sb(){return new URLSearchParams(window.location.search).has("draw")}function ob(n,e){ki=n,At=document.createElement("div"),At.id="draw-paper",At.innerHTML=`
  ...
  `,e}function hb(n){return new Promise(e=>{const t=n.querySelector("#update-splash-dismiss"),i=()=>{n.classList.add("update-splash-out"),setTimeout(()=>{n.remove(),as=null,e()},420)};t.addEventListener("click",i,{once:!0});const r=s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),window.removeEventListener("keydown",r),i())};window.addEventListener("keydown",r)})}async function fb(){if(location.hostname==="localhost"||location.hostname==="127.0.0.1")return;let n;try{n=await db()}catch{return}const e=n==null?void 0:n.v;if(!e)return;const t=localStorage.getItem(Tl)==="1",i=localStorage.getItem(Rh(e))==="1";if(!t&&i){localStorage.setItem(Ah,e),Ph();return}localStorage.removeItem(Tl),localStorage.setItem(Ah,e),localStorage.setItem(Rh(e),"1"),Ph(),as=ub(e),document.body.appendChild(as),requestAnimationFrame(()=>as.classList.add("update-splash-in")),await hb(as)}function pb(){localStorage.setItem(Tl,"1")}const mb=10,gb=.5,Lh=2.4,_b=2.2,xb=92,yb=1.6,vb=[[24,18],[-30,22],[45,-35],[-50,40],[12,-55],[-65,-20],[70,55],[-15,75],[88,-12],[-40,-70]];function Sb(){const n=document.createElement("canvas");n.width=256,n.height=72;const e=n.getContext("2d");e.fillStyle="rgba(15,23,42,0.55)",e.beginPath(),e.roundRect(8,8,240,56,10),e.fill(),e.fillStyle="#ffffff",e.font="bold 34px system-ui,sans-serif",e.textAlign="center",e.textBaseline="middle",e.fillText("Dashing",128,38);const t=new Rv(n);t.colorSpace=Qt;const i=new Nf({map:t,transparent:!0,depthTest:!1}),r=new Cv(i);return r.scale.set(3.6,1,1),r.renderOrder=10,r}function Dh(){const n=new We,e=new re(new qt(1.15,1.15,.18,28),new cn({color:2450411,emissive:1920728,emissiveIntensity:.45,flatShading:!0}));e.position.y=.1,n.add(e);const t=new re(new Qo(1.28,.08,8,28),new cn({color:6333946,flatShading:!0}));t.rotation.x=Math.PI/2,t.position.y=.18,n.add(t);const i=Sb();return i.position.y=_b,n.add(i),n}function Mb(n){let e=n>>>0;return()=>(e=e*1664525+1013904223>>>0,e/4294967296)}function bb(n,{getPlayerId:e,isHost:t,send:i,relay:r}){const s=new We;s.name="dash-pickups",n.add(s);let o=[],a={},c=!1,l=0,u=!1;function d(){return(e==null?void 0:e())??"local"}function h(){i==null||i({t:"dashState",pickups:o.map(k=>({id:k.id,x:k.x,z:k.z,active:k.active})),scores:a})}function p(k=Date.now()){for(o=[],a={},c=!1,u=!1;s.children.length;)s.remove(s.children[0]);const H=Mb(k);u=!0;for(let O=0;O<mb;O++){if(H()>=gb)continue;const[$,W]=vb[O],ne=Dh();ne.position.set($,0,W),s.add(ne),o.push({id:O,x:$,z:W,active:!0,mesh:ne,bob:H()*Math.PI*2,pending:!1})}t!=null&&t()&&h()}function g(){return o.length>0}function _(k){if(k!=null&&k.pickups){for(u=k.pickups.length>0,a={...k.scores??{}};s.children.length;)s.remove(s.children[0]);o=k.pickups.map(H=>{const O=H.active?Dh():null;return O&&(O.position.set(H.x,0,H.z),s.add(O)),{id:H.id,x:H.x,z:H.z,active:H.active,mesh:O,bob:0,pending:!1}})}}function m(k){if(!k.active)return;k.active=!1,k.mesh&&(s.remove(k.mesh),k.mesh=null);const H=d();a[H]=(a[H]??0)+1,B==null||B("Dashing +1!"),t!=null&&t()?h():i==null||i({t:"dashCollect",pickupId:k.id,playerId:H})}function f(k){if(!(t!=null&&t()))return;const H=o.find(O=>O.id===k.pickupId&&O.active);H&&(H.active=!1,H.mesh&&(s.remove(H.mesh),H.mesh=null),a[k.playerId]=(a[k.playerId]??0)+1,h())}function S(k){t!=null&&t()&&(k.playerId&&(a[k.playerId]=0),h())}function T(k=null){const H=k??d();a[H]=0,H===d()&&(c=!1),t!=null&&t()?h():i==null||i({t:"dashScoreReset",playerId:H})}function x(k){k.t==="dashState"&&_(k),k.t==="dashCollect"&&f(k),k.t==="dashScoreReset"&&S(k)}function R(){return{...a}}function y(){const k=Object.entries(a);if(!k.length)return[];const H=Math.max(...k.map(([,O])=>O));return H<=0?[]:k.filter(([,O])=>O===H).map(([O])=>O)}function w(){return y().includes(d())}function A(){return w()?(c=!c,c):!1}function v(k){c=!!k}function b(){return c}function P(k,H){l+=k;for(const O of o)!O.active||!O.mesh||(O.mesh.position.y=Math.sin(l*2.8+O.bob)*.12,O.mesh.children[0].rotation.y+=k*1.6);if(!(!H||!u))for(const O of o){if(!O.active)continue;const $=H.x-O.x,W=H.z-O.z;if($*$+W*W<=Lh*Lh){if(O.pending)break;(t==null?void 0:t())??!0?m(O):(O.pending=!0,i==null||i({t:"dashCollect",pickupId:O.id,playerId:d()}));break}}}let B=null;function F(k){B=k}return{group:s,reset:p,update:P,getScores:R,getLeaderIds:y,isLocalLeader:w,isSuperDashOn:b,toggleSuperDash:A,setSuperDash:v,handleMessage:x,setToast:F,syncState:h,resetPlayerScore:T,isSessionActive:g,SUPER_MAX_SPEED:xb,SUPER_ACCEL_MULT:yb}}const Eb={wood:{label:"Wood",color:9136404,costMult:1},metal:{label:"Metal",color:9741240,costMult:3},obsidian:{label:"Obsidian",color:1973067,costMult:8},diamond:{label:"Diamond",color:6809849,costMult:16,adminOnly:!0},plasma:{label:"Plasma",color:11032055,costMult:24,adminOnly:!0},inferno:{label:"Inferno",color:16347926,costMult:40,adminOnly:!0}},Yp={mini_gun:{label:"Mini Gun",baseCost:50,shredBonus:1},saw_blade:{label:"Saw Blade",baseCost:65,shredBonus:1.15},chainsaw:{label:"Chainsaw",baseCost:80,shredBonus:1.3}},Tb=["wood","metal","obsidian"],wb=["diamond","plasma","inferno"];function Cb(n,e){const t=Yp[n],i=Eb[e];return{id:`${n}_${e}`,type:n,material:e,name:`${i.label} ${t.label}`,cost:Math.round(t.baseCost*i.costMult),color:i.color,shredBonus:t.shredBonus*(i.costMult>=16?1.5:i.costMult>=8?1.25:1),adminOnly:!!i.adminOnly,tier:i.adminOnly?"premium":"basic"}}const qp=[];for(const n of Object.keys(Yp))for(const e of[...Tb,...wb])qp.push(Cb(n,e));const vd=qp;function ii(n){return vd.find(e=>e.id===n)??null}function Ab(){return vd.filter(n=>n.tier==="basic")}function Ih(){return vd}const Po=[{id:"neon_lime",name:"Neon Lime",color:8702998,accent:1332013,cost:350},{id:"hot_pink",name:"Hot Pink",color:15485081,accent:8591427,cost:350},{id:"gold_rush",name:"Gold Rush",color:16436245,accent:8736014,cost:500},{id:"ice_blue",name:"Ice Blue",color:3718648,accent:805486,cost:400},{id:"lava_orange",name:"Lava Orange",color:15357964,accent:4396039,cost:450},{id:"galaxy_purple",name:"Galaxy Purple",color:8141549,accent:3018853,cost:550},{id:"stealth_black",name:"Stealth Black",color:1976635,accent:132631,cost:600},{id:"candy_red",name:"Candy Red",color:15680580,accent:8330525,cost:400},{id:"mint_cream",name:"Mint Cream",color:10090212,accent:1265226,cost:350},{id:"sunset_gradient",name:"Sunset Burst",color:16347926,accent:14362487,cost:750}];function jp(n){return Po.find(e=>e.id===n)??null}function Rb(n,e){const t=jp(e);return t?{...n,color:t.color,skinId:t.id,skinAccent:t.accent}:n}const Uh="ccwd-loadout-";function Ka(){return{coins:0,ownedWeapons:[],ownedSkins:[],equippedWeapon:null,equippedSkin:null}}function Pb(n){let e=Ka(),t=`${Uh}local`;function i(){try{localStorage.setItem(t,JSON.stringify(e))}catch{}}function r(){t=`${Uh}${(n==null?void 0:n())??"local"}`;try{const y=localStorage.getItem(t);y&&(e={...Ka(),...JSON.parse(y)})}catch{e=Ka()}}function s(){r()}function o(){return e.coins}function a(y){return!y||y<=0?0:(e.coins+=y,i(),e.coins)}function c(y){return e.coins>=y}function l(y){return c(y)?(e.coins-=y,i(),!0):!1}function u(y){return e.ownedWeapons.includes(y)}function d(y){return e.ownedSkins.includes(y)}function h(y){const w=ii(y);if(!w)return{ok:!1,reason:"invalid"};if(u(y))return g(y),{ok:!0,weapon:w,alreadyOwned:!0};if(e.ownedWeapons=e.ownedWeapons.filter(A=>{const v=ii(A);return(v==null?void 0:v.type)!==w.type}),e.equippedWeapon){const A=ii(e.equippedWeapon);(A==null?void 0:A.type)===w.type&&(e.equippedWeapon=null)}return l(w.cost)?(e.ownedWeapons.push(y),e.equippedWeapon=y,i(),{ok:!0,weapon:w}):{ok:!1,reason:"insufficient"}}function p(y){const w=jp(y);return!w||d(y)?{ok:!1,reason:"already_owned"}:l(w.cost)?(e.ownedSkins.push(y),i(),{ok:!0,skin:w}):{ok:!1,reason:"insufficient"}}function g(y){return y&&!u(y)?!1:(e.equippedWeapon=y,i(),!0)}function _(y){return y&&!d(y)?!1:(e.equippedSkin=y,i(),!0)}function m(){return e.equippedWeapon?ii(e.equippedWeapon):null}function f(){return e.equippedSkin}function S(){return[...e.ownedWeapons]}function T(){return[...e.ownedSkins]}function x(y){return e.ownedWeapons.some(w=>{var A;return((A=ii(w))==null?void 0:A.type)===y})}function R(y){const w=e.ownedWeapons.find(A=>{var v;return((v=ii(A))==null?void 0:v.type)===y});return w?ii(w):null}return r(),{reloadForPlayer:s,getCoins:o,addCoins:a,canAfford:c,spendCoins:l,ownsWeapon:u,ownsSkin:d,buyWeapon:h,buySkin:p,equipWeapon:g,equipSkin:_,getEquippedWeapon:m,getEquippedSkinId:f,getOwnedWeapons:S,getOwnedSkins:T,ownsWeaponType:x,getOwnedWeaponOfType:R}}const Nh=[{radius:It+24,coins:18},{radius:It+38,coins:24},{radius:It+52,coins:32}],kh=28,Lb=1.28,Db=.42;function Ib(n,e,t,i,r,s){const o=s.mesh.rotation.y,a=n-s.x,c=e-s.z,l=Math.cos(-o),u=Math.sin(-o),d=a*l-c*u,h=a*u+c*l,p=t-o,g=Math.abs(Math.cos(p)),_=Math.abs(Math.sin(p)),m=i*g+r*_,f=i*_+r*g;return Math.abs(d)<m+Lb&&Math.abs(h)<f+Db}function Ub(){const n=[];for(let e=0;e<kh;e++){const t=e/kh*Math.PI*2+.18,i=Nh[e%Nh.length];n.push({x:Math.cos(t)*i.radius,z:Math.sin(t)*i.radius,coins:i.coins})}return n}const Nb=Ub();function kb(){const n=new We;n.name="shred-target";const e=new re(new qt(.14,.18,2.6,8),it(7029795));e.position.y=1.3,e.castShadow=!0,n.add(e);const t=new We;t.position.y=2.55;const i=new re(new qe(2.4,2.4,.12),it(16317180));t.add(i);const r=[{r:1.05,color:14427686,z:.07},{r:.72,color:16777215,z:.08},{r:.38,color:14427686,z:.09},{r:.14,color:16777215,z:.1}];for(const s of r){const o=new re(new qt(s.r,s.r,.08,24),pi(s.color));o.rotation.x=Math.PI/2,o.position.z=s.z,t.add(o)}return n.add(t),n.userData.board=t,n}function Ob(n){const e=new We;e.name="shred-targets",n.add(e);let t=[],i=null;const r=[];function s(){r.length=0;for(const f of t)f.alive&&f.mesh.traverse(S=>{S.isMesh&&(S.userData.shredTarget=f,r.push(S))})}function o(){a();for(const f of Nb){const S=kb();S.position.set(f.x,0,f.z),S.rotation.y=Math.atan2(-f.x,-f.z),e.add(S),t.push({mesh:S,x:f.x,z:f.z,health:50,maxHealth:50,coinValue:f.coins,alive:!0,hitCooldown:0,wobble:0})}s()}function a(){for(const f of t)f.mesh.parent&&e.remove(f.mesh);t=[],r.length=0}function c(){o()}function l(f){i=f}function u(f){return f.alive?(f.alive=!1,e.remove(f.mesh),s(),i==null||i(f),!0):!1}function d(f,S){return f!=null&&f.alive?(f.health-=S,f.wobble=1,f.health<=0?u(f):!1):!1}function h(f){const S=f.intersectObjects(r,!1);return S.length?S[0].object.userData.shredTarget??null:null}function p(f){for(const S of t)f(S)}function g(f,S,T=0,x=1.15,R=2.25){for(const y of t)if(y.alive&&Ib(f,S,T,x,R,y))return y;return null}function _(f,S){if(!(f!=null&&f.alive))return;const T=Math.abs(S),x=Math.min(1.6,.55+T*.028);f.wobble=Math.max(f.wobble,x),T>=6&&f.hitCooldown<=0&&(f.hitCooldown=.35,d(f,T*.45),f.wobble=Math.max(f.wobble,x))}function m(f){for(const S of t){if(!S.alive)continue;S.hitCooldown=Math.max(0,S.hitCooldown-f);const T=S.mesh.userData.board;if(S.wobble>0){S.wobble=Math.max(0,S.wobble-f*4.2);const x=S.wobble;S.mesh.rotation.z=Math.sin(x*24)*x*.1,S.mesh.position.y=Math.abs(Math.sin(x*30))*x*.08,T&&(T.rotation.z=Math.sin(x*20)*x*.55,T.position.x=Math.sin(x*27)*x*.07)}else S.mesh.rotation.z=0,S.mesh.position.y=0,T&&(T.rotation.z=0,T.position.x=0)}}return o(),{reset:c,update:m,setOnDestroyed:l,damageTarget:d,raycast:h,forEachTarget:p,checkCarCollision:g,applyCarImpact:_,count:()=>t.filter(f=>f.alive).length}}const Fb=150;function Ja(n,e=1.1){const t=new We,i=new re(new qe(.38,.32,.55),pi(n));i.position.y=.12,t.add(i);const r=new re(new qe(.1,.12,e),it(6583435));r.position.set(0,.08,e*.45),t.add(r);const s=new re(new qe(.14,.08,e*.92),it(13358561));return s.position.set(0,.08,e*.45),s.name="chain",t.add(s),t}function Bb(n){const e=new We;e.name="weapon-mini_gun";const t=new re(new qe(.55,.22,.55),it(3359061));t.position.set(0,.12,0),e.add(t);const i=new re(new qe(.62,.42,.75),pi(n));i.position.set(0,.42,.35),e.add(i);const r=new We;r.name="barrels";for(const o of[-.12,0,.12]){const a=new re(new qt(.06,.06,.85,8),Ss());a.rotation.x=Math.PI/2,a.position.set(o,.42,.95),r.add(a)}e.add(r);const s=new re(new qe(.72,.28,.35),it(1976635));return s.position.set(0,.55,.55),e.add(s),e}function zb(n){const e=new We;e.name="weapon-saw_blade";const t=new re(new qe(1.35,.18,.35),it(3359061));t.position.set(0,.12,.15),e.add(t);const i=new re(new qt(.18,.18,.2,10),it(4674921));i.rotation.x=Math.PI/2,i.position.set(0,.28,.55),e.add(i);const r=new re(new qt(.78,.78,.1,10),pi(n));r.rotation.x=Math.PI/2,r.position.set(0,.28,.55),r.name="blade",e.add(r);const s=new re(new qt(.88,.88,.05,8),it(14870768));return s.rotation.x=Math.PI/2,s.position.set(0,.28,.55),s.name="teeth",e.add(s),e}function Hb(n){const e=new We;e.name="weapon-chainsaw";const t=Ja(n,1.15);t.name="chainsaw-left",t.rotation.y=Math.PI/2,e.add(t);const i=Ja(n,1.15);i.name="chainsaw-right",i.rotation.y=-Math.PI/2,e.add(i);const r=Ja(n,1.05);return r.name="chainsaw-rear",r.rotation.y=Math.PI,e.add(r),e}function Gb(n){if(!(n!=null&&n.mesh))return;const e=n.mesh.getObjectByName("car-weapons");e&&n.mesh.remove(e),n.equippedWeapon=null}function ra(n,e){var o,a,c;if(Gb(n),!e||!(n!=null&&n.mesh))return null;const t=ii(e);if(!t)return null;const i=n.collisionHw??.94,r=n.collisionHd??2.25,s=new We;if(s.name="car-weapons",t.type==="mini_gun"){const l=Bb(t.color);l.position.set(0,.62,r*.72),s.add(l)}else if(t.type==="saw_blade"){const l=zb(t.color);l.position.set(0,.18,r*.88),s.add(l)}else if(t.type==="chainsaw"){const l=Hb(t.color);(o=l.children.find(u=>u.name==="chainsaw-left"))==null||o.position.set(-i*.92,.35,-r*.05),(a=l.children.find(u=>u.name==="chainsaw-right"))==null||a.position.set(i*.92,.35,-r*.05),(c=l.children.find(u=>u.name==="chainsaw-rear"))==null||c.position.set(0,.35,-r*.82),s.add(l)}return n.mesh.add(s),n.equippedWeapon=t,t}function Vb(n){var e;return((e=n==null?void 0:n.equippedWeapon)==null?void 0:e.shredBonus)??1}function Wb(n,e,t=!1){var o,a,c,l,u;const i=(o=n==null?void 0:n.mesh)==null?void 0:o.getObjectByName("car-weapons");if(!i||!n.equippedWeapon)return;const r=Math.abs(n.speed),s=n.equippedWeapon;if(s.type==="mini_gun"){const d=(a=i.getObjectByName("weapon-mini_gun"))==null?void 0:a.getObjectByName("barrels");d&&(d.rotation.z+=e*(t?28:4+r*.08))}else if(s.type==="saw_blade"){const d=i.getObjectByName("weapon-saw_blade"),h=e*(6+r*.35);(c=d==null?void 0:d.getObjectByName("blade"))==null||c.rotateZ(h),(l=d==null?void 0:d.getObjectByName("teeth"))==null||l.rotateZ(h*1.1)}else if(s.type==="chainsaw"){const d=i.getObjectByName("weapon-chainsaw"),h=e*(8+r*.25);for(const p of["chainsaw-left","chainsaw-right","chainsaw-rear"])(u=d==null?void 0:d.getObjectByName(p))==null||u.traverse(g=>{g.name==="chain"&&(g.rotation.y+=h)})}}function Qa(n,e,t){const i=e-n.x,r=t-n.z,s=Math.cos(n.rotY),o=Math.sin(n.rotY),a=i*s-r*o,c=i*o+r*s,l=n.collisionHw??.94,u=n.collisionHd??2.25;return c>u*.25&&Math.abs(a)<l*.85?"front":c<-u*.35&&Math.abs(a)<l*.9?"rear":a<-l*.45&&Math.abs(c)<u*.75?"left":a>l*.45&&Math.abs(c)<u*.75?"right":"body"}const mr=new Nv,ec=new Ue,ri=[],Xb=.09,tc=8,nc=6,$b=.35;let cs=!1,ao=0,co=!1,wl=!1,Cl=0,Al=0,Oh=0,Fh=0,ic=!1;function Yb(n){n&&(n.addEventListener("pointerdown",e=>{e.button===0&&(co=!0,wl=!1,Oh=e.clientX,Fh=e.clientY,Cl=e.clientX,Al=e.clientY,cs=!0)}),n.addEventListener("pointermove",e=>{co&&(Cl=e.clientX,Al=e.clientY,Math.hypot(e.clientX-Oh,e.clientY-Fh)>10&&(wl=!0,cs=!1))}),n.addEventListener("pointerup",e=>{e.button===0&&(cs=!1,co=!1)}),n.addEventListener("pointerleave",()=>{cs=!1,co=!1}))}function qb(){return cs&&!wl}function jb(n,e){const{vehicle:t,camera:i,renderer:r,scene:s,shredTargets:o,remotePlayers:a,onTargetHit:c,onPlayerShred:l}=e;if(ao=Math.max(0,ao-n),Jb(s,n),!(t!=null&&t.equippedWeapon))return{firing:!1};const u=t.equippedWeapon;if(u.type==="mini_gun"&&qb()&&ao<=0){ao=Xb,ic=!0;const d=Zb({vehicle:t,camera:i,renderer:r,shredTargets:o,remotePlayers:a,scene:s,weapon:u,onPlayerShred:l});return d!=null&&d.coins&&(c==null||c(d.coins,d.kind)),{firing:!0}}return ic=!1,(u.type==="saw_blade"||u.type==="chainsaw")&&Kb(t,u,o,a,c,l),{firing:ic}}function Zb({vehicle:n,camera:e,renderer:t,shredTargets:i,remotePlayers:r,scene:s,weapon:o,onPlayerShred:a}){var p,g;const c=t.domElement.getBoundingClientRect();ec.x=(Cl-c.left)/c.width*2-1,ec.y=-((Al-c.top)/c.height)*2+1,mr.setFromCamera(ec,e);const l=(p=i==null?void 0:i.raycast)==null?void 0:p.call(i,mr),u=o.shredBonus??1;if(l){const _=14*u,m=l.coinValue,f=i.damageTarget(l,_);return Bh(s,n,l.mesh.position),f?{coins:Math.round(m*u),kind:"target"}:{coins:Math.round(4*u),kind:"chip"}}const d=new si(new L(0,1,0),0),h=new L;return mr.ray.intersectPlane(d,h)&&Bh(s,n,h),(g=r==null?void 0:r.forEach)==null||g.call(r,(_,m)=>{const f=new L(m.x,1,m.z);if(mr.ray.origin.distanceTo(f)>55)return;const T=f.clone().sub(mr.ray.origin).normalize();mr.ray.direction.dot(T)>.985&&r.tryGunHit(_,1.5,()=>a==null?void 0:a(_))}),null}function Kb(n,e,t,i,r,s){var c,l,u;const o=Math.abs(n.speed),a=e.shredBonus??1;(c=t==null?void 0:t.forEachTarget)==null||c.call(t,d=>{if(!d.alive||d.hitCooldown>0||Math.hypot(n.x-d.x,n.z-d.z)>3.5)return;const p=Qa(n,d.x,d.z);let g=!1;if(e.type==="saw_blade"&&p==="front"&&o>=tc&&(g=!0),e.type==="chainsaw"&&(p==="left"||p==="right"||p==="rear")&&o>=nc&&(g=!0),!g)return;const _=o*.85*a;d.hitCooldown=$b;const m=d.coinValue;t.damageTarget(d,_)&&(r==null||r(Math.round(m*a),"shred"))}),e.type==="saw_blade"&&o>=tc&&((l=i==null?void 0:i.forEach)==null||l.call(i,(d,h)=>{Qa(n,h.x,h.z)==="front"&&i.tryShred(d,n,{minSpeed:tc,cooldownSec:4,onShred:()=>s==null?void 0:s(d)})})),e.type==="chainsaw"&&o>=nc&&((u=i==null?void 0:i.forEach)==null||u.call(i,(d,h)=>{const p=Qa(n,h.x,h.z);p!=="left"&&p!=="right"&&p!=="rear"||i.tryShred(d,n,{minSpeed:nc,cooldownSec:4,onShred:()=>s==null?void 0:s(d)})}))}function Bh(n,e,t){var c,l;const i=new L(e.x,.9,e.z),r=(l=(c=e.mesh)==null?void 0:c.getObjectByName("car-weapons"))==null?void 0:l.getObjectByName("weapon-mini_gun");r&&r.getWorldPosition(i);const s=new Zt().setFromPoints([i,t.clone()]),o=new Jl({color:16498468,transparent:!0,opacity:.9}),a=new Of(s,o);n.add(a),ri.push({mesh:a,life:.08})}function Jb(n,e){for(let t=ri.length-1;t>=0;t--)ri[t].life-=e,ri[t].life<=0&&(n.remove(ri[t].mesh),ri[t].mesh.geometry.dispose(),ri[t].mesh.material.dispose(),ri.splice(t,1))}function Qb(n){return String(n).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/"/g,"&quot;")}function eE(n,{onEquip:e,onClose:t,getCoinsText:i,onPurchaseFail:r}){let s=null,o=!1;s=document.createElement("div"),s.id="kill-shop",s.className="shop-overlay",s.innerHTML=`
  ...
  `,document.body.appendChild(o);const c=o.querySelector("#admin-shop-grid"),l=o.querySelector("#admin-shop-coins");let u="skins";function d(S){const T=S?Po:Po.filter(x=>n.ownsSkin(x.id));if(!S&&T.length===0){c.innerHTML='<p class="shop-empty">Buy a skin in the Skins tab!</p>';return}for(const x of T){const R=n.ownsSkin(x.id),y=n.getEquippedSkinId()===x.id,w=document.createElement("button");w.type="button",w.className="shop-item",y&&w.classList.add("equipped"),w.innerHTML=`
        <span class="shop-item-swatch" style="background:#${x.color.toString(16).padStart(6,"0")}"></span>
        <span class="shop-item-name">${zh(x.name)}</span>
      ...
      `,w.addEventListener("click",()=>{if(S)if(R)n.equipSkin(x.id),t==null||t(x.id);else{const A=n.buySkin(x.id);A.ok?(n.equipSkin(x.id),t==null||t(x.id)):A.reason==="insufficient"&&(s==null||s("insufficient"))}else n.equipSkin(x.id),t==null||t(x.id);p()}),c.appendChild(w)}}function h(S){var R;const T=Ih(),x=S?T:T.filter(y=>n.ownsWeapon(y.id));if(!S&&x.length===0){c.innerHTML='<p class="shop-empty">Buy weapons in the Weapons tab!</p>';return}for(const y of x){const w=n.ownsWeapon(y.id),A=((R=n.getEquippedWeapon())==null?void 0:R.id)===y.id,v=document.createElement("button");v.type="button",v.className="shop-item",A&&v.classList.add("equipped"),y.tier==="premium"&&v.classList.add("premium"),v.innerHTML=`
        ...
        <span class="shop-item-name">${zh(y.name)}</span>
        <span class="shop-item-meta">${S?`${y.cost} coins`:A?"Equipped":"Owned"}${y.tier==="premium"?" ★":""}</span>
      `,v.addEventListener("click",()=>{var b;if(S)if(w)n.equipWeapon(y.id),e==null||e(y.id);else{const P=n.buyWeapon(y.id);P.ok?e==null||e(((b=P.weapon)==null?void 0:b.id)??y.id):P.reason==="insufficient"&&(s==null||s("insufficient"))}else n.equipWeapon(y.id),e==null||e(y.id);p()}),c.appendChild(v)}}function p(){if(c){if(c.innerHTML="",l.textContent=(r==null?void 0:r())??`Coins: ${n.getCoins()}`,u==="skins")d(!0);else if(u==="weapons")h(!0);else if(u==="equip"){const S=Po.filter(x=>n.ownsSkin(x.id)),T=Ih().filter(x=>n.ownsWeapon(x.id));if(S.length===0&&T.length===0){c.innerHTML='<p class="shop-empty">Buy skins or weapons first!</p>';return}S.length&&d(!1),T.length&&h(!1)}}}o.querySelectorAll(".shop-tab").forEach(S=>{S.addEventListener("click",()=>{u=S.dataset.tab,o.querySelectorAll(".shop-tab").forEach(T=>T.classList.toggle("active",T===S)),p()})}),o.querySelector("#admin-shop-close").addEventListener("click",()=>_());function g(){a=!0,o.style.display="flex",p()}function _(){a=!1,o.style.display="none",i==null||i()}function m(){return a}function f(){a&&p()}return{showAdminShop:g,hideAdminShop:_,isAdminShopVisible:m,refreshAdminShop:f}}const rc="ccwd-build";function nE(){const n=location.hostname;if(n==="localhost"||n==="127.0.0.1")return;const e=async()=>{try{const t=await fetch(`./version.json?_=${Date.now()}`,{cache:"no-store"});if(!t.ok)return;const{v:i}=await t.json();if(!i)return;const r=localStorage.getItem(rc);if(r&&r!==i){pb(),localStorage.setItem(rc,i),location.reload();return}r||localStorage.setItem(rc,i)}catch{}};e(),setInterval(e,180*1e3)}fb().then(()=>{nE()});const iE=5,Hh=7,rE=.05,sE=0,oE=0,Gh=5,aE=new URLSearchParams(window.location.search).has("teleport"),{canvas:Xt,ctx:he}=lm();Xt.id="title-canvas";Xt.style.position="fixed";Xt.style.inset="0";Xt.style.zIndex="1";const hn=new um(document.body),an=Xv();an.onExit(()=>em());const Ve=aS(),xe=Bf(0,0);uS(Ve.scene,xe);const Cr=tb(Ve.scene);let Ct=sb()?"drawPaper":"title",ts=aE?1.8:0,ns=0,lo=0,sc=0,us=!1,hs=!1,uo=!1,Rl=0,ot=null,Hi=!1,oc=0,yr=1,ac=!1,cc=!1,lc=!1,ee=null,Nt=!1,Oi=null,Ar=0,Vh=0,ls=0,vn=[],Pi=0,Wh=!1,Xh={},ds=0;const fs=document.getElementById("action-toast"),Mn=document.getElementById("controls-hud"),Gi=document.getElementById("damage-hud"),Li=document.getElementById("room-banner"),vr=document.getElementById("super-dash-btn"),ho=document.getElementById("dash-score-hud"),Go=document.getElementById("death-overlay"),Vo=document.getElementById("death-timer"),Sr=document.getElementById("non-dying-btn"),Wo=document.getElementById("regenerate-btn"),dc=document.getElementById("coin-hud"),Xo=document.getElementById("kill-shop-btn"),$o=document.getElementById("admin-shop-btn");let $n=!1;function cE(){return(ot==null?void 0:ot.id)??"local"}const wn=Pb(cE),Fi=Ob(Ve.scene);function Sd(){return`Coins: ${wn.getCoins()}`}function Zp(n,e){!n||n<=0||(wn.addCoins(n),Td(),pE(),gE(),e&&vt(e))}Fi.setOnDestroyed(()=>{});let $h={firing:!1};function lE(n,e){if(!n||n<=0)return;const t=e==="shred"?`+${n} coins — shredded!`:e==="target"?`+${n} coins — target destroyed!`:`+${n} coins — hit!`;Zp(n,t)}function dE(){const n=Math.round(Fb*Vb(ee));Zp(n,`+${n} coins — player shredded!`)}const uE=eE(wn,{getCoinsText:Sd,onEquip:n=>{ee&&ra(ee,n);const e=wn.getEquippedWeapon();(e==null?void 0:e.type)==="mini_gun"?vt("Mini gun mounted — hold click to shoot!"):(e==null?void 0:e.type)==="saw_blade"?vt("Saw blade mounted — ram targets head-on!"):(e==null?void 0:e.type)==="chainsaw"?vt("Chainsaws mounted on sides & back — sideswipe to shred!"):vt("Weapon equipped on your car!")},onClose:()=>qi(),onPurchaseFail:()=>vt("Not enough coins!")}),hE=tE(wn,{getCoinsText:Sd,onEquipWeapon:n=>{ee&&ra(ee,n);const e=wn.getEquippedWeapon();(e==null?void 0:e.type)==="mini_gun"?vt("Mini gun mounted — hold click to shoot!"):(e==null?void 0:e.type)==="saw_blade"?vt("Saw blade mounted — ram targets head-on!"):(e==null?void 0:e.type)==="chainsaw"?vt("Chainsaws mounted on sides & back — sideswipe to shred!"):vt("Weapon equipped on your car!")},onEquipSkin:()=>{vt("Skin equipped — spawn a car from the garage to apply it!")},onClose:()=>qi(),onPurchaseFail:()=>vt("Not enough coins!")}),{showKillShop:fE,isKillShopVisible:Pl,refreshKillShop:pE}=uE,{showAdminShop:mE,isAdminShopVisible:Ll,refreshAdminShop:gE}=hE;function Cn(){return Hi||!ot}ef(()=>Yo(Mn,{driving:Nt}));hS(Md);ob(()=>Yh(),()=>Yh(!0));function Yh(n=!1){Ct="title",Xt.style.display="block",$p(),n&&Gp()}Ct==="drawPaper"&&(Xt.style.display="none",rb());eb(({room:n,isHost:e})=>{ot=n,Hi=e,Cn()||($n=!1),wn.reloadForPlayer(),xe.x=0,xe.z=0,xi(xe),_E(n),Ct="world",im(),nm(tm(n.code??"solo")),Lo(),Fi.reset(),vt("You're in the game!")});function _E(n){n.onMessage=(e,t)=>{e.t==="pose"&&e.id&&e.id!==n.id&&(n.role==="host"&&n.relay(t,e),Cr.applyPose(e.id,e)),e.t==="join"&&e.id&&(Cr.applyPose(e.id,{x:0,z:4,facing:0,walkPhase:0,isMoving:!1}),yr+=1,Lo(),vt("Someone joined!"),Hi&&yt.syncState()),e.t==="leave"&&e.id&&(Cr.remove(e.id),yr=Math.max(1,yr-1),Lo()),(e.t==="dashState"||e.t==="dashCollect")&&(yt.handleMessage(e),Nr()),e.t==="dashScoreReset"&&(yt.handleMessage(e),Nr())},n.onPeerCount=e=>{yr=e,Lo()}}function Lo(){if(!(!Li||!(ot!=null&&ot.code)))if(Hi){const n=Hp(ot.code);Li.innerHTML=`Room <strong>${ot.code}</strong> · ${yr} player(s) · <a href="${n}" target="_blank" rel="noopener">Share link</a>`,Li.hidden=!1}else Li.textContent=`Room ${ot.code} · ${yr} player(s)`,Li.hidden=!1}function xE(){ot!=null&&ot.id&&ot.send({t:"pose",id:ot.id,x:xe.x,z:xe.z,facing:xe.facing,walkPhase:xe.walkPhase,isMoving:xe.isMoving})}const yE="cybertruck";function Kp(){if(Oi!=null&&Oi.id){const n=Zu(Oi.id);if(n)return n}return Zu(yE)}function Jp(n){const e=Cn()?wn.getEquippedSkinId():null;return e?Rb(n,e):n}function Md(n){var e;n&&(Oi=n,_s(),ee&&(Zf(xe,Ve.scene),jf(Ve.scene,ee),ee=null,Nt=!1),ee=SM(xe,Jp(n),Ve.clampPosition,Ve.envTex),mM(Ve.scene,ee),ra(ee,((e=wn.getEquippedWeapon())==null?void 0:e.id)??null),id(ee),Nt=!0,an.setDriving(!0),Kf(xe,ee),ta(ee),Ve.updateDrivingCamera(ee.x,ee.z,ee.rotY),Yo(Mn,{driving:!0}),rd(Gi,!0),ea(Gi,ee),bd(),qi(),li(Mn,!0,{driving:!0}))}function vE(n){if(!(!ee||Ar>0)){if(iM(ee,Ve.scene,n,vn),ea(Gi,ee),Yf(ee)&&!$n){Qp();return}if(ld(n)){Qf(ee,n);const e=Math.abs(n)>=38;ls=e?.5:.22,Ar=e?.55:.4}else Math.abs(n)>5&&(ee.speed*=.55,Ar=.12)}}function Qp(){if(!xe.dead){if(xe.dead=!0,Pi=Gh,Nt&&ee){const n=ee.x,e=ee.z,t=ee.rotY;Jf(xe,ee),xe.x=n,xe.z=e,xe.facing=t,ee.speed=0,Nt=!1,an.setDriving(!1),yt.setSuperDash(!1),ee.superDashOn=!1}yt.resetPlayerScore(),Nr(),xe.mesh.rotation.x=-Math.PI/2,xi(xe),li(Mn,!1),rd(Gi,!1),ci(!1),Nr(),Go&&(Go.hidden=!1),Vo&&(Vo.textContent=`Respawning in ${Gh}...`),vt("Your car was destroyed!")}}function SE(){var e;xe.dead=!1,Pi=0,ee&&(jf(Ve.scene,ee),ee=null);for(const t of vn)(e=t.mesh.parent)==null||e.remove(t.mesh);vn.length=0,xe.x=sE,xe.z=oE,xe.facing=0,xe.mesh.rotation.set(0,0,0),xe.mesh.visible=!0,xe.inVehicle=null,xi(xe),Nt=!1,an.setDriving(!1),Go&&(Go.hidden=!0),ci(!0),_s(),li(Mn,!0,{driving:!1});const n=Kp();n?(Md(n),vt("Respawned — back in your car!")):(sd(),vt("Respawned at spawn!"))}function ME(n){Pi=Math.max(0,Pi-n),Vo&&(Vo.textContent=Pi>0?`Respawning in ${Math.ceil(Pi)}...`:"Respawning..."),pd(vn,n),Ve.updateWorld(xe.x,xe.z),Ve.updateCamera(xe.x,xe.z,xe.facing),Pi<=0&&SE()}function em(){!ee||!Nt||(Jf(xe,ee),Nt=!1,an.setDriving(!1),xi(xe),Ve.updateCamera(xe.x,xe.z,xe.facing),Yo(Mn,{driving:!1}),rd(Gi,!1),vt("Exited vehicle"))}function bE(){return gm(hn)}function qh(n,e){return{throttle:Math.max(n.throttle??0,e.throttle??0),brake:Math.max(n.brake??0,e.brake??0),reverse:Math.max(n.reverse??0,e.reverse??0),steer:Math.abs(n.steer)>Math.abs(e.steer)?n.steer:e.steer}}function jh(n){var i,r;if(!n||Ct!=="world"||hc()||cl())return;const{fired:e,prevPressed:t}=xm(n,Ol(),Xh);Xh=t;for(const s of e)vt(s.action);(i=n.buttons[9])!=null&&i.pressed&&!ac&&(ac=!0,tf()),(r=n==null?void 0:n.buttons[9])!=null&&r.pressed||(ac=!1)}function EE(n,e){const t=Math.max(0,Math.min(1,(e-n.topY)/(n.bottomY-n.topY)));return n.topW*2+(n.bottomW-n.topW*2)*t}function TE(n,e,t){const i=e*.56,r=EE(t,i),s=Math.min(r*.82,n*.78,420),o=s*.34;return{x:t.cx-s/2,y:i-o/2,w:s,h:o,cx:t.cx,cy:i}}function wE(n){const t=n.h*.72,i=n.w*.92,r=n.cy+n.h/2+14+t/2;return{x:n.cx-i/2,y:r-t/2,w:i,h:t,cx:n.cx,cy:r}}function CE(n,e){const t=Xt.getBoundingClientRect(),i=Xt.width/t.width,r=Xt.height/t.height;return{x:(n-t.left)*i,y:(e-t.top)*r}}function Zh(n,e,t){return n>=t.x&&n<=t.x+t.w&&e>=t.y&&e<=t.y+t.h}function AE(n,e,t){const i=e*.22,r=44,s="car crashing with ",o="dashing";he.save(),he.globalAlpha=t,he.font=`800 ${r}px system-ui, sans-serif`,he.textBaseline="middle";const a=he.measureText(s+o).width;let c=n/2-a/2;he.textAlign="left",he.fillStyle="#14532d",he.fillText(s,c,i),c+=he.measureText(s).width,he.fillText(o,c,i);const l=he.measureText(o).width,u=i+r*.38;he.strokeStyle="#14532d",he.lineWidth=4,he.beginPath(),he.moveTo(c,u),he.lineTo(c+l,u),he.stroke(),he.restore()}function Kh(n,e,t,i,r,s){const o=1+Math.sin(i)*.04+(r?.05:0)+(s?-.03:0),a=n.w*o,c=n.h*o,l=n.cx-a/2,u=n.cy-c/2,d=c*.28;he.save(),he.shadowColor="rgba(0,0,0,0.45)",he.shadowBlur=24,he.shadowOffsetY=8;const h=he.createLinearGradient(l,u,l,u+c);h.addColorStop(0,s?t.pressedTop:t.top),h.addColorStop(1,s?t.pressedBottom:t.bottom),he.fillStyle=h,he.beginPath(),he.roundRect(l,u,a,c,d),he.fill(),he.shadowBlur=0,he.shadowOffsetY=0,he.strokeStyle=t.stroke,he.lineWidth=5,he.stroke(),uc(he,e,n.cx,n.cy,{size:Math.floor(c*.38),color:t.text}),he.restore()}function RE(){Ct="comingSoon",Rl=iE,ot=null,Hi=!1,wn.reloadForPlayer(),xe.x=0,xe.z=0,xi(xe),im(),nm(tm(String(Date.now()))),Fi.reset()}function PE(n,e){const t=CE(hn.pointer.x,hn.pointer.y);us=Zh(t.x,t.y,n),hs=Zh(t.x,t.y,e),Xt.style.cursor=us||hs?"pointer":"default",hn.pointer.down&&!uo&&(us?(RE(),uo=!0):hs&&(Gp(),uo=!0)),hn.pointer.down||(uo=!1)}function Jh(n,e,t=1){const i=n/2,r=e*.42,s=e,o=n*.08*t,a=n*.92;return{cx:i,topY:r,bottomY:s,topW:o,bottomW:a}}function LE(n,e,t){if(t<=0)return Jh(n,e,t);const i=Jh(n,e,t),{cx:r,topY:s,bottomY:o,topW:a,bottomW:c}=i;he.save(),he.globalAlpha=Math.min(1,t);const l=he.createLinearGradient(0,s,0,o);return l.addColorStop(0,"#334155"),l.addColorStop(1,"#1e293b"),he.fillStyle=l,he.beginPath(),he.moveTo(r-a,s),he.lineTo(r+a,s),he.lineTo(r+c/2,o),he.lineTo(r-c/2,o),he.closePath(),he.fill(),he.strokeStyle="rgba(250,204,21,0.85)",he.lineWidth=3,he.setLineDash([18,16]),he.beginPath(),he.moveTo(r,s),he.lineTo(r,o),he.stroke(),he.setLineDash([]),he.fillStyle="rgba(15,23,42,0.35)",he.fillRect(0,e*.72,n,e*.28),he.restore(),i}function vt(n){ds=2,fs&&(fs.textContent=n,fs.classList.add("show"))}function tm(n){let e=0;for(let t=0;t<n.length;t++)e=(e<<5)-e+n.charCodeAt(t)|0;return Math.abs(e)||1}const yt=bb(Ve.scene,{getPlayerId:()=>(ot==null?void 0:ot.id)??"local",isHost:()=>!ot||Hi,send:n=>{ot&&(Hi&&n.t==="dashState"?ot.send(n):n.t==="dashCollect"||n.t==="dashScoreReset"?ot.sendToHost(n):ot.send(n))}});yt.setToast(vt);function nm(n){yt.reset(n),yt.isSessionActive()&&vt("Blue Dashing circles spawned — collect them!")}function DE(){var e,t;if(!Cn()||!ee||!Oi||xe.dead)return;for(let i=vn.length-1;i>=0;i--)vn[i].isPart&&((e=vn[i].mesh.parent)==null||e.remove(vn[i].mesh),vn.splice(i,1));const n=(t=wn.getEquippedWeapon())==null?void 0:t.id;Zf(xe,Ve.scene),yM(ee,Ve.scene,Jp(Oi),Ve.envTex),ra(ee,n??null),Kf(xe,ee),ea(Gi,ee),vt("Car regenerated — good as new!")}function bd(){if(!Wo)return;const n=Cn()&&Nt&&ee&&!xe.dead&&(Ct==="world"||Ct==="comingSoon");Wo.hidden=!n}Wo&&Wo.addEventListener("click",()=>DE());function Ed(){if(!Sr)return;Cn()||($n=!1);const n=Cn()&&(Ct==="world"||Ct==="comingSoon")&&!xe.dead;Sr.hidden=!n,Sr.classList.toggle("active",$n),Sr.textContent=$n?"NON-DYING":"DYING ON"}Sr&&Sr.addEventListener("click",()=>{Cn()&&($n=!$n,Ed(),vt($n?"Non-dying ON — drive with no parts!":"Dying ON — destroyed car kills you"))});function Td(){if(!dc)return;const n=(Ct==="world"||Ct==="comingSoon")&&!xe.dead;dc.hidden=!n,dc.textContent=Sd()}function qi(){const n=(Ct==="world"||Ct==="comingSoon")&&!xe.dead,e=Pl()||Ll();Xo&&(Xo.hidden=!n||Cn()||e),$o&&($o.hidden=!n||!Cn()||e)}Xo&&Xo.addEventListener("click",()=>{Cn()||(fE(),qi())});$o&&$o.addEventListener("click",()=>{Cn()&&(mE(),qi())});function Nr(){const n=yt.isLocalLeader()&&Nt&&yt.isSessionActive();if(vr&&(vr.hidden=!n,vr.classList.toggle("active",yt.isSuperDashOn()),vr.textContent=yt.isSuperDashOn()?"NORMAL SPEED":"SUPER DASH"),ho)if(Ct==="world"&&yt.isSessionActive()){const e=yt.getScores(),t=e[(ot==null?void 0:ot.id)??"local"]??0,i=yt.getLeaderIds(),r=i.length?Math.max(...i.map(s=>e[s]??0)):0;ho.hidden=!1,ho.textContent=`Dashing: ${t}${n?" ★ LEADING":""} · Best: ${r}`}else ho.hidden=!0;n?ee&&(ee.superDashOn=yt.isSuperDashOn(),ee.superMaxSpeed=yt.SUPER_MAX_SPEED,ee.superAccelMult=yt.SUPER_ACCEL_MULT):(yt.setSuperDash(!1),ee&&(ee.superDashOn=!1))}vr&&vr.addEventListener("click",()=>{if(!yt.isLocalLeader()||!Nt||!ee)return;const n=yt.toggleSuperDash();ee.superDashOn=n,ee.superMaxSpeed=yt.SUPER_MAX_SPEED,ee.superAccelMult=yt.SUPER_ACCEL_MULT,vt(n?"Super dash ON!":"Normal speed"),Nr()});function im(){if(Xt.style.display="none",Ve.show(),Wh||(qv(Ve.renderer.domElement),Yb(Ve.renderer.domElement),Wh=!0),ci(!0),_s(),an.setVisible(!0),!Nt&&!xe.dead){const n=Kp();n?Md(n):sd()}else an.setDriving(Nt),li(Mn,!0,{driving:Nt});Ed(),bd(),Td(),qi()}function IE(n){if(xe.dead){ME(n);return}const e=fm();let{mx:t,mz:i}=pm(e);const r=mm(hn),s=an.readMove();t+=r.mx+s.mx,i+=r.mz+s.mz;const o=Math.hypot(t,i);if(o>1&&(t/=o,i/=o),Ar>0&&(Ar=Math.max(0,Ar-n)),ls>0&&(ls=Math.max(0,ls-n*2.8)),Vh+=n,Nt&&ee){const u=_m(e),d=bE(),h=an.readDrive(),p=qh(qh(u,d),h),{impactSpeed:g,wallHit:_}=vM(ee,p,n,Ve.clampPosition),m=Ve.city.checkCarCollision(ee.x,ee.z,ee.rotY,ee.collisionHw??1.15,ee.collisionHd??2.25),f=Fi.checkCarCollision(ee.x,ee.z,ee.rotY,ee.collisionHw??1.15,ee.collisionHd??2.25);if(m||_||f){const S=g;f&&Fi.applyCarImpact(f,S),vE(S),f?(ee.x=ee.prevX,ee.z=ee.prevZ,Math.abs(S)>5?Qf(ee,S):ee.speed*=.45):ld(S)||(ee.x=ee.prevX,ee.z=ee.prevZ),ta(ee)}if(xM(ee,Vh,n),pd(vn,n),Fi.update(n),$h=jb(n,{vehicle:ee,camera:Ve.camera,renderer:Ve.renderer,scene:Ve.scene,shredTargets:Fi,remotePlayers:Cr,onTargetHit:lE,onPlayerShred:dE}),Wb(ee,n,$h.firing),Cr.tickCooldowns(n),ea(Gi,ee),Yf(ee)&&!$n){Qp();return}Ve.updateWorld(ee.x,ee.z),Ve.updateDrivingCamera(ee.x,ee.z,ee.rotY,ls),jh(e),hn.isPressed("e")&&!lc&&(lc=!0,em()),hn.isPressed("e")||(lc=!1);return}dS(xe,t,i,n);const a=xe.x+t*Hh*n,c=xe.z+i*Hh*n,l=Ve.clampPosition(a,c);xe.x=l.x,xe.z=l.z,xi(xe),Ve.updateWorld(xe.x,xe.z),Ve.updateCamera(xe.x,xe.z,xe.facing),Cr.lerpAll(n),oc+=n,oc>=rE&&(oc=0,xE()),jh(e),hn.isPressed("m")&&!cc&&(cc=!0,tf()),hn.isPressed("m")||(cc=!1)}function UE(n){const{width:e,height:t}=Xt;if(!((hc()||cl()||Mh()||Ch()||Pl()||Ll())&&(li(Mn,!1),hc()||Ch()))){if(ds>0&&(ds=Math.max(0,ds-n),ds===0&&fs&&fs.classList.remove("show")),ts>0){ts=Math.max(0,ts-n);const i=ts>.35?1-(1.8-ts)/1.45:0;Xt.style.display="block",Ve.hide(),ci(!1),an.setVisible(!1),Ud(he,i>.2?"#e0f2fe":"#22c55e"),i>.05&&(he.fillStyle=`rgba(255,255,255,${i*.75})`,he.fillRect(0,0,e,t)),uc(he,"TELEPORTING...",e/2,t*.38,{color:"#0f172a",size:36});return}if(Ct==="drawPaper"){Xt.style.display="none",Ve.hide(),ci(!1),an.setVisible(!1);return}if(Ct==="title"){Xt.style.display="block",Ve.hide(),ci(!1),an.setVisible(!1),li(Mn,!1),Li&&(Li.hidden=!0),ns=Math.min(1,ns+n*1.2),lo=Math.min(1,lo+n*.55),sc+=n*4,Ud(he,"#22c55e");const i=LE(e,t,lo),r=TE(e,t,i),s=wE(r);if(he.globalAlpha=ns,AE(e,t,ns),uc(he,"The best game ever — realism incoming.",e/2,t*.3,{color:"#166534",size:18}),he.globalAlpha=1,!Mh()){PE(r,s);const o=Math.min(1,.35+lo*.65)*ns;he.globalAlpha=o,Kh(r,"PLAY",{top:"#fde047",bottom:"#facc15",pressedTop:"#facc15",pressedBottom:"#eab308",stroke:"#854d0e",text:"#422006"},sc,us,hn.pointer.down&&us),Kh(s,"MULTIPLAYER",{top:"#4ade80",bottom:"#22c55e",pressedTop:"#22c55e",pressedBottom:"#16a34a",stroke:"#14532d",text:"#14532d"},sc+.5,hs,hn.pointer.down&&hs),he.globalAlpha=1}return}(Ct==="comingSoon"||Ct==="world")&&(Ve.renderer.domElement.style.boxShadow="",yt.update(n,Nt?ee:null),pd(vn,n),Nr(),Ed(),bd(),Td(),qi(),!cl()&&!Pl()&&!Ll()&&IE(n),Ct==="comingSoon"?(Rl-=n,Rl<=0&&(Ct="world"),li(Mn,!0,{driving:Nt}),ci(!0),an.setVisible(!1)):(ci(!0),li(Mn,!0,{driving:Nt})),Ve.render())}}window.addEventListener("gamepadconnected",()=>{});hm(UE);
