...
`);i.RTCSessionDescription&&r instanceof i.RTCSessionDescription?arguments[0]=new i.RTCSessionDescription({type:r.type,sdp:s}):r.sdp=s}return t.apply(this,arguments)}}function es(i,e){if(!(i.RTCPeerConnection&&i.RTCPeerConnection.prototype))return;const t=i.RTCPeerConnection.prototype.addIceCandidate;!t||t.length===0||(i.RTCPeerConnection.prototype.addIceCandidate=function(){return arguments[0]?(e.browser==="chrome"&&e.version<78||e.browser==="firefox"&&e.version<68||e.browser==="safari")&&arguments[0]&&arguments[0].candidate===""?Promise.resolve():t.apply(this,arguments):(arguments[1]&&arguments[1].apply(null),Promise.resolve())})}function ts(i,e){if(!(i.RTCPeerConnection&&i.RTCPeerConnection.prototype))return;const t=i.RTCPeerConnection.prototype.setLocalDescription;!t||t.length===0||(i.RTCPeerConnection.prototype.setLocalDescription=function(){let r=arguments[0]||{};if(typeof r!="object"||r.type&&r.sdp)return t.apply(this,arguments);if(r={type:r.type,sdp:r.sdp},!r.type)switch(this.signalingState){case"stable":case"have-local-offer":case"have-remote-pranswer":r.type="offer";break;default:r.type="answer";break}return r.sdp||r.type!=="offer"&&r.type!=="answer"?t.apply(this,[r]):(r.type==="offer"?this.createOffer:this.createAnswer).apply(this).then(a=>t.apply(this,[a]))})}const a0=Object.freeze(Object.defineProperty({__proto__:null,removeExtmapAllowMixed:so,shimAddIceCandidateNullOrEmpty:es,shimConnectionState:ro,shimMaxMessageSize:Jr,shimParameterlessSetLocalDescription:ts,shimRTCIceCandidate:Zr,shimRTCIceCandidateRelayProtocol:io,shimSendThrowTypeError:Qr},Symbol.toStringTag,{value:"Module"}));function o0({window:i}={},e={shimChrome:!0,shimFirefox:!0,shimSafari:!0}){const t=bo,n=t0(i),r={browserDetails:n,commonShim:a0,extractVersion:ir,disableLog:Q_,disableWarnings:e0,sdp:s0};switch(n.browser){case"chrome":if(!Qc||!to||!e.shimChrome)return t("Chrome shim is not included in this adapter release."),r;if(n.version===null)return t("Chrome shim can not determine version, not shimming."),r;t("adapter.js shimming chrome."),r.browserShim=Qc,es(i,n),ts(i),lu(i,n),uu(i),to(i,n),du(i,n),mu(i,n),fu(i),hu(i,n),gu(i,n),Zr(i),io(i),ro(i),Jr(i,n),Qr(i,n),so(i,n);break;case"firefox":if(!el||!no||!e.shimFirefox)return t("Firefox shim is not included in this adapter release."),r;t("adapter.js shimming firefox."),r.browserShim=el,es(i,n),ts(i),_u(i,n),no(i,n),xu(i,n),vu(i),Mu(i),yu(i),Su(i),Eu(i),bu(i,n),Tu(i,n),Cu(i,n),Au(i,n),Zr(i),ro(i),Jr(i,n),Qr(i,n);break;case"safari":if(!tl||!e.shimSafari)return t("Safari shim is not included in this adapter release."),r;t("adapter.js shimming safari."),r.browserShim=tl,es(i,n),ts(i),Iu(i),Nu(i),Pu(i),Ru(i),wu(i),Uu(i),Lu(i),Fu(i),Zr(i),io(i),Jr(i,n),Qr(i,n),so(i,n);break;default:t("Unsupported browser!");break}return r}const il=o0({window:typeof window>"u"?void 0:window});function ai(i,e,t,n){Object.defineProperty(i,e,{get:t,set:n,enumerable:!0,configurable:!0})}class ku{constructor(){this.chunkedMTU=16300,this._dataCount=1,this.chunk=e=>{const t=[],n=e.byteLength,r=Math.ceil(n/this.chunkedMTU);let s=0,a=0;for(;a<n;){const o=Math.min(n,a+this.chunkedMTU),c=e.slice(a,o),l={__peerData:this._dataCount,n:s,data:c,total:r};t.push(l),a=o,s++}return this._dataCount++,t}}}function c0(i){let e=0;for(const r of i)e+=r.byteLength;const t=new Uint8Array(e);let n=0;for(const r of i)t.set(r,n),n+=r.byteLength;return t}const Js=il.default||il,Ji=new class{isWebRTCSupported(){return typeof RTCPeerConnection<"u"}isBrowserSupported(){const i=this.getBrowser(),e=this.getVersion();return this.supportedBrowsers.includes(i)?i==="chrome"?e>=this.minChromeVersion:i==="firefox"?e>=this.minFirefoxVersion:i==="safari"?!this.isIOS&&e>=this.minSafariVersion:!1:!1}getBrowser(){return Js.browserDetails.browser}getVersion(){return Js.browserDetails.version||0}isUnifiedPlanSupported(){const i=this.getBrowser(),e=Js.browserDetails.version||0;if(i==="chrome"&&e<this.minChromeVersion)return!1;if(i==="firefox"&&e>=this.minFirefoxVersion)return!0;if(!window.RTCRtpTransceiver||!("currentDirection"in RTCRtpTransceiver.prototype))return!1;let t,n=!1;try{t=new RTCPeerConnection,t.addTransceiver("audio"),n=!0}catch{}finally{t&&t.close()}return n}toString(){return`Supports:
  ...
  `,document.body.appendChild(ht);const e=ht.querySelector("#lobby-status"),t=ht.querySelector("#host-info"),n=ht.querySelector("#room-code"),r=ht.querySelector("#share-link");function s(c){e&&(e.textContent=c)}ht.querySelector("#btn-generate").addEventListener("click",async()=>{try{bt&&bt.close(),bt=cl(),bt.onStatus=s;const c=S0(),l=await bt.host(c);n.textContent=l.code,r.value=l.link,t.hidden=!1,history.replaceState(null,"",l.link),ea(),nn==null||nn({room:bt,isHost:!0})}catch{s("Could not create room — try again.")}}),ht.querySelector("#btn-copy").addEventListener("click",async()=>{try{await navigator.clipboard.writeText(r.value),s("Link copied! Send it to your family.")}catch{r.select(),s("Select the link and copy it.")}}),ht.querySelector("#btn-enter-host").addEventListener("click",()=>{!bt||bt.role!=="host"||(ea(),nn==null||nn({room:bt,isHost:!0}))}),ht.querySelector("#btn-join").addEventListener("click",()=>a()),ht.querySelector("#join-code").addEventListener("keydown",c=>{c.key==="Enter"&&a()});async function a(){const c=ht.querySelector("#join-code").value.trim();if(!c){s("Type a room code first.");return}try{bt&&bt.close(),bt=cl(),bt.onStatus=s,await bt.join(c),ea(),nn==null||nn({room:bt,isHost:!1})}catch{}}const o=new URLSearchParams(window.location.search).get("room");return o&&(ht.querySelector("#join-code").value=o,s("Joining from your link…"),setTimeout(()=>a(),400)),ht}function ea(){ht&&(ht.style.display="none")}const ll=[15680580,16347926,15381256,2278750,440020,11032055,15485081];function E0(i){const e=new Map;let t=0;function n(){const l=ll[t%ll.length];return t+=1,l}function r(l){if(e.has(l))return e.get(l);const u=n(),d=nu(0,0,u);d.mesh.userData.remoteId=l,i.add(d.mesh);const f={player:d,target:{x:0,z:0,facing:0,walkPhase:0,isMoving:!1}};return e.set(l,f),f}function s(l,u){const d=r(l);Object.assign(d.target,u);const f=d.player;f.x=u.x,f.z=u.z,f.facing=u.facing??0,f.walkPhase=u.walkPhase??0,f.isMoving=!!u.isMoving,lr(f)}function a(l){const u=e.get(l);u&&(i.remove(u.player.mesh),e.delete(l))}function o(l){const u=Math.min(1,l*12);for(const[,d]of e){const f=d.player,m=d.target;f.x+=(m.x-f.x)*u,f.z+=(m.z-f.z)*u,f.facing+=(m.facing-f.facing)*u,f.walkPhase=m.walkPhase,f.isMoving=m.isMoving,lr(f)}}function c(){for(const l of[...e.keys()])a(l)}return{applyPose:s,remove:a,lerpAll:o,clear:c,count:()=>e.size}}const b0="car crashing with dashing",ul=7,T0=.05,C0=new URLSearchParams(window.location.search).has("teleport"),{canvas:On,ctx:$e}=Ju();On.id="title-canvas";On.style.position="fixed";On.style.inset="0";On.style.zIndex="1";const yn=new ed(document.body),Lt=x_(),Ke=nu(0,0);E_(Lt.scene,Ke);const is=E0(Lt.scene);let fs="title",Qi=C0?1.8:0,ta=0,na=0,Wt=null,$u=!1,ia=0,bi=1,ra=!1,sa=!1,aa=!1,kt=null,Fi=!1,dl={},rr=0;const sr=document.getElementById("action-toast"),sn=document.getElementById("map-hint"),ni=document.getElementById("hud"),Jn=document.getElementById("room-banner");_l();b_(w0);M0(({room:i,isHost:e})=>{Wt=i,$u=e,Ke.x=0,Ke.z=0,lr(Ke),A0(i),fs="world",F0(),rs(),_r(e?"You are the host — share your link!":`Joined room ${i.code}`)});function A0(i){i.onMessage=(e,t)=>{e.t==="pose"&&e.id&&e.id!==i.id&&(i.role==="host"&&i.relay(t,e),is.applyPose(e.id,e)),e.t==="join"&&e.id&&(is.applyPose(e.id,{x:0,z:4,facing:0,walkPhase:0,isMoving:!1}),bi+=1,rs(),_r("Someone joined!")),e.t==="leave"&&e.id&&(is.remove(e.id),bi=Math.max(1,bi-1),rs())},i.onPeerCount=e=>{bi=e,rs()}}function rs(){if(!(!Jn||!(Wt!=null&&Wt.code)))if($u){const i=Xu(Wt.code);Jn.innerHTML=`Room <strong>${Wt.code}</strong> · ${bi} player(s) · <a href="${i}" target="_blank" rel="noopener">Share link</a>`,Jn.hidden=!1}else Jn.textContent=`Room ${Wt.code} · ${bi} player(s)`,Jn.hidden=!1}function R0(){Wt!=null&&Wt.id&&Wt.send({t:"pose",id:Wt.id,x:Ke.x,z:Ke.z,facing:Ke.facing,walkPhase:Ke.walkPhase,isMoving:Ke.isMoving})}function w0(i){kt&&(H_(Lt.scene,kt),kt=null,Fi=!1,Ke.inVehicle=null,Ke.mesh.visible=!0),kt=Y_(Ke,i,Lt.clampPosition),G_(Lt.scene,kt),Fi=!0,V_(Ke,kt),_r(`Driving ${i.name}`)}function P0(){!kt||!Fi||(W_(Ke,kt),Fi=!1,lr(Ke),Lt.updateCamera(Ke.x,Ke.z,Ke.facing),_r("Exited vehicle"))}function L0(){let i=0,e=0;return yn.isPressed("w","arrowup")&&(e+=1),yn.isPressed("s","arrowdown")&&(e-=1),yn.isPressed("a","arrowleft")&&(i-=1),yn.isPressed("d","arrowright")&&(i+=1),{mx:i,mz:e}}function D0(){return rd(yn)}function I0(i,e){return{throttle:Math.max(i.throttle,e.throttle),brake:Math.max(i.brake,e.brake),steer:Math.abs(i.steer)>Math.abs(e.steer)?i.steer:e.steer}}function fl(i){var n,r;if(!i||fs!=="world"||oa()||Ja())return;const{fired:e,prevPressed:t}=ad(i,gl(),dl);dl=t;for(const s of e)_r(s.action);(n=i.buttons[9])!=null&&n.pressed&&!ra&&(ra=!0,vl(),sn&&(sn.hidden=!0)),(r=i==null?void 0:i.buttons[9])!=null&&r.pressed||(ra=!1)}function U0(i,e,t=1){const n=i/2,r=e*.42,s=e,a=i*.08*t,o=i*.92;return{cx:n,topY:r,bottomY:s,topW:a,bottomW:o}}function N0(i,e,t){if(t<=0)return;const n=U0(i,e,t),{cx:r,topY:s,bottomY:a,topW:o,bottomW:c}=n;$e.save(),$e.globalAlpha=Math.min(1,t);const l=$e.createLinearGradient(0,s,0,a);l.addColorStop(0,"#334155"),l.addColorStop(1,"#1e293b"),$e.fillStyle=l,$e.beginPath(),$e.moveTo(r-o,s),$e.lineTo(r+o,s),$e.lineTo(r+c/2,a),$e.lineTo(r-c/2,a),$e.closePath(),$e.fill(),$e.strokeStyle="rgba(250,204,21,0.85)",$e.lineWidth=3,$e.setLineDash([18,16]),$e.beginPath(),$e.moveTo(r,s),$e.lineTo(r,a),$e.stroke(),$e.setLineDash([]),$e.fillStyle="rgba(15,23,42,0.35)",$e.fillRect(0,e*.72,i,e*.28),$e.restore()}function _r(i){rr=2,sr&&(sr.textContent=i,sr.classList.add("show"))}function F0(){On.style.display="none",Lt.show(),ni&&(ni.hidden=!1),Qa(!0)}function O0(i){const e=nd();let{mx:t,mz:n}=id(e);const r=L0();t+=r.mx,n+=r.mz;const s=Math.hypot(t,n);if(s>1&&(t/=s,n/=s),Fi&&kt){const l=sd(e),u=D0(),d=I0(l,u);q_(kt,d,i,Lt.clampPosition),Lt.updateDrivingCamera(kt.x,kt.z,kt.rotY),fl(e),yn.isPressed("e")&&!aa&&(aa=!0,P0()),yn.isPressed("e")||(aa=!1);return}M_(Ke,t,n,i);const a=Ke.x+t*ul*i,o=Ke.z+n*ul*i,c=Lt.clampPosition(a,o);Ke.x=c.x,Ke.z=c.z,lr(Ke),Lt.updateCamera(Ke.x,Ke.z,Ke.facing),is.lerpAll(i),ia+=i,ia>=T0&&(ia=0,R0()),fl(e),yn.isPressed("m")&&!sa&&(sa=!0,vl(),sn&&(sn.hidden=!0)),yn.isPressed("m")||(sa=!1)}function hl(i){ni&&(ni.textContent=i,ni.hidden=!1)}function k0(i){const{width:e,height:t}=On;if(!((oa()||Ja())&&(sn&&(sn.hidden=!0),oa()))){if(rr>0&&(rr=Math.max(0,rr-i),rr===0&&sr&&sr.classList.remove("show")),Qi>0){Qi=Math.max(0,Qi-i);const n=Qi>.35?1-(1.8-Qi)/1.45:0;On.style.display="block",Lt.hide(),Qa(!1),Oo($e,n>.2?"#e0f2fe":"#22c55e"),n>.05&&($e.fillStyle=`rgba(255,255,255,${n*.75})`,$e.fillRect(0,0,e,t)),ko($e,"TELEPORTING...",e/2,t*.38,{color:"#0f172a",size:36});return}if(fs==="title"){On.style.display="block",Lt.hide(),Qa(!1),ni&&(ni.hidden=!0),sn&&(sn.hidden=!0),Jn&&(Jn.hidden=!0),ta=Math.min(1,ta+i*1.2),na=Math.min(1,na+i*.55),Oo($e,"#22c55e"),N0(e,t,na),$e.globalAlpha=ta,ko($e,b0,e/2,t*.14,{color:"#14532d",size:40}),$e.globalAlpha=1;return}fs==="world"&&(Ja()||O0(i),hl(Fi?"WASD = Xbox drive (W gas · S brake · A/D turn) · E exit · M = map":"WASD / arrows move · Garage (left) · M = controller map"),sn&&(sn.hidden=!1),Lt.render())}}window.addEventListener("gamepadconnected",()=>{});td(k0);
