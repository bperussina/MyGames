...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:In,depthTest:!1,depthWrite:!1})}function vc(){return new kn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:So(),fragmentShader:`
		...
		`,blending:In,depthTest:!1,depthWrite:!1})}function xc(){return new kn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:So(),fragmentShader:`
	...
	`}function mm(i){let e=new WeakMap,t=null;function n(o){if(o&&o.isTexture){const c=o.mapping,l=c===_a||c===va,u=c===Pi||c===Li;if(l||u){let d=e.get(o);const f=d!==void 0?d.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==f)return t===null&&(t=new gc(i)),d=l?t.fromEquirectangular(o,d):t.fromCubemap(o,d),d.texture.pmremVersion=o.pmremVersion,e.set(o,d),d.texture;if(d!==void 0)return d.texture;{const m=o.image;return l&&m&&m.height>0||u&&m&&r(m)?(t===null&&(t=new gc(i)),d=l?t.fromEquirectangular(o):t.fromCubemap(o),d.texture.pmremVersion=o.pmremVersion,e.set(o,d),o.addEventListener("dispose",s),d.texture):null}}}return o}function r(o){let c=0;const l=6;for(let u=0;u<l;u++)o[u]!==void 0&&c++;return c===l}function s(o){const c=o.target;c.removeEventListener("dispose",s);const l=e.get(c);l!==void 0&&(e.delete(c),l.dispose())}function a(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:a}}function gm(i){const e={};function t(n){if(e[n]!==void 0)return e[n];let r;switch(n){case"WEBGL_depth_texture":r=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=i.getExtension(n)}return e[n]=r,r}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const r=t(n);return r===null&&tr("THREE.WebGLRenderer: "+n+" extension not supported."),r}}}function _m(i,e,t,n){const r={},s=new WeakMap;function a(d){const f=d.target;f.index!==null&&e.remove(f.index);for(const g in f.attributes)e.remove(f.attributes[g]);for(const g in f.morphAttributes){const v=f.morphAttributes[g];for(let p=0,h=v.length;p<h;p++)e.remove(v[p])}f.removeEventListener("dispose",a),delete r[f.id];const m=s.get(f);m&&(e.remove(m),s.delete(f)),n.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,t.memory.geometries--}function o(d,f){return r[f.id]===!0||(f.addEventListener("dispose",a),r[f.id]=!0,t.memory.geometries++),f}function c(d){const f=d.attributes;for(const g in f)e.update(f[g],i.ARRAY_BUFFER);const m=d.morphAttributes;for(const g in m){const v=m[g];for(let p=0,h=v.length;p<h;p++)e.update(v[p],i.ARRAY_BUFFER)}}function l(d){const f=[],m=d.index,g=d.attributes.position;let v=0;if(m!==null){const T=m.array;v=m.version;for(let b=0,S=T.length;b<S;b+=3){const N=T[b+0],R=T[b+1],C=T[b+2];f.push(N,R,R,C,C,N)}}else if(g!==void 0){const T=g.array;v=g.version;for(let b=0,S=T.length/3-1;b<S;b+=3){const N=b+0,R=b+1,C=b+2;f.push(N,R,R,C,C,N)}}else return;const p=new(Nl(f)?Vl:Hl)(f,1);p.version=v;const h=s.get(d);h&&e.remove(h),s.set(d,p)}function u(d){const f=s.get(d);if(f){const m=d.index;m!==null&&f.version<m.version&&l(d)}else l(d);return s.get(d)}return{get:o,update:c,getWireframeAttribute:u}}function vm(i,e,t){let n;function r(f){n=f}let s,a;function o(f){s=f.type,a=f.bytesPerElement}function c(f,m){i.drawElements(n,m,s,f*a),t.update(m,n,1)}function l(f,m,g){g!==0&&(i.drawElementsInstanced(n,m,s,f*a,g),t.update(m,n,g))}function u(f,m,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,m,0,s,f,0,g);let p=0;for(let h=0;h<g;h++)p+=m[h];t.update(p,n,1)}function d(f,m,g,v){if(g===0)return;const p=e.get("WEBGL_multi_draw");if(p===null)for(let h=0;h<f.length;h++)l(f[h]/a,m[h],v[h]);else{p.multiDrawElementsInstancedWEBGL(n,m,0,s,f,0,v,0,g);let h=0;for(let T=0;T<g;T++)h+=m[T]*v[T];t.update(h,n,1)}}this.setMode=r,this.setIndex=o,this.render=c,this.renderInstances=l,this.renderMultiDraw=u,this.renderMultiDrawInstances=d}function xm(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(s/3);break;case i.LINES:t.lines+=o*(s/2);break;case i.LINE_STRIP:t.lines+=o*(s-1);break;case i.LINE_LOOP:t.lines+=o*s;break;case i.POINTS:t.points+=o*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:n}}function ym(i,e,t){const n=new WeakMap,r=new at;function s(a,o,c){const l=a.morphTargetInfluences,u=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,d=u!==void 0?u.length:0;let f=n.get(o);if(f===void 0||f.count!==d){let y=function(){I.dispose(),n.delete(o),o.removeEventListener("dispose",y)};var m=y;f!==void 0&&f.texture.dispose();const g=o.morphAttributes.position!==void 0,v=o.morphAttributes.normal!==void 0,p=o.morphAttributes.color!==void 0,h=o.morphAttributes.position||[],T=o.morphAttributes.normal||[],b=o.morphAttributes.color||[];let S=0;g===!0&&(S=1),v===!0&&(S=2),p===!0&&(S=3);let N=o.attributes.position.count*S,R=1;N>e.maxTextureSize&&(R=Math.ceil(N/e.maxTextureSize),N=e.maxTextureSize);const C=new Float32Array(N*R*4*d),I=new Ol(C,N,R,d);I.type=vn,I.needsUpdate=!0;const M=S*4;for(let A=0;A<d;A++){const z=h[A],B=T[A],W=b[A],j=N*R*4*A;for(let V=0;V<z.count;V++){const Z=V*M;g===!0&&(r.fromBufferAttribute(z,V),C[j+Z+0]=r.x,C[j+Z+1]=r.y,C[j+Z+2]=r.z,C[j+Z+3]=0),v===!0&&(r.fromBufferAttribute(B,V),C[j+Z+4]=r.x,C[j+Z+5]=r.y,C[j+Z+6]=r.z,C[j+Z+7]=0),p===!0&&(r.fromBufferAttribute(W,V),C[j+Z+8]=r.x,C[j+Z+9]=r.y,C[j+Z+10]=r.z,C[j+Z+11]=W.itemSize===4?r.w:1)}}f={count:d,texture:I,size:new Ve(N,R)},n.set(o,f),o.addEventListener("dispose",y)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)c.getUniforms().setValue(i,"morphTexture",a.morphTexture,t);else{let g=0;for(let p=0;p<l.length;p++)g+=l[p];const v=o.morphTargetsRelative?1:1-g;c.getUniforms().setValue(i,"morphTargetBaseInfluence",v),c.getUniforms().setValue(i,"morphTargetInfluences",l)}c.getUniforms().setValue(i,"morphTargetsTexture",f.texture,t),c.getUniforms().setValue(i,"morphTargetsTextureSize",f.size)}return{update:s}}function Sm(i,e,t,n){let r=new WeakMap;function s(c){const l=n.render.frame,u=c.geometry,d=e.get(c,u);if(r.get(d)!==l&&(e.update(d),r.set(d,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",o)===!1&&c.addEventListener("dispose",o),r.get(c)!==l&&(t.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,i.ARRAY_BUFFER),r.set(c,l))),c.isSkinnedMesh){const f=c.skeleton;r.get(f)!==l&&(f.update(),r.set(f,l))}return d}function a(){r=new WeakMap}function o(c){const l=c.target;l.removeEventListener("dispose",o),t.remove(l.instanceMatrix),l.instanceColor!==null&&t.remove(l.instanceColor)}return{update:s,dispose:a}}class jl extends It{constructor(e,t,n,r,s,a,o,c,l,u=Ci){if(u!==Ci&&u!==Ii)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&u===Ci&&(n=ni),n===void 0&&u===Ii&&(n=Di),super(null,r,s,a,o,c,u,n,l),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=o!==void 0?o:Qt,this.minFilter=c!==void 0?c:Qt,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const Kl=new It,yc=new jl(1,1),Zl=new Ol,Jl=new of,Ql=new $l,Sc=[],Mc=[],Ec=new Float32Array(16),bc=new Float32Array(9),Tc=new Float32Array(4);function zi(i,e,t){const n=i[0];if(n<=0||n>0)return i;const r=e*t;let s=Sc[r];if(s===void 0&&(s=new Float32Array(r),Sc[r]=s),e!==0){n.toArray(s,0);for(let a=1,o=0;a!==e;++a)o+=t,i[a].toArray(s,o)}return s}function ut(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function dt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function gs(i,e){let t=Mc[e];t===void 0&&(t=new Int32Array(e),Mc[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function Mm(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function Em(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(ut(t,e))return;i.uniform2fv(this.addr,e),dt(t,e)}}function bm(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(ut(t,e))return;i.uniform3fv(this.addr,e),dt(t,e)}}function Tm(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(ut(t,e))return;i.uniform4fv(this.addr,e),dt(t,e)}}function Cm(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(ut(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),dt(t,e)}else{if(ut(t,n))return;Tc.set(n),i.uniformMatrix2fv(this.addr,!1,Tc),dt(t,n)}}function Am(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(ut(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),dt(t,e)}else{if(ut(t,n))return;bc.set(n),i.uniformMatrix3fv(this.addr,!1,bc),dt(t,n)}}function Rm(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(ut(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),dt(t,e)}else{if(ut(t,n))return;Ec.set(n),i.uniformMatrix4fv(this.addr,!1,Ec),dt(t,n)}}function wm(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function Pm(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(ut(t,e))return;i.uniform2iv(this.addr,e),dt(t,e)}}function Lm(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(ut(t,e))return;i.uniform3iv(this.addr,e),dt(t,e)}}function Dm(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(ut(t,e))return;i.uniform4iv(this.addr,e),dt(t,e)}}function Im(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function Um(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(ut(t,e))return;i.uniform2uiv(this.addr,e),dt(t,e)}}function Nm(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(ut(t,e))return;i.uniform3uiv(this.addr,e),dt(t,e)}}function Fm(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(ut(t,e))return;i.uniform4uiv(this.addr,e),dt(t,e)}}function Om(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r);let s;this.type===i.SAMPLER_2D_SHADOW?(yc.compareFunction=Ul,s=yc):s=Kl,t.setTexture2D(e||s,r)}function km(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture3D(e||Jl,r)}function Bm(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTextureCube(e||Ql,r)}function zm(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture2DArray(e||Zl,r)}function Gm(i){switch(i){case 5126:return Mm;case 35664:return Em;case 35665:return bm;case 35666:return Tm;case 35674:return Cm;case 35675:return Am;case 35676:return Rm;case 5124:case 35670:return wm;case 35667:case 35671:return Pm;case 35668:case 35672:return Lm;case 35669:case 35673:return Dm;case 5125:return Im;case 36294:return Um;case 36295:return Nm;case 36296:return Fm;case 35678:case 36198:case 36298:case 36306:case 35682:return Om;case 35679:case 36299:case 36307:return km;case 35680:case 36300:case 36308:case 36293:return Bm;case 36289:case 36303:case 36311:case 36292:return zm}}function Hm(i,e){i.uniform1fv(this.addr,e)}function Vm(i,e){const t=zi(e,this.size,2);i.uniform2fv(this.addr,t)}function Wm(i,e){const t=zi(e,this.size,3);i.uniform3fv(this.addr,t)}function Xm(i,e){const t=zi(e,this.size,4);i.uniform4fv(this.addr,t)}function $m(i,e){const t=zi(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function qm(i,e){const t=zi(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function Ym(i,e){const t=zi(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function jm(i,e){i.uniform1iv(this.addr,e)}function Km(i,e){i.uniform2iv(this.addr,e)}function Zm(i,e){i.uniform3iv(this.addr,e)}function Jm(i,e){i.uniform4iv(this.addr,e)}function Qm(i,e){i.uniform1uiv(this.addr,e)}function eg(i,e){i.uniform2uiv(this.addr,e)}function tg(i,e){i.uniform3uiv(this.addr,e)}function ng(i,e){i.uniform4uiv(this.addr,e)}function ig(i,e,t){const n=this.cache,r=e.length,s=gs(t,r);ut(n,s)||(i.uniform1iv(this.addr,s),dt(n,s));for(let a=0;a!==r;++a)t.setTexture2D(e[a]||Kl,s[a])}function rg(i,e,t){const n=this.cache,r=e.length,s=gs(t,r);ut(n,s)||(i.uniform1iv(this.addr,s),dt(n,s));for(let a=0;a!==r;++a)t.setTexture3D(e[a]||Jl,s[a])}function sg(i,e,t){const n=this.cache,r=e.length,s=gs(t,r);ut(n,s)||(i.uniform1iv(this.addr,s),dt(n,s));for(let a=0;a!==r;++a)t.setTextureCube(e[a]||Ql,s[a])}function ag(i,e,t){const n=this.cache,r=e.length,s=gs(t,r);ut(n,s)||(i.uniform1iv(this.addr,s),dt(n,s));for(let a=0;a!==r;++a)t.setTexture2DArray(e[a]||Zl,s[a])}function og(i){switch(i){case 5126:return Hm;case 35664:return Vm;case 35665:return Wm;case 35666:return Xm;case 35674:return $m;case 35675:return qm;case 35676:return Ym;case 5124:case 35670:return jm;case 35667:case 35671:return Km;case 35668:case 35672:return Zm;case 35669:case 35673:return Jm;case 5125:return Qm;case 36294:return eg;case 36295:return tg;case 36296:return ng;case 35678:case 36198:case 36298:case 36306:case 35682:return ig;case 35679:case 36299:case 36307:return rg;case 35680:case 36300:case 36308:case 36293:return sg;case 36289:case 36303:case 36311:case 36292:return ag}}class cg{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=Gm(t.type)}}class lg{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=og(t.type)}}class ug{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const r=this.seq;for(let s=0,a=r.length;s!==a;++s){const o=r[s];o.setValue(e,t[o.id],n)}}}const qs=/(\w+)(\])?(\[|\.)?/g;function Cc(i,e){i.seq.push(e),i.map[e.id]=e}function dg(i,e,t){const n=i.name,r=n.length;for(qs.lastIndex=0;;){const s=qs.exec(n),a=qs.lastIndex;let o=s[1];const c=s[2]==="]",l=s[3];if(c&&(o=o|0),l===void 0||l==="["&&a+2===r){Cc(t,l===void 0?new cg(o,i,e):new lg(o,i,e));break}else{let d=t.map[o];d===void 0&&(d=new ug(o),Cc(t,d)),t=d}}}class Kr{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<n;++r){const s=e.getActiveUniform(t,r),a=e.getUniformLocation(t,s.name);dg(s,a,this)}}setValue(e,t,n,r){const s=this.map[t];s!==void 0&&s.setValue(e,n,r)}setOptional(e,t,n){const r=t[n];r!==void 0&&this.setValue(e,n,r)}static upload(e,t,n,r){for(let s=0,a=t.length;s!==a;++s){const o=t[s],c=n[o.id];c.needsUpdate!==!1&&o.setValue(e,c.value,r)}}static seqWithValue(e,t){const n=[];for(let r=0,s=e.length;r!==s;++r){const a=e[r];a.id in t&&n.push(a)}return n}}function Ac(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const fg=37297;let hg=0;function pg(i,e){const t=i.split(`
`),n=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let a=r;a<s;a++){const o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}const Rc=new Pe;function mg(i){Ge._getMatrix(Rc,Ge.workingColorSpace,i);const e=`mat3( ${Rc.elements.map(t=>t.toFixed(4))} )`;switch(Ge.getTransfer(i)){case ps:return[e,"LinearTransferOETF"];case Ye:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function wc(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),r=i.getShaderInfoLog(e).trim();if(n&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const a=parseInt(s[1]);return t.toUpperCase()+`

`+r+`

`+pg(i.getShaderSource(e),a)}else return r}function gg(i,e){const t=mg(e);return[`vec4 ${i}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}function _g(i,e){let t;switch(e){case Id:t="Linear";break;case Ud:t="Reinhard";break;case Nd:t="Cineon";break;case Fd:t="ACESFilmic";break;case kd:t="AgX";break;case Bd:t="Neutral";break;case Od:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const zr=new U;function vg(){Ge.getLuminanceCoefficients(zr);const i=zr.x.toFixed(4),e=zr.y.toFixed(4),t=zr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}function Ag(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===xl?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===yl?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===gn&&(e="SHADOWMAP_TYPE_VSM"),e}function Rg(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Pi:case Li:e="ENVMAP_TYPE_CUBE";break;case hs:e="ENVMAP_TYPE_CUBE_UV";break}return e}function wg(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Li:e="ENVMAP_MODE_REFRACTION";break}return e}function Pg(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Sl:e="ENVMAP_BLENDING_MULTIPLY";break;case Ld:e="ENVMAP_BLENDING_MIX";break;case Dd:e="ENVMAP_BLENDING_ADD";break}return e}function Lg(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function Dg(i,e,t,n){const r=i.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const c=Ag(t),l=Rg(t),u=wg(t),d=Pg(t),f=Lg(t),m=xg(t),g=yg(s),v=r.createProgram();let p,h,T=t.glslVersion?"#version "+t.glslVersion+`
...
`);i.RTCSessionDescription&&r instanceof i.RTCSessionDescription?arguments[0]=new i.RTCSessionDescription({type:r.type,sdp:s}):r.sdp=s}return t.apply(this,arguments)}}function es(i,e){if(!(i.RTCPeerConnection&&i.RTCPeerConnection.prototype))return;const t=i.RTCPeerConnection.prototype.addIceCandidate;!t||t.length===0||(i.RTCPeerConnection.prototype.addIceCandidate=function(){return arguments[0]?(e.browser==="chrome"&&e.version<78||e.browser==="firefox"&&e.version<68||e.browser==="safari")&&arguments[0]&&arguments[0].candidate===""?Promise.resolve():t.apply(this,arguments):(arguments[1]&&arguments[1].apply(null),Promise.resolve())})}function ts(i,e){if(!(i.RTCPeerConnection&&i.RTCPeerConnection.prototype))return;const t=i.RTCPeerConnection.prototype.setLocalDescription;!t||t.length===0||(i.RTCPeerConnection.prototype.setLocalDescription=function(){let r=arguments[0]||{};if(typeof r!="object"||r.type&&r.sdp)return t.apply(this,arguments);if(r={type:r.type,sdp:r.sdp},!r.type)switch(this.signalingState){case"stable":case"have-local-offer":case"have-remote-pranswer":r.type="offer";break;default:r.type="answer";break}return r.sdp||r.type!=="offer"&&r.type!=="answer"?t.apply(this,[r]):(r.type==="offer"?this.createOffer:this.createAnswer).apply(this).then(a=>t.apply(this,[a]))})}const o0=Object.freeze(Object.defineProperty({__proto__:null,removeExtmapAllowMixed:so,shimAddIceCandidateNullOrEmpty:es,shimConnectionState:ro,shimMaxMessageSize:Jr,shimParameterlessSetLocalDescription:ts,shimRTCIceCandidate:Zr,shimRTCIceCandidateRelayProtocol:io,shimSendThrowTypeError:Qr},Symbol.toStringTag,{value:"Module"}));function c0({window:i}={},e={shimChrome:!0,shimFirefox:!0,shimSafari:!0}){const t=bo,n=n0(i),r={browserDetails:n,commonShim:o0,extractVersion:ir,disableLog:e0,disableWarnings:t0,sdp:a0};switch(n.browser){case"chrome":if(!Qc||!to||!e.shimChrome)return t("Chrome shim is not included in this adapter release."),r;if(n.version===null)return t("Chrome shim can not determine version, not shimming."),r;t("adapter.js shimming chrome."),r.browserShim=Qc,es(i,n),ts(i),lu(i,n),uu(i),to(i,n),du(i,n),mu(i,n),fu(i),hu(i,n),gu(i,n),Zr(i),io(i),ro(i),Jr(i,n),Qr(i,n),so(i,n);break;case"firefox":if(!el||!no||!e.shimFirefox)return t("Firefox shim is not included in this adapter release."),r;t("adapter.js shimming firefox."),r.browserShim=el,es(i,n),ts(i),_u(i,n),no(i,n),xu(i,n),vu(i),Mu(i),yu(i),Su(i),Eu(i),bu(i,n),Tu(i,n),Cu(i,n),Au(i,n),Zr(i),ro(i),Jr(i,n),Qr(i,n);break;case"safari":if(!tl||!e.shimSafari)return t("Safari shim is not included in this adapter release."),r;t("adapter.js shimming safari."),r.browserShim=tl,es(i,n),ts(i),Iu(i),Nu(i),Pu(i),Ru(i),wu(i),Uu(i),Lu(i),Fu(i),Zr(i),io(i),Jr(i,n),Qr(i,n),so(i,n);break;default:t("Unsupported browser!");break}return r}const il=c0({window:typeof window>"u"?void 0:window});function si(i,e,t,n){Object.defineProperty(i,e,{get:t,set:n,enumerable:!0,configurable:!0})}class ku{constructor(){this.chunkedMTU=16300,this._dataCount=1,this.chunk=e=>{const t=[],n=e.byteLength,r=Math.ceil(n/this.chunkedMTU);let s=0,a=0;for(;a<n;){const o=Math.min(n,a+this.chunkedMTU),c=e.slice(a,o),l={__peerData:this._dataCount,n:s,data:c,total:r};t.push(l),a=o,s++}return this._dataCount++,t}}}function l0(i){let e=0;for(const r of i)e+=r.byteLength;const t=new Uint8Array(e);let n=0;for(const r of i)t.set(r,n),n+=r.byteLength;return t}const Js=il.default||il,Ji=new class{isWebRTCSupported(){return typeof RTCPeerConnection<"u"}isBrowserSupported(){const i=this.getBrowser(),e=this.getVersion();return this.supportedBrowsers.includes(i)?i==="chrome"?e>=this.minChromeVersion:i==="firefox"?e>=this.minFirefoxVersion:i==="safari"?!this.isIOS&&e>=this.minSafariVersion:!1:!1}getBrowser(){return Js.browserDetails.browser}getVersion(){return Js.browserDetails.version||0}isUnifiedPlanSupported(){const i=this.getBrowser(),e=Js.browserDetails.version||0;if(i==="chrome"&&e<this.minChromeVersion)return!1;if(i==="firefox"&&e>=this.minFirefoxVersion)return!0;if(!window.RTCRtpTransceiver||!("currentDirection"in RTCRtpTransceiver.prototype))return!1;let t,n=!1;try{t=new RTCPeerConnection,t.addTransceiver("audio"),n=!0}catch{}finally{t&&t.close()}return n}toString(){return`Supports:
  ...
  `,document.body.appendChild(ht);const e=ht.querySelector("#lobby-status"),t=ht.querySelector("#host-info"),n=ht.querySelector("#room-code"),r=ht.querySelector("#share-link");function s(c){e&&(e.textContent=c)}ht.querySelector("#btn-generate").addEventListener("click",async()=>{try{bt&&bt.close(),bt=cl(),bt.onStatus=s;const c=M0(),l=await bt.host(c);n.textContent=l.code,r.value=l.link,t.hidden=!1,history.replaceState(null,"",l.link),ea(),nn==null||nn({room:bt,isHost:!0})}catch{s("Could not create room — try again.")}}),ht.querySelector("#btn-copy").addEventListener("click",async()=>{try{await navigator.clipboard.writeText(r.value),s("Link copied! Send it to your family.")}catch{r.select(),s("Select the link and copy it.")}}),ht.querySelector("#btn-enter-host").addEventListener("click",()=>{!bt||bt.role!=="host"||(ea(),nn==null||nn({room:bt,isHost:!0}))}),ht.querySelector("#btn-join").addEventListener("click",()=>a()),ht.querySelector("#join-code").addEventListener("keydown",c=>{c.key==="Enter"&&a()});async function a(){const c=ht.querySelector("#join-code").value.trim();if(!c){s("Type a room code first.");return}try{bt&&bt.close(),bt=cl(),bt.onStatus=s,await bt.join(c),ea(),nn==null||nn({room:bt,isHost:!1})}catch{}}const o=new URLSearchParams(window.location.search).get("room");return o&&(ht.querySelector("#join-code").value=o,s("Joining from your link…"),setTimeout(()=>a(),400)),ht}function ea(){ht&&(ht.style.display="none")}const ll=[15680580,16347926,15381256,2278750,440020,11032055,15485081];function b0(i){const e=new Map;let t=0;function n(){const l=ll[t%ll.length];return t+=1,l}function r(l){if(e.has(l))return e.get(l);const u=n(),d=nu(0,0,u);d.mesh.userData.remoteId=l,i.add(d.mesh);const f={player:d,target:{x:0,z:0,facing:0,walkPhase:0,isMoving:!1}};return e.set(l,f),f}function s(l,u){const d=r(l);Object.assign(d.target,u);const f=d.player;f.x=u.x,f.z=u.z,f.facing=u.facing??0,f.walkPhase=u.walkPhase??0,f.isMoving=!!u.isMoving,lr(f)}function a(l){const u=e.get(l);u&&(i.remove(u.player.mesh),e.delete(l))}function o(l){const u=Math.min(1,l*12);for(const[,d]of e){const f=d.player,m=d.target;f.x+=(m.x-f.x)*u,f.z+=(m.z-f.z)*u,f.facing+=(m.facing-f.facing)*u,f.walkPhase=m.walkPhase,f.isMoving=m.isMoving,lr(f)}}function c(){for(const l of[...e.keys()])a(l)}return{applyPose:s,remove:a,lerpAll:o,clear:c,count:()=>e.size}}const T0="car crashing with dashing",ul=7,C0=.05,A0=new URLSearchParams(window.location.search).has("teleport"),{canvas:Fn,ctx:$e}=Ju();Fn.id="title-canvas";Fn.style.position="fixed";Fn.style.inset="0";Fn.style.zIndex="1";const Mi=new ed(document.body),Lt=y_(),Ke=nu(0,0);b_(Lt.scene,Ke);const is=b0(Lt.scene);let fs="title",Qi=A0?1.8:0,ta=0,na=0,Wt=null,$u=!1,ia=0,bi=1,ra=!1,sa=!1,aa=!1,kt=null,Fi=!1,dl={},rr=0;const sr=document.getElementById("action-toast"),sn=document.getElementById("map-hint"),ti=document.getElementById("hud"),Zn=document.getElementById("room-banner");_l();T_(P0);E0(({room:i,isHost:e})=>{Wt=i,$u=e,Ke.x=0,Ke.z=0,lr(Ke),R0(i),fs="world",F0(),rs(),_r(e?"You are the host — share your link!":`Joined room ${i.code}`)});function R0(i){i.onMessage=(e,t)=>{e.t==="pose"&&e.id&&e.id!==i.id&&(i.role==="host"&&i.relay(t,e),is.applyPose(e.id,e)),e.t==="join"&&e.id&&(is.applyPose(e.id,{x:0,z:4,facing:0,walkPhase:0,isMoving:!1}),bi+=1,rs(),_r("Someone joined!")),e.t==="leave"&&e.id&&(is.remove(e.id),bi=Math.max(1,bi-1),rs())},i.onPeerCount=e=>{bi=e,rs()}}function rs(){if(!(!Zn||!(Wt!=null&&Wt.code)))if($u){const i=Xu(Wt.code);Zn.innerHTML=`Room <strong>${Wt.code}</strong> · ${bi} player(s) · <a href="${i}" target="_blank" rel="noopener">Share link</a>`,Zn.hidden=!1}else Zn.textContent=`Room ${Wt.code} · ${bi} player(s)`,Zn.hidden=!1}function w0(){Wt!=null&&Wt.id&&Wt.send({t:"pose",id:Wt.id,x:Ke.x,z:Ke.z,facing:Ke.facing,walkPhase:Ke.walkPhase,isMoving:Ke.isMoving})}function P0(i){kt&&(V_(Lt.scene,kt),kt=null,Fi=!1,Ke.inVehicle=null,Ke.mesh.visible=!0),kt=j_(Ke,i,Lt.clampPosition),H_(Lt.scene,kt),Fi=!0,W_(Ke,kt),_r(`Driving ${i.name}`)}function L0(){!kt||!Fi||(X_(Ke,kt),Fi=!1,lr(Ke),Lt.updateCamera(Ke.x,Ke.z,Ke.facing),_r("Exited vehicle"))}function D0(){return sd(Mi)}function I0(i,e){return{throttle:Math.max(i.throttle,e.throttle),brake:Math.max(i.brake,e.brake),steer:Math.abs(i.steer)>Math.abs(e.steer)?i.steer:e.steer}}function fl(i){var n,r;if(!i||fs!=="world"||oa()||Ja())return;const{fired:e,prevPressed:t}=od(i,gl(),dl);dl=t;for(const s of e)_r(s.action);(n=i.buttons[9])!=null&&n.pressed&&!ra&&(ra=!0,vl(),sn&&(sn.hidden=!0)),(r=i==null?void 0:i.buttons[9])!=null&&r.pressed||(ra=!1)}function U0(i,e,t=1){const n=i/2,r=e*.42,s=e,a=i*.08*t,o=i*.92;return{cx:n,topY:r,bottomY:s,topW:a,bottomW:o}}function N0(i,e,t){if(t<=0)return;const n=U0(i,e,t),{cx:r,topY:s,bottomY:a,topW:o,bottomW:c}=n;$e.save(),$e.globalAlpha=Math.min(1,t);const l=$e.createLinearGradient(0,s,0,a);l.addColorStop(0,"#334155"),l.addColorStop(1,"#1e293b"),$e.fillStyle=l,$e.beginPath(),$e.moveTo(r-o,s),$e.lineTo(r+o,s),$e.lineTo(r+c/2,a),$e.lineTo(r-c/2,a),$e.closePath(),$e.fill(),$e.strokeStyle="rgba(250,204,21,0.85)",$e.lineWidth=3,$e.setLineDash([18,16]),$e.beginPath(),$e.moveTo(r,s),$e.lineTo(r,a),$e.stroke(),$e.setLineDash([]),$e.fillStyle="rgba(15,23,42,0.35)",$e.fillRect(0,e*.72,i,e*.28),$e.restore()}function _r(i){rr=2,sr&&(sr.textContent=i,sr.classList.add("show"))}function F0(){Fn.style.display="none",Lt.show(),ti&&(ti.hidden=!1),Qa(!0)}function O0(i){const e=nd();let{mx:t,mz:n}=id(e);const r=rd(Mi);t+=r.mx,n+=r.mz;const s=Math.hypot(t,n);if(s>1&&(t/=s,n/=s),Fi&&kt){const l=ad(e),u=D0(),d=I0(l,u);Y_(kt,d,i,Lt.clampPosition),Lt.updateDrivingCamera(kt.x,kt.z,kt.rotY),fl(e),Mi.isPressed("e")&&!aa&&(aa=!0,L0()),Mi.isPressed("e")||(aa=!1);return}E_(Ke,t,n,i);const a=Ke.x+t*ul*i,o=Ke.z+n*ul*i,c=Lt.clampPosition(a,o);Ke.x=c.x,Ke.z=c.z,lr(Ke),Lt.updateCamera(Ke.x,Ke.z,Ke.facing),is.lerpAll(i),ia+=i,ia>=C0&&(ia=0,w0()),fl(e),Mi.isPressed("m")&&!sa&&(sa=!0,vl(),sn&&(sn.hidden=!0)),Mi.isPressed("m")||(sa=!1)}function hl(i){ti&&(ti.textContent=i,ti.hidden=!1)}function k0(i){const{width:e,height:t}=Fn;if(!((oa()||Ja())&&(sn&&(sn.hidden=!0),oa()))){if(rr>0&&(rr=Math.max(0,rr-i),rr===0&&sr&&sr.classList.remove("show")),Qi>0){Qi=Math.max(0,Qi-i);const n=Qi>.35?1-(1.8-Qi)/1.45:0;Fn.style.display="block",Lt.hide(),Qa(!1),Oo($e,n>.2?"#e0f2fe":"#22c55e"),n>.05&&($e.fillStyle=`rgba(255,255,255,${n*.75})`,$e.fillRect(0,0,e,t)),ko($e,"TELEPORTING...",e/2,t*.38,{color:"#0f172a",size:36});return}if(fs==="title"){Fn.style.display="block",Lt.hide(),Qa(!1),ti&&(ti.hidden=!0),sn&&(sn.hidden=!0),Zn&&(Zn.hidden=!0),ta=Math.min(1,ta+i*1.2),na=Math.min(1,na+i*.55),Oo($e,"#22c55e"),N0(e,t,na),$e.globalAlpha=ta,ko($e,T0,e/2,t*.14,{color:"#14532d",size:40}),$e.globalAlpha=1;return}fs==="world"&&(Ja()||O0(i),hl(Fi?"WASD to drive · Xbox: hold X gas, B brake, LB/LT/RB turn · E exit · M = map":"WASD to move · Xbox: stick/D-pad · M = controller map · Garage (left)"),sn&&(sn.hidden=!1),Lt.render())}}window.addEventListener("gamepadconnected",()=>{});td(k0);
