var Tp=n=>{throw TypeError(n)};var kr=(n,e,t)=>e.has(n)?Tp("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(n):e.set(n,t);function wp(n,e){for(var t=0;t<e.length;t++){const i=e[t];if(typeof i!="string"&&!Array.isArray(i)){for(const r in i)if(r!=="default"&&!(r in n)){const s=Object.getOwnPropertyDescriptor(i,r);s&&Object.defineProperty(n,r,s.get?s:{enumerable:!0,get:()=>i[r]})}}}return Object.freeze(Object.defineProperty(n,Symbol.toStringTag,{value:"Module"}))}(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function t(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerPolicy&&(s.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?s.credentials="include":r.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(r){if(r.ep)return;r.ep=!0;const s=t(r);fetch(r.href,s)}})();function Cp(n=document.body){const e=document.createElement("canvas");e.style.display="block",n.appendChild(e);const t=e.getContext("2d");function i(){e.width=window.innerWidth,e.height=window.innerHeight}return i(),window.addEventListener("resize",i),{canvas:e,ctx:t,resize:i}}function od(n,e="#1a1a2e"){n.fillStyle=e,n.fillRect(0,0,n.canvas.width,n.canvas.height)}const Ap=new Set(["arrowup","arrowdown","arrowleft","arrowright"," ","w","a","s","d","x","e","r","l","b"]);class Rp{constructor(e=window){this.keys=new Set,this.pointer={x:0,y:0,down:!1},document.addEventListener("keydown",t=>{const i=t.key.toLowerCase();this.keys.add(i),Ap.has(i)&&t.preventDefault()}),document.addEventListener("keyup",t=>{this.keys.delete(t.key.toLowerCase())}),e.addEventListener("pointermove",t=>{this.pointer.x=t.clientX,this.pointer.y=t.clientY}),e.addEventListener("pointerdown",t=>{this.pointer.x=t.clientX,this.pointer.y=t.clientY,this.pointer.down=!0,e.focus&&e.focus()}),e.addEventListener("pointerup",()=>{this.pointer.down=!1})}isDown(e){return this.keys.has(e.toLowerCase())}isPressed(...e){return e.some(t=>this.isDown(t))}}function Pp(n){let e=0,t=performance.now();function i(r){const s=(r-t)/1e3;t=r,n(s),e=requestAnimationFrame(i)}return e=requestAnimationFrame(i),()=>cancelAnimationFrame(e)}function Ya(n,e,t,i,r={}){const{color:s="#ffffff",size:o=24,align:a="center",baseline:c="middle",font:l="sans-serif"}=r;n.fillStyle=s,n.font=`${o}px ${l}`,n.textAlign=a,n.textBaseline=c,n.fillText(e,t,i)}const ad=.18;function Lp(){var e;return(((e=navigator.getGamepads)==null?void 0:e.call(navigator))??[]).find(t=>t==null?void 0:t.connected)??null}function Dp(n){var i,r,s,o;let e=0,t=0;if(n){const a=n.axes[0]??0,c=n.axes[1]??0;Math.abs(a)>ad&&(e+=a),Math.abs(c)>ad&&(t-=c),(i=n.buttons[14])!=null&&i.pressed&&(e-=1),(r=n.buttons[15])!=null&&r.pressed&&(e+=1),(s=n.buttons[12])!=null&&s.pressed&&(t+=1),(o=n.buttons[13])!=null&&o.pressed&&(t-=1)}return{mx:e,mz:t}}function Ip(n){let e=0,t=0;return n.isPressed("w","arrowup")&&(t+=1),n.isPressed("s","arrowdown")&&(t-=1),n.isPressed("a","arrowleft")&&(e-=1),n.isPressed("d","arrowright")&&(e+=1),{mx:e,mz:t}}function Up(n){let e=0,t=0,i=0,r=0;return n.isPressed("w","arrowup")&&(e=1),n.isPressed("s")&&(t=1),n.isPressed("arrowdown")&&(i=1),n.isPressed("a","arrowleft")&&(r-=1),n.isPressed("d","arrowright")&&(r+=1),r=Math.max(-1,Math.min(1,r)),{throttle:e,brake:t,reverse:i,steer:r}}function Np(n){var a,c,l,d,u,h;let e=0,t=0,i=0;if(!n)return{throttle:e,brake:t,reverse:0,steer:i};(a=n.buttons[2])!=null&&a.pressed&&(e=1),(c=n.buttons[1])!=null&&c.pressed&&(t=1);let r=0,s=0;return(l=n.buttons[4])!=null&&l.pressed&&(r=1),(((d=n.buttons[6])==null?void 0:d.value)??((u=n.buttons[6])!=null&&u.pressed?1:0))>.08&&(r=1),(h=n.buttons[5])!=null&&h.pressed&&(s=1),i=s-r,{throttle:e,brake:t,reverse:0,steer:i}}const ml=[{id:"a",label:"A",index:0},{id:"b",label:"B",index:1},{id:"x",label:"X",index:2},{id:"y",label:"Y",index:3},{id:"lb",label:"LB",index:4},{id:"rb",label:"RB",index:5},{id:"lt",label:"LT",index:6},{id:"rt",label:"RT",index:7},{id:"view",label:"View",index:8},{id:"menu",label:"Menu",index:9},{id:"ls",label:"Left stick press",index:10},{id:"rs",label:"Right stick press",index:11},{id:"dpadUp",label:"D-pad Up",index:12},{id:"dpadDown",label:"D-pad Down",index:13},{id:"dpadLeft",label:"D-pad Left",index:14},{id:"dpadRight",label:"D-pad Right",index:15},{id:"xbox",label:"Xbox",index:16}];function kp(n,e,t={}){var s;const i=[];if(!n)return{fired:i,prevPressed:t};const r={...t};for(const o of ml){const a=!!((s=n.buttons[o.index])!=null&&s.pressed),c=t[o.id]??!1;if(r[o.id]=a,a&&!c){const l=(e[o.id]??"").trim();l&&i.push({id:o.id,action:l})}}return{fired:i,prevPressed:r}}const vh="ccwd-button-labels";function gl(){try{return JSON.parse(localStorage.getItem(vh)??"{}")}catch{return{}}}function Op(n){try{localStorage.setItem(vh,JSON.stringify(n))}catch{}}let Ft=null,Kr=null;function yh(n){if(Kr=n,Ft)return Ft;Ft=document.createElement("div"),Ft.id="controller-map",Ft.innerHTML=`
    <div class="cm-header">
  ...
  `,document.body.appendChild(Ft);const e=Ft.querySelector("#cm-fields"),t=gl();for(const i of ml){const r=document.createElement("div");r.className="cm-row",r.innerHTML=`
      ...
      <input type="text" class="cm-input" data-id="${i.id}" placeholder="(blank = does nothing)" value="${Fp(t[i.id]??"")}" />
    `,e.appendChild(r)}return Ft.querySelector("#cm-done").addEventListener("click",()=>{const i={};Ft.querySelectorAll(".cm-input").forEach(r=>{i[r.dataset.id]=r.value}),Op(i),Bp(),Kr==null||Kr()}),Ft}function Fp(n){return String(n).replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;")}function Sh(){yh(Kr),Ft.style.display="flex"}function Bp(){Ft&&(Ft.style.display="none")}function qa(){return(Ft==null?void 0:Ft.style.display)==="flex"}const zp={x:"Gas",b:"Brake",lb:"Turn left",lt:"Turn left",rb:"Turn right",menu:"Change controls"},Hp={a:"chip-a",b:"chip-b",x:"chip-x",y:"chip-y",lb:"chip-bump",rb:"chip-bump",lt:"chip-trigger",rt:"chip-trigger",view:"chip-misc",menu:"chip-misc",ls:"chip-misc",rs:"chip-misc",dpadUp:"chip-dpad",dpadDown:"chip-dpad",dpadLeft:"chip-dpad",dpadRight:"chip-dpad",xbox:"chip-misc"};function Ri(n){return String(n).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/"/g,"&quot;")}function Gp(n,e){const t=(n[e]??"").trim();return t||(zp[e]??"").trim()}function Vp(n,e){return`<span class="pc-key" title="${Ri(e)}"><span class="pc-key-letter">${Ri(n)}</span><span class="pc-key-word">${Ri(e)}</span></span>`}function Wp(n,e){return`<span class="pad-chip ${Hp[n.id]??"chip-misc"}" title="${Ri(n.label)} button — ${Ri(e)}"><span class="pad-chip-mark">${Ri(n.label)}</span><span class="pad-chip-word">${Ri(e)}</span></span>`}function ko(n,{driving:e=!1}={}){if(!n)return;const t=n.querySelector("#controls-body");if(!t)return;const i=gl(),r=e?[{key:"W",word:"Gas"},{key:"↑",word:"Gas"},{key:"S",word:"Brake"},{key:"↓",word:"Reverse"},{key:"A",word:"Left"},{key:"←",word:"Left"},{key:"D",word:"Right"},{key:"→",word:"Right"},{key:"E",word:"Exit car"}]:[{key:"W",word:"Forward"},{key:"↑",word:"Forward"},{key:"A",word:"Left"},{key:"←",word:"Left"},{key:"S",word:"Back"},{key:"↓",word:"Back"},{key:"D",word:"Right"},{key:"→",word:"Right"}],s=['<span class="pad-chip chip-stick" title="Left stick — move"><span class="pad-chip-mark">Stick</span><span class="pad-chip-word">Move</span></span>'];for(const o of ml){const a=Gp(i,o.id);a&&s.push(Wp(o,a))}t.innerHTML=`
    ...
    <div class="controls-mini-block">
      ...
      <div class="pc-keys">${r.map(({key:o,word:a})=>Vp(o,a)).join("")}</div>
    </div>
    <div class="controls-mini-block">
      <span class="controls-mini-label">Xbox</span>
      <div class="pad-chips">${s.join("")}</div>
    </div>
  `}function Pi(n,e,t={}){if(!n)return;if(!e){n.hidden=!0;return}const i=t.driving?"1":"0";(n.hidden||n.dataset.driving!==i)&&(ko(n,t),n.dataset.driving=i),n.hidden=!1}function Xp(n){const e=n.width??1.88,t=n.length??4.55;return{hw:e*.5+.06,hd:t*.5+.08,width:e,length:t}}function $p(n,e,t){const i=Math.abs(Math.cos(n)),r=Math.abs(Math.sin(n));return{halfX:e*i+t*r,halfZ:e*r+t*i}}function Yp(n,e,t,i,r){return n+t>r.minX&&n-t<r.maxX&&e+i>r.minZ&&e-i<r.maxZ}function qp(n){return n<=1.5?"Ultra-slim — slips through the tightest alleys":n<=1.65?"Slim — fits narrow alleys":n<=1.85?"Average — most city gaps":n<=2?"Wide — tight alleys are tricky":"Extra wide — needs open roads"}function jp(n){return n>66?"#22c55e":n>33?"#eab308":"#ef4444"}function Or(n,e){const t=jp(e);return`<div class="dmg-row"><span class="dmg-label">${n}</span>
    <div class="dmg-track"><div class="dmg-fill" style="width:${e}%;background:${t}"></div></div>
    <span class="dmg-pct">${Math.round(e)}%</span></div>`}function _l(n,e){if(!n||!(e!=null&&e.partHealth))return;const t=e.partHealth,i=Math.round((t.wheel_fl+t.wheel_fr+t.wheel_rl+t.wheel_rr)/4),r=e.collisionWidth??1.88;n.innerHTML=`
    <p class="dmg-title">Vehicle damage</p>
    <p class="dmg-width">${r.toFixed(2)}m wide · ${qp(r)}</p>
    ${Or("Engine",t.engine)}
    ${Or("Body",t.body)}
    ${Or("Hood",t.hood)}
    ${Or("Glass",t.windshield)}
    ${Or("Wheels",i)}
  `}function xl(n,e){n&&(e?n.removeAttribute("hidden"):n.setAttribute("hidden",""))}function Zp(){return matchMedia("(pointer: coarse)").matches||"ontouchstart"in window}const Kp=()=>({mx:0,mz:0}),Jp=()=>({throttle:0,brake:0,reverse:0,steer:0});function Qp(){if(!Zp())return{readMove:Kp,readDrive:Jp,setDriving:()=>{},setVisible:()=>{},onExit:()=>{}};const n=document.createElement("div");n.id="touch-pad",n.innerHTML=`
...
void main() {
	...
	`}function nx(n){let e=new WeakMap,t=null;function i(a){if(a&&a.isTexture){const c=a.mapping,l=c===rc||c===sc,d=c===Sr||c===Mr;if(l||d){let u=e.get(a);const h=u!==void 0?u.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==h)return t===null&&(t=new kc(n)),u=l?t.fromEquirectangular(a,u):t.fromCubemap(a,u),u.texture.pmremVersion=a.pmremVersion,e.set(a,u),u.texture;if(u!==void 0)return u.texture;{const p=a.image;return l&&p&&p.height>0||d&&p&&r(p)?(t===null&&(t=new kc(n)),u=l?t.fromEquirectangular(a):t.fromCubemap(a),u.texture.pmremVersion=a.pmremVersion,e.set(a,u),a.addEventListener("dispose",s),u.texture):null}}}return a}function r(a){let c=0;const l=6;for(let d=0;d<l;d++)a[d]!==void 0&&c++;return c===l}function s(a){const c=a.target;c.removeEventListener("dispose",s);const l=e.get(c);l!==void 0&&(e.delete(c),l.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:i,dispose:o}}function ix(n){const e={};function t(i){if(e[i]!==void 0)return e[i];let r;switch(i){case"WEBGL_depth_texture":r=n.getExtension("WEBGL_depth_texture")||n.getExtension("MOZ_WEBGL_depth_texture")||n.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=n.getExtension("EXT_texture_filter_anisotropic")||n.getExtension("MOZ_EXT_texture_filter_anisotropic")||n.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=n.getExtension("WEBGL_compressed_texture_s3tc")||n.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=n.getExtension("WEBGL_compressed_texture_pvrtc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=n.getExtension(i)}return e[i]=r,r}return{has:function(i){return t(i)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(i){const r=t(i);return r===null&&Jr("THREE.WebGLRenderer: "+i+" extension not supported."),r}}}function rx(n,e,t,i){const r={},s=new WeakMap;function o(u){const h=u.target;h.index!==null&&e.remove(h.index);for(const g in h.attributes)e.remove(h.attributes[g]);for(const g in h.morphAttributes){const _=h.morphAttributes[g];for(let m=0,f=_.length;m<f;m++)e.remove(_[m])}h.removeEventListener("dispose",o),delete r[h.id];const p=s.get(h);p&&(e.remove(p),s.delete(h)),i.releaseStatesOfGeometry(h),h.isInstancedBufferGeometry===!0&&delete h._maxInstanceCount,t.memory.geometries--}function a(u,h){return r[h.id]===!0||(h.addEventListener("dispose",o),r[h.id]=!0,t.memory.geometries++),h}function c(u){const h=u.attributes;for(const g in h)e.update(h[g],n.ARRAY_BUFFER);const p=u.morphAttributes;for(const g in p){const _=p[g];for(let m=0,f=_.length;m<f;m++)e.update(_[m],n.ARRAY_BUFFER)}}function l(u){const h=[],p=u.index,g=u.attributes.position;let _=0;if(p!==null){const E=p.array;_=p.version;for(let w=0,x=E.length;w<x;w+=3){const A=E[w+0],M=E[w+1],T=E[w+2];h.push(A,M,M,T,T,A)}}else if(g!==void 0){const E=g.array;_=g.version;for(let w=0,x=E.length/3-1;w<x;w+=3){const A=w+0,M=w+1,T=w+2;h.push(A,M,M,T,T,A)}}else return;const m=new(Oh(h)?Wh:Vh)(h,1);m.version=_;const f=s.get(u);f&&e.remove(f),s.set(u,m)}function d(u){const h=s.get(u);if(h){const p=u.index;p!==null&&h.version<p.version&&l(u)}else l(u);return s.get(u)}return{get:a,update:c,getWireframeAttribute:d}}function sx(n,e,t){let i;function r(h){i=h}let s,o;function a(h){s=h.type,o=h.bytesPerElement}function c(h,p){n.drawElements(i,p,s,h*o),t.update(p,i,1)}function l(h,p,g){g!==0&&(n.drawElementsInstanced(i,p,s,h*o,g),t.update(p,i,g))}function d(h,p,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,p,0,s,h,0,g);let m=0;for(let f=0;f<g;f++)m+=p[f];t.update(m,i,1)}function u(h,p,g,_){if(g===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let f=0;f<h.length;f++)l(h[f]/o,p[f],_[f]);else{m.multiDrawElementsInstancedWEBGL(i,p,0,s,h,0,_,0,g);let f=0;for(let E=0;E<g;E++)f+=p[E]*_[E];t.update(f,i,1)}}this.setMode=r,this.setIndex=a,this.render=c,this.renderInstances=l,this.renderMultiDraw=d,this.renderMultiDrawInstances=u}function ox(n){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function i(s,o,a){switch(t.calls++,o){case n.TRIANGLES:t.triangles+=a*(s/3);break;case n.LINES:t.lines+=a*(s/2);break;case n.LINE_STRIP:t.lines+=a*(s-1);break;case n.LINE_LOOP:t.lines+=a*s;break;case n.POINTS:t.points+=a*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:i}}function ax(n,e,t){const i=new WeakMap,r=new ct;function s(o,a,c){const l=o.morphTargetInfluences,d=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,u=d!==void 0?d.length:0;let h=i.get(a);if(h===void 0||h.count!==u){let S=function(){R.dispose(),i.delete(a),a.removeEventListener("dispose",S)};var p=S;h!==void 0&&h.texture.dispose();const g=a.morphAttributes.position!==void 0,_=a.morphAttributes.normal!==void 0,m=a.morphAttributes.color!==void 0,f=a.morphAttributes.position||[],E=a.morphAttributes.normal||[],w=a.morphAttributes.color||[];let x=0;g===!0&&(x=1),_===!0&&(x=2),m===!0&&(x=3);let A=a.attributes.position.count*x,M=1;A>e.maxTextureSize&&(M=Math.ceil(A/e.maxTextureSize),A=e.maxTextureSize);const T=new Float32Array(A*M*4*u),R=new Bh(T,A,M,u);R.type=Bn,R.needsUpdate=!0;const v=x*4;for(let P=0;P<u;P++){const B=f[P],F=E[P],k=w[P],H=A*M*4*P;for(let O=0;O<B.count;O++){const $=O*v;g===!0&&(r.fromBufferAttribute(B,O),T[H+$+0]=r.x,T[H+$+1]=r.y,T[H+$+2]=r.z,T[H+$+3]=0),_===!0&&(r.fromBufferAttribute(F,O),T[H+$+4]=r.x,T[H+$+5]=r.y,T[H+$+6]=r.z,T[H+$+7]=0),m===!0&&(r.fromBufferAttribute(k,O),T[H+$+8]=r.x,T[H+$+9]=r.y,T[H+$+10]=r.z,T[H+$+11]=k.itemSize===4?r.w:1)}}h={count:u,texture:R,size:new Fe(A,M)},i.set(a,h),a.addEventListener("dispose",S)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)c.getUniforms().setValue(n,"morphTexture",o.morphTexture,t);else{let g=0;for(let m=0;m<l.length;m++)g+=l[m];const _=a.morphTargetsRelative?1:1-g;c.getUniforms().setValue(n,"morphTargetBaseInfluence",_),c.getUniforms().setValue(n,"morphTargetInfluences",l)}c.getUniforms().setValue(n,"morphTargetsTexture",h.texture,t),c.getUniforms().setValue(n,"morphTargetsTextureSize",h.size)}return{update:s}}function cx(n,e,t,i){let r=new WeakMap;function s(c){const l=i.render.frame,d=c.geometry,u=e.get(c,d);if(r.get(u)!==l&&(e.update(u),r.set(u,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",a)===!1&&c.addEventListener("dispose",a),r.get(c)!==l&&(t.update(c.instanceMatrix,n.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,n.ARRAY_BUFFER),r.set(c,l))),c.isSkinnedMesh){const h=c.skeleton;r.get(h)!==l&&(h.update(),r.set(h,l))}return u}function o(){r=new WeakMap}function a(c){const l=c.target;l.removeEventListener("dispose",a),t.remove(l.instanceMatrix),l.instanceColor!==null&&t.remove(l.instanceColor)}return{update:s,dispose:o}}class Zh extends Yt{constructor(e,t,i,r,s,o,a,c,l,d=mr){if(d!==mr&&d!==Er)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");i===void 0&&d===mr&&(i=Ni),i===void 0&&d===Er&&(i=br),super(null,r,s,o,a,c,d,i,l),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=a!==void 0?a:Sn,this.minFilter=c!==void 0?c:Sn,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const Kh=new Yt,zd=new Zh(1,1),Jh=new Bh,Qh=new qm,ef=new Yh,Hd=[],Gd=[],Vd=new Float32Array(16),Wd=new Float32Array(9),Xd=new Float32Array(4);function Dr(n,e,t){const i=n[0];if(i<=0||i>0)return n;const r=e*t;let s=Hd[r];if(s===void 0&&(s=new Float32Array(r),Hd[r]=s),e!==0){i.toArray(s,0);for(let o=1,a=0;o!==e;++o)a+=t,n[o].toArray(s,a)}return s}function Pt(n,e){if(n.length!==e.length)return!1;for(let t=0,i=n.length;t<i;t++)if(n[t]!==e[t])return!1;return!0}function Lt(n,e){for(let t=0,i=e.length;t<i;t++)n[t]=e[t]}function Ho(n,e){let t=Gd[e];t===void 0&&(t=new Int32Array(e),Gd[e]=t);for(let i=0;i!==e;++i)t[i]=n.allocateTextureUnit();return t}function lx(n,e){const t=this.cache;t[0]!==e&&(n.uniform1f(this.addr,e),t[0]=e)}function dx(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Pt(t,e))return;n.uniform2fv(this.addr,e),Lt(t,e)}}function ux(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(n.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(Pt(t,e))return;n.uniform3fv(this.addr,e),Lt(t,e)}}function hx(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Pt(t,e))return;n.uniform4fv(this.addr,e),Lt(t,e)}}function fx(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(Pt(t,e))return;n.uniformMatrix2fv(this.addr,!1,e),Lt(t,e)}else{if(Pt(t,i))return;Xd.set(i),n.uniformMatrix2fv(this.addr,!1,Xd),Lt(t,i)}}function px(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(Pt(t,e))return;n.uniformMatrix3fv(this.addr,!1,e),Lt(t,e)}else{if(Pt(t,i))return;Wd.set(i),n.uniformMatrix3fv(this.addr,!1,Wd),Lt(t,i)}}function mx(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(Pt(t,e))return;n.uniformMatrix4fv(this.addr,!1,e),Lt(t,e)}else{if(Pt(t,i))return;Vd.set(i),n.uniformMatrix4fv(this.addr,!1,Vd),Lt(t,i)}}function gx(n,e){const t=this.cache;t[0]!==e&&(n.uniform1i(this.addr,e),t[0]=e)}function _x(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Pt(t,e))return;n.uniform2iv(this.addr,e),Lt(t,e)}}function xx(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Pt(t,e))return;n.uniform3iv(this.addr,e),Lt(t,e)}}function vx(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Pt(t,e))return;n.uniform4iv(this.addr,e),Lt(t,e)}}function yx(n,e){const t=this.cache;t[0]!==e&&(n.uniform1ui(this.addr,e),t[0]=e)}function Sx(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Pt(t,e))return;n.uniform2uiv(this.addr,e),Lt(t,e)}}function Mx(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Pt(t,e))return;n.uniform3uiv(this.addr,e),Lt(t,e)}}function bx(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Pt(t,e))return;n.uniform4uiv(this.addr,e),Lt(t,e)}}function Ex(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r);let s;this.type===n.SAMPLER_2D_SHADOW?(zd.compareFunction=kh,s=zd):s=Kh,t.setTexture2D(e||s,r)}function Tx(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture3D(e||Qh,r)}function wx(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTextureCube(e||ef,r)}function Cx(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture2DArray(e||Jh,r)}function Ax(n){switch(n){case 5126:return lx;case 35664:return dx;case 35665:return ux;case 35666:return hx;case 35674:return fx;case 35675:return px;case 35676:return mx;case 5124:case 35670:return gx;case 35667:case 35671:return _x;case 35668:case 35672:return xx;case 35669:case 35673:return vx;case 5125:return yx;case 36294:return Sx;case 36295:return Mx;case 36296:return bx;case 35678:case 36198:case 36298:case 36306:case 35682:return Ex;case 35679:case 36299:case 36307:return Tx;case 35680:case 36300:case 36308:case 36293:return wx;case 36289:case 36303:case 36311:case 36292:return Cx}}function Rx(n,e){n.uniform1fv(this.addr,e)}function Px(n,e){const t=Dr(e,this.size,2);n.uniform2fv(this.addr,t)}function Lx(n,e){const t=Dr(e,this.size,3);n.uniform3fv(this.addr,t)}function Dx(n,e){const t=Dr(e,this.size,4);n.uniform4fv(this.addr,t)}function Ix(n,e){const t=Dr(e,this.size,4);n.uniformMatrix2fv(this.addr,!1,t)}function Ux(n,e){const t=Dr(e,this.size,9);n.uniformMatrix3fv(this.addr,!1,t)}function Nx(n,e){const t=Dr(e,this.size,16);n.uniformMatrix4fv(this.addr,!1,t)}function kx(n,e){n.uniform1iv(this.addr,e)}function Ox(n,e){n.uniform2iv(this.addr,e)}function Fx(n,e){n.uniform3iv(this.addr,e)}function Bx(n,e){n.uniform4iv(this.addr,e)}function zx(n,e){n.uniform1uiv(this.addr,e)}function Hx(n,e){n.uniform2uiv(this.addr,e)}function Gx(n,e){n.uniform3uiv(this.addr,e)}function Vx(n,e){n.uniform4uiv(this.addr,e)}function Wx(n,e,t){const i=this.cache,r=e.length,s=Ho(t,r);Pt(i,s)||(n.uniform1iv(this.addr,s),Lt(i,s));for(let o=0;o!==r;++o)t.setTexture2D(e[o]||Kh,s[o])}function Xx(n,e,t){const i=this.cache,r=e.length,s=Ho(t,r);Pt(i,s)||(n.uniform1iv(this.addr,s),Lt(i,s));for(let o=0;o!==r;++o)t.setTexture3D(e[o]||Qh,s[o])}function $x(n,e,t){const i=this.cache,r=e.length,s=Ho(t,r);Pt(i,s)||(n.uniform1iv(this.addr,s),Lt(i,s));for(let o=0;o!==r;++o)t.setTextureCube(e[o]||ef,s[o])}function Yx(n,e,t){const i=this.cache,r=e.length,s=Ho(t,r);Pt(i,s)||(n.uniform1iv(this.addr,s),Lt(i,s));for(let o=0;o!==r;++o)t.setTexture2DArray(e[o]||Jh,s[o])}function qx(n){switch(n){case 5126:return Rx;case 35664:return Px;case 35665:return Lx;case 35666:return Dx;case 35674:return Ix;case 35675:return Ux;case 35676:return Nx;case 5124:case 35670:return kx;case 35667:case 35671:return Ox;case 35668:case 35672:return Fx;case 35669:case 35673:return Bx;case 5125:return zx;case 36294:return Hx;case 36295:return Gx;case 36296:return Vx;case 35678:case 36198:case 36298:case 36306:case 35682:return Wx;case 35679:case 36299:case 36307:return Xx;case 35680:case 36300:case 36308:case 36293:return $x;case 36289:case 36303:case 36311:case 36292:return Yx}}class jx{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.setValue=Ax(t.type)}}class Zx{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=qx(t.type)}}class Kx{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,i){const r=this.seq;for(let s=0,o=r.length;s!==o;++s){const a=r[s];a.setValue(e,t[a.id],i)}}}const Sa=/(\w+)(\])?(\[|\.)?/g;function $d(n,e){n.seq.push(e),n.map[e.id]=e}function Jx(n,e,t){const i=n.name,r=i.length;for(Sa.lastIndex=0;;){const s=Sa.exec(i),o=Sa.lastIndex;let a=s[1];const c=s[2]==="]",l=s[3];if(c&&(a=a|0),l===void 0||l==="["&&o+2===r){$d(t,l===void 0?new jx(a,n,e):new Zx(a,n,e));break}else{let u=t.map[a];u===void 0&&(u=new Kx(a),$d(t,u)),t=u}}}class co{constructor(e,t){this.seq=[],this.map={};const i=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<i;++r){const s=e.getActiveUniform(t,r),o=e.getUniformLocation(t,s.name);Jx(s,o,this)}}setValue(e,t,i,r){const s=this.map[t];s!==void 0&&s.setValue(e,i,r)}setOptional(e,t,i){const r=t[i];r!==void 0&&this.setValue(e,i,r)}static upload(e,t,i,r){for(let s=0,o=t.length;s!==o;++s){const a=t[s],c=i[a.id];c.needsUpdate!==!1&&a.setValue(e,c.value,r)}}static seqWithValue(e,t){const i=[];for(let r=0,s=e.length;r!==s;++r){const o=e[r];o.id in t&&i.push(o)}return i}}function Yd(n,e,t){const i=n.createShader(e);return n.shaderSource(i,t),n.compileShader(i),i}const Qx=37297;let ev=0;function tv(n,e){const t=n.split(`
`),i=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let o=r;o<s;o++){const a=o+1;i.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return i.join(`
`)}const qd=new Oe;function nv(n){je._getMatrix(qd,je.workingColorSpace,n);const e=`mat3( ${qd.elements.map(t=>t.toFixed(4))} )`;switch(je.getTransfer(n)){case Fo:return[e,"LinearTransferOETF"];case st:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",n),[e,"LinearTransferOETF"]}}function jd(n,e,t){const i=n.getShaderParameter(e,n.COMPILE_STATUS),r=n.getShaderInfoLog(e).trim();if(i&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const o=parseInt(s[1]);return t.toUpperCase()+`
...
`)}function rv(n,e){let t;switch(e){case Eh:t="Linear";break;case Mm:t="Reinhard";break;case bm:t="Cineon";break;case Em:t="ACESFilmic";break;case wm:t="AgX";break;case Cm:t="Neutral";break;case Tm:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Os=new L;function sv(){je.getLuminanceCoefficients(Os);const n=Os.x.toFixed(4),e=Os.y.toFixed(4),t=Os.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function ov(n){return[n.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",n.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Qr).join(`
`)}function av(n){const e=[];for(const t in n){const i=n[t];i!==!1&&e.push("#define "+t+" "+i)}return e.join(`
`)}function cv(n,e){const t={},i=n.getProgramParameter(e,n.ACTIVE_ATTRIBUTES);for(let r=0;r<i;r++){const s=n.getActiveAttrib(e,r),o=s.name;let a=1;s.type===n.FLOAT_MAT2&&(a=2),s.type===n.FLOAT_MAT3&&(a=3),s.type===n.FLOAT_MAT4&&(a=4),t[o]={type:s.type,location:n.getAttribLocation(e,o),locationSize:a}}return t}function Qr(n){return n!==""}function Zd(n,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return n.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Kd(n,e){return n.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const lv=/^[ \t]*#include +<([\w\d./]+)>/gm;function Oc(n){return n.replace(lv,uv)}const dv=new Map;function uv(n,e){let t=He[e];if(t===void 0){const i=dv.get(e);if(i!==void 0)t=He[i],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,i);else throw new Error("Can not resolve #include <"+e+">")}return Oc(t)}const hv=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Jd(n){return n.replace(hv,fv)}function fv(n,e,t,i){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=i.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function Qd(n){let e=`precision ${n.precision} float;
...
#define LOW_PRECISION`),e}function pv(n){let e="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===Mh?e="SHADOWMAP_TYPE_PCF":n.shadowMapType===bh?e="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===On&&(e="SHADOWMAP_TYPE_VSM"),e}function mv(n){let e="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case Sr:case Mr:e="ENVMAP_TYPE_CUBE";break;case Oo:e="ENVMAP_TYPE_CUBE_UV";break}return e}function gv(n){let e="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case Mr:e="ENVMAP_MODE_REFRACTION";break}return e}function _v(n){let e="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case yl:e="ENVMAP_BLENDING_MULTIPLY";break;case ym:e="ENVMAP_BLENDING_MIX";break;case Sm:e="ENVMAP_BLENDING_ADD";break}return e}function xv(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:i,maxMip:t}}function vv(n,e,t,i){const r=n.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const c=pv(t),l=mv(t),d=gv(t),u=_v(t),h=xv(t),p=ov(t),g=av(s),_=r.createProgram();let m,f,E=t.glslVersion?"#version "+t.glslVersion+`
...
`);n.RTCSessionDescription&&r instanceof n.RTCSessionDescription?arguments[0]=new n.RTCSessionDescription({type:r.type,sdp:s}):r.sdp=s}return t.apply(this,arguments)}}function mo(n,e){if(!(n.RTCPeerConnection&&n.RTCPeerConnection.prototype))return;const t=n.RTCPeerConnection.prototype.addIceCandidate;!t||t.length===0||(n.RTCPeerConnection.prototype.addIceCandidate=function(){return arguments[0]?(e.browser==="chrome"&&e.version<78||e.browser==="firefox"&&e.version<68||e.browser==="safari")&&arguments[0]&&arguments[0].candidate===""?Promise.resolve():t.apply(this,arguments):(arguments[1]&&arguments[1].apply(null),Promise.resolve())})}function go(n,e){if(!(n.RTCPeerConnection&&n.RTCPeerConnection.prototype))return;const t=n.RTCPeerConnection.prototype.setLocalDescription;!t||t.length===0||(n.RTCPeerConnection.prototype.setLocalDescription=function(){let r=arguments[0]||{};if(typeof r!="object"||r.type&&r.sdp)return t.apply(this,arguments);if(r={type:r.type,sdp:r.sdp},!r.type)switch(this.signalingState){case"stable":case"have-local-offer":case"have-remote-pranswer":r.type="offer";break;default:r.type="answer";break}return r.sdp||r.type!=="offer"&&r.type!=="answer"?t.apply(this,[r]):(r.type==="offer"?this.createOffer:this.createAnswer).apply(this).then(o=>t.apply(this,[o]))})}const eM=Object.freeze(Object.defineProperty({__proto__:null,removeExtmapAllowMixed:nl,shimAddIceCandidateNullOrEmpty:mo,shimConnectionState:tl,shimMaxMessageSize:fo,shimParameterlessSetLocalDescription:go,shimRTCIceCandidate:ho,shimRTCIceCandidateRelayProtocol:el,shimSendThrowTypeError:po},Symbol.toStringTag,{value:"Module"}));function tM({window:n}={},e={shimChrome:!0,shimFirefox:!0,shimSafari:!0}){const t=Gl,i=jS(n),r={browserDetails:i,commonShim:eM,extractVersion:es,disableLog:YS,disableWarnings:qS,sdp:QS};switch(i.browser){case"chrome":if(!Lu||!Jc||!e.shimChrome)return t("Chrome shim is not included in this adapter release."),r;if(i.version===null)return t("Chrome shim can not determine version, not shimming."),r;t("adapter.js shimming chrome."),r.browserShim=Lu,mo(n,i),go(n),Tf(n,i),wf(n),Jc(n,i),Cf(n,i),Lf(n,i),Af(n),Rf(n,i),Df(n,i),ho(n),el(n),tl(n),fo(n,i),po(n,i),nl(n,i);break;case"firefox":if(!Du||!Qc||!e.shimFirefox)return t("Firefox shim is not included in this adapter release."),r;t("adapter.js shimming firefox."),r.browserShim=Du,mo(n,i),go(n),If(n,i),Qc(n,i),Nf(n,i),Uf(n),Ff(n),kf(n),Of(n),Bf(n),zf(n,i),Hf(n,i),Gf(n,i),Vf(n,i),ho(n),tl(n),fo(n,i),po(n,i);break;case"safari":if(!Iu||!e.shimSafari)return t("Safari shim is not included in this adapter release."),r;t("adapter.js shimming safari."),r.browserShim=Iu,mo(n,i),go(n),jf(n),Kf(n),$f(n),Wf(n),Xf(n),Zf(n),Yf(n),Jf(n),ho(n),el(n),fo(n,i),po(n,i),nl(n,i);break;default:t("Unsupported browser!");break}return r}const Nu=tM({window:typeof window>"u"?void 0:window});function zi(n,e,t,i){Object.defineProperty(n,e,{get:t,set:i,enumerable:!0,configurable:!0})}class ep{constructor(){this.chunkedMTU=16300,this._dataCount=1,this.chunk=e=>{const t=[],i=e.byteLength,r=Math.ceil(i/this.chunkedMTU);let s=0,o=0;for(;o<i;){const a=Math.min(i,o+this.chunkedMTU),c=e.slice(o,a),l={__peerData:this._dataCount,n:s,data:c,total:r};t.push(l),o=a,s++}return this._dataCount++,t}}}function nM(n){let e=0;for(const r of n)e+=r.byteLength;const t=new Uint8Array(e);let i=0;for(const r of n)t.set(r,i),i+=r.byteLength;return t}const Na=Nu.default||Nu,Yr=new class{isWebRTCSupported(){return typeof RTCPeerConnection<"u"}isBrowserSupported(){const n=this.getBrowser(),e=this.getVersion();return this.supportedBrowsers.includes(n)?n==="chrome"?e>=this.minChromeVersion:n==="firefox"?e>=this.minFirefoxVersion:n==="safari"?!this.isIOS&&e>=this.minSafariVersion:!1:!1}getBrowser(){return Na.browserDetails.browser}getVersion(){return Na.browserDetails.version||0}isUnifiedPlanSupported(){const n=this.getBrowser(),e=Na.browserDetails.version||0;if(n==="chrome"&&e<this.minChromeVersion)return!1;if(n==="firefox"&&e>=this.minFirefoxVersion)return!0;if(!window.RTCRtpTransceiver||!("currentDirection"in RTCRtpTransceiver.prototype))return!1;let t,i=!1;try{t=new RTCPeerConnection,t.addTransceiver("audio"),i=!0}catch{}finally{t&&t.close()}return i}toString(){return`Supports:
  ...
  `,e}function IM(n){return new Promise(e=>{const t=n.querySelector("#update-splash-dismiss"),i=()=>{n.classList.add("update-splash-out"),setTimeout(()=>{n.remove(),ts=null,e()},420)};t.addEventListener("click",i,{once:!0});const r=s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),window.removeEventListener("keydown",r),i())};window.addEventListener("keydown",r)})}async function UM(){if(location.hostname==="localhost"||location.hostname==="127.0.0.1")return;let n;try{n=await LM()}catch{return}const e=n==null?void 0:n.v;if(!e)return;const t=localStorage.getItem(sl)==="1",i=localStorage.getItem(Ju(e))==="1";if(!t&&i){localStorage.setItem(Ku,e),Qu();return}localStorage.removeItem(sl),localStorage.setItem(Ku,e),localStorage.setItem(Ju(e),"1"),Qu(),ts=DM(e),document.body.appendChild(ts),requestAnimationFrame(()=>ts.classList.add("update-splash-in")),await IM(ts)}function NM(){localStorage.setItem(sl,"1")}const kM=10,OM=.5,eh=2.4,FM=2.2,BM=92,zM=1.6,HM=[[24,18],[-30,22],[45,-35],[-50,40],[12,-55],[-65,-20],[70,55],[-15,75],[88,-12],[-40,-70]];function GM(){const n=document.createElement("canvas");n.width=256,n.height=72;const e=n.getContext("2d");e.fillStyle="rgba(15,23,42,0.55)",e.beginPath(),e.roundRect(8,8,240,56,10),e.fill(),e.fillStyle="#ffffff",e.font="bold 34px system-ui,sans-serif",e.textAlign="center",e.textBaseline="middle",e.fillText("Dashing",128,38);const t=new iy(n);t.colorSpace=Kt;const i=new nf({map:t,transparent:!0,depthTest:!1}),r=new ey(i);return r.scale.set(3.6,1,1),r.renderOrder=10,r}function th(){const n=new Ke,e=new ne(new an(1.15,1.15,.18,28),new cn({color:2450411,emissive:1920728,emissiveIntensity:.45,flatShading:!0}));e.position.y=.1,n.add(e);const t=new ne(new Go(1.28,.08,8,28),new cn({color:6333946,flatShading:!0}));t.rotation.x=Math.PI/2,t.position.y=.18,n.add(t);const i=GM();return i.position.y=FM,n.add(i),n}function VM(n){let e=n>>>0;return()=>(e=e*1664525+1013904223>>>0,e/4294967296)}function WM(n,{getPlayerId:e,isHost:t,send:i,relay:r}){const s=new Ke;s.name="dash-pickups",n.add(s);let o=[],a={},c=!1,l=0,d=!1;function u(){return(e==null?void 0:e())??"local"}function h(){i==null||i({t:"dashState",pickups:o.map(k=>({id:k.id,x:k.x,z:k.z,active:k.active})),scores:a})}function p(k=Date.now()){for(o=[],a={},c=!1,d=!1;s.children.length;)s.remove(s.children[0]);const H=VM(k);d=!0;for(let O=0;O<kM;O++){if(H()>=OM)continue;const[$,W]=HM[O],te=th();te.position.set($,0,W),s.add(te),o.push({id:O,x:$,z:W,active:!0,mesh:te,bob:H()*Math.PI*2,pending:!1})}t!=null&&t()&&h()}function g(){return o.length>0}function _(k){if(k!=null&&k.pickups){for(d=k.pickups.length>0,a={...k.scores??{}};s.children.length;)s.remove(s.children[0]);o=k.pickups.map(H=>{const O=H.active?th():null;return O&&(O.position.set(H.x,0,H.z),s.add(O)),{id:H.id,x:H.x,z:H.z,active:H.active,mesh:O,bob:0,pending:!1}})}}function m(k){if(!k.active)return;k.active=!1,k.mesh&&(s.remove(k.mesh),k.mesh=null);const H=u();a[H]=(a[H]??0)+1,B==null||B("Dashing +1!"),t!=null&&t()?h():i==null||i({t:"dashCollect",pickupId:k.id,playerId:H})}function f(k){if(!(t!=null&&t()))return;const H=o.find(O=>O.id===k.pickupId&&O.active);H&&(H.active=!1,H.mesh&&(s.remove(H.mesh),H.mesh=null),a[k.playerId]=(a[k.playerId]??0)+1,h())}function E(k){t!=null&&t()&&(k.playerId&&(a[k.playerId]=0),h())}function w(k=null){const H=k??u();a[H]=0,H===u()&&(c=!1),t!=null&&t()?h():i==null||i({t:"dashScoreReset",playerId:H})}function x(k){k.t==="dashState"&&_(k),k.t==="dashCollect"&&f(k),k.t==="dashScoreReset"&&E(k)}function A(){return{...a}}function M(){const k=Object.entries(a);if(!k.length)return[];const H=Math.max(...k.map(([,O])=>O));return H<=0?[]:k.filter(([,O])=>O===H).map(([O])=>O)}function T(){return M().includes(u())}function R(){return T()?(c=!c,c):!1}function v(k){c=!!k}function S(){return c}function P(k,H){l+=k;for(const O of o)!O.active||!O.mesh||(O.mesh.position.y=Math.sin(l*2.8+O.bob)*.12,O.mesh.children[0].rotation.y+=k*1.6);if(!(!H||!d))for(const O of o){if(!O.active)continue;const $=H.x-O.x,W=H.z-O.z;if($*$+W*W<=eh*eh){if(O.pending)break;(t==null?void 0:t())??!0?m(O):(O.pending=!0,i==null||i({t:"dashCollect",pickupId:O.id,playerId:u()}));break}}}let B=null;function F(k){B=k}return{group:s,reset:p,update:P,getScores:A,getLeaderIds:M,isLocalLeader:T,isSuperDashOn:S,toggleSuperDash:R,setSuperDash:v,handleMessage:x,setToast:F,syncState:h,resetPlayerScore:w,isSessionActive:g,SUPER_MAX_SPEED:BM,SUPER_ACCEL_MULT:zM}}const XM={wood:{label:"Wood",color:9136404,costMult:1},metal:{label:"Metal",color:9741240,costMult:3},obsidian:{label:"Obsidian",color:1973067,costMult:8},diamond:{label:"Diamond",color:6809849,costMult:16,adminOnly:!0},plasma:{label:"Plasma",color:11032055,costMult:24,adminOnly:!0},inferno:{label:"Inferno",color:16347926,costMult:40,adminOnly:!0}},fp={mini_gun:{label:"Mini Gun",baseCost:50,shredBonus:1},saw_blade:{label:"Saw Blade",baseCost:65,shredBonus:1.15},chainsaw:{label:"Chainsaw",baseCost:80,shredBonus:1.3}},$M=["wood","metal","obsidian"],YM=["diamond","plasma","inferno"];function qM(n,e){const t=fp[n],i=XM[e];return{id:`${n}_${e}`,type:n,material:e,name:`${i.label} ${t.label}`,cost:Math.round(t.baseCost*i.costMult),color:i.color,shredBonus:t.shredBonus*(i.costMult>=16?1.5:i.costMult>=8?1.25:1),adminOnly:!!i.adminOnly,tier:i.adminOnly?"premium":"basic"}}const pp=[];for(const n of Object.keys(fp))for(const e of[...$M,...YM])pp.push(qM(n,e));const Yl=pp;function ol(n){return Yl.find(e=>e.id===n)??null}function jM(){return Yl.filter(n=>n.tier==="basic")}function nh(){return Yl}const yo=[{id:"neon_lime",name:"Neon Lime",color:8702998,accent:1332013,cost:350},{id:"hot_pink",name:"Hot Pink",color:15485081,accent:8591427,cost:350},{id:"gold_rush",name:"Gold Rush",color:16436245,accent:8736014,cost:500},{id:"ice_blue",name:"Ice Blue",color:3718648,accent:805486,cost:400},{id:"lava_orange",name:"Lava Orange",color:15357964,accent:4396039,cost:450},{id:"galaxy_purple",name:"Galaxy Purple",color:8141549,accent:3018853,cost:550},{id:"stealth_black",name:"Stealth Black",color:1976635,accent:132631,cost:600},{id:"candy_red",name:"Candy Red",color:15680580,accent:8330525,cost:400},{id:"mint_cream",name:"Mint Cream",color:10090212,accent:1265226,cost:350},{id:"sunset_gradient",name:"Sunset Burst",color:16347926,accent:14362487,cost:750}];function mp(n){return yo.find(e=>e.id===n)??null}function ZM(n,e){const t=mp(e);return t?{...n,color:t.color,skinId:t.id,skinAccent:t.accent}:n}const ih="ccwd-loadout-";function Ba(){return{coins:0,ownedWeapons:[],ownedSkins:[],equippedWeapon:null,equippedSkin:null}}function KM(n){let e=Ba(),t=`${ih}local`;function i(){try{localStorage.setItem(t,JSON.stringify(e))}catch{}}function r(){t=`${ih}${(n==null?void 0:n())??"local"}`;try{const x=localStorage.getItem(t);x&&(e={...Ba(),...JSON.parse(x)})}catch{e=Ba()}}function s(){r()}function o(){return e.coins}function a(x){return!x||x<=0?0:(e.coins+=x,i(),e.coins)}function c(x){return e.coins>=x}function l(x){return c(x)?(e.coins-=x,i(),!0):!1}function d(x){return e.ownedWeapons.includes(x)}function u(x){return e.ownedSkins.includes(x)}function h(x){const A=ol(x);return!A||d(x)?{ok:!1,reason:"already_owned"}:l(A.cost)?(e.ownedWeapons.push(x),i(),{ok:!0,weapon:A}):{ok:!1,reason:"insufficient"}}function p(x){const A=mp(x);return!A||u(x)?{ok:!1,reason:"already_owned"}:l(A.cost)?(e.ownedSkins.push(x),i(),{ok:!0,skin:A}):{ok:!1,reason:"insufficient"}}function g(x){return x&&!d(x)?!1:(e.equippedWeapon=x,i(),!0)}function _(x){return x&&!u(x)?!1:(e.equippedSkin=x,i(),!0)}function m(){return e.equippedWeapon?ol(e.equippedWeapon):null}function f(){return e.equippedSkin}function E(){return[...e.ownedWeapons]}function w(){return[...e.ownedSkins]}return r(),{reloadForPlayer:s,getCoins:o,addCoins:a,canAfford:c,spendCoins:l,ownsWeapon:d,ownsSkin:u,buyWeapon:h,buySkin:p,equipWeapon:g,equipSkin:_,getEquippedWeapon:m,getEquippedSkinId:f,getOwnedWeapons:E,getOwnedSkins:w}}const rh=[{radius:Tt+24,coins:18},{radius:Tt+38,coins:24},{radius:Tt+52,coins:32}],sh=28,oh=2.2,JM=10,QM=1.4;function eb(){const n=[];for(let e=0;e<sh;e++){const t=e/sh*Math.PI*2+.18,i=rh[e%rh.length];n.push({x:Math.cos(t)*i.radius,z:Math.sin(t)*i.radius,coins:i.coins})}return n}const tb=eb();function nb(){const n=new Ke;n.name="shred-target";const e=new ne(new an(.14,.18,2.6,8),lt(7029795));e.position.y=1.3,e.castShadow=!0,n.add(e);const t=new Ke;t.position.y=2.55;const i=new ne(new Ve(2.4,2.4,.12),lt(16317180));t.add(i);const r=[{r:1.05,color:14427686,z:.07},{r:.72,color:16777215,z:.08},{r:.38,color:14427686,z:.09},{r:.14,color:16777215,z:.1}];for(const s of r){const o=new ne(new an(s.r,s.r,.08,24),ci(s.color));o.rotation.x=Math.PI/2,o.position.z=s.z,t.add(o)}return n.add(t),n.userData.board=t,n}function ib(n){const e=new Ke;e.name="shred-targets",n.add(e);let t=[],i=null;function r(){s();for(const d of tb){const u=nb();u.position.set(d.x,0,d.z),u.rotation.y=Math.atan2(-d.x,-d.z),e.add(u),t.push({mesh:u,x:d.x,z:d.z,health:50,maxHealth:50,coinValue:d.coins,alive:!0,hitCooldown:0,wobble:0})}}function s(){for(const d of t)d.mesh.parent&&e.remove(d.mesh);t=[]}function o(){r()}function a(d){i=d}function c(d){d.alive&&(d.alive=!1,e.remove(d.mesh),i==null||i(d))}function l(d,u,h=1){if(!u)return[];const p=[],g=Math.abs(u.speed);for(const _ of t){if(!_.alive)continue;if(_.hitCooldown=Math.max(0,_.hitCooldown-d),_.wobble>0){_.wobble=Math.max(0,_.wobble-d*5);const x=_.mesh.userData.board;x&&(x.rotation.z=Math.sin(_.wobble*18)*_.wobble*.35)}const m=u.x-_.x,f=u.z-_.z,E=Math.hypot(m,f);if(E>oh+2||E>oh||g<JM||_.hitCooldown>0)continue;const w=g*.75*h;_.health-=w,_.hitCooldown=QM,_.wobble=1,_.health<=0&&(c(_),p.push(_))}return p}return r(),{reset:o,update:l,setOnDestroyed:a,count:()=>t.filter(d=>d.alive).length}}const rb=150,sb=22,ob=4;function ab(n){const e=new Ke;e.name="car-weapon";const t=new ne(new Ve(.5,.25,.5),lt(3359061));t.position.set(0,.15,0),e.add(t);const i=new ne(new Ve(.35,.2,.9),ci(n));i.position.set(0,.35,.55),e.add(i);const r=new ne(new Ve(.2,.15,.15),ps());return r.position.set(0,.35,1.05),e.add(r),e}function cb(n){const e=new Ke;e.name="car-weapon";const t=new ne(new Ve(.3,.2,.7),lt(3359061));t.position.set(0,.2,.2),e.add(t);const i=new ne(new an(.55,.55,.12,8),ci(n));i.rotation.x=Math.PI/2,i.position.set(0,.35,.75),e.add(i);const r=new ne(new an(.62,.62,.06,6),lt(13358561));return r.rotation.x=Math.PI/2,r.position.set(0,.35,.75),e.add(r),e}function lb(n){const e=new Ke;e.name="car-weapon";const t=new ne(new Ve(.45,.35,1.1),ci(n));t.position.set(0,.25,.35),e.add(t);const i=new ne(new Ve(.12,.15,1.4),lt(6583435));i.position.set(0,.2,.95),e.add(i);const r=new ne(new Ve(.2,.25,.25),lt(1976635));return r.position.set(0,.45,0),e.add(r),e}function db(n){return n.type==="saw_blade"?cb(n.color):n.type==="chainsaw"?lb(n.color):ab(n.color)}function ub(n){if(!(n!=null&&n.mesh))return;const e=n.mesh.getObjectByName("car-weapon");e&&n.mesh.remove(e),n.equippedWeapon=null}function ql(n,e){if(ub(n),!e||!(n!=null&&n.mesh))return null;const t=ol(e);if(!t)return null;const i=db(t);return i.position.set(0,.55,1.85),i.rotation.y=Math.PI,n.mesh.add(i),n.equippedWeapon=t,t}function al(n){var e;return((e=n==null?void 0:n.equippedWeapon)==null?void 0:e.shredBonus)??1}function hb(n,e){var r;const t=(r=n==null?void 0:n.mesh)==null?void 0:r.getObjectByName("car-weapon");if(!t||!n.equippedWeapon)return;const i=Math.abs(n.speed);n.equippedWeapon.type==="mini_gun"?t.children.forEach((s,o)=>{o>0&&(s.rotation.z+=e*i*.15)}):t.rotation.z+=e*(3+i*.2)}function fb(n){return String(n).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/"/g,"&quot;")}function pb(n,{onEquip:e,onClose:t,getCoinsText:i,onPurchaseFail:r}){let s=null,o=!1;s=document.createElement("div"),s.id="kill-shop",s.className="shop-overlay",s.innerHTML=`
  ...
  `,document.body.appendChild(o);const c=o.querySelector("#admin-shop-grid"),l=o.querySelector("#admin-shop-coins");let d="skins";function u(E){const w=E?yo:yo.filter(x=>n.ownsSkin(x.id));if(!E&&w.length===0){c.innerHTML='<p class="shop-empty">Buy a skin in the Skins tab!</p>';return}for(const x of w){const A=n.ownsSkin(x.id),M=n.getEquippedSkinId()===x.id,T=document.createElement("button");T.type="button",T.className="shop-item",M&&T.classList.add("equipped"),T.innerHTML=`
      ...
      `,v.addEventListener("click",()=>{if(E)if(T)n.equipWeapon(M.id),e==null||e(M.id);else{const S=n.buyWeapon(M.id);S.ok?(n.equipWeapon(M.id),e==null||e(M.id)):S.reason==="insufficient"&&(s==null||s("insufficient"))}else n.equipWeapon(M.id),e==null||e(M.id);p()}),c.appendChild(v)}}function p(){if(c){if(c.innerHTML="",l.textContent=(r==null?void 0:r())??`Coins: ${n.getCoins()}`,d==="skins")u(!0);else if(d==="weapons")h(!0);else if(d==="equip"){const E=yo.filter(x=>n.ownsSkin(x.id)),w=nh().filter(x=>n.ownsWeapon(x.id));if(E.length===0&&w.length===0){c.innerHTML='<p class="shop-empty">Buy skins or weapons first!</p>';return}E.length&&u(!1),w.length&&h(!1)}}}o.querySelectorAll(".shop-tab").forEach(E=>{E.addEventListener("click",()=>{d=E.dataset.tab,o.querySelectorAll(".shop-tab").forEach(w=>w.classList.toggle("active",w===E)),p()})}),o.querySelector("#admin-shop-close").addEventListener("click",()=>_());function g(){a=!0,o.style.display="flex",p()}function _(){a=!1,o.style.display="none",i==null||i()}function m(){return a}function f(){a&&p()}return{showAdminShop:g,hideAdminShop:_,isAdminShopVisible:m,refreshAdminShop:f}}const za="ccwd-build";function gb(){const n=location.hostname;if(n==="localhost"||n==="127.0.0.1")return;const e=async()=>{try{const t=await fetch(`./version.json?_=${Date.now()}`,{cache:"no-store"});if(!t.ok)return;const{v:i}=await t.json();if(!i)return;const r=localStorage.getItem(za);if(r&&r!==i){NM(),localStorage.setItem(za,i),location.reload();return}r||localStorage.setItem(za,i)}catch{}};e(),setInterval(e,180*1e3)}UM().then(()=>{gb()});const _b=5,ch=7,xb=.05,vb=0,yb=0,lh=5,Sb=new URLSearchParams(window.location.search).has("teleport"),{canvas:Xt,ctx:he}=Cp();Xt.id="title-canvas";Xt.style.position="fixed";Xt.style.inset="0";Xt.style.zIndex="1";const hn=new Rp(document.body),on=Qp();on.onExit(()=>xp());const at=Ty(),ve=af(0,0);Ry(at.scene,ve);const Ui=MM(at.scene);let It=wM()?"drawPaper":"title",jr=Sb?1.8:0,Zr=0,Qs=0,Ha=0,rs=!1,ss=!1,eo=!1,cl=0,rt=null,Oi=!1,Ga=0,ur=1,Va=!1,Wa=!1,Xa=!1,ue=null,zt=!1,vr=0,dh=0,ns=0,wr=[],wi=0,uh=!1,hh={},is=0;const os=document.getElementById("action-toast"),Rn=document.getElementById("controls-hud"),Cr=document.getElementById("damage-hud"),Ci=document.getElementById("room-banner"),hr=document.getElementById("super-dash-btn"),to=document.getElementById("dash-score-hud"),Do=document.getElementById("death-overlay"),Io=document.getElementById("death-timer"),fr=document.getElementById("non-dying-btn"),$a=document.getElementById("coin-hud"),Uo=document.getElementById("kill-shop-btn"),No=document.getElementById("admin-shop-btn");let Vn=!1;function Mb(){return(rt==null?void 0:rt.id)??"local"}const pi=KM(Mb),$o=ib(at.scene);function jl(){return`Coins: ${pi.getCoins()}`}function gp(n,e){!n||n<=0||(pi.addCoins(n),Kl(),wb(),Ab(),e&&Ht(e))}$o.setOnDestroyed(n=>{const e=ue?al(ue):1,t=Math.round(n.coinValue*e);gp(t,`+${t} coins — target shredded!`)});const bb=pb(pi,{getCoinsText:jl,onEquip:n=>{ue&&ql(ue,n),Ht("Weapon equipped on your car!")},onClose:()=>Ir(),onPurchaseFail:()=>Ht("Not enough coins!")}),Eb=mb(pi,{getCoinsText:jl,onEquipWeapon:n=>{ue&&ql(ue,n),Ht("Weapon equipped on your car!")},onEquipSkin:()=>{Ht("Skin equipped — spawn a car from the garage to apply it!")},onClose:()=>Ir(),onPurchaseFail:()=>Ht("Not enough coins!")}),{showKillShop:Tb,isKillShopVisible:ll,refreshKillShop:wb}=bb,{showAdminShop:Cb,isAdminShopVisible:dl,refreshAdminShop:Ab}=Eb;function Xn(){return Oi||!rt}yh(()=>ko(Rn,{driving:zt}));Py(Db);CM(()=>fh(),()=>fh(!0));function fh(n=!1){It="title",Xt.style.display="block",hp(),n&&cp()}It==="drawPaper"&&(Xt.style.display="none",TM());SM(({room:n,isHost:e})=>{rt=n,Oi=e,Xn()||(Vn=!1),pi.reloadForPlayer(),ve.x=0,ve.z=0,hi(ve),Rb(n),It="world",Sp(),yp(vp(n.code??"solo")),So(),$o.reset(),Ht("You're in the game!")});function Rb(n){n.onMessage=(e,t)=>{e.t==="pose"&&e.id&&e.id!==n.id&&(n.role==="host"&&n.relay(t,e),Ui.applyPose(e.id,e)),e.t==="join"&&e.id&&(Ui.applyPose(e.id,{x:0,z:4,facing:0,walkPhase:0,isMoving:!1}),ur+=1,So(),Ht("Someone joined!"),Oi&&vt.syncState()),e.t==="leave"&&e.id&&(Ui.remove(e.id),ur=Math.max(1,ur-1),So()),(e.t==="dashState"||e.t==="dashCollect")&&(vt.handleMessage(e),Ar()),e.t==="dashScoreReset"&&(vt.handleMessage(e),Ar())},n.onPeerCount=e=>{ur=e,So()}}function So(){if(!(!Ci||!(rt!=null&&rt.code)))if(Oi){const n=ap(rt.code);Ci.innerHTML=`Room <strong>${rt.code}</strong> · ${ur} player(s) · <a href="${n}" target="_blank" rel="noopener">Share link</a>`,Ci.hidden=!1}else Ci.textContent=`Room ${rt.code} · ${ur} player(s)`,Ci.hidden=!1}function Pb(){rt!=null&&rt.id&&rt.send({t:"pose",id:rt.id,x:ve.x,z:ve.z,facing:ve.facing,walkPhase:ve.walkPhase,isMoving:ve.isMoving})}function Lb(n){const e=Xn()?pi.getEquippedSkinId():null;return e?ZM(n,e):n}function Db(n){var e;ue&&(_f(at.scene,ue),ue=null,zt=!1,ve.inVehicle=null,ve.mesh.visible=!0),ue=GS(ve,Lb(n),at.clampPosition,at.envTex),NS(at.scene,ue),ql(ue,((e=pi.getEquippedWeapon())==null?void 0:e.id)??null),zt=!0,on.setDriving(!0),kS(ve,ue),ko(Rn,{driving:!0}),xl(Cr,!0),_l(Cr,ue)}function Ib(n){if(!(!ue||vr>0)){if(bS(ue,at.scene,n,wr),_l(Cr,ue),mf(ue)&&!Vn){_p();return}if(Ol(n)){zS(ue,n);const e=Math.abs(n)>=38;ns=e?.5:.22,vr=e?.55:.4}else Math.abs(n)>5&&(ue.speed*=.55,vr=.12)}}function _p(){if(!ve.dead){if(ve.dead=!0,wi=lh,zt&&ue){const n=ue.x,e=ue.z,t=ue.rotY;xf(ve,ue),ve.x=n,ve.z=e,ve.facing=t,ue.speed=0,zt=!1,on.setDriving(!1),vt.setSuperDash(!1),ue.superDashOn=!1}vt.resetPlayerScore(),Ar(),ve.mesh.rotation.x=-Math.PI/2,hi(ve),Pi(Rn,!1),xl(Cr,!1),ii(!1),Ar(),Do&&(Do.hidden=!1),Io&&(Io.textContent=`Respawning in ${lh}...`),Ht("Your car was destroyed!")}}function Ub(){var n;ve.dead=!1,wi=0,ue&&(_f(at.scene,ue),ue=null);for(const e of wr)(n=e.mesh.parent)==null||n.remove(e.mesh);wr.length=0,ve.x=vb,ve.z=yb,ve.facing=0,ve.mesh.rotation.set(0,0,0),ve.mesh.visible=!0,ve.inVehicle=null,hi(ve),zt=!1,on.setDriving(!1),Do&&(Do.hidden=!0),ii(!0),Ul(),Pi(Rn,!0,{driving:!1}),at.updateCamera(ve.x,ve.z,ve.facing),Ht("Respawned at spawn!")}function Nb(n){wi=Math.max(0,wi-n),Io&&(Io.textContent=wi>0?`Respawning in ${Math.ceil(wi)}...`:"Respawning..."),Hl(wr,n),at.updateWorld(ve.x,ve.z),at.updateCamera(ve.x,ve.z,ve.facing),wi<=0&&Ub()}function xp(){!ue||!zt||(xf(ve,ue),zt=!1,on.setDriving(!1),hi(ve),at.updateCamera(ve.x,ve.z,ve.facing),ko(Rn,{driving:!1}),xl(Cr,!1),Ht("Exited vehicle"))}function kb(){return Up(hn)}function ph(n,e){return{throttle:Math.max(n.throttle??0,e.throttle??0),brake:Math.max(n.brake??0,e.brake??0),reverse:Math.max(n.reverse??0,e.reverse??0),steer:Math.abs(n.steer)>Math.abs(e.steer)?n.steer:e.steer}}function mh(n){var i,r;if(!n||It!=="world"||qa()||Gc())return;const{fired:e,prevPressed:t}=kp(n,gl(),hh);hh=t;for(const s of e)Ht(s.action);(i=n.buttons[9])!=null&&i.pressed&&!Va&&(Va=!0,Sh()),(r=n==null?void 0:n.buttons[9])!=null&&r.pressed||(Va=!1)}function Ob(n,e){const t=Math.max(0,Math.min(1,(e-n.topY)/(n.bottomY-n.topY)));return n.topW*2+(n.bottomW-n.topW*2)*t}function Fb(n,e,t){const i=e*.56,r=Ob(t,i),s=Math.min(r*.82,n*.78,420),o=s*.34;return{x:t.cx-s/2,y:i-o/2,w:s,h:o,cx:t.cx,cy:i}}function Bb(n){const t=n.h*.72,i=n.w*.92,r=n.cy+n.h/2+14+t/2;return{x:n.cx-i/2,y:r-t/2,w:i,h:t,cx:n.cx,cy:r}}function zb(n,e){const t=Xt.getBoundingClientRect(),i=Xt.width/t.width,r=Xt.height/t.height;return{x:(n-t.left)*i,y:(e-t.top)*r}}function gh(n,e,t){return n>=t.x&&n<=t.x+t.w&&e>=t.y&&e<=t.y+t.h}function Hb(n,e,t){const i=e*.22,r=44,s="car crashing with ",o="dashing";he.save(),he.globalAlpha=t,he.font=`800 ${r}px system-ui, sans-serif`,he.textBaseline="middle";const a=he.measureText(s+o).width;let c=n/2-a/2;he.textAlign="left",he.fillStyle="#14532d",he.fillText(s,c,i),c+=he.measureText(s).width,he.fillText(o,c,i);const l=he.measureText(o).width,d=i+r*.38;he.strokeStyle="#14532d",he.lineWidth=4,he.beginPath(),he.moveTo(c,d),he.lineTo(c+l,d),he.stroke(),he.restore()}function _h(n,e,t,i,r,s){const o=1+Math.sin(i)*.04+(r?.05:0)+(s?-.03:0),a=n.w*o,c=n.h*o,l=n.cx-a/2,d=n.cy-c/2,u=c*.28;he.save(),he.shadowColor="rgba(0,0,0,0.45)",he.shadowBlur=24,he.shadowOffsetY=8;const h=he.createLinearGradient(l,d,l,d+c);h.addColorStop(0,s?t.pressedTop:t.top),h.addColorStop(1,s?t.pressedBottom:t.bottom),he.fillStyle=h,he.beginPath(),he.roundRect(l,d,a,c,u),he.fill(),he.shadowBlur=0,he.shadowOffsetY=0,he.strokeStyle=t.stroke,he.lineWidth=5,he.stroke(),Ya(he,e,n.cx,n.cy,{size:Math.floor(c*.38),color:t.text}),he.restore()}function Gb(){It="comingSoon",cl=_b,rt=null,Oi=!1,pi.reloadForPlayer(),ve.x=0,ve.z=0,hi(ve),Sp(),yp(vp(String(Date.now()))),$o.reset()}function Vb(n,e){const t=zb(hn.pointer.x,hn.pointer.y);rs=gh(t.x,t.y,n),ss=gh(t.x,t.y,e),Xt.style.cursor=rs||ss?"pointer":"default",hn.pointer.down&&!eo&&(rs?(Gb(),eo=!0):ss&&(cp(),eo=!0)),hn.pointer.down||(eo=!1)}function xh(n,e,t=1){const i=n/2,r=e*.42,s=e,o=n*.08*t,a=n*.92;return{cx:i,topY:r,bottomY:s,topW:o,bottomW:a}}function Wb(n,e,t){if(t<=0)return xh(n,e,t);const i=xh(n,e,t),{cx:r,topY:s,bottomY:o,topW:a,bottomW:c}=i;he.save(),he.globalAlpha=Math.min(1,t);const l=he.createLinearGradient(0,s,0,o);return l.addColorStop(0,"#334155"),l.addColorStop(1,"#1e293b"),he.fillStyle=l,he.beginPath(),he.moveTo(r-a,s),he.lineTo(r+a,s),he.lineTo(r+c/2,o),he.lineTo(r-c/2,o),he.closePath(),he.fill(),he.strokeStyle="rgba(250,204,21,0.85)",he.lineWidth=3,he.setLineDash([18,16]),he.beginPath(),he.moveTo(r,s),he.lineTo(r,o),he.stroke(),he.setLineDash([]),he.fillStyle="rgba(15,23,42,0.35)",he.fillRect(0,e*.72,n,e*.28),he.restore(),i}function Ht(n){is=2,os&&(os.textContent=n,os.classList.add("show"))}function vp(n){let e=0;for(let t=0;t<n.length;t++)e=(e<<5)-e+n.charCodeAt(t)|0;return Math.abs(e)||1}const vt=WM(at.scene,{getPlayerId:()=>(rt==null?void 0:rt.id)??"local",isHost:()=>!rt||Oi,send:n=>{rt&&(Oi&&n.t==="dashState"?rt.send(n):n.t==="dashCollect"||n.t==="dashScoreReset"?rt.sendToHost(n):rt.send(n))}});vt.setToast(Ht);function yp(n){vt.reset(n),vt.isSessionActive()&&Ht("Blue Dashing circles spawned — collect them!")}function Zl(){if(!fr)return;Xn()||(Vn=!1);const n=Xn()&&(It==="world"||It==="comingSoon")&&!ve.dead;fr.hidden=!n,fr.classList.toggle("active",Vn),fr.textContent=Vn?"NON-DYING":"DYING ON"}fr&&fr.addEventListener("click",()=>{Xn()&&(Vn=!Vn,Zl(),Ht(Vn?"Non-dying ON — drive with no parts!":"Dying ON — destroyed car kills you"))});function Kl(){if(!$a)return;const n=(It==="world"||It==="comingSoon")&&!ve.dead;$a.hidden=!n,$a.textContent=jl()}function Ir(){const n=(It==="world"||It==="comingSoon")&&!ve.dead,e=ll()||dl();Uo&&(Uo.hidden=!n||Xn()||e),No&&(No.hidden=!n||!Xn()||e)}Uo&&Uo.addEventListener("click",()=>{Xn()||(Tb(),Ir())});No&&No.addEventListener("click",()=>{Xn()&&(Cb(),Ir())});function Ar(){const n=vt.isLocalLeader()&&zt&&vt.isSessionActive();if(hr&&(hr.hidden=!n,hr.classList.toggle("active",vt.isSuperDashOn()),hr.textContent=vt.isSuperDashOn()?"NORMAL SPEED":"SUPER DASH"),to)if(It==="world"&&vt.isSessionActive()){const e=vt.getScores(),t=e[(rt==null?void 0:rt.id)??"local"]??0,i=vt.getLeaderIds(),r=i.length?Math.max(...i.map(s=>e[s]??0)):0;to.hidden=!1,to.textContent=`Dashing: ${t}${n?" ★ LEADING":""} · Best: ${r}`}else to.hidden=!0;n?ue&&(ue.superDashOn=vt.isSuperDashOn(),ue.superMaxSpeed=vt.SUPER_MAX_SPEED,ue.superAccelMult=vt.SUPER_ACCEL_MULT):(vt.setSuperDash(!1),ue&&(ue.superDashOn=!1))}hr&&hr.addEventListener("click",()=>{if(!vt.isLocalLeader()||!zt||!ue)return;const n=vt.toggleSuperDash();ue.superDashOn=n,ue.superMaxSpeed=vt.SUPER_MAX_SPEED,ue.superAccelMult=vt.SUPER_ACCEL_MULT,Ht(n?"Super dash ON!":"Normal speed"),Ar()});function Sp(){Xt.style.display="none",at.show(),uh||(uy(at.renderer.domElement),uh=!0),ii(!0),Ul(),on.setVisible(!0),on.setDriving(zt),Pi(Rn,!0,{driving:zt}),Zl(),Kl(),Ir()}function Xb(n){if(ve.dead){Nb(n);return}const e=Lp();let{mx:t,mz:i}=Dp(e);const r=Ip(hn),s=on.readMove();t+=r.mx+s.mx,i+=r.mz+s.mz;const o=Math.hypot(t,i);if(o>1&&(t/=o,i/=o),vr>0&&(vr=Math.max(0,vr-n)),ns>0&&(ns=Math.max(0,ns-n*2.8)),dh+=n,zt&&ue){const d=Np(e),u=kb(),h=on.readDrive(),p=ph(ph(d,u),h),{impactSpeed:g,wallHit:_}=HS(ue,p,n,at.clampPosition);if(at.city.checkCarCollision(ue.x,ue.z,ue.rotY,ue.collisionHw??1.15,ue.collisionHd??2.25)||_){const f=g;Ib(f),Ol(f)||(ue.x=ue.prevX,ue.z=ue.prevZ),vf(ue)}if(BS(ue,dh,n),Hl(wr,n),hb(ue,n),$o.update(n,ue,al(ue)),Ui.tickCooldowns(n),Ui.forEach(f=>{Ui.tryShred(f,ue,{minSpeed:sb,cooldownSec:ob,onShred:()=>{const E=Math.round(rb*al(ue));gp(E,`+${E} coins — player shredded!`)}})}),_l(Cr,ue),mf(ue)&&!Vn){_p();return}at.updateWorld(ue.x,ue.z),at.updateDrivingCamera(ue.x,ue.z,ue.rotY,ns),mh(e),hn.isPressed("e")&&!Xa&&(Xa=!0,xp()),hn.isPressed("e")||(Xa=!1);return}Ay(ve,t,i,n);const a=ve.x+t*ch*n,c=ve.z+i*ch*n,l=at.clampPosition(a,c);ve.x=l.x,ve.z=l.z,hi(ve),at.updateWorld(ve.x,ve.z),at.updateCamera(ve.x,ve.z,ve.facing),Ui.lerpAll(n),Ga+=n,Ga>=xb&&(Ga=0,Pb()),mh(e),hn.isPressed("m")&&!Wa&&(Wa=!0,Sh()),hn.isPressed("m")||(Wa=!1)}function $b(n){const{width:e,height:t}=Xt;if(!((qa()||Gc()||Xu()||Zu()||ll()||dl())&&(Pi(Rn,!1),qa()||Zu()))){if(is>0&&(is=Math.max(0,is-n),is===0&&os&&os.classList.remove("show")),jr>0){jr=Math.max(0,jr-n);const i=jr>.35?1-(1.8-jr)/1.45:0;Xt.style.display="block",at.hide(),ii(!1),on.setVisible(!1),od(he,i>.2?"#e0f2fe":"#22c55e"),i>.05&&(he.fillStyle=`rgba(255,255,255,${i*.75})`,he.fillRect(0,0,e,t)),Ya(he,"TELEPORTING...",e/2,t*.38,{color:"#0f172a",size:36});return}if(It==="drawPaper"){Xt.style.display="none",at.hide(),ii(!1),on.setVisible(!1);return}if(It==="title"){Xt.style.display="block",at.hide(),ii(!1),on.setVisible(!1),Pi(Rn,!1),Ci&&(Ci.hidden=!0),Zr=Math.min(1,Zr+n*1.2),Qs=Math.min(1,Qs+n*.55),Ha+=n*4,od(he,"#22c55e");const i=Wb(e,t,Qs),r=Fb(e,t,i),s=Bb(r);if(he.globalAlpha=Zr,Hb(e,t,Zr),Ya(he,"The best game ever — realism incoming.",e/2,t*.3,{color:"#166534",size:18}),he.globalAlpha=1,!Xu()){Vb(r,s);const o=Math.min(1,.35+Qs*.65)*Zr;he.globalAlpha=o,_h(r,"PLAY",{top:"#fde047",bottom:"#facc15",pressedTop:"#facc15",pressedBottom:"#eab308",stroke:"#854d0e",text:"#422006"},Ha,rs,hn.pointer.down&&rs),_h(s,"MULTIPLAYER",{top:"#4ade80",bottom:"#22c55e",pressedTop:"#22c55e",pressedBottom:"#16a34a",stroke:"#14532d",text:"#14532d"},Ha+.5,ss,hn.pointer.down&&ss),he.globalAlpha=1}return}(It==="comingSoon"||It==="world")&&(at.renderer.domElement.style.boxShadow="",vt.update(n,zt?ue:null),Hl(wr,n),Ar(),Zl(),Kl(),Ir(),!Gc()&&!ll()&&!dl()&&Xb(n),It==="comingSoon"?(cl-=n,cl<=0&&(It="world"),Pi(Rn,!0,{driving:zt}),ii(!0),on.setVisible(!1)):(ii(!0),Pi(Rn,!0,{driving:zt})),at.render())}}window.addEventListener("gamepadconnected",()=>{});Pp($b);
