...
`].filter(rs).join(`
`)),o=tl(o),o=Eu(o,t),o=Tu(o,t),a=tl(a),a=Eu(a,t),a=Tu(a,t),o=wu(o),a=wu(a),t.isRawShaderMaterial!==!0&&(w=`#version 300 es
...
`);n.RTCSessionDescription&&r instanceof n.RTCSessionDescription?arguments[0]=new n.RTCSessionDescription({type:r.type,sdp:s}):r.sdp=s}return t.apply(this,arguments)}}function To(n,e){if(!(n.RTCPeerConnection&&n.RTCPeerConnection.prototype))return;const t=n.RTCPeerConnection.prototype.addIceCandidate;!t||t.length===0||(n.RTCPeerConnection.prototype.addIceCandidate=function(){return arguments[0]?(e.browser==="chrome"&&e.version<78||e.browser==="firefox"&&e.version<68||e.browser==="safari")&&arguments[0]&&arguments[0].candidate===""?Promise.resolve():t.apply(this,arguments):(arguments[1]&&arguments[1].apply(null),Promise.resolve())})}function wo(n,e){if(!(n.RTCPeerConnection&&n.RTCPeerConnection.prototype))return;const t=n.RTCPeerConnection.prototype.setLocalDescription;!t||t.length===0||(n.RTCPeerConnection.prototype.setLocalDescription=function(){let r=arguments[0]||{};if(typeof r!="object"||r.type&&r.sdp)return t.apply(this,arguments);if(r={type:r.type,sdp:r.sdp},!r.type)switch(this.signalingState){case"stable":case"have-local-offer":case"have-remote-pranswer":r.type="offer";break;default:r.type="answer";break}return r.sdp||r.type!=="offer"&&r.type!=="answer"?t.apply(this,[r]):(r.type==="offer"?this.createOffer:this.createAnswer).apply(this).then(o=>t.apply(this,[o]))})}const IM=Object.freeze(Object.defineProperty({__proto__:null,removeExtmapAllowMixed:Ml,shimAddIceCandidateNullOrEmpty:To,shimConnectionState:Sl,shimMaxMessageSize:bo,shimParameterlessSetLocalDescription:wo,shimRTCIceCandidate:Mo,shimRTCIceCandidateRelayProtocol:vl,shimSendThrowTypeError:Eo},Symbol.toStringTag,{value:"Module"}));function UM({window:n}={},e={shimChrome:!0,shimFirefox:!0,shimSafari:!0}){const t=md,i=AM(n),r={browserDetails:i,commonShim:IM,extractVersion:ss,disableLog:wM,disableWarnings:CM,sdp:DM};switch(i.browser){case"chrome":if(!ch||!xl||!e.shimChrome)return t("Chrome shim is not included in this adapter release."),r;if(i.version===null)return t("Chrome shim can not determine version, not shimming."),r;t("adapter.js shimming chrome."),r.browserShim=ch,To(n,i),wo(n),rp(n,i),sp(n),xl(n,i),op(n,i),dp(n,i),ap(n),cp(n,i),up(n,i),Mo(n),vl(n),Sl(n),bo(n,i),Eo(n,i),Ml(n,i);break;case"firefox":if(!lh||!yl||!e.shimFirefox)return t("Firefox shim is not included in this adapter release."),r;t("adapter.js shimming firefox."),r.browserShim=lh,To(n,i),wo(n),hp(n,i),yl(n,i),pp(n,i),fp(n),_p(n),mp(n),gp(n),xp(n),yp(n,i),vp(n,i),Sp(n,i),Mp(n,i),Mo(n),Sl(n),bo(n,i),Eo(n,i);break;case"safari":if(!dh||!e.shimSafari)return t("Safari shim is not included in this adapter release."),r;t("adapter.js shimming safari."),r.browserShim=dh,To(n,i),wo(n),Ap(n),Pp(n),Tp(n),bp(n),Ep(n),Rp(n),wp(n),Lp(n),Mo(n),vl(n),bo(n,i),Eo(n,i),Ml(n,i);break;default:t("Unsupported browser!");break}return r}const hh=UM({window:typeof window>"u"?void 0:window});function Xi(n,e,t,i){Object.defineProperty(n,e,{get:t,set:i,enumerable:!0,configurable:!0})}class Ip{constructor(){this.chunkedMTU=16300,this._dataCount=1,this.chunk=e=>{const t=[],i=e.byteLength,r=Math.ceil(i/this.chunkedMTU);let s=0,o=0;for(;o<i;){const a=Math.min(i,o+this.chunkedMTU),c=e.slice(o,a),l={__peerData:this._dataCount,n:s,data:c,total:r};t.push(l),o=a,s++}return this._dataCount++,t}}}function NM(n){let e=0;for(const r of n)e+=r.byteLength;const t=new Uint8Array(e);let i=0;for(const r of n)t.set(r,i),i+=r.byteLength;return t}const Ya=hh.default||hh,Jr=new class{isWebRTCSupported(){return typeof RTCPeerConnection<"u"}isBrowserSupported(){const n=this.getBrowser(),e=this.getVersion();return this.supportedBrowsers.includes(n)?n==="chrome"?e>=this.minChromeVersion:n==="firefox"?e>=this.minFirefoxVersion:n==="safari"?!this.isIOS&&e>=this.minSafariVersion:!1:!1}getBrowser(){return Ya.browserDetails.browser}getVersion(){return Ya.browserDetails.version||0}isUnifiedPlanSupported(){const n=this.getBrowser(),e=Ya.browserDetails.version||0;if(n==="chrome"&&e<this.minChromeVersion)return!1;if(n==="firefox"&&e>=this.minFirefoxVersion)return!0;if(!window.RTCRtpTransceiver||!("currentDirection"in RTCRtpTransceiver.prototype))return!1;let t,i=!1;try{t=new RTCPeerConnection,t.addTransceiver("audio"),i=!0}catch{}finally{t&&t.close()}return i}toString(){return`Supports:
  ...
  `,document.body.appendChild(o);const c=o.querySelector("#admin-shop-grid"),l=o.querySelector("#admin-shop-coins");let u="skins";function d(w){const T=w?Po:Po.filter(x=>n.ownsSkin(x.id));if(!w&&T.length===0){c.innerHTML='<p class="shop-empty">Buy a skin in the Skins tab!</p>';return}for(const x of T){const R=n.ownsSkin(x.id),y=n.getEquippedSkinId()===x.id,E=document.createElement("button");E.type="button",E.className="shop-item",y&&E.classList.add("equipped"),E.innerHTML=`
      ...
      `,v.addEventListener("click",()=>{var M;if(w)if(E)n.equipWeapon(y.id),e==null||e(y.id);else{const P=n.buyWeapon(y.id);P.ok?e==null||e(((M=P.weapon)==null?void 0:M.id)??y.id):P.reason==="insufficient"&&(s==null||s("insufficient"))}else n.equipWeapon(y.id),e==null||e(y.id);p()}),c.appendChild(v)}}function p(){if(c){if(c.innerHTML="",l.textContent=(r==null?void 0:r())??`Coins: ${n.getCoins()}`,u==="skins")d(!0);else if(u==="weapons")h(!0);else if(u==="equip"){const w=Po.filter(x=>n.ownsSkin(x.id)),T=Ih().filter(x=>n.ownsWeapon(x.id));if(w.length===0&&T.length===0){c.innerHTML='<p class="shop-empty">Buy skins or weapons first!</p>';return}w.length&&d(!1),T.length&&h(!1)}}}o.querySelectorAll(".shop-tab").forEach(w=>{w.addEventListener("click",()=>{u=w.dataset.tab,o.querySelectorAll(".shop-tab").forEach(T=>T.classList.toggle("active",T===w)),p()})}),o.querySelector("#admin-shop-close").addEventListener("click",()=>_());function g(){a=!0,o.style.display="flex",p()}function _(){a=!1,o.style.display="none",i==null||i()}function m(){return a}function f(){a&&p()}return{showAdminShop:g,hideAdminShop:_,isAdminShopVisible:m,refreshAdminShop:f}}const rc="ccwd-build";function Qb(){const n=location.hostname;if(n==="localhost"||n==="127.0.0.1")return;const e=async()=>{try{const t=await fetch(`./version.json?_=${Date.now()}`,{cache:"no-store"});if(!t.ok)return;const{v:i}=await t.json();if(!i)return;const r=localStorage.getItem(rc);if(r&&r!==i){pb(),localStorage.setItem(rc,i),location.reload();return}r||localStorage.setItem(rc,i)}catch{}};e(),setInterval(e,180*1e3)}fb().then(()=>{Qb()});const eE=5,Hh=7,tE=.05,nE=0,iE=0,Gh=5,rE=new URLSearchParams(window.location.search).has("teleport"),{canvas:Xt,ctx:he}=cm();Xt.id="title-canvas";Xt.style.position="fixed";Xt.style.inset="0";Xt.style.zIndex="1";const hn=new dm(document.body),an=Wv();an.onExit(()=>Qp());const Ve=oS(),xe=Bf(0,0);dS(Ve.scene,xe);const wr=tb(Ve.scene);let Ct=sb()?"drawPaper":"title",es=rE?1.8:0,ts=0,lo=0,sc=0,ds=!1,us=!1,uo=!1,Rl=0,ot=null,zi=!1,oc=0,xr=1,ac=!1,cc=!1,lc=!1,ie=null,Nt=!1,Oi=null,Cr=0,Vh=0,cs=0,vn=[],Pi=0,Wh=!1,Xh={},ls=0;const hs=document.getElementById("action-toast"),Mn=document.getElementById("controls-hud"),Hi=document.getElementById("damage-hud"),Li=document.getElementById("room-banner"),yr=document.getElementById("super-dash-btn"),ho=document.getElementById("dash-score-hud"),Go=document.getElementById("death-overlay"),Vo=document.getElementById("death-timer"),vr=document.getElementById("non-dying-btn"),Wo=document.getElementById("regenerate-btn"),dc=document.getElementById("coin-hud"),Xo=document.getElementById("kill-shop-btn"),$o=document.getElementById("admin-shop-btn");let $n=!1;function sE(){return(ot==null?void 0:ot.id)??"local"}const wn=Pb(sE),ys=Ub(Ve.scene);function Sd(){return`Coins: ${wn.getCoins()}`}function jp(n,e){!n||n<=0||(wn.addCoins(n),Td(),uE(),fE(),e&&vt(e))}ys.setOnDestroyed(()=>{});let $h={firing:!1};function oE(n,e){if(!n||n<=0)return;const t=e==="shred"?`+${n} coins — shredded!`:e==="target"?`+${n} coins — target destroyed!`:`+${n} coins — hit!`;jp(n,t)}function aE(){const n=Math.round(Nb*zb(ie));jp(n,`+${n} coins — player shredded!`)}const cE=Kb(wn,{getCoinsText:Sd,onEquip:n=>{ie&&ra(ie,n);const e=wn.getEquippedWeapon();(e==null?void 0:e.type)==="mini_gun"?vt("Mini gun mounted — hold click to shoot!"):(e==null?void 0:e.type)==="saw_blade"?vt("Saw blade mounted — ram targets head-on!"):(e==null?void 0:e.type)==="chainsaw"?vt("Chainsaws mounted on sides & back — sideswipe to shred!"):vt("Weapon equipped on your car!")},onClose:()=>Yi(),onPurchaseFail:()=>vt("Not enough coins!")}),lE=Jb(wn,{getCoinsText:Sd,onEquipWeapon:n=>{ie&&ra(ie,n);const e=wn.getEquippedWeapon();(e==null?void 0:e.type)==="mini_gun"?vt("Mini gun mounted — hold click to shoot!"):(e==null?void 0:e.type)==="saw_blade"?vt("Saw blade mounted — ram targets head-on!"):(e==null?void 0:e.type)==="chainsaw"?vt("Chainsaws mounted on sides & back — sideswipe to shred!"):vt("Weapon equipped on your car!")},onEquipSkin:()=>{vt("Skin equipped — spawn a car from the garage to apply it!")},onClose:()=>Yi(),onPurchaseFail:()=>vt("Not enough coins!")}),{showKillShop:dE,isKillShopVisible:Pl,refreshKillShop:uE}=cE,{showAdminShop:hE,isAdminShopVisible:Ll,refreshAdminShop:fE}=lE;function Cn(){return zi||!ot}ef(()=>Yo(Mn,{driving:Nt}));uS(Md);ob(()=>Yh(),()=>Yh(!0));function Yh(n=!1){Ct="title",Xt.style.display="block",Xp(),n&&Hp()}Ct==="drawPaper"&&(Xt.style.display="none",rb());eb(({room:n,isHost:e})=>{ot=n,zi=e,Cn()||($n=!1),wn.reloadForPlayer(),xe.x=0,xe.z=0,xi(xe),pE(n),Ct="world",nm(),tm(em(n.code??"solo")),Lo(),ys.reset(),vt("You're in the game!")});function pE(n){n.onMessage=(e,t)=>{e.t==="pose"&&e.id&&e.id!==n.id&&(n.role==="host"&&n.relay(t,e),wr.applyPose(e.id,e)),e.t==="join"&&e.id&&(wr.applyPose(e.id,{x:0,z:4,facing:0,walkPhase:0,isMoving:!1}),xr+=1,Lo(),vt("Someone joined!"),zi&&yt.syncState()),e.t==="leave"&&e.id&&(wr.remove(e.id),xr=Math.max(1,xr-1),Lo()),(e.t==="dashState"||e.t==="dashCollect")&&(yt.handleMessage(e),Ur()),e.t==="dashScoreReset"&&(yt.handleMessage(e),Ur())},n.onPeerCount=e=>{xr=e,Lo()}}function Lo(){if(!(!Li||!(ot!=null&&ot.code)))if(zi){const n=zp(ot.code);Li.innerHTML=`Room <strong>${ot.code}</strong> · ${xr} player(s) · <a href="${n}" target="_blank" rel="noopener">Share link</a>`,Li.hidden=!1}else Li.textContent=`Room ${ot.code} · ${xr} player(s)`,Li.hidden=!1}function mE(){ot!=null&&ot.id&&ot.send({t:"pose",id:ot.id,x:xe.x,z:xe.z,facing:xe.facing,walkPhase:xe.walkPhase,isMoving:xe.isMoving})}const gE="cybertruck";function Zp(){if(Oi!=null&&Oi.id){const n=Zu(Oi.id);if(n)return n}return Zu(gE)}function Kp(n){const e=Cn()?wn.getEquippedSkinId():null;return e?Rb(n,e):n}function Md(n){var e;n&&(Oi=n,gs(),ie&&(Zf(xe,Ve.scene),jf(Ve.scene,ie),ie=null,Nt=!1),ie=SM(xe,Kp(n),Ve.clampPosition,Ve.envTex),pM(Ve.scene,ie),ra(ie,((e=wn.getEquippedWeapon())==null?void 0:e.id)??null),id(ie),Nt=!0,an.setDriving(!0),Kf(xe,ie),ta(ie),Ve.updateDrivingCamera(ie.x,ie.z,ie.rotY),Yo(Mn,{driving:!0}),rd(Hi,!0),ea(Hi,ie),bd(),Yi(),li(Mn,!0,{driving:!0}))}function _E(n){if(!(!ie||Cr>0)){if(nM(ie,Ve.scene,n,vn),ea(Hi,ie),Yf(ie)&&!$n){Jp();return}if(ld(n)){xM(ie,n);const e=Math.abs(n)>=38;cs=e?.5:.22,Cr=e?.55:.4}else Math.abs(n)>5&&(ie.speed*=.55,Cr=.12)}}function Jp(){if(!xe.dead){if(xe.dead=!0,Pi=Gh,Nt&&ie){const n=ie.x,e=ie.z,t=ie.rotY;Jf(xe,ie),xe.x=n,xe.z=e,xe.facing=t,ie.speed=0,Nt=!1,an.setDriving(!1),yt.setSuperDash(!1),ie.superDashOn=!1}yt.resetPlayerScore(),Ur(),xe.mesh.rotation.x=-Math.PI/2,xi(xe),li(Mn,!1),rd(Hi,!1),ci(!1),Ur(),Go&&(Go.hidden=!1),Vo&&(Vo.textContent=`Respawning in ${Gh}...`),vt("Your car was destroyed!")}}function xE(){var e;xe.dead=!1,Pi=0,ie&&(jf(Ve.scene,ie),ie=null);for(const t of vn)(e=t.mesh.parent)==null||e.remove(t.mesh);vn.length=0,xe.x=nE,xe.z=iE,xe.facing=0,xe.mesh.rotation.set(0,0,0),xe.mesh.visible=!0,xe.inVehicle=null,xi(xe),Nt=!1,an.setDriving(!1),Go&&(Go.hidden=!0),ci(!0),gs(),li(Mn,!0,{driving:!1});const n=Zp();n?(Md(n),vt("Respawned — back in your car!")):(sd(),vt("Respawned at spawn!"))}function yE(n){Pi=Math.max(0,Pi-n),Vo&&(Vo.textContent=Pi>0?`Respawning in ${Math.ceil(Pi)}...`:"Respawning..."),pd(vn,n),Ve.updateWorld(xe.x,xe.z),Ve.updateCamera(xe.x,xe.z,xe.facing),Pi<=0&&xE()}function Qp(){!ie||!Nt||(Jf(xe,ie),Nt=!1,an.setDriving(!1),xi(xe),Ve.updateCamera(xe.x,xe.z,xe.facing),Yo(Mn,{driving:!1}),rd(Hi,!1),vt("Exited vehicle"))}function vE(){return mm(hn)}function qh(n,e){return{throttle:Math.max(n.throttle??0,e.throttle??0),brake:Math.max(n.brake??0,e.brake??0),reverse:Math.max(n.reverse??0,e.reverse??0),steer:Math.abs(n.steer)>Math.abs(e.steer)?n.steer:e.steer}}function jh(n){var i,r;if(!n||Ct!=="world"||hc()||cl())return;const{fired:e,prevPressed:t}=_m(n,Ol(),Xh);Xh=t;for(const s of e)vt(s.action);(i=n.buttons[9])!=null&&i.pressed&&!ac&&(ac=!0,tf()),(r=n==null?void 0:n.buttons[9])!=null&&r.pressed||(ac=!1)}function SE(n,e){const t=Math.max(0,Math.min(1,(e-n.topY)/(n.bottomY-n.topY)));return n.topW*2+(n.bottomW-n.topW*2)*t}function ME(n,e,t){const i=e*.56,r=SE(t,i),s=Math.min(r*.82,n*.78,420),o=s*.34;return{x:t.cx-s/2,y:i-o/2,w:s,h:o,cx:t.cx,cy:i}}function bE(n){const t=n.h*.72,i=n.w*.92,r=n.cy+n.h/2+14+t/2;return{x:n.cx-i/2,y:r-t/2,w:i,h:t,cx:n.cx,cy:r}}function EE(n,e){const t=Xt.getBoundingClientRect(),i=Xt.width/t.width,r=Xt.height/t.height;return{x:(n-t.left)*i,y:(e-t.top)*r}}function Zh(n,e,t){return n>=t.x&&n<=t.x+t.w&&e>=t.y&&e<=t.y+t.h}function TE(n,e,t){const i=e*.22,r=44,s="car crashing with ",o="dashing";he.save(),he.globalAlpha=t,he.font=`800 ${r}px system-ui, sans-serif`,he.textBaseline="middle";const a=he.measureText(s+o).width;let c=n/2-a/2;he.textAlign="left",he.fillStyle="#14532d",he.fillText(s,c,i),c+=he.measureText(s).width,he.fillText(o,c,i);const l=he.measureText(o).width,u=i+r*.38;he.strokeStyle="#14532d",he.lineWidth=4,he.beginPath(),he.moveTo(c,u),he.lineTo(c+l,u),he.stroke(),he.restore()}function Kh(n,e,t,i,r,s){const o=1+Math.sin(i)*.04+(r?.05:0)+(s?-.03:0),a=n.w*o,c=n.h*o,l=n.cx-a/2,u=n.cy-c/2,d=c*.28;he.save(),he.shadowColor="rgba(0,0,0,0.45)",he.shadowBlur=24,he.shadowOffsetY=8;const h=he.createLinearGradient(l,u,l,u+c);h.addColorStop(0,s?t.pressedTop:t.top),h.addColorStop(1,s?t.pressedBottom:t.bottom),he.fillStyle=h,he.beginPath(),he.roundRect(l,u,a,c,d),he.fill(),he.shadowBlur=0,he.shadowOffsetY=0,he.strokeStyle=t.stroke,he.lineWidth=5,he.stroke(),uc(he,e,n.cx,n.cy,{size:Math.floor(c*.38),color:t.text}),he.restore()}function wE(){Ct="comingSoon",Rl=eE,ot=null,zi=!1,wn.reloadForPlayer(),xe.x=0,xe.z=0,xi(xe),nm(),tm(em(String(Date.now()))),ys.reset()}function CE(n,e){const t=EE(hn.pointer.x,hn.pointer.y);ds=Zh(t.x,t.y,n),us=Zh(t.x,t.y,e),Xt.style.cursor=ds||us?"pointer":"default",hn.pointer.down&&!uo&&(ds?(wE(),uo=!0):us&&(Hp(),uo=!0)),hn.pointer.down||(uo=!1)}function Jh(n,e,t=1){const i=n/2,r=e*.42,s=e,o=n*.08*t,a=n*.92;return{cx:i,topY:r,bottomY:s,topW:o,bottomW:a}}function AE(n,e,t){if(t<=0)return Jh(n,e,t);const i=Jh(n,e,t),{cx:r,topY:s,bottomY:o,topW:a,bottomW:c}=i;he.save(),he.globalAlpha=Math.min(1,t);const l=he.createLinearGradient(0,s,0,o);return l.addColorStop(0,"#334155"),l.addColorStop(1,"#1e293b"),he.fillStyle=l,he.beginPath(),he.moveTo(r-a,s),he.lineTo(r+a,s),he.lineTo(r+c/2,o),he.lineTo(r-c/2,o),he.closePath(),he.fill(),he.strokeStyle="rgba(250,204,21,0.85)",he.lineWidth=3,he.setLineDash([18,16]),he.beginPath(),he.moveTo(r,s),he.lineTo(r,o),he.stroke(),he.setLineDash([]),he.fillStyle="rgba(15,23,42,0.35)",he.fillRect(0,e*.72,n,e*.28),he.restore(),i}function vt(n){ls=2,hs&&(hs.textContent=n,hs.classList.add("show"))}function em(n){let e=0;for(let t=0;t<n.length;t++)e=(e<<5)-e+n.charCodeAt(t)|0;return Math.abs(e)||1}const yt=bb(Ve.scene,{getPlayerId:()=>(ot==null?void 0:ot.id)??"local",isHost:()=>!ot||zi,send:n=>{ot&&(zi&&n.t==="dashState"?ot.send(n):n.t==="dashCollect"||n.t==="dashScoreReset"?ot.sendToHost(n):ot.send(n))}});yt.setToast(vt);function tm(n){yt.reset(n),yt.isSessionActive()&&vt("Blue Dashing circles spawned — collect them!")}function RE(){var e,t;if(!Cn()||!ie||!Oi||xe.dead)return;for(let i=vn.length-1;i>=0;i--)vn[i].isPart&&((e=vn[i].mesh.parent)==null||e.remove(vn[i].mesh),vn.splice(i,1));const n=(t=wn.getEquippedWeapon())==null?void 0:t.id;Zf(xe,Ve.scene),yM(ie,Ve.scene,Kp(Oi),Ve.envTex),ra(ie,n??null),Kf(xe,ie),ea(Hi,ie),vt("Car regenerated — good as new!")}function bd(){if(!Wo)return;const n=Cn()&&Nt&&ie&&!xe.dead&&(Ct==="world"||Ct==="comingSoon");Wo.hidden=!n}Wo&&Wo.addEventListener("click",()=>RE());function Ed(){if(!vr)return;Cn()||($n=!1);const n=Cn()&&(Ct==="world"||Ct==="comingSoon")&&!xe.dead;vr.hidden=!n,vr.classList.toggle("active",$n),vr.textContent=$n?"NON-DYING":"DYING ON"}vr&&vr.addEventListener("click",()=>{Cn()&&($n=!$n,Ed(),vt($n?"Non-dying ON — drive with no parts!":"Dying ON — destroyed car kills you"))});function Td(){if(!dc)return;const n=(Ct==="world"||Ct==="comingSoon")&&!xe.dead;dc.hidden=!n,dc.textContent=Sd()}function Yi(){const n=(Ct==="world"||Ct==="comingSoon")&&!xe.dead,e=Pl()||Ll();Xo&&(Xo.hidden=!n||Cn()||e),$o&&($o.hidden=!n||!Cn()||e)}Xo&&Xo.addEventListener("click",()=>{Cn()||(dE(),Yi())});$o&&$o.addEventListener("click",()=>{Cn()&&(hE(),Yi())});function Ur(){const n=yt.isLocalLeader()&&Nt&&yt.isSessionActive();if(yr&&(yr.hidden=!n,yr.classList.toggle("active",yt.isSuperDashOn()),yr.textContent=yt.isSuperDashOn()?"NORMAL SPEED":"SUPER DASH"),ho)if(Ct==="world"&&yt.isSessionActive()){const e=yt.getScores(),t=e[(ot==null?void 0:ot.id)??"local"]??0,i=yt.getLeaderIds(),r=i.length?Math.max(...i.map(s=>e[s]??0)):0;ho.hidden=!1,ho.textContent=`Dashing: ${t}${n?" ★ LEADING":""} · Best: ${r}`}else ho.hidden=!0;n?ie&&(ie.superDashOn=yt.isSuperDashOn(),ie.superMaxSpeed=yt.SUPER_MAX_SPEED,ie.superAccelMult=yt.SUPER_ACCEL_MULT):(yt.setSuperDash(!1),ie&&(ie.superDashOn=!1))}yr&&yr.addEventListener("click",()=>{if(!yt.isLocalLeader()||!Nt||!ie)return;const n=yt.toggleSuperDash();ie.superDashOn=n,ie.superMaxSpeed=yt.SUPER_MAX_SPEED,ie.superAccelMult=yt.SUPER_ACCEL_MULT,vt(n?"Super dash ON!":"Normal speed"),Ur()});function nm(){if(Xt.style.display="none",Ve.show(),Wh||(Yv(Ve.renderer.domElement),Wb(Ve.renderer.domElement),Wh=!0),ci(!0),gs(),an.setVisible(!0),!Nt&&!xe.dead){const n=Zp();n?Md(n):sd()}else an.setDriving(Nt),li(Mn,!0,{driving:Nt});Ed(),bd(),Td(),Yi()}function PE(n){if(xe.dead){yE(n);return}const e=hm();let{mx:t,mz:i}=fm(e);const r=pm(hn),s=an.readMove();t+=r.mx+s.mx,i+=r.mz+s.mz;const o=Math.hypot(t,i);if(o>1&&(t/=o,i/=o),Cr>0&&(Cr=Math.max(0,Cr-n)),cs>0&&(cs=Math.max(0,cs-n*2.8)),Vh+=n,Nt&&ie){const u=gm(e),d=vE(),h=an.readDrive(),p=qh(qh(u,d),h),{impactSpeed:g,wallHit:_}=vM(ie,p,n,Ve.clampPosition);if(Ve.city.checkCarCollision(ie.x,ie.z,ie.rotY,ie.collisionHw??1.15,ie.collisionHd??2.25)||_){const f=g;_E(f),ld(f)||(ie.x=ie.prevX,ie.z=ie.prevZ),ta(ie)}if(_M(ie,Vh,n),pd(vn,n),ys.update(n),$h=$b(n,{vehicle:ie,camera:Ve.camera,renderer:Ve.renderer,scene:Ve.scene,shredTargets:ys,remotePlayers:wr,onTargetHit:oE,onPlayerShred:aE}),Hb(ie,n,$h.firing),wr.tickCooldowns(n),ea(Hi,ie),Yf(ie)&&!$n){Jp();return}Ve.updateWorld(ie.x,ie.z),Ve.updateDrivingCamera(ie.x,ie.z,ie.rotY,cs),jh(e),hn.isPressed("e")&&!lc&&(lc=!0,Qp()),hn.isPressed("e")||(lc=!1);return}lS(xe,t,i,n);const a=xe.x+t*Hh*n,c=xe.z+i*Hh*n,l=Ve.clampPosition(a,c);xe.x=l.x,xe.z=l.z,xi(xe),Ve.updateWorld(xe.x,xe.z),Ve.updateCamera(xe.x,xe.z,xe.facing),wr.lerpAll(n),oc+=n,oc>=tE&&(oc=0,mE()),jh(e),hn.isPressed("m")&&!cc&&(cc=!0,tf()),hn.isPressed("m")||(cc=!1)}function LE(n){const{width:e,height:t}=Xt;if(!((hc()||cl()||Mh()||Ch()||Pl()||Ll())&&(li(Mn,!1),hc()||Ch()))){if(ls>0&&(ls=Math.max(0,ls-n),ls===0&&hs&&hs.classList.remove("show")),es>0){es=Math.max(0,es-n);const i=es>.35?1-(1.8-es)/1.45:0;Xt.style.display="block",Ve.hide(),ci(!1),an.setVisible(!1),Ud(he,i>.2?"#e0f2fe":"#22c55e"),i>.05&&(he.fillStyle=`rgba(255,255,255,${i*.75})`,he.fillRect(0,0,e,t)),uc(he,"TELEPORTING...",e/2,t*.38,{color:"#0f172a",size:36});return}if(Ct==="drawPaper"){Xt.style.display="none",Ve.hide(),ci(!1),an.setVisible(!1);return}if(Ct==="title"){Xt.style.display="block",Ve.hide(),ci(!1),an.setVisible(!1),li(Mn,!1),Li&&(Li.hidden=!0),ts=Math.min(1,ts+n*1.2),lo=Math.min(1,lo+n*.55),sc+=n*4,Ud(he,"#22c55e");const i=AE(e,t,lo),r=ME(e,t,i),s=bE(r);if(he.globalAlpha=ts,TE(e,t,ts),uc(he,"The best game ever — realism incoming.",e/2,t*.3,{color:"#166534",size:18}),he.globalAlpha=1,!Mh()){CE(r,s);const o=Math.min(1,.35+lo*.65)*ts;he.globalAlpha=o,Kh(r,"PLAY",{top:"#fde047",bottom:"#facc15",pressedTop:"#facc15",pressedBottom:"#eab308",stroke:"#854d0e",text:"#422006"},sc,ds,hn.pointer.down&&ds),Kh(s,"MULTIPLAYER",{top:"#4ade80",bottom:"#22c55e",pressedTop:"#22c55e",pressedBottom:"#16a34a",stroke:"#14532d",text:"#14532d"},sc+.5,us,hn.pointer.down&&us),he.globalAlpha=1}return}(Ct==="comingSoon"||Ct==="world")&&(Ve.renderer.domElement.style.boxShadow="",yt.update(n,Nt?ie:null),pd(vn,n),Ur(),Ed(),bd(),Td(),Yi(),!cl()&&!Pl()&&!Ll()&&PE(n),Ct==="comingSoon"?(Rl-=n,Rl<=0&&(Ct="world"),li(Mn,!0,{driving:Nt}),ci(!0),an.setVisible(!1)):(ci(!0),li(Mn,!0,{driving:Nt})),Ve.render())}}window.addEventListener("gamepadconnected",()=>{});um(LE);
