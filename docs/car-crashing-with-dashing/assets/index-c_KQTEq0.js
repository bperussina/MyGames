var dm=n=>{throw TypeError(n)};var Xr=(n,e,t)=>e.has(n)?dm("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(n):e.set(n,t);function um(n,e){for(var t=0;t<e.length;t++){const i=e[t];if(typeof i!="string"&&!Array.isArray(i)){for(const r in i)if(r!=="default"&&!(r in n)){const s=Object.getOwnPropertyDescriptor(i,r);s&&Object.defineProperty(n,r,s.get?s:{enumerable:!0,get:()=>i[r]})}}}return Object.freeze(Object.defineProperty(n,Symbol.toStringTag,{value:"Module"}))}(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function t(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerPolicy&&(s.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?s.credentials="include":r.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(r){if(r.ep)return;r.ep=!0;const s=t(r);fetch(r.href,s)}})();function hm(n=document.body){const e=document.createElement("canvas");e.style.display="block",n.appendChild(e);const t=e.getContext("2d");function i(){e.width=window.innerWidth,e.height=window.innerHeight}return i(),window.addEventListener("resize",i),{canvas:e,ctx:t,resize:i}}function kd(n,e="#1a1a2e"){n.fillStyle=e,n.fillRect(0,0,n.canvas.width,n.canvas.height)}const fm=new Set(["arrowup","arrowdown","arrowleft","arrowright"," ","w","a","s","d","x","e","r","l","b"]);class pm{constructor(e=window){this.keys=new Set,this.pointer={x:0,y:0,down:!1},document.addEventListener("keydown",t=>{const i=t.key.toLowerCase();this.keys.add(i),fm.has(i)&&t.preventDefault()}),document.addEventListener("keyup",t=>{this.keys.delete(t.key.toLowerCase())}),e.addEventListener("pointermove",t=>{this.pointer.x=t.clientX,this.pointer.y=t.clientY}),e.addEventListener("pointerdown",t=>{this.pointer.x=t.clientX,this.pointer.y=t.clientY,this.pointer.down=!0,e.focus&&e.focus()}),e.addEventListener("pointerup",()=>{this.pointer.down=!1})}isDown(e){return this.keys.has(e.toLowerCase())}isPressed(...e){return e.some(t=>this.isDown(t))}}function mm(n){let e=0,t=performance.now();function i(r){const s=(r-t)/1e3;t=r,n(s),e=requestAnimationFrame(i)}return e=requestAnimationFrame(i),()=>cancelAnimationFrame(e)}function hc(n,e,t,i,r={}){const{color:s="#ffffff",size:o=24,align:a="center",baseline:c="middle",font:l="sans-serif"}=r;n.fillStyle=s,n.font=`${o}px ${l}`,n.textAlign=a,n.textBaseline=c,n.fillText(e,t,i)}const Od=.18;function gm(){var e;return(((e=navigator.getGamepads)==null?void 0:e.call(navigator))??[]).find(t=>t==null?void 0:t.connected)??null}function _m(n){var i,r,s,o;let e=0,t=0;if(n){const a=n.axes[0]??0,c=n.axes[1]??0;Math.abs(a)>Od&&(e+=a),Math.abs(c)>Od&&(t-=c),(i=n.buttons[14])!=null&&i.pressed&&(e-=1),(r=n.buttons[15])!=null&&r.pressed&&(e+=1),(s=n.buttons[12])!=null&&s.pressed&&(t+=1),(o=n.buttons[13])!=null&&o.pressed&&(t-=1)}return{mx:e,mz:t}}function xm(n){let e=0,t=0;return n.isPressed("w","arrowup")&&(t+=1),n.isPressed("s","arrowdown")&&(t-=1),n.isPressed("a","arrowleft")&&(e-=1),n.isPressed("d","arrowright")&&(e+=1),{mx:e,mz:t}}function ym(n){let e=0,t=0,i=0,r=0;return n.isPressed("w","arrowup")&&(e=1),n.isPressed("s")&&(t=1),n.isPressed("arrowdown")&&(i=1),n.isPressed("a","arrowleft")&&(r-=1),n.isPressed("d","arrowright")&&(r+=1),r=Math.max(-1,Math.min(1,r)),{throttle:e,brake:t,reverse:i,steer:r}}function vm(n){var a,c,l,u,d,h;let e=0,t=0,i=0;if(!n)return{throttle:e,brake:t,reverse:0,steer:i};(a=n.buttons[2])!=null&&a.pressed&&(e=1),(c=n.buttons[1])!=null&&c.pressed&&(t=1);let r=0,s=0;return(l=n.buttons[4])!=null&&l.pressed&&(r=1),(((u=n.buttons[6])==null?void 0:u.value)??((d=n.buttons[6])!=null&&d.pressed?1:0))>.08&&(r=1),(h=n.buttons[5])!=null&&h.pressed&&(s=1),i=s-r,{throttle:e,brake:t,reverse:0,steer:i}}const Ol=[{id:"a",label:"A",index:0},{id:"b",label:"B",index:1},{id:"x",label:"X",index:2},{id:"y",label:"Y",index:3},{id:"lb",label:"LB",index:4},{id:"rb",label:"RB",index:5},{id:"lt",label:"LT",index:6},{id:"rt",label:"RT",index:7},{id:"view",label:"View",index:8},{id:"menu",label:"Menu",index:9},{id:"ls",label:"Left stick press",index:10},{id:"rs",label:"Right stick press",index:11},{id:"dpadUp",label:"D-pad Up",index:12},{id:"dpadDown",label:"D-pad Down",index:13},{id:"dpadLeft",label:"D-pad Left",index:14},{id:"dpadRight",label:"D-pad Right",index:15},{id:"xbox",label:"Xbox",index:16}];function Sm(n,e,t={}){var s;const i=[];if(!n)return{fired:i,prevPressed:t};const r={...t};for(const o of Ol){const a=!!((s=n.buttons[o.index])!=null&&s.pressed),c=t[o.id]??!1;if(r[o.id]=a,a&&!c){const l=(e[o.id]??"").trim();l&&i.push({id:o.id,action:l})}}return{fired:i,prevPressed:r}}const nf="ccwd-button-labels";function Fl(){try{return JSON.parse(localStorage.getItem(nf)??"{}")}catch{return{}}}function Mm(n){try{localStorage.setItem(nf,JSON.stringify(n))}catch{}}let zt=null,os=null;function rf(n){if(os=n,zt)return zt;zt=document.createElement("div"),zt.id="controller-map",zt.innerHTML=`
    <div class="cm-header">
  ...
  `,document.body.appendChild(zt);const e=zt.querySelector("#cm-fields"),t=Fl();for(const i of Ol){const r=document.createElement("div");r.className="cm-row",r.innerHTML=`
      <span class="cm-line"></span>
      <label class="cm-label">${i.label}</label>
      <input type="text" class="cm-input" data-id="${i.id}" placeholder="(blank = does nothing)" value="${bm(t[i.id]??"")}" />
    `,e.appendChild(r)}return zt.querySelector("#cm-done").addEventListener("click",()=>{const i={};zt.querySelectorAll(".cm-input").forEach(r=>{i[r.dataset.id]=r.value}),Mm(i),Em(),os==null||os()}),zt}function bm(n){return String(n).replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;")}function sf(){rf(os),zt.style.display="flex"}function Em(){zt&&(zt.style.display="none")}function fc(){return(zt==null?void 0:zt.style.display)==="flex"}const Tm={x:"Gas",b:"Brake",lb:"Turn left",lt:"Turn left",rb:"Turn right",menu:"Change controls"},wm={a:"chip-a",b:"chip-b",x:"chip-x",y:"chip-y",lb:"chip-bump",rb:"chip-bump",lt:"chip-trigger",rt:"chip-trigger",view:"chip-misc",menu:"chip-misc",ls:"chip-misc",rs:"chip-misc",dpadUp:"chip-dpad",dpadDown:"chip-dpad",dpadLeft:"chip-dpad",dpadRight:"chip-dpad",xbox:"chip-misc"};function Ui(n){return String(n).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/"/g,"&quot;")}function Cm(n,e){const t=(n[e]??"").trim();return t||(Tm[e]??"").trim()}function Am(n,e){return`<span class="pc-key" title="${Ui(e)}"><span class="pc-key-letter">${Ui(n)}</span><span class="pc-key-word">${Ui(e)}</span></span>`}function Rm(n,e){return`<span class="pad-chip ${wm[n.id]??"chip-misc"}" title="${Ui(n.label)} button — ${Ui(e)}"><span class="pad-chip-mark">${Ui(n.label)}</span><span class="pad-chip-word">${Ui(e)}</span></span>`}function qo(n,{driving:e=!1}={}){if(!n)return;const t=n.querySelector("#controls-body");if(!t)return;const i=Fl(),r=e?[{key:"W",word:"Gas"},{key:"↑",word:"Gas"},{key:"S",word:"Brake"},{key:"↓",word:"Reverse"},{key:"A",word:"Left"},{key:"←",word:"Left"},{key:"D",word:"Right"},{key:"→",word:"Right"},{key:"E",word:"Exit car"}]:[{key:"W",word:"Forward"},{key:"↑",word:"Forward"},{key:"A",word:"Left"},{key:"←",word:"Left"},{key:"S",word:"Back"},{key:"↓",word:"Back"},{key:"D",word:"Right"},{key:"→",word:"Right"}],s=['<span class="pad-chip chip-stick" title="Left stick — move"><span class="pad-chip-mark">Stick</span><span class="pad-chip-word">Move</span></span>'];for(const o of Ol){const a=Cm(i,o.id);a&&s.push(Rm(o,a))}t.innerHTML=`
    ...
    <div class="controls-mini-block">
      ...
      <div class="pc-keys">${r.map(({key:o,word:a})=>Am(o,a)).join("")}</div>
    </div>
    <div class="controls-mini-block">
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:fi,depthTest:!1,depthWrite:!1})}function pu(){return new yi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Kl(),fragmentShader:`
		...
		`,blending:fi,depthTest:!1,depthWrite:!1})}function mu(){return new yi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Kl(),fragmentShader:`
	...
	`}function Dx(n){let e=new WeakMap,t=null;function i(a){if(a&&a.isTexture){const c=a.mapping,l=c===bc||c===Ec,u=c===Lr||c===Dr;if(l||u){let d=e.get(a);const h=d!==void 0?d.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==h)return t===null&&(t=new tl(n)),d=l?t.fromEquirectangular(a,d):t.fromCubemap(a,d),d.texture.pmremVersion=a.pmremVersion,e.set(a,d),d.texture;if(d!==void 0)return d.texture;{const p=a.image;return l&&p&&p.height>0||u&&p&&r(p)?(t===null&&(t=new tl(n)),d=l?t.fromEquirectangular(a):t.fromCubemap(a),d.texture.pmremVersion=a.pmremVersion,e.set(a,d),a.addEventListener("dispose",s),d.texture):null}}}return a}function r(a){let c=0;const l=6;for(let u=0;u<l;u++)a[u]!==void 0&&c++;return c===l}function s(a){const c=a.target;c.removeEventListener("dispose",s);const l=e.get(c);l!==void 0&&(e.delete(c),l.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:i,dispose:o}}function Ix(n){const e={};function t(i){if(e[i]!==void 0)return e[i];let r;switch(i){case"WEBGL_depth_texture":r=n.getExtension("WEBGL_depth_texture")||n.getExtension("MOZ_WEBGL_depth_texture")||n.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=n.getExtension("EXT_texture_filter_anisotropic")||n.getExtension("MOZ_EXT_texture_filter_anisotropic")||n.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=n.getExtension("WEBGL_compressed_texture_s3tc")||n.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=n.getExtension("WEBGL_compressed_texture_pvrtc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=n.getExtension(i)}return e[i]=r,r}return{has:function(i){return t(i)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(i){const r=t(i);return r===null&&as("THREE.WebGLRenderer: "+i+" extension not supported."),r}}}function Ux(n,e,t,i){const r={},s=new WeakMap;function o(d){const h=d.target;h.index!==null&&e.remove(h.index);for(const g in h.attributes)e.remove(h.attributes[g]);for(const g in h.morphAttributes){const _=h.morphAttributes[g];for(let m=0,f=_.length;m<f;m++)e.remove(_[m])}h.removeEventListener("dispose",o),delete r[h.id];const p=s.get(h);p&&(e.remove(p),s.delete(h)),i.releaseStatesOfGeometry(h),h.isInstancedBufferGeometry===!0&&delete h._maxInstanceCount,t.memory.geometries--}function a(d,h){return r[h.id]===!0||(h.addEventListener("dispose",o),r[h.id]=!0,t.memory.geometries++),h}function c(d){const h=d.attributes;for(const g in h)e.update(h[g],n.ARRAY_BUFFER);const p=d.morphAttributes;for(const g in p){const _=p[g];for(let m=0,f=_.length;m<f;m++)e.update(_[m],n.ARRAY_BUFFER)}}function l(d){const h=[],p=d.index,g=d.attributes.position;let _=0;if(p!==null){const S=p.array;_=p.version;for(let T=0,x=S.length;T<x;T+=3){const P=S[T+0],b=S[T+1],w=S[T+2];h.push(P,b,b,w,w,P)}}else if(g!==void 0){const S=g.array;_=g.version;for(let T=0,x=S.length/3-1;T<x;T+=3){const P=T+0,b=T+1,w=T+2;h.push(P,b,b,w,w,P)}}else return;const m=new(Sf(h)?wf:Tf)(h,1);m.version=_;const f=s.get(d);f&&e.remove(f),s.set(d,m)}function u(d){const h=s.get(d);if(h){const p=d.index;p!==null&&h.version<p.version&&l(d)}else l(d);return s.get(d)}return{get:a,update:c,getWireframeAttribute:u}}function Nx(n,e,t){let i;function r(h){i=h}let s,o;function a(h){s=h.type,o=h.bytesPerElement}function c(h,p){n.drawElements(i,p,s,h*o),t.update(p,i,1)}function l(h,p,g){g!==0&&(n.drawElementsInstanced(i,p,s,h*o,g),t.update(p,i,g))}function u(h,p,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,p,0,s,h,0,g);let m=0;for(let f=0;f<g;f++)m+=p[f];t.update(m,i,1)}function d(h,p,g,_){if(g===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let f=0;f<h.length;f++)l(h[f]/o,p[f],_[f]);else{m.multiDrawElementsInstancedWEBGL(i,p,0,s,h,0,_,0,g);let f=0;for(let S=0;S<g;S++)f+=p[S]*_[S];t.update(f,i,1)}}this.setMode=r,this.setIndex=a,this.render=c,this.renderInstances=l,this.renderMultiDraw=u,this.renderMultiDrawInstances=d}function kx(n){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function i(s,o,a){switch(t.calls++,o){case n.TRIANGLES:t.triangles+=a*(s/3);break;case n.LINES:t.lines+=a*(s/2);break;case n.LINE_STRIP:t.lines+=a*(s-1);break;case n.LINE_LOOP:t.lines+=a*s;break;case n.POINTS:t.points+=a*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:i}}function Ox(n,e,t){const i=new WeakMap,r=new lt;function s(o,a,c){const l=o.morphTargetInfluences,u=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,d=u!==void 0?u.length:0;let h=i.get(a);if(h===void 0||h.count!==d){let v=function(){C.dispose(),i.delete(a),a.removeEventListener("dispose",v)};var p=v;h!==void 0&&h.texture.dispose();const g=a.morphAttributes.position!==void 0,_=a.morphAttributes.normal!==void 0,m=a.morphAttributes.color!==void 0,f=a.morphAttributes.position||[],S=a.morphAttributes.normal||[],T=a.morphAttributes.color||[];let x=0;g===!0&&(x=1),_===!0&&(x=2),m===!0&&(x=3);let P=a.attributes.position.count*x,b=1;P>e.maxTextureSize&&(b=Math.ceil(P/e.maxTextureSize),P=e.maxTextureSize);const w=new Float32Array(P*b*4*d),C=new bf(w,P,b,d);C.type=Gn,C.needsUpdate=!0;const y=x*4;for(let R=0;R<d;R++){const B=f[R],F=S[R],k=T[R],H=P*b*4*R;for(let O=0;O<B.count;O++){const $=O*y;g===!0&&(r.fromBufferAttribute(B,O),w[H+$+0]=r.x,w[H+$+1]=r.y,w[H+$+2]=r.z,w[H+$+3]=0),_===!0&&(r.fromBufferAttribute(F,O),w[H+$+4]=r.x,w[H+$+5]=r.y,w[H+$+6]=r.z,w[H+$+7]=0),m===!0&&(r.fromBufferAttribute(k,O),w[H+$+8]=r.x,w[H+$+9]=r.y,w[H+$+10]=r.z,w[H+$+11]=k.itemSize===4?r.w:1)}}h={count:d,texture:C,size:new Ue(P,b)},i.set(a,h),a.addEventListener("dispose",v)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)c.getUniforms().setValue(n,"morphTexture",o.morphTexture,t);else{let g=0;for(let m=0;m<l.length;m++)g+=l[m];const _=a.morphTargetsRelative?1:1-g;c.getUniforms().setValue(n,"morphTargetBaseInfluence",_),c.getUniforms().setValue(n,"morphTargetInfluences",l)}c.getUniforms().setValue(n,"morphTargetsTexture",h.texture,t),c.getUniforms().setValue(n,"morphTargetsTextureSize",h.size)}return{update:s}}function Fx(n,e,t,i){let r=new WeakMap;function s(c){const l=i.render.frame,u=c.geometry,d=e.get(c,u);if(r.get(d)!==l&&(e.update(d),r.set(d,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",a)===!1&&c.addEventListener("dispose",a),r.get(c)!==l&&(t.update(c.instanceMatrix,n.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,n.ARRAY_BUFFER),r.set(c,l))),c.isSkinnedMesh){const h=c.skeleton;r.get(h)!==l&&(h.update(),r.set(h,l))}return d}function o(){r=new WeakMap}function a(c){const l=c.target;l.removeEventListener("dispose",a),t.remove(l.instanceMatrix),l.instanceColor!==null&&t.remove(l.instanceColor)}return{update:s,dispose:o}}class Df extends Yt{constructor(e,t,i,r,s,o,a,c,l,u=Tr){if(u!==Tr&&u!==Ur)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");i===void 0&&u===Tr&&(i=zi),i===void 0&&u===Ur&&(i=Ir),super(null,r,s,o,a,c,u,i,l),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=a!==void 0?a:En,this.minFilter=c!==void 0?c:En,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const If=new Yt,gu=new Df(1,1),Uf=new bf,Nf=new E0,kf=new Rf,_u=[],xu=[],yu=new Float32Array(16),vu=new Float32Array(9),Su=new Float32Array(4);function Gr(n,e,t){const i=n[0];if(i<=0||i>0)return n;const r=e*t;let s=_u[r];if(s===void 0&&(s=new Float32Array(r),_u[r]=s),e!==0){i.toArray(s,0);for(let o=1,a=0;o!==e;++o)a+=t,n[o].toArray(s,a)}return s}function Lt(n,e){if(n.length!==e.length)return!1;for(let t=0,i=n.length;t<i;t++)if(n[t]!==e[t])return!1;return!0}function Dt(n,e){for(let t=0,i=e.length;t<i;t++)n[t]=e[t]}function Qo(n,e){let t=xu[e];t===void 0&&(t=new Int32Array(e),xu[e]=t);for(let i=0;i!==e;++i)t[i]=n.allocateTextureUnit();return t}function Bx(n,e){const t=this.cache;t[0]!==e&&(n.uniform1f(this.addr,e),t[0]=e)}function zx(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Lt(t,e))return;n.uniform2fv(this.addr,e),Dt(t,e)}}function Hx(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(n.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(Lt(t,e))return;n.uniform3fv(this.addr,e),Dt(t,e)}}function Gx(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Lt(t,e))return;n.uniform4fv(this.addr,e),Dt(t,e)}}function Vx(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(Lt(t,e))return;n.uniformMatrix2fv(this.addr,!1,e),Dt(t,e)}else{if(Lt(t,i))return;Su.set(i),n.uniformMatrix2fv(this.addr,!1,Su),Dt(t,i)}}function Wx(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(Lt(t,e))return;n.uniformMatrix3fv(this.addr,!1,e),Dt(t,e)}else{if(Lt(t,i))return;vu.set(i),n.uniformMatrix3fv(this.addr,!1,vu),Dt(t,i)}}function Xx(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(Lt(t,e))return;n.uniformMatrix4fv(this.addr,!1,e),Dt(t,e)}else{if(Lt(t,i))return;yu.set(i),n.uniformMatrix4fv(this.addr,!1,yu),Dt(t,i)}}function $x(n,e){const t=this.cache;t[0]!==e&&(n.uniform1i(this.addr,e),t[0]=e)}function Yx(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Lt(t,e))return;n.uniform2iv(this.addr,e),Dt(t,e)}}function qx(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Lt(t,e))return;n.uniform3iv(this.addr,e),Dt(t,e)}}function jx(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Lt(t,e))return;n.uniform4iv(this.addr,e),Dt(t,e)}}function Zx(n,e){const t=this.cache;t[0]!==e&&(n.uniform1ui(this.addr,e),t[0]=e)}function Kx(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Lt(t,e))return;n.uniform2uiv(this.addr,e),Dt(t,e)}}function Jx(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Lt(t,e))return;n.uniform3uiv(this.addr,e),Dt(t,e)}}function Qx(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Lt(t,e))return;n.uniform4uiv(this.addr,e),Dt(t,e)}}function ey(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r);let s;this.type===n.SAMPLER_2D_SHADOW?(gu.compareFunction=vf,s=gu):s=If,t.setTexture2D(e||s,r)}function ty(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture3D(e||Nf,r)}function ny(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTextureCube(e||kf,r)}function iy(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture2DArray(e||Uf,r)}function ry(n){switch(n){case 5126:return Bx;case 35664:return zx;case 35665:return Hx;case 35666:return Gx;case 35674:return Vx;case 35675:return Wx;case 35676:return Xx;case 5124:case 35670:return $x;case 35667:case 35671:return Yx;case 35668:case 35672:return qx;case 35669:case 35673:return jx;case 5125:return Zx;case 36294:return Kx;case 36295:return Jx;case 36296:return Qx;case 35678:case 36198:case 36298:case 36306:case 35682:return ey;case 35679:case 36299:case 36307:return ty;case 35680:case 36300:case 36308:case 36293:return ny;case 36289:case 36303:case 36311:case 36292:return iy}}function sy(n,e){n.uniform1fv(this.addr,e)}function oy(n,e){const t=Gr(e,this.size,2);n.uniform2fv(this.addr,t)}function ay(n,e){const t=Gr(e,this.size,3);n.uniform3fv(this.addr,t)}function cy(n,e){const t=Gr(e,this.size,4);n.uniform4fv(this.addr,t)}function ly(n,e){const t=Gr(e,this.size,4);n.uniformMatrix2fv(this.addr,!1,t)}function dy(n,e){const t=Gr(e,this.size,9);n.uniformMatrix3fv(this.addr,!1,t)}function uy(n,e){const t=Gr(e,this.size,16);n.uniformMatrix4fv(this.addr,!1,t)}function hy(n,e){n.uniform1iv(this.addr,e)}function fy(n,e){n.uniform2iv(this.addr,e)}function py(n,e){n.uniform3iv(this.addr,e)}function my(n,e){n.uniform4iv(this.addr,e)}function gy(n,e){n.uniform1uiv(this.addr,e)}function _y(n,e){n.uniform2uiv(this.addr,e)}function xy(n,e){n.uniform3uiv(this.addr,e)}function yy(n,e){n.uniform4uiv(this.addr,e)}function vy(n,e,t){const i=this.cache,r=e.length,s=Qo(t,r);Lt(i,s)||(n.uniform1iv(this.addr,s),Dt(i,s));for(let o=0;o!==r;++o)t.setTexture2D(e[o]||If,s[o])}function Sy(n,e,t){const i=this.cache,r=e.length,s=Qo(t,r);Lt(i,s)||(n.uniform1iv(this.addr,s),Dt(i,s));for(let o=0;o!==r;++o)t.setTexture3D(e[o]||Nf,s[o])}function My(n,e,t){const i=this.cache,r=e.length,s=Qo(t,r);Lt(i,s)||(n.uniform1iv(this.addr,s),Dt(i,s));for(let o=0;o!==r;++o)t.setTextureCube(e[o]||kf,s[o])}function by(n,e,t){const i=this.cache,r=e.length,s=Qo(t,r);Lt(i,s)||(n.uniform1iv(this.addr,s),Dt(i,s));for(let o=0;o!==r;++o)t.setTexture2DArray(e[o]||Uf,s[o])}function Ey(n){switch(n){case 5126:return sy;case 35664:return oy;case 35665:return ay;case 35666:return cy;case 35674:return ly;case 35675:return dy;case 35676:return uy;case 5124:case 35670:return hy;case 35667:case 35671:return fy;case 35668:case 35672:return py;case 35669:case 35673:return my;case 5125:return gy;case 36294:return _y;case 36295:return xy;case 36296:return yy;case 35678:case 36198:case 36298:case 36306:case 35682:return vy;case 35679:case 36299:case 36307:return Sy;case 35680:case 36300:case 36308:case 36293:return My;case 36289:case 36303:case 36311:case 36292:return by}}class Ty{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.setValue=ry(t.type)}}class wy{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Ey(t.type)}}class Cy{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,i){const r=this.seq;for(let s=0,o=r.length;s!==o;++s){const a=r[s];a.setValue(e,t[a.id],i)}}}const Na=/(\w+)(\])?(\[|\.)?/g;function Mu(n,e){n.seq.push(e),n.map[e.id]=e}function Ay(n,e,t){const i=n.name,r=i.length;for(Na.lastIndex=0;;){const s=Na.exec(i),o=Na.lastIndex;let a=s[1];const c=s[2]==="]",l=s[3];if(c&&(a=a|0),l===void 0||l==="["&&o+2===r){Mu(t,l===void 0?new Ty(a,n,e):new wy(a,n,e));break}else{let d=t.map[a];d===void 0&&(d=new Cy(a),Mu(t,d)),t=d}}}class So{constructor(e,t){this.seq=[],this.map={};const i=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<i;++r){const s=e.getActiveUniform(t,r),o=e.getUniformLocation(t,s.name);Ay(s,o,this)}}setValue(e,t,i,r){const s=this.map[t];s!==void 0&&s.setValue(e,i,r)}setOptional(e,t,i){const r=t[i];r!==void 0&&this.setValue(e,i,r)}static upload(e,t,i,r){for(let s=0,o=t.length;s!==o;++s){const a=t[s],c=i[a.id];c.needsUpdate!==!1&&a.setValue(e,c.value,r)}}static seqWithValue(e,t){const i=[];for(let r=0,s=e.length;r!==s;++r){const o=e[r];o.id in t&&i.push(o)}return i}}function bu(n,e,t){const i=n.createShader(e);return n.shaderSource(i,t),n.compileShader(i),i}const Ry=37297;let Py=0;function Ly(n,e){const t=n.split(`
`),i=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let o=r;o<s;o++){const a=o+1;i.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return i.join(`
`)}const Eu=new Fe;function Dy(n){Ke._getMatrix(Eu,Ke.workingColorSpace,n);const e=`mat3( ${Eu.elements.map(t=>t.toFixed(4))} )`;switch(Ke.getTransfer(n)){case Zo:return[e,"LinearTransferOETF"];case at:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",n),[e,"LinearTransferOETF"]}}function Tu(n,e,t){const i=n.getShaderParameter(e,n.COMPILE_STATUS),r=n.getShaderInfoLog(e).trim();if(i&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const o=parseInt(s[1]);return t.toUpperCase()+`

`+r+`

`+Ly(n.getShaderSource(e),o)}else return r}function Iy(n,e){const t=Dy(e);return[`vec4 ${n}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}function Uy(n,e){let t;switch(e){case cf:t="Linear";break;case Jm:t="Reinhard";break;case Qm:t="Cineon";break;case e0:t="ACESFilmic";break;case n0:t="AgX";break;case i0:t="Neutral";break;case t0:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const $s=new L;function Ny(){Ke.getLuminanceCoefficients($s);const n=$s.x.toFixed(4),e=$s.y.toFixed(4),t=$s.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function ky(n){return[n.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",n.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(cs).join(`
`)}function Oy(n){const e=[];for(const t in n){const i=n[t];i!==!1&&e.push("#define "+t+" "+i)}return e.join(`
`)}function Fy(n,e){const t={},i=n.getProgramParameter(e,n.ACTIVE_ATTRIBUTES);for(let r=0;r<i;r++){const s=n.getActiveAttrib(e,r),o=s.name;let a=1;s.type===n.FLOAT_MAT2&&(a=2),s.type===n.FLOAT_MAT3&&(a=3),s.type===n.FLOAT_MAT4&&(a=4),t[o]={type:s.type,location:n.getAttribLocation(e,o),locationSize:a}}return t}function cs(n){return n!==""}function wu(n,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return n.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Cu(n,e){return n.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const By=/^[ \t]*#include +<([\w\d./]+)>/gm;function nl(n){return n.replace(By,Hy)}const zy=new Map;function Hy(n,e){let t=He[e];if(t===void 0){const i=zy.get(e);if(i!==void 0)t=He[i],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,i);else throw new Error("Can not resolve #include <"+e+">")}return nl(t)}const Gy=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Au(n){return n.replace(Gy,Vy)}function Vy(n,e,t,i){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=i.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function Ru(n){let e=`precision ${n.precision} float;
...
#define LOW_PRECISION`),e}function Wy(n){let e="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===of?e="SHADOWMAP_TYPE_PCF":n.shadowMapType===af?e="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===Bn&&(e="SHADOWMAP_TYPE_VSM"),e}function Xy(n){let e="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case Lr:case Dr:e="ENVMAP_TYPE_CUBE";break;case jo:e="ENVMAP_TYPE_CUBE_UV";break}return e}function $y(n){let e="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case Dr:e="ENVMAP_MODE_REFRACTION";break}return e}function Yy(n){let e="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case zl:e="ENVMAP_BLENDING_MULTIPLY";break;case Zm:e="ENVMAP_BLENDING_MIX";break;case Km:e="ENVMAP_BLENDING_ADD";break}return e}function qy(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:i,maxMip:t}}function jy(n,e,t,i){const r=n.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const c=Wy(t),l=Xy(t),u=$y(t),d=Yy(t),h=qy(t),p=ky(t),g=Oy(s),_=r.createProgram();let m,f,S=t.glslVersion?"#version "+t.glslVersion+`
...
void main() {
    ...
    <p class="dmg-width">${r.toFixed(2)}m wide · ${Vv(r,e)}</p>
    ${ts("Engine",t.engine)}
    ${ts("Body",t.body)}
    ${ts("Hood",t.hood)}
    ${ts("Glass",t.windshield)}
    ${ts("Wheels",i)}
  `}function na(n,e){n&&(e?n.removeAttribute("hidden"):n.setAttribute("hidden",""))}function Xv(){return matchMedia("(pointer: coarse)").matches||"ontouchstart"in window}const $v=()=>({mx:0,mz:0}),Yv=()=>({throttle:0,brake:0,reverse:0,steer:0});function qv(){if(!Xv())return{readMove:$v,readDrive:Yv,setDriving:()=>{},setVisible:()=>{},onExit:()=>{}};const n=document.createElement("div");n.id="touch-pad",n.innerHTML=`
...
`);n.RTCSessionDescription&&r instanceof n.RTCSessionDescription?arguments[0]=new n.RTCSessionDescription({type:r.type,sdp:s}):r.sdp=s}return t.apply(this,arguments)}}function Co(n,e){if(!(n.RTCPeerConnection&&n.RTCPeerConnection.prototype))return;const t=n.RTCPeerConnection.prototype.addIceCandidate;!t||t.length===0||(n.RTCPeerConnection.prototype.addIceCandidate=function(){return arguments[0]?(e.browser==="chrome"&&e.version<78||e.browser==="firefox"&&e.version<68||e.browser==="safari")&&arguments[0]&&arguments[0].candidate===""?Promise.resolve():t.apply(this,arguments):(arguments[1]&&arguments[1].apply(null),Promise.resolve())})}function Ao(n,e){if(!(n.RTCPeerConnection&&n.RTCPeerConnection.prototype))return;const t=n.RTCPeerConnection.prototype.setLocalDescription;!t||t.length===0||(n.RTCPeerConnection.prototype.setLocalDescription=function(){let r=arguments[0]||{};if(typeof r!="object"||r.type&&r.sdp)return t.apply(this,arguments);if(r={type:r.type,sdp:r.sdp},!r.type)switch(this.signalingState){case"stable":case"have-local-offer":case"have-remote-pranswer":r.type="offer";break;default:r.type="answer";break}return r.sdp||r.type!=="offer"&&r.type!=="answer"?t.apply(this,[r]):(r.type==="offer"?this.createOffer:this.createAnswer).apply(this).then(o=>t.apply(this,[o]))})}const kM=Object.freeze(Object.defineProperty({__proto__:null,removeExtmapAllowMixed:bl,shimAddIceCandidateNullOrEmpty:Co,shimConnectionState:Ml,shimMaxMessageSize:To,shimParameterlessSetLocalDescription:Ao,shimRTCIceCandidate:Eo,shimRTCIceCandidateRelayProtocol:Sl,shimSendThrowTypeError:wo},Symbol.toStringTag,{value:"Module"}));function OM({window:n}={},e={shimChrome:!0,shimFirefox:!0,shimSafari:!0}){const t=_d,i=LM(n),r={browserDetails:i,commonShim:kM,extractVersion:ls,disableLog:RM,disableWarnings:PM,sdp:NM};switch(i.browser){case"chrome":if(!dh||!yl||!e.shimChrome)return t("Chrome shim is not included in this adapter release."),r;if(i.version===null)return t("Chrome shim can not determine version, not shimming."),r;t("adapter.js shimming chrome."),r.browserShim=dh,Co(n,i),Ao(n),op(n,i),ap(n),yl(n,i),cp(n,i),hp(n,i),lp(n),dp(n,i),fp(n,i),Eo(n),Sl(n),Ml(n),To(n,i),wo(n,i),bl(n,i);break;case"firefox":if(!uh||!vl||!e.shimFirefox)return t("Firefox shim is not included in this adapter release."),r;t("adapter.js shimming firefox."),r.browserShim=uh,Co(n,i),Ao(n),pp(n,i),vl(n,i),gp(n,i),mp(n),yp(n),_p(n),xp(n),vp(n),Sp(n,i),Mp(n,i),bp(n,i),Ep(n,i),Eo(n),Ml(n),To(n,i),wo(n,i);break;case"safari":if(!hh||!e.shimSafari)return t("Safari shim is not included in this adapter release."),r;t("adapter.js shimming safari."),r.browserShim=hh,Co(n,i),Ao(n),Pp(n),Dp(n),Cp(n),Tp(n),wp(n),Lp(n),Ap(n),Ip(n),Eo(n),Sl(n),To(n,i),wo(n,i),bl(n,i);break;default:t("Unsupported browser!");break}return r}const ph=OM({window:typeof window>"u"?void 0:window});function Yi(n,e,t,i){Object.defineProperty(n,e,{get:t,set:i,enumerable:!0,configurable:!0})}class Np{constructor(){this.chunkedMTU=16300,this._dataCount=1,this.chunk=e=>{const t=[],i=e.byteLength,r=Math.ceil(i/this.chunkedMTU);let s=0,o=0;for(;o<i;){const a=Math.min(i,o+this.chunkedMTU),c=e.slice(o,a),l={__peerData:this._dataCount,n:s,data:c,total:r};t.push(l),o=a,s++}return this._dataCount++,t}}}function FM(n){let e=0;for(const r of n)e+=r.byteLength;const t=new Uint8Array(e);let i=0;for(const r of n)t.set(r,i),i+=r.byteLength;return t}const ja=ph.default||ph,ns=new class{isWebRTCSupported(){return typeof RTCPeerConnection<"u"}isBrowserSupported(){const n=this.getBrowser(),e=this.getVersion();return this.supportedBrowsers.includes(n)?n==="chrome"?e>=this.minChromeVersion:n==="firefox"?e>=this.minFirefoxVersion:n==="safari"?!this.isIOS&&e>=this.minSafariVersion:!1:!1}getBrowser(){return ja.browserDetails.browser}getVersion(){return ja.browserDetails.version||0}isUnifiedPlanSupported(){const n=this.getBrowser(),e=ja.browserDetails.version||0;if(n==="chrome"&&e<this.minChromeVersion)return!1;if(n==="firefox"&&e>=this.minFirefoxVersion)return!0;if(!window.RTCRtpTransceiver||!("currentDirection"in RTCRtpTransceiver.prototype))return!1;let t,i=!1;try{t=new RTCPeerConnection,t.addTransceiver("audio"),i=!0}catch{}finally{t&&t.close()}return i}toString(){return`Supports:
  ...
  `,e}function mb(n){return new Promise(e=>{const t=n.querySelector("#update-splash-dismiss"),i=()=>{n.classList.add("update-splash-out"),setTimeout(()=>{n.remove(),ds=null,e()},420)};t.addEventListener("click",i,{once:!0});const r=s=>{(s.key==="Enter"||s.key===" ")&&(s.preventDefault(),window.removeEventListener("keydown",r),i())};window.addEventListener("keydown",r)})}async function gb(){if(location.hostname==="localhost"||location.hostname==="127.0.0.1")return;let n;try{n=await fb()}catch{return}const e=n==null?void 0:n.v;if(!e)return;const t=localStorage.getItem(wl)==="1",i=localStorage.getItem(Lh(e))==="1";if(!t&&i){localStorage.setItem(Ph,e),Dh();return}localStorage.removeItem(wl),localStorage.setItem(Ph,e),localStorage.setItem(Lh(e),"1"),Dh(),ds=pb(e),document.body.appendChild(ds),requestAnimationFrame(()=>ds.classList.add("update-splash-in")),await mb(ds)}function _b(){localStorage.setItem(wl,"1")}const xb=10,yb=.5,Ih=2.4,vb=2.2,Sb=92,Mb=1.6,bb=[[24,18],[-30,22],[45,-35],[-50,40],[12,-55],[-65,-20],[70,55],[-15,75],[88,-12],[-40,-70]];function Eb(){const n=document.createElement("canvas");n.width=256,n.height=72;const e=n.getContext("2d");e.fillStyle="rgba(15,23,42,0.55)",e.beginPath(),e.roundRect(8,8,240,56,10),e.fill(),e.fillStyle="#ffffff",e.font="bold 34px system-ui,sans-serif",e.textAlign="center",e.textBaseline="middle",e.fillText("Dashing",128,38);const t=new Dv(n);t.colorSpace=Qt;const i=new Ff({map:t,transparent:!0,depthTest:!1}),r=new Pv(i);return r.scale.set(3.6,1,1),r.renderOrder=10,r}function Uh(){const n=new We,e=new re(new qt(1.15,1.15,.18,28),new dn({color:2450411,emissive:1920728,emissiveIntensity:.45,flatShading:!0}));e.position.y=.1,n.add(e);const t=new re(new ea(1.28,.08,8,28),new dn({color:6333946,flatShading:!0}));t.rotation.x=Math.PI/2,t.position.y=.18,n.add(t);const i=Eb();return i.position.y=vb,n.add(i),n}function Tb(n){let e=n>>>0;return()=>(e=e*1664525+1013904223>>>0,e/4294967296)}function wb(n,{getPlayerId:e,isHost:t,send:i,relay:r}){const s=new We;s.name="dash-pickups",n.add(s);let o=[],a={},c=!1,l=0,u=!1;function d(){return(e==null?void 0:e())??"local"}function h(){i==null||i({t:"dashState",pickups:o.map(k=>({id:k.id,x:k.x,z:k.z,active:k.active})),scores:a})}function p(k=Date.now()){for(o=[],a={},c=!1,u=!1;s.children.length;)s.remove(s.children[0]);const H=Tb(k);u=!0;for(let O=0;O<xb;O++){if(H()>=yb)continue;const[$,W]=bb[O],ne=Uh();ne.position.set($,0,W),s.add(ne),o.push({id:O,x:$,z:W,active:!0,mesh:ne,bob:H()*Math.PI*2,pending:!1})}t!=null&&t()&&h()}function g(){return o.length>0}function _(k){if(k!=null&&k.pickups){for(u=k.pickups.length>0,a={...k.scores??{}};s.children.length;)s.remove(s.children[0]);o=k.pickups.map(H=>{const O=H.active?Uh():null;return O&&(O.position.set(H.x,0,H.z),s.add(O)),{id:H.id,x:H.x,z:H.z,active:H.active,mesh:O,bob:0,pending:!1}})}}function m(k){if(!k.active)return;k.active=!1,k.mesh&&(s.remove(k.mesh),k.mesh=null);const H=d();a[H]=(a[H]??0)+1,B==null||B("Dashing +1!"),t!=null&&t()?h():i==null||i({t:"dashCollect",pickupId:k.id,playerId:H})}function f(k){if(!(t!=null&&t()))return;const H=o.find(O=>O.id===k.pickupId&&O.active);H&&(H.active=!1,H.mesh&&(s.remove(H.mesh),H.mesh=null),a[k.playerId]=(a[k.playerId]??0)+1,h())}function S(k){t!=null&&t()&&(k.playerId&&(a[k.playerId]=0),h())}function T(k=null){const H=k??d();a[H]=0,H===d()&&(c=!1),t!=null&&t()?h():i==null||i({t:"dashScoreReset",playerId:H})}function x(k){k.t==="dashState"&&_(k),k.t==="dashCollect"&&f(k),k.t==="dashScoreReset"&&S(k)}function P(){return{...a}}function b(){const k=Object.entries(a);if(!k.length)return[];const H=Math.max(...k.map(([,O])=>O));return H<=0?[]:k.filter(([,O])=>O===H).map(([O])=>O)}function w(){return b().includes(d())}function C(){return w()?(c=!c,c):!1}function y(k){c=!!k}function v(){return c}function R(k,H){l+=k;for(const O of o)!O.active||!O.mesh||(O.mesh.position.y=Math.sin(l*2.8+O.bob)*.12,O.mesh.children[0].rotation.y+=k*1.6);if(!(!H||!u))for(const O of o){if(!O.active)continue;const $=H.x-O.x,W=H.z-O.z;if($*$+W*W<=Ih*Ih){if(O.pending)break;(t==null?void 0:t())??!0?m(O):(O.pending=!0,i==null||i({t:"dashCollect",pickupId:O.id,playerId:d()}));break}}}let B=null;function F(k){B=k}return{group:s,reset:p,update:R,getScores:P,getLeaderIds:b,isLocalLeader:w,isSuperDashOn:v,toggleSuperDash:C,setSuperDash:y,handleMessage:x,setToast:F,syncState:h,resetPlayerScore:T,isSessionActive:g,SUPER_MAX_SPEED:Sb,SUPER_ACCEL_MULT:Mb}}const Cb={wood:{label:"Wood",color:9136404,costMult:1},metal:{label:"Metal",color:9741240,costMult:3},obsidian:{label:"Obsidian",color:1973067,costMult:8},diamond:{label:"Diamond",color:6809849,costMult:16,adminOnly:!0},plasma:{label:"Plasma",color:11032055,costMult:24,adminOnly:!0},inferno:{label:"Inferno",color:16347926,costMult:40,adminOnly:!0}},qp={mini_gun:{label:"Mini Gun",baseCost:50,shredBonus:1},saw_blade:{label:"Saw Blade",baseCost:65,shredBonus:1.15},chainsaw:{label:"Chainsaw",baseCost:80,shredBonus:1.3}},Ab=["wood","metal","obsidian"],Rb=["diamond","plasma","inferno"];function Pb(n,e){const t=qp[n],i=Cb[e];return{id:`${n}_${e}`,type:n,material:e,name:`${i.label} ${t.label}`,cost:Math.round(t.baseCost*i.costMult),color:i.color,shredBonus:t.shredBonus*(i.costMult>=16?1.5:i.costMult>=8?1.25:1),adminOnly:!!i.adminOnly,tier:i.adminOnly?"premium":"basic"}}const jp=[];for(const n of Object.keys(qp))for(const e of[...Ab,...Rb])jp.push(Pb(n,e));const Md=jp;function zn(n){return Md.find(e=>e.id===n)??null}function Lb(){return Md.filter(n=>n.tier==="basic")}function Nh(){return Md}const Do=[{id:"neon_lime",name:"Neon Lime",color:8702998,accent:1332013,cost:350},{id:"hot_pink",name:"Hot Pink",color:15485081,accent:8591427,cost:350},{id:"gold_rush",name:"Gold Rush",color:16436245,accent:8736014,cost:500},{id:"ice_blue",name:"Ice Blue",color:3718648,accent:805486,cost:400},{id:"lava_orange",name:"Lava Orange",color:15357964,accent:4396039,cost:450},{id:"galaxy_purple",name:"Galaxy Purple",color:8141549,accent:3018853,cost:550},{id:"stealth_black",name:"Stealth Black",color:1976635,accent:132631,cost:600},{id:"candy_red",name:"Candy Red",color:15680580,accent:8330525,cost:400},{id:"mint_cream",name:"Mint Cream",color:10090212,accent:1265226,cost:350},{id:"sunset_gradient",name:"Sunset Burst",color:16347926,accent:14362487,cost:750}];function kh(n){return Do.find(e=>e.id===n)??null}const Oh="ccwd-loadout-";function co(){return{coins:0,ownedWeapons:[],ownedSkins:[],equippedWeapon:null,equippedSkin:null}}function Db(n){let e=co(),t=`${Oh}local`;function i(){try{localStorage.setItem(t,JSON.stringify(e))}catch{}}function r(){t=`${Oh}${(n==null?void 0:n())??"local"}`;try{const C=localStorage.getItem(t);C&&(e={...co(),...JSON.parse(C)})}catch{e=co()}e.ownedWeapons=e.ownedWeapons.filter(C=>zn(C)),e.ownedSkins=e.ownedSkins.filter(C=>kh(C)),e.equippedWeapon&&!h(e.equippedWeapon)&&(e.equippedWeapon=null),e.equippedSkin&&!p(e.equippedSkin)&&(e.equippedSkin=null)}function s(){r()}function o(){e=co(),i()}function a(){r(),o()}function c(){return e.coins}function l(C){return!C||C<=0?0:(e.coins+=C,i(),e.coins)}function u(C){return e.coins>=C}function d(C){return u(C)?(e.coins-=C,i(),!0):!1}function h(C){return e.ownedWeapons.includes(C)}function p(C){return e.ownedSkins.includes(C)}function g(C){const y=zn(C);if(!y)return{ok:!1,reason:"invalid"};if(h(C))return m(C),{ok:!0,weapon:y,alreadyOwned:!0};if(e.ownedWeapons=e.ownedWeapons.filter(v=>{const R=zn(v);return(R==null?void 0:R.type)!==y.type}),e.equippedWeapon){const v=zn(e.equippedWeapon);(v==null?void 0:v.type)===y.type&&(e.equippedWeapon=null)}return d(y.cost)?(e.ownedWeapons.push(C),e.equippedWeapon=C,i(),{ok:!0,weapon:y}):{ok:!1,reason:"insufficient"}}function _(C){const y=kh(C);return!y||p(C)?{ok:!1,reason:"already_owned"}:d(y.cost)?(e.ownedSkins.push(C),i(),{ok:!0,skin:y}):{ok:!1,reason:"insufficient"}}function m(C){return C&&!h(C)?!1:(e.equippedWeapon=C,i(),!0)}function f(C){return C&&!p(C)?!1:(e.equippedSkin=C,i(),!0)}function S(){return!e.equippedWeapon||!h(e.equippedWeapon)?null:zn(e.equippedWeapon)}function T(){return e.equippedSkin}function x(){return[...e.ownedWeapons]}function P(){return[...e.ownedSkins]}function b(C){return e.ownedWeapons.some(y=>{var v;return((v=zn(y))==null?void 0:v.type)===C})}function w(C){const y=e.ownedWeapons.find(v=>{var R;return((R=zn(v))==null?void 0:R.type)===C});return y?zn(y):null}return r(),{reloadForPlayer:s,resetSession:o,resetForPlayer:a,getCoins:c,addCoins:l,canAfford:u,spendCoins:d,ownsWeapon:h,ownsSkin:p,buyWeapon:g,buySkin:_,equipWeapon:m,equipSkin:f,getEquippedWeapon:S,getEquippedSkinId:T,getOwnedWeapons:x,getOwnedSkins:P,ownsWeaponType:b,getOwnedWeaponOfType:w}}const Fh=[{radius:Ut+24,coins:18},{radius:Ut+38,coins:24},{radius:Ut+52,coins:32}],Bh=28,Ib=1.28,Ub=.42;function Nb(n,e,t,i,r,s){const o=s.mesh.rotation.y,a=n-s.x,c=e-s.z,l=Math.cos(-o),u=Math.sin(-o),d=a*l-c*u,h=a*u+c*l,p=t-o,g=Math.abs(Math.cos(p)),_=Math.abs(Math.sin(p)),m=i*g+r*_,f=i*_+r*g;return Math.abs(d)<m+Ib&&Math.abs(h)<f+Ub}function kb(){const n=[];for(let e=0;e<Bh;e++){const t=e/Bh*Math.PI*2+.18,i=Fh[e%Fh.length];n.push({x:Math.cos(t)*i.radius,z:Math.sin(t)*i.radius,coins:i.coins})}return n}const Ob=kb();function Fb(){const n=new We;n.name="shred-target";const e=new re(new qt(.14,.18,2.6,8),it(7029795));e.position.y=1.3,e.castShadow=!0,n.add(e);const t=new We;t.position.y=2.55;const i=new re(new qe(2.4,2.4,.12),it(16317180));t.add(i);const r=[{r:1.05,color:14427686,z:.07},{r:.72,color:16777215,z:.08},{r:.38,color:14427686,z:.09},{r:.14,color:16777215,z:.1}];for(const s of r){const o=new re(new qt(s.r,s.r,.08,24),gi(s.color));o.rotation.x=Math.PI/2,o.position.z=s.z,t.add(o)}return n.add(t),n.userData.board=t,n}function Bb(n){const e=new We;e.name="shred-targets",n.add(e);let t=[],i=null;const r=[];function s(){r.length=0;for(const f of t)f.alive&&f.mesh.traverse(S=>{S.isMesh&&(S.userData.shredTarget=f,r.push(S))})}function o(){a();for(const f of Ob){const S=Fb();S.position.set(f.x,0,f.z),S.rotation.y=Math.atan2(-f.x,-f.z),e.add(S),t.push({mesh:S,x:f.x,z:f.z,health:50,maxHealth:50,coinValue:f.coins,alive:!0,hitCooldown:0,wobble:0})}s()}function a(){for(const f of t)f.mesh.parent&&e.remove(f.mesh);t=[],r.length=0}function c(){o()}function l(f){i=f}function u(f){return f.alive?(f.alive=!1,e.remove(f.mesh),s(),i==null||i(f),!0):!1}function d(f,S){return f!=null&&f.alive?(f.health-=S,f.wobble=1,f.health<=0?u(f):!1):!1}function h(f){const S=f.intersectObjects(r,!1);return S.length?S[0].object.userData.shredTarget??null:null}function p(f){for(const S of t)f(S)}function g(f,S,T=0,x=1.15,P=2.25){for(const b of t)if(b.alive&&Nb(f,S,T,x,P,b))return b;return null}function _(f,S){if(!(f!=null&&f.alive))return;const T=Math.abs(S),x=Math.min(1.6,.55+T*.028);f.wobble=Math.max(f.wobble,x),T>=6&&f.hitCooldown<=0&&(f.hitCooldown=.35,d(f,T*.45),f.wobble=Math.max(f.wobble,x))}function m(f){for(const S of t){if(!S.alive)continue;S.hitCooldown=Math.max(0,S.hitCooldown-f);const T=S.mesh.userData.board;if(S.wobble>0){S.wobble=Math.max(0,S.wobble-f*4.2);const x=S.wobble;S.mesh.rotation.z=Math.sin(x*24)*x*.1,S.mesh.position.y=Math.abs(Math.sin(x*30))*x*.08,T&&(T.rotation.z=Math.sin(x*20)*x*.55,T.position.x=Math.sin(x*27)*x*.07)}else S.mesh.rotation.z=0,S.mesh.position.y=0,T&&(T.rotation.z=0,T.position.x=0)}}return o(),{reset:c,update:m,setOnDestroyed:l,damageTarget:d,raycast:h,forEachTarget:p,checkCarCollision:g,applyCarImpact:_,count:()=>t.filter(f=>f.alive).length}}const zb=150;function Qa(n,e=1.1){const t=new We,i=new re(new qe(.38,.32,.55),gi(n));i.position.y=.12,t.add(i);const r=new re(new qe(.1,.12,e),it(6583435));r.position.set(0,.08,e*.45),t.add(r);const s=new re(new qe(.14,.08,e*.92),it(13358561));return s.position.set(0,.08,e*.45),s.name="chain",t.add(s),t}function Hb(n){const e=new We;e.name="weapon-mini_gun";const t=new re(new qe(.55,.22,.55),it(3359061));t.position.set(0,.12,0),e.add(t);const i=new re(new qe(.62,.42,.75),gi(n));i.position.set(0,.42,.35),e.add(i);const r=new We;r.name="barrels";for(const o of[-.12,0,.12]){const a=new re(new qt(.06,.06,.85,8),Ms());a.rotation.x=Math.PI/2,a.position.set(o,.42,.95),r.add(a)}e.add(r);const s=new re(new qe(.72,.28,.35),it(1976635));return s.position.set(0,.55,.55),e.add(s),e}function Gb(n){const e=new We;e.name="weapon-saw_blade";const t=new re(new qe(1.35,.18,.35),it(3359061));t.position.set(0,.12,.15),e.add(t);const i=new re(new qt(.18,.18,.2,10),it(4674921));i.rotation.x=Math.PI/2,i.position.set(0,.28,.55),e.add(i);const r=new re(new qt(.78,.78,.1,10),gi(n));r.rotation.x=Math.PI/2,r.position.set(0,.28,.55),r.name="blade",e.add(r);const s=new re(new qt(.88,.88,.05,8),it(14870768));return s.rotation.x=Math.PI/2,s.position.set(0,.28,.55),s.name="teeth",e.add(s),e}function Vb(n){const e=new We;e.name="weapon-chainsaw";const t=Qa(n,1.15);t.name="chainsaw-left",t.rotation.y=Math.PI/2,e.add(t);const i=Qa(n,1.15);i.name="chainsaw-right",i.rotation.y=-Math.PI/2,e.add(i);const r=Qa(n,1.05);return r.name="chainsaw-rear",r.rotation.y=Math.PI,e.add(r),e}function Wb(n){if(!(n!=null&&n.mesh))return;const e=n.mesh.getObjectByName("car-weapons");e&&n.mesh.remove(e),n.equippedWeapon=null}function oa(n,e){var o,a,c;if(Wb(n),!e||!(n!=null&&n.mesh))return null;const t=zn(e);if(!t)return null;const i=n.collisionHw??.94,r=n.collisionHd??2.25,s=new We;if(s.name="car-weapons",t.type==="mini_gun"){const l=Hb(t.color);l.position.set(0,.62,r*.72),s.add(l)}else if(t.type==="saw_blade"){const l=Gb(t.color);l.position.set(0,.18,r*.88),s.add(l)}else if(t.type==="chainsaw"){const l=Vb(t.color);(o=l.children.find(u=>u.name==="chainsaw-left"))==null||o.position.set(-i*.92,.35,-r*.05),(a=l.children.find(u=>u.name==="chainsaw-right"))==null||a.position.set(i*.92,.35,-r*.05),(c=l.children.find(u=>u.name==="chainsaw-rear"))==null||c.position.set(0,.35,-r*.82),s.add(l)}return n.mesh.add(s),n.equippedWeapon=t,t}function Xb(n){var e;return((e=n==null?void 0:n.equippedWeapon)==null?void 0:e.shredBonus)??1}function $b(n,e,t=!1){var o,a,c,l,u;const i=(o=n==null?void 0:n.mesh)==null?void 0:o.getObjectByName("car-weapons");if(!i||!n.equippedWeapon)return;const r=Math.abs(n.speed),s=n.equippedWeapon;if(s.type==="mini_gun"){const d=(a=i.getObjectByName("weapon-mini_gun"))==null?void 0:a.getObjectByName("barrels");d&&(d.rotation.z+=e*(t?28:4+r*.08))}else if(s.type==="saw_blade"){const d=i.getObjectByName("weapon-saw_blade"),h=e*(6+r*.35);(c=d==null?void 0:d.getObjectByName("blade"))==null||c.rotateZ(h),(l=d==null?void 0:d.getObjectByName("teeth"))==null||l.rotateZ(h*1.1)}else if(s.type==="chainsaw"){const d=i.getObjectByName("weapon-chainsaw"),h=e*(8+r*.25);for(const p of["chainsaw-left","chainsaw-right","chainsaw-rear"])(u=d==null?void 0:d.getObjectByName(p))==null||u.traverse(g=>{g.name==="chain"&&(g.rotation.y+=h)})}}function ec(n,e,t){const i=e-n.x,r=t-n.z,s=Math.cos(n.rotY),o=Math.sin(n.rotY),a=i*s-r*o,c=i*o+r*s,l=n.collisionHw??.94,u=n.collisionHd??2.25;return c>u*.25&&Math.abs(a)<l*.85?"front":c<-u*.35&&Math.abs(a)<l*.9?"rear":a<-l*.45&&Math.abs(c)<u*.75?"left":a>l*.45&&Math.abs(c)<u*.75?"right":"body"}const gr=new Fv,tc=new Ue,ri=[],Yb=.09,nc=8,ic=6,qb=.35;let us=!1,lo=0,uo=!1,Cl=!1,Al=0,Rl=0,zh=0,Hh=0,rc=!1;function jb(n){n&&(n.addEventListener("pointerdown",e=>{e.button===0&&(uo=!0,Cl=!1,zh=e.clientX,Hh=e.clientY,Al=e.clientX,Rl=e.clientY,us=!0)}),n.addEventListener("pointermove",e=>{uo&&(Al=e.clientX,Rl=e.clientY,Math.hypot(e.clientX-zh,e.clientY-Hh)>10&&(Cl=!0,us=!1))}),n.addEventListener("pointerup",e=>{e.button===0&&(us=!1,uo=!1)}),n.addEventListener("pointerleave",()=>{us=!1,uo=!1}))}function Zb(){return us&&!Cl}function Kb(n,e){const{vehicle:t,camera:i,renderer:r,scene:s,shredTargets:o,remotePlayers:a,onTargetHit:c,onPlayerShred:l}=e;if(lo=Math.max(0,lo-n),eE(s,n),!(t!=null&&t.equippedWeapon))return{firing:!1};const u=t.equippedWeapon;if(u.type==="mini_gun"&&Zb()&&lo<=0){if(typeof e.canFireMinigun=="function"&&!e.canFireMinigun())return{firing:!1};lo=Yb,rc=!0;const d=Jb({vehicle:t,camera:i,renderer:r,shredTargets:o,remotePlayers:a,scene:s,weapon:u,onPlayerShred:l});return d!=null&&d.coins&&(c==null||c(d.coins,d.kind)),{firing:!0}}return rc=!1,(u.type==="saw_blade"||u.type==="chainsaw")&&Qb(t,u,o,a,c,l),{firing:rc}}function Jb({vehicle:n,camera:e,renderer:t,shredTargets:i,remotePlayers:r,scene:s,weapon:o,onPlayerShred:a}){var p,g;const c=t.domElement.getBoundingClientRect();tc.x=(Al-c.left)/c.width*2-1,tc.y=-((Rl-c.top)/c.height)*2+1,gr.setFromCamera(tc,e);const l=(p=i==null?void 0:i.raycast)==null?void 0:p.call(i,gr),u=o.shredBonus??1;if(l){const _=14*u,m=l.coinValue,f=i.damageTarget(l,_);return Gh(s,n,l.mesh.position),f?{coins:Math.round(m*u),kind:"target"}:{coins:Math.round(4*u),kind:"chip"}}const d=new si(new L(0,1,0),0),h=new L;return gr.ray.intersectPlane(d,h)&&Gh(s,n,h),(g=r==null?void 0:r.forEach)==null||g.call(r,(_,m)=>{const f=new L(m.x,1,m.z);if(gr.ray.origin.distanceTo(f)>55)return;const T=f.clone().sub(gr.ray.origin).normalize();gr.ray.direction.dot(T)>.985&&r.tryGunHit(_,1.5,()=>a==null?void 0:a(_))}),null}function Qb(n,e,t,i,r,s){var c,l,u;const o=Math.abs(n.speed),a=e.shredBonus??1;(c=t==null?void 0:t.forEachTarget)==null||c.call(t,d=>{if(!d.alive||d.hitCooldown>0||Math.hypot(n.x-d.x,n.z-d.z)>3.5)return;const p=ec(n,d.x,d.z);let g=!1;if(e.type==="saw_blade"&&p==="front"&&o>=nc&&(g=!0),e.type==="chainsaw"&&(p==="left"||p==="right"||p==="rear")&&o>=ic&&(g=!0),!g)return;const _=o*.85*a;d.hitCooldown=qb;const m=d.coinValue;t.damageTarget(d,_)&&(r==null||r(Math.round(m*a),"shred"))}),e.type==="saw_blade"&&o>=nc&&((l=i==null?void 0:i.forEach)==null||l.call(i,(d,h)=>{ec(n,h.x,h.z)==="front"&&i.tryShred(d,n,{minSpeed:nc,cooldownSec:4,onShred:()=>s==null?void 0:s(d)})})),e.type==="chainsaw"&&o>=ic&&((u=i==null?void 0:i.forEach)==null||u.call(i,(d,h)=>{const p=ec(n,h.x,h.z);p!=="left"&&p!=="right"&&p!=="rear"||i.tryShred(d,n,{minSpeed:ic,cooldownSec:4,onShred:()=>s==null?void 0:s(d)})}))}function Gh(n,e,t){var c,l;const i=new L(e.x,.9,e.z),r=(l=(c=e.mesh)==null?void 0:c.getObjectByName("car-weapons"))==null?void 0:l.getObjectByName("weapon-mini_gun");r&&r.getWorldPosition(i);const s=new Zt().setFromPoints([i,t.clone()]),o=new Ql({color:16498468,transparent:!0,opacity:.9}),a=new zf(s,o);n.add(a),ri.push({mesh:a,life:.08})}function eE(n,e){for(let t=ri.length-1;t>=0;t--)ri[t].life-=e,ri[t].life<=0&&(n.remove(ri[t].mesh),ri[t].mesh.geometry.dispose(),ri[t].mesh.material.dispose(),ri.splice(t,1))}function tE(n){return String(n).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/"/g,"&quot;")}function nE(n,{onEquip:e,onClose:t,getCoinsText:i,onPurchaseFail:r}){let s=null,o=!1;s=document.createElement("div"),s.id="kill-shop",s.className="shop-overlay",s.innerHTML=`
  ...
  `,document.body.appendChild(o);const c=o.querySelector("#admin-shop-grid"),l=o.querySelector("#admin-shop-coins");let u="skins";function d(S){const T=S?Do:Do.filter(x=>n.ownsSkin(x.id));if(!S&&T.length===0){c.innerHTML='<p class="shop-empty">Buy a skin in the Skins tab!</p>';return}for(const x of T){const P=n.ownsSkin(x.id),b=n.getEquippedSkinId()===x.id,w=document.createElement("button");w.type="button",w.className="shop-item",b&&w.classList.add("equipped"),w.innerHTML=`
      ...
      `,y.addEventListener("click",()=>{var v;if(S)if(w)n.equipWeapon(b.id),e==null||e(b.id);else{const R=n.buyWeapon(b.id);R.ok?e==null||e(((v=R.weapon)==null?void 0:v.id)??b.id):R.reason==="insufficient"&&(s==null||s("insufficient"))}else n.equipWeapon(b.id),e==null||e(b.id);p()}),c.appendChild(y)}}function p(){if(c){if(c.innerHTML="",l.textContent=(r==null?void 0:r())??`Coins: ${n.getCoins()}`,u==="skins")d(!0);else if(u==="weapons")h(!0);else if(u==="equip"){const S=Do.filter(x=>n.ownsSkin(x.id)),T=Nh().filter(x=>n.ownsWeapon(x.id));if(S.length===0&&T.length===0){c.innerHTML='<p class="shop-empty">Buy skins or weapons first!</p>';return}S.length&&d(!1),T.length&&h(!1)}}}o.querySelectorAll(".shop-tab").forEach(S=>{S.addEventListener("click",()=>{u=S.dataset.tab,o.querySelectorAll(".shop-tab").forEach(T=>T.classList.toggle("active",T===S)),p()})}),o.querySelector("#admin-shop-close").addEventListener("click",()=>_());function g(){a=!0,o.style.display="flex",p()}function _(){a=!1,o.style.display="none",i==null||i()}function m(){return a}function f(){a&&p()}return{showAdminShop:g,hideAdminShop:_,isAdminShopVisible:m,refreshAdminShop:f}}const sc="ccwd-build";function rE(){const n=location.hostname;if(n==="localhost"||n==="127.0.0.1")return;const e=async()=>{try{const t=await fetch(`./version.json?_=${Date.now()}`,{cache:"no-store"});if(!t.ok)return;const{v:i}=await t.json();if(!i)return;const r=localStorage.getItem(sc);if(r&&r!==i){_b(),localStorage.setItem(sc,i),location.reload();return}r||localStorage.setItem(sc,i)}catch{}};e(),setInterval(e,180*1e3)}gb().then(()=>{rE()});const sE=5,Wh=7,oE=.05,Zp=0,Kp=0,Xh=5,aE=new URLSearchParams(window.location.search).has("teleport"),{canvas:Xt,ctx:he}=hm();Xt.id="title-canvas";Xt.style.position="fixed";Xt.style.inset="0";Xt.style.zIndex="1";const pn=new pm(document.body),tn=qv();tn.onExit(()=>nm());const Ve=dS(),pe=Gf(0,0);pS(Ve.scene,pe);const Rr=rb(Ve.scene);let Ct=cb()?"drawPaper":"title",rs=aE?1.8:0,ss=0,ho=0,oc=0,fs=!1,ps=!1,fo=!1,Pl=0,ot=null,Vi=!1,ac=0,vr=1,cc=!1,lc=!1,dc=!1,J=null,Pt=!1,hi=null,Bi=0,$h=0,Sr=0,ln=[],li=0,Yh=!1,qh={},hs=0;const ms=document.getElementById("action-toast"),bn=document.getElementById("controls-hud"),vi=document.getElementById("damage-hud"),Di=document.getElementById("room-banner"),Mr=document.getElementById("super-dash-btn"),po=document.getElementById("dash-score-hud"),Or=document.getElementById("death-overlay"),Wo=document.getElementById("death-timer"),br=document.getElementById("non-dying-btn"),Xo=document.getElementById("regenerate-btn"),uc=document.getElementById("coin-hud"),$o=document.getElementById("kill-shop-btn"),Yo=document.getElementById("admin-shop-btn");let $n=!1;function cE(){return(ot==null?void 0:ot.id)??"local"}const nn=Db(cE),Fi=Bb(Ve.scene);function bd(){return`Coins: ${nn.getCoins()}`}function Jp(n,e){!n||n<=0||(nn.addCoins(n),Cd(),mE(),xE(),e&&vt(e))}Fi.setOnDestroyed(()=>{});let jh={firing:!1};function lE(n,e){if(!n||n<=0)return;const t=e==="shred"?`+${n} coins — shredded!`:e==="target"?`+${n} coins — target destroyed!`:`+${n} coins — hit!`;Jp(n,t)}function dE(){const n=Math.round(zb*Xb(J));Jp(n,`+${n} coins — player shredded!`)}const uE=nE(nn,{getCoinsText:bd,onEquip:n=>{J&&oa(J,nn.ownsWeapon(n)?n:null);const e=nn.getEquippedWeapon();(e==null?void 0:e.type)==="mini_gun"?vt("Mini gun mounted — hold click to shoot!"):(e==null?void 0:e.type)==="saw_blade"?vt("Saw blade mounted — ram targets head-on!"):(e==null?void 0:e.type)==="chainsaw"?vt("Chainsaws mounted on sides & back — sideswipe to shred!"):vt("Weapon equipped on your car!")},onClose:()=>ji(),onPurchaseFail:()=>vt("Not enough coins!")}),hE=iE(nn,{getCoinsText:bd,onEquipWeapon:n=>{J&&oa(J,nn.ownsWeapon(n)?n:null);const e=nn.getEquippedWeapon();(e==null?void 0:e.type)==="mini_gun"?vt("Mini gun mounted — hold click to shoot!"):(e==null?void 0:e.type)==="saw_blade"?vt("Saw blade mounted — ram targets head-on!"):(e==null?void 0:e.type)==="chainsaw"?vt("Chainsaws mounted on sides & back — sideswipe to shred!"):vt("Weapon equipped on your car!")},onEquipSkin:()=>{vt("Skin equipped — spawn a car from the garage to apply it!")},onClose:()=>ji(),onPurchaseFail:()=>vt("Not enough coins!")}),{showKillShop:fE,hideKillShop:pE,isKillShopVisible:Ll,refreshKillShop:mE}=uE,{showAdminShop:gE,hideAdminShop:_E,isAdminShopVisible:Dl,refreshAdminShop:xE}=hE;function qn(){return Vi||!ot}rf(()=>qo(bn,{driving:Pt}));mS(Ed);lb(()=>Zh(),()=>Zh(!0));function Zh(n=!1){Ct="title",Xt.style.display="block",Yp(),n&&Vp()}Ct==="drawPaper"&&(Xt.style.display="none",ab());ib(({room:n,isHost:e})=>{ot=n,Vi=e,nn.resetForPlayer(),im(),yE(n),Ct="world",om(),sm(rm(n.code??"solo")),Io(),Fi.reset(),vt("You're in the game!")});function yE(n){n.onMessage=(e,t)=>{e.t==="pose"&&e.id&&e.id!==n.id&&(n.role==="host"&&n.relay(t,e),Rr.applyPose(e.id,e)),e.t==="join"&&e.id&&(Rr.applyPose(e.id,{x:0,z:4,facing:0,walkPhase:0,isMoving:!1}),vr+=1,Io(),vt("Someone joined!"),Vi&&pt.syncState()),e.t==="leave"&&e.id&&(Rr.remove(e.id),vr=Math.max(1,vr-1),Io()),(e.t==="dashState"||e.t==="dashCollect")&&(pt.handleMessage(e),Fr()),e.t==="dashScoreReset"&&(pt.handleMessage(e),Fr())},n.onPeerCount=e=>{vr=e,Io()}}function Io(){if(!(!Di||!(ot!=null&&ot.code)))if(Vi){const n=Gp(ot.code);Di.innerHTML=`Room <strong>${ot.code}</strong> · ${vr} player(s) · <a href="${n}" target="_blank" rel="noopener">Share link</a>`,Di.hidden=!1}else Di.textContent=`Room ${ot.code} · ${vr} player(s)`,Di.hidden=!1}function vE(){ot!=null&&ot.id&&ot.send({t:"pose",id:ot.id,x:pe.x,z:pe.z,facing:pe.facing,walkPhase:pe.walkPhase,isMoving:pe.isMoving})}const SE="cybertruck";function Qp(){if(hi!=null&&hi.id){const n=Ju(hi.id);if(n)return n}return Ju(SE)}function em(){var n;return((n=nn.getEquippedWeapon())==null?void 0:n.id)??null}function ME(){const n=nn.getEquippedWeapon();return(n==null?void 0:n.type)==="mini_gun"&&nn.ownsWeapon(n.id)}function Ed(n){n&&(hi=n,kr(),J&&(gd(pe,Ve.scene),md(Ve.scene,J),J=null,Pt=!1),J=EM(pe,buildSpawnSpec(n),Ve.clampPosition,Ve.envTex),xM(Ve.scene,J),oa(J,em()),rd(J),Pt=!0,tn.setDriving(!0),Jf(pe,J),ia(J),Ve.updateDrivingCamera(J.x,J.z,J.rotY),qo(bn,{driving:!0}),na(vi,!0),ta(vi,J),Td(),ji(),di(bn,!0,{driving:!0}))}function bE(n){if(!(!J||Bi>0)){if(oM(J,Ve.scene,n,ln),ta(vi,J),Zf(J)&&!$n){tm();return}if(ld(n)){ep(J,n);const e=Math.abs(n)>=38;Sr=e?.5:.22,Bi=e?.55:.4}else Math.abs(n)>5&&(J.speed*=.55,Bi=.12)}}function tm(){if(!pe.dead){if(pe.dead=!0,li=Xh,Pt&&J){const n=J.x,e=J.z,t=J.rotY;Qf(pe,J),pe.x=n,pe.z=e,pe.facing=t,J.speed=0,Pt=!1,tn.setDriving(!1),pt.setSuperDash(!1),J.superDashOn=!1}pt.resetPlayerScore(),Fr(),pe.mesh.rotation.x=-Math.PI/2,Gi(pe),di(bn,!1),na(vi,!1),ci(!1),Fr(),Or&&(Or.hidden=!1),Wo&&(Wo.textContent=`Respawning in ${Xh}...`),vt("Your car was destroyed!")}}function EE(){var e;pe.dead=!1,li=0,J&&(md(Ve.scene,J),J=null);for(const t of ln)(e=t.mesh.parent)==null||e.remove(t.mesh);ln.length=0,pe.x=Zp,pe.z=Kp,pe.facing=0,pe.mesh.rotation.set(0,0,0),pe.mesh.visible=!0,pe.inVehicle=null,Gi(pe),Pt=!1,tn.setDriving(!1),Or&&(Or.hidden=!0),ci(!0),kr(),di(bn,!0,{driving:!1});const n=Qp();n?(Ed(n),vt("Respawned — back in your car!")):(sd(),vt("Respawned at spawn!"))}function TE(n){li=Math.max(0,li-n),Wo&&(Wo.textContent=li>0?`Respawning in ${Math.ceil(li)}...`:"Respawning..."),pd(ln,n),Ve.updateWorld(pe.x,pe.z),Ve.updateCamera(pe.x,pe.z,pe.facing),li<=0&&EE()}function nm(){!J||!Pt||(Qf(pe,J),Pt=!1,tn.setDriving(!1),Gi(pe),Ve.updateCamera(pe.x,pe.z,pe.facing),qo(bn,{driving:!1}),na(vi,!1),vt("Exited vehicle"))}function wE(){return ym(pn)}function Kh(n,e){return{throttle:Math.max(n.throttle??0,e.throttle??0),brake:Math.max(n.brake??0,e.brake??0),reverse:Math.max(n.reverse??0,e.reverse??0),steer:Math.abs(n.steer)>Math.abs(e.steer)?n.steer:e.steer}}function Jh(n){var i,r;if(!n||Ct!=="world"||fc()||ll())return;const{fired:e,prevPressed:t}=Sm(n,Fl(),qh);qh=t;for(const s of e)vt(s.action);(i=n.buttons[9])!=null&&i.pressed&&!cc&&(cc=!0,sf()),(r=n==null?void 0:n.buttons[9])!=null&&r.pressed||(cc=!1)}function CE(n,e){const t=Math.max(0,Math.min(1,(e-n.topY)/(n.bottomY-n.topY)));return n.topW*2+(n.bottomW-n.topW*2)*t}function AE(n,e,t){const i=e*.56,r=CE(t,i),s=Math.min(r*.82,n*.78,420),o=s*.34;return{x:t.cx-s/2,y:i-o/2,w:s,h:o,cx:t.cx,cy:i}}function RE(n){const t=n.h*.72,i=n.w*.92,r=n.cy+n.h/2+14+t/2;return{x:n.cx-i/2,y:r-t/2,w:i,h:t,cx:n.cx,cy:r}}function PE(n,e){const t=Xt.getBoundingClientRect(),i=Xt.width/t.width,r=Xt.height/t.height;return{x:(n-t.left)*i,y:(e-t.top)*r}}function Qh(n,e,t){return n>=t.x&&n<=t.x+t.w&&e>=t.y&&e<=t.y+t.h}function LE(n,e,t){const i=e*.22,r=44,s="car crashing with ",o="dashing";he.save(),he.globalAlpha=t,he.font=`800 ${r}px system-ui, sans-serif`,he.textBaseline="middle";const a=he.measureText(s+o).width;let c=n/2-a/2;he.textAlign="left",he.fillStyle="#14532d",he.fillText(s,c,i),c+=he.measureText(s).width,he.fillText(o,c,i);const l=he.measureText(o).width,u=i+r*.38;he.strokeStyle="#14532d",he.lineWidth=4,he.beginPath(),he.moveTo(c,u),he.lineTo(c+l,u),he.stroke(),he.restore()}function ef(n,e,t,i,r,s){const o=1+Math.sin(i)*.04+(r?.05:0)+(s?-.03:0),a=n.w*o,c=n.h*o,l=n.cx-a/2,u=n.cy-c/2,d=c*.28;he.save(),he.shadowColor="rgba(0,0,0,0.45)",he.shadowBlur=24,he.shadowOffsetY=8;const h=he.createLinearGradient(l,u,l,u+c);h.addColorStop(0,s?t.pressedTop:t.top),h.addColorStop(1,s?t.pressedBottom:t.bottom),he.fillStyle=h,he.beginPath(),he.roundRect(l,u,a,c,d),he.fill(),he.shadowBlur=0,he.shadowOffsetY=0,he.strokeStyle=t.stroke,he.lineWidth=5,he.stroke(),hc(he,e,n.cx,n.cy,{size:Math.floor(c*.38),color:t.text}),he.restore()}function im(){var n;$n=!1,J&&(gd(pe,Ve.scene),md(Ve.scene,J),J=null),Pt=!1,hi=null,tn.setDriving(!1),pe.dead=!1,li=0,pe.x=Zp,pe.z=Kp,pe.facing=0,pe.mesh.rotation.set(0,0,0),pe.mesh.visible=!0,pe.inVehicle=null,Gi(pe);for(const e of ln)(n=e.mesh.parent)==null||n.remove(e.mesh);ln.length=0,Bi=0,Sr=0,pt.setSuperDash(!1),pt.resetPlayerScore(),Or&&(Or.hidden=!0),na(vi,!1),kr(),pE(),_E()}function DE(){Ct="comingSoon",Pl=sE,ot=null,Vi=!1,nn.resetForPlayer(),im(),om(),sm(rm(String(Date.now()))),Fi.reset()}function IE(n,e){const t=PE(pn.pointer.x,pn.pointer.y);fs=Qh(t.x,t.y,n),ps=Qh(t.x,t.y,e),Xt.style.cursor=fs||ps?"pointer":"default",pn.pointer.down&&!fo&&(fs?(DE(),fo=!0):ps&&(Vp(),fo=!0)),pn.pointer.down||(fo=!1)}function tf(n,e,t=1){const i=n/2,r=e*.42,s=e,o=n*.08*t,a=n*.92;return{cx:i,topY:r,bottomY:s,topW:o,bottomW:a}}function UE(n,e,t){if(t<=0)return tf(n,e,t);const i=tf(n,e,t),{cx:r,topY:s,bottomY:o,topW:a,bottomW:c}=i;he.save(),he.globalAlpha=Math.min(1,t);const l=he.createLinearGradient(0,s,0,o);return l.addColorStop(0,"#334155"),l.addColorStop(1,"#1e293b"),he.fillStyle=l,he.beginPath(),he.moveTo(r-a,s),he.lineTo(r+a,s),he.lineTo(r+c/2,o),he.lineTo(r-c/2,o),he.closePath(),he.fill(),he.strokeStyle="rgba(250,204,21,0.85)",he.lineWidth=3,he.setLineDash([18,16]),he.beginPath(),he.moveTo(r,s),he.lineTo(r,o),he.stroke(),he.setLineDash([]),he.fillStyle="rgba(15,23,42,0.35)",he.fillRect(0,e*.72,n,e*.28),he.restore(),i}function vt(n){hs=2,ms&&(ms.textContent=n,ms.classList.add("show"))}function rm(n){let e=0;for(let t=0;t<n.length;t++)e=(e<<5)-e+n.charCodeAt(t)|0;return Math.abs(e)||1}const pt=wb(Ve.scene,{getPlayerId:()=>(ot==null?void 0:ot.id)??"local",isHost:()=>!ot||Vi,send:n=>{ot&&(Vi&&n.t==="dashState"?ot.send(n):n.t==="dashCollect"||n.t==="dashScoreReset"?ot.sendToHost(n):ot.send(n))}});pt.setToast(vt);function sm(n){pt.reset(n),pt.isSessionActive()&&vt("Blue Dashing circles spawned — collect them!")}function NE(){var n,e;if(!(!qn()||!J||!hi||pe.dead)){for(let t=ln.length-1;t>=0;t--)ln[t].isPart&&((n=ln[t].mesh.parent)==null||n.remove(ln[t].mesh),ln.splice(t,1));(e=nn.getEquippedWeapon())==null||e.id,gd(pe,Ve.scene),MM(J,Ve.scene,buildSpawnSpec(hi),Ve.envTex),oa(J,em()),Jf(pe,J),ta(vi,J),vt("Car regenerated — good as new!")}}function Td(){if(!Xo)return;const n=qn()&&Pt&&J&&!pe.dead&&(Ct==="world"||Ct==="comingSoon");Xo.hidden=!n}Xo&&Xo.addEventListener("click",()=>NE());function wd(){if(!br)return;qn()||($n=!1);const n=qn()&&(Ct==="world"||Ct==="comingSoon")&&!pe.dead;br.hidden=!n,br.classList.toggle("active",$n),br.textContent=$n?"NON-DYING":"DYING ON"}br&&br.addEventListener("click",()=>{qn()&&($n=!$n,wd(),vt($n?"Non-dying ON — drive with no parts!":"Dying ON — destroyed car kills you"))});function Cd(){if(!uc)return;const n=(Ct==="world"||Ct==="comingSoon")&&!pe.dead;uc.hidden=!n,uc.textContent=bd()}function ji(){const n=(Ct==="world"||Ct==="comingSoon")&&!pe.dead,e=Ll()||Dl();$o&&($o.hidden=!n||qn()||e),Yo&&(Yo.hidden=!n||!qn()||e)}$o&&$o.addEventListener("click",()=>{qn()||(fE(),ji())});Yo&&Yo.addEventListener("click",()=>{qn()&&(gE(),ji())});function Fr(){const n=pt.isLocalLeader()&&Pt&&pt.isSessionActive();if(Mr&&(Mr.hidden=!n,Mr.classList.toggle("active",pt.isSuperDashOn()),Mr.textContent=pt.isSuperDashOn()?"NORMAL SPEED":"SUPER DASH"),po)if(Ct==="world"&&pt.isSessionActive()){const e=pt.getScores(),t=e[(ot==null?void 0:ot.id)??"local"]??0,i=pt.getLeaderIds(),r=i.length?Math.max(...i.map(s=>e[s]??0)):0;po.hidden=!1,po.textContent=`Dashing: ${t}${n?" ★ LEADING":""} · Best: ${r}`}else po.hidden=!0;n?J&&(J.superDashOn=pt.isSuperDashOn(),J.superMaxSpeed=pt.SUPER_MAX_SPEED,J.superAccelMult=pt.SUPER_ACCEL_MULT):(pt.setSuperDash(!1),J&&(J.superDashOn=!1))}Mr&&Mr.addEventListener("click",()=>{if(!pt.isLocalLeader()||!Pt||!J)return;const n=pt.toggleSuperDash();J.superDashOn=n,J.superMaxSpeed=pt.SUPER_MAX_SPEED,J.superAccelMult=pt.SUPER_ACCEL_MULT,vt(n?"Super dash ON!":"Normal speed"),Fr()});function om(){if(Xt.style.display="none",Ve.show(),Yh||(Kv(Ve.renderer.domElement),jb(Ve.renderer.domElement),Yh=!0),ci(!0),kr(),tn.setVisible(!0),!Pt&&!pe.dead){const n=Qp();n?Ed(n):sd()}else tn.setDriving(Pt),di(bn,!0,{driving:Pt});wd(),Td(),Cd(),ji()}function kE(n){if(pe.dead){TE(n);return}const e=gm();let{mx:t,mz:i}=_m(e);const r=xm(pn),s=tn.readMove();t+=r.mx+s.mx,i+=r.mz+s.mz;const o=Math.hypot(t,i);if(o>1&&(t/=o,i/=o),Bi>0&&(Bi=Math.max(0,Bi-n)),Sr>0&&(Sr=Math.max(0,Sr-n*2.8)),$h+=n,Pt&&J){const u=vm(e),d=wE(),h=tn.readDrive(),p=Kh(Kh(u,d),h),{impactSpeed:g,wallHit:_}=bM(J,p,n,Ve.clampPosition),m=Ve.city.checkCarCollision(J.x,J.z,J.rotY,J.collisionHw??1.15,J.collisionHd??2.25),f=Fi.checkCarCollision(J.x,J.z,J.rotY,J.collisionHw??1.15,J.collisionHd??2.25);if(m||_||f){const S=g;f&&Fi.applyCarImpact(f,S),bE(S),f?(J.x=J.prevX,J.z=J.prevZ,Math.abs(S)>5?ep(J,S):J.speed*=.45):ld(S)||(J.x=J.prevX,J.z=J.prevZ),ia(J)}if(SM(J,$h,n),pd(ln,n),Fi.update(n),jh=Kb(n,{vehicle:J,camera:Ve.camera,renderer:Ve.renderer,scene:Ve.scene,shredTargets:Fi,remotePlayers:Rr,onTargetHit:lE,onPlayerShred:dE,canFireMinigun:ME}),$b(J,n,jh.firing),Rr.tickCooldowns(n),ta(vi,J),Zf(J)&&!$n){tm();return}Ve.updateWorld(J.x,J.z),Ve.updateDrivingCamera(J.x,J.z,J.rotY,Sr),Jh(e),pn.isPressed("e")&&!dc&&(dc=!0,nm()),pn.isPressed("e")||(dc=!1);return}fS(pe,t,i,n);const a=pe.x+t*Wh*n,c=pe.z+i*Wh*n,l=Ve.clampPosition(a,c);pe.x=l.x,pe.z=l.z,Gi(pe),Ve.updateWorld(pe.x,pe.z),Ve.updateCamera(pe.x,pe.z,pe.facing),Rr.lerpAll(n),ac+=n,ac>=oE&&(ac=0,vE()),Jh(e),pn.isPressed("m")&&!lc&&(lc=!0,sf()),pn.isPressed("m")||(lc=!1)}function OE(n){const{width:e,height:t}=Xt;if(!((fc()||ll()||Eh()||Rh()||Ll()||Dl())&&(di(bn,!1),fc()||Rh()))){if(hs>0&&(hs=Math.max(0,hs-n),hs===0&&ms&&ms.classList.remove("show")),rs>0){rs=Math.max(0,rs-n);const i=rs>.35?1-(1.8-rs)/1.45:0;Xt.style.display="block",Ve.hide(),ci(!1),tn.setVisible(!1),kd(he,i>.2?"#e0f2fe":"#22c55e"),i>.05&&(he.fillStyle=`rgba(255,255,255,${i*.75})`,he.fillRect(0,0,e,t)),hc(he,"TELEPORTING...",e/2,t*.38,{color:"#0f172a",size:36});return}if(Ct==="drawPaper"){Xt.style.display="none",Ve.hide(),ci(!1),tn.setVisible(!1);return}if(Ct==="title"){Xt.style.display="block",Ve.hide(),ci(!1),tn.setVisible(!1),di(bn,!1),Di&&(Di.hidden=!0),ss=Math.min(1,ss+n*1.2),ho=Math.min(1,ho+n*.55),oc+=n*4,kd(he,"#22c55e");const i=UE(e,t,ho),r=AE(e,t,i),s=RE(r);if(he.globalAlpha=ss,LE(e,t,ss),hc(he,"The best game ever — realism incoming.",e/2,t*.3,{color:"#166534",size:18}),he.globalAlpha=1,!Eh()){IE(r,s);const o=Math.min(1,.35+ho*.65)*ss;he.globalAlpha=o,ef(r,"PLAY",{top:"#fde047",bottom:"#facc15",pressedTop:"#facc15",pressedBottom:"#eab308",stroke:"#854d0e",text:"#422006"},oc,fs,pn.pointer.down&&fs),ef(s,"MULTIPLAYER",{top:"#4ade80",bottom:"#22c55e",pressedTop:"#22c55e",pressedBottom:"#16a34a",stroke:"#14532d",text:"#14532d"},oc+.5,ps,pn.pointer.down&&ps),he.globalAlpha=1}return}(Ct==="comingSoon"||Ct==="world")&&(Ve.renderer.domElement.style.boxShadow="",pt.update(n,Pt?J:null),pd(ln,n),Fr(),wd(),Td(),Cd(),ji(),!ll()&&!Ll()&&!Dl()&&kE(n),Ct==="comingSoon"?(Pl-=n,Pl<=0&&(Ct="world"),di(bn,!0,{driving:Pt}),ci(!0),tn.setVisible(!1)):(ci(!0),di(bn,!0,{driving:Pt})),Ve.render())}}window.addEventListener("gamepadconnected",()=>{});mm(OE);
